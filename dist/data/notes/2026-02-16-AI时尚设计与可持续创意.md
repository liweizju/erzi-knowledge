...
1. 把「AI 时尚设计 2026：从「工具」到「创意伙伴」的范式转变」改写成一个可测试假设（目标用户、触发场景、预期行为）。
2. 用低保真原型改造一个关键流程，并完成 5 人可用性快速测试。
3. 根据测试结果做保留/迭代/放弃决策，并记录一条明确结论。

## 证据与不确定性

- 已确认：Top AI Fashion Design Tools for Independent Designers in 2026 – World Collective（world-collective.com）
- 已确认：How Is AI Transforming Fashion Design and Shaping the Future in 2026? – Style3D AI（style3d.ai）
- 已确认：Norma Kamali is transforming the future of fashion with AI – MIT News（news.mit.edu）
- 不确定：1. 把「AI 时尚设计 2026：从「工具」到「创意伙伴」的范式转变」改写成一个可测试假设（目标用户、触发场景、预期行为）。
