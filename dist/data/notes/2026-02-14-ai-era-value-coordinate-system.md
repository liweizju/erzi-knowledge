...
> **30秒结论**：价值公式重构：传统"能力 × 效率 × 稀缺性"失效；新公式是"存在深度 × 智能密度 × 可控性"
...
1. 围绕「AI 时代的价值坐标系重构：能力、智能、存在的三角博弈」盘点当前工作流最耗时的 1 个环节，记录基线数据。
...
- 已确认：Large Language Models and Emergence | arXiv（arxiv.org）
