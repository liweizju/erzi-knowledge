...
> **30秒结论**：从"工具"到"关系"的设计范式转变：Agentic AI 不是设计工具，而是设计用户与 AI 之间的伙伴关系，需要沟通、理解和边界。
...
- 已确认：Designing For Agentic AI: Practical UX Patterns | Smashing Magazine（smashingmagazine.com）
