var qo=Object.defineProperty;var Jo=(n,e,t)=>e in n?qo(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var Q=(n,e,t)=>Jo(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();/**
* @vue/shared v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ci(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const Y={},Pe=[],Vn=()=>{},Ls=()=>!1,Pt=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),Ai=n=>n.startsWith("onUpdate:"),gn=Object.assign,Ii=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Yo=Object.prototype.hasOwnProperty,z=(n,e)=>Yo.call(n,e),E=Array.isArray,Ce=n=>nt(n)==="[object Map]",Gs=n=>nt(n)==="[object Set]",Hi=n=>nt(n)==="[object Date]",N=n=>typeof n=="function",an=n=>typeof n=="string",$n=n=>typeof n=="symbol",q=n=>n!==null&&typeof n=="object",Ds=n=>(q(n)||N(n))&&N(n.then)&&N(n.catch),xs=Object.prototype.toString,nt=n=>xs.call(n),Zo=n=>nt(n).slice(8,-1),Bs=n=>nt(n)==="[object Object]",ui=n=>an(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,Ve=ci(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ct=n=>{const e=Object.create(null);return(t=>e[t]||(e[t]=n(t)))},nr=/-\w/g,ae=Ct(n=>n.replace(nr,e=>e.slice(1).toUpperCase())),er=/\B([A-Z])/g,fe=Ct(n=>n.replace(er,"-$1").toLowerCase()),Es=Ct(n=>n.charAt(0).toUpperCase()+n.slice(1)),Ut=Ct(n=>n?`on${Es(n)}`:""),re=(n,e)=>!Object.is(n,e),It=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},Us=(n,e,t,i=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:i,value:t})},gi=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Ki;const Mt=()=>Ki||(Ki=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function di(n){if(E(n)){const e={};for(let t=0;t<n.length;t++){const i=n[t],s=an(i)?or(i):di(i);if(s)for(const o in s)e[o]=s[o]}return e}else if(an(n)||q(n))return n}const tr=/;(?![^(]*\))/g,ir=/:([^]+)/,sr=/\/\*[^]*?\*\//g;function or(n){const e={};return n.replace(sr,"").split(tr).forEach(t=>{if(t){const i=t.split(ir);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Me(n){let e="";if(an(n))e=n;else if(E(n))for(let t=0;t<n.length;t++){const i=Me(n[t]);i&&(e+=i+" ")}else if(q(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const rr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",ar=ci(rr);function Ns(n){return!!n||n===""}function lr(n,e){if(n.length!==e.length)return!1;let t=!0;for(let i=0;t&&i<n.length;i++)t=hi(n[i],e[i]);return t}function hi(n,e){if(n===e)return!0;let t=Hi(n),i=Hi(e);if(t||i)return t&&i?n.getTime()===e.getTime():!1;if(t=$n(n),i=$n(e),t||i)return n===e;if(t=E(n),i=E(e),t||i)return t&&i?lr(n,e):!1;if(t=q(n),i=q(e),t||i){if(!t||!i)return!1;const s=Object.keys(n).length,o=Object.keys(e).length;if(s!==o)return!1;for(const r in n){const a=n.hasOwnProperty(r),l=e.hasOwnProperty(r);if(a&&!l||!a&&l||!hi(n[r],e[r]))return!1}}return String(n)===String(e)}const Fs=n=>!!(n&&n.__v_isRef===!0),en=n=>an(n)?n:n==null?"":E(n)||q(n)&&(n.toString===xs||!N(n.toString))?Fs(n)?en(n.value):JSON.stringify(n,Os,2):String(n),Os=(n,e)=>Fs(e)?Os(n,e.value):Ce(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[i,s],o)=>(t[Nt(i,o)+" =>"]=s,t),{})}:Gs(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>Nt(t))}:$n(e)?Nt(e):q(e)&&!E(e)&&!Bs(e)?String(e):e,Nt=(n,e="")=>{var t;return $n(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let vn;class cr{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=vn,!e&&vn&&(this.index=(vn.scopes||(vn.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=vn;try{return vn=this,e()}finally{vn=t}}}on(){++this._on===1&&(this.prevScope=vn,vn=this)}off(){this._on>0&&--this._on===0&&(vn=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Ar(){return vn}let tn;const Ft=new WeakSet;class Ws{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,vn&&vn.active&&vn.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ft.has(this)&&(Ft.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Vs(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,zi(this),$s(this);const e=tn,t=xn;tn=this,xn=!0;try{return this.fn()}finally{Hs(this),tn=e,xn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)fi(e);this.deps=this.depsTail=void 0,zi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ft.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Xt(this)&&this.run()}get dirty(){return Xt(this)}}let _s=0,$e,He;function Vs(n,e=!1){if(n.flags|=8,e){n.next=He,He=n;return}n.next=$e,$e=n}function pi(){_s++}function mi(){if(--_s>0)return;if(He){let e=He;for(He=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;$e;){let e=$e;for($e=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(i){n||(n=i)}e=t}}if(n)throw n}function $s(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Hs(n){let e,t=n.depsTail,i=t;for(;i;){const s=i.prevDep;i.version===-1?(i===t&&(t=s),fi(i),Ir(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}n.deps=e,n.depsTail=t}function Xt(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Ks(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function Ks(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Qe)||(n.globalVersion=Qe,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Xt(n))))return;n.flags|=2;const e=n.dep,t=tn,i=xn;tn=n,xn=!0;try{$s(n);const s=n.fn(n._value);(e.version===0||re(s,n._value))&&(n.flags|=128,n._value=s,e.version++)}catch(s){throw e.version++,s}finally{tn=t,xn=i,Hs(n),n.flags&=-3}}function fi(n,e=!1){const{dep:t,prevSub:i,nextSub:s}=n;if(i&&(i.nextSub=s,n.prevSub=void 0),s&&(s.prevSub=i,n.nextSub=void 0),t.subs===n&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let o=t.computed.deps;o;o=o.nextDep)fi(o,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Ir(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let xn=!0;const zs=[];function Zn(){zs.push(xn),xn=!1}function ne(){const n=zs.pop();xn=n===void 0?!0:n}function zi(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=tn;tn=void 0;try{e()}finally{tn=t}}}let Qe=0;class ur{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class yi{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!tn||!xn||tn===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==tn)t=this.activeLink=new ur(tn,this),tn.deps?(t.prevDep=tn.depsTail,tn.depsTail.nextDep=t,tn.depsTail=t):tn.deps=tn.depsTail=t,js(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=tn.depsTail,t.nextDep=void 0,tn.depsTail.nextDep=t,tn.depsTail=t,tn.deps===t&&(tn.deps=i)}return t}trigger(e){this.version++,Qe++,this.notify(e)}notify(e){pi();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{mi()}}}function js(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)js(i)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Qt=new WeakMap,he=Symbol(""),qt=Symbol(""),qe=Symbol("");function In(n,e,t){if(xn&&tn){let i=Qt.get(n);i||Qt.set(n,i=new Map);let s=i.get(t);s||(i.set(t,s=new yi),s.map=i,s.key=t),s.track()}}function qn(n,e,t,i,s,o){const r=Qt.get(n);if(!r){Qe++;return}const a=l=>{l&&l.trigger()};if(pi(),e==="clear")r.forEach(a);else{const l=E(n),c=l&&ui(t);if(l&&t==="length"){const A=Number(i);r.forEach((g,p)=>{(p==="length"||p===qe||!$n(p)&&p>=A)&&a(g)})}else switch((t!==void 0||r.has(void 0))&&a(r.get(t)),c&&a(r.get(qe)),e){case"add":l?c&&a(r.get("length")):(a(r.get(he)),Ce(n)&&a(r.get(qt)));break;case"delete":l||(a(r.get(he)),Ce(n)&&a(r.get(qt)));break;case"set":Ce(n)&&a(r.get(he));break}}mi()}function we(n){const e=K(n);return e===n?e:(In(e,"iterate",qe),Rn(n)?e:e.map(Bn))}function Tt(n){return In(n=K(n),"iterate",qe),n}function se(n,e){return ee(n)?Re(pe(n)?Bn(e):e):Bn(e)}const gr={__proto__:null,[Symbol.iterator](){return Ot(this,Symbol.iterator,n=>se(this,n))},concat(...n){return we(this).concat(...n.map(e=>E(e)?we(e):e))},entries(){return Ot(this,"entries",n=>(n[1]=se(this,n[1]),n))},every(n,e){return Kn(this,"every",n,e,void 0,arguments)},filter(n,e){return Kn(this,"filter",n,e,t=>t.map(i=>se(this,i)),arguments)},find(n,e){return Kn(this,"find",n,e,t=>se(this,t),arguments)},findIndex(n,e){return Kn(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return Kn(this,"findLast",n,e,t=>se(this,t),arguments)},findLastIndex(n,e){return Kn(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return Kn(this,"forEach",n,e,void 0,arguments)},includes(...n){return Wt(this,"includes",n)},indexOf(...n){return Wt(this,"indexOf",n)},join(n){return we(this).join(n)},lastIndexOf(...n){return Wt(this,"lastIndexOf",n)},map(n,e){return Kn(this,"map",n,e,void 0,arguments)},pop(){return Be(this,"pop")},push(...n){return Be(this,"push",n)},reduce(n,...e){return ji(this,"reduce",n,e)},reduceRight(n,...e){return ji(this,"reduceRight",n,e)},shift(){return Be(this,"shift")},some(n,e){return Kn(this,"some",n,e,void 0,arguments)},splice(...n){return Be(this,"splice",n)},toReversed(){return we(this).toReversed()},toSorted(n){return we(this).toSorted(n)},toSpliced(...n){return we(this).toSpliced(...n)},unshift(...n){return Be(this,"unshift",n)},values(){return Ot(this,"values",n=>se(this,n))}};function Ot(n,e,t){const i=Tt(n),s=i[e]();return i!==n&&!Rn(n)&&(s._next=s.next,s.next=()=>{const o=s._next();return o.done||(o.value=t(o.value)),o}),s}const dr=Array.prototype;function Kn(n,e,t,i,s,o){const r=Tt(n),a=r!==n&&!Rn(n),l=r[e];if(l!==dr[e]){const g=l.apply(n,o);return a?Bn(g):g}let c=t;r!==n&&(a?c=function(g,p){return t.call(this,se(n,g),p,n)}:t.length>2&&(c=function(g,p){return t.call(this,g,p,n)}));const A=l.call(r,c,i);return a&&s?s(A):A}function ji(n,e,t,i){const s=Tt(n);let o=t;return s!==n&&(Rn(n)?t.length>3&&(o=function(r,a,l){return t.call(this,r,a,l,n)}):o=function(r,a,l){return t.call(this,r,se(n,a),l,n)}),s[e](o,...i)}function Wt(n,e,t){const i=K(n);In(i,"iterate",qe);const s=i[e](...t);return(s===-1||s===!1)&&Si(t[0])?(t[0]=K(t[0]),i[e](...t)):s}function Be(n,e,t=[]){Zn(),pi();const i=K(n)[e].apply(n,t);return mi(),ne(),i}const hr=ci("__proto__,__v_isRef,__isVue"),Xs=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter($n));function pr(n){$n(n)||(n=String(n));const e=K(this);return In(e,"has",n),e.hasOwnProperty(n)}class Qs{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,i){if(t==="__v_skip")return e.__v_skip;const s=this._isReadonly,o=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return o;if(t==="__v_raw")return i===(s?o?Mr:Zs:o?Ys:Js).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const r=E(e);if(!s){let l;if(r&&(l=gr[t]))return l;if(t==="hasOwnProperty")return pr}const a=Reflect.get(e,t,un(e)?e:i);if(($n(t)?Xs.has(t):hr(t))||(s||In(e,"get",t),o))return a;if(un(a)){const l=r&&ui(t)?a:a.value;return s&&q(l)?Yt(l):l}return q(a)?s?Yt(a):bi(a):a}}class qs extends Qs{constructor(e=!1){super(!1,e)}set(e,t,i,s){let o=e[t];const r=E(e)&&ui(t);if(!this._isShallow){const c=ee(o);if(!Rn(i)&&!ee(i)&&(o=K(o),i=K(i)),!r&&un(o)&&!un(i))return c||(o.value=i),!0}const a=r?Number(t)<e.length:z(e,t),l=Reflect.set(e,t,i,un(e)?e:s);return e===K(s)&&(a?re(i,o)&&qn(e,"set",t,i):qn(e,"add",t,i)),l}deleteProperty(e,t){const i=z(e,t);e[t];const s=Reflect.deleteProperty(e,t);return s&&i&&qn(e,"delete",t,void 0),s}has(e,t){const i=Reflect.has(e,t);return(!$n(t)||!Xs.has(t))&&In(e,"has",t),i}ownKeys(e){return In(e,"iterate",E(e)?"length":he),Reflect.ownKeys(e)}}class mr extends Qs{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const fr=new qs,yr=new mr,wr=new qs(!0);const Jt=n=>n,rt=n=>Reflect.getPrototypeOf(n);function br(n,e,t){return function(...i){const s=this.__v_raw,o=K(s),r=Ce(o),a=n==="entries"||n===Symbol.iterator&&r,l=n==="keys"&&r,c=s[n](...i),A=t?Jt:e?Re:Bn;return!e&&In(o,"iterate",l?qt:he),gn(Object.create(c),{next(){const{value:g,done:p}=c.next();return p?{value:g,done:p}:{value:a?[A(g[0]),A(g[1])]:A(g),done:p}}})}}function at(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function vr(n,e){const t={get(s){const o=this.__v_raw,r=K(o),a=K(s);n||(re(s,a)&&In(r,"get",s),In(r,"get",a));const{has:l}=rt(r),c=e?Jt:n?Re:Bn;if(l.call(r,s))return c(o.get(s));if(l.call(r,a))return c(o.get(a));o!==r&&o.get(s)},get size(){const s=this.__v_raw;return!n&&In(K(s),"iterate",he),s.size},has(s){const o=this.__v_raw,r=K(o),a=K(s);return n||(re(s,a)&&In(r,"has",s),In(r,"has",a)),s===a?o.has(s):o.has(s)||o.has(a)},forEach(s,o){const r=this,a=r.__v_raw,l=K(a),c=e?Jt:n?Re:Bn;return!n&&In(l,"iterate",he),a.forEach((A,g)=>s.call(o,c(A),c(g),r))}};return gn(t,n?{add:at("add"),set:at("set"),delete:at("delete"),clear:at("clear")}:{add(s){!e&&!Rn(s)&&!ee(s)&&(s=K(s));const o=K(this);return rt(o).has.call(o,s)||(o.add(s),qn(o,"add",s,s)),this},set(s,o){!e&&!Rn(o)&&!ee(o)&&(o=K(o));const r=K(this),{has:a,get:l}=rt(r);let c=a.call(r,s);c||(s=K(s),c=a.call(r,s));const A=l.call(r,s);return r.set(s,o),c?re(o,A)&&qn(r,"set",s,o):qn(r,"add",s,o),this},delete(s){const o=K(this),{has:r,get:a}=rt(o);let l=r.call(o,s);l||(s=K(s),l=r.call(o,s)),a&&a.call(o,s);const c=o.delete(s);return l&&qn(o,"delete",s,void 0),c},clear(){const s=K(this),o=s.size!==0,r=s.clear();return o&&qn(s,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=br(s,n,e)}),t}function wi(n,e){const t=vr(n,e);return(i,s,o)=>s==="__v_isReactive"?!n:s==="__v_isReadonly"?n:s==="__v_raw"?i:Reflect.get(z(t,s)&&s in i?t:i,s,o)}const Sr={get:wi(!1,!1)},Pr={get:wi(!1,!0)},Cr={get:wi(!0,!1)};const Js=new WeakMap,Ys=new WeakMap,Zs=new WeakMap,Mr=new WeakMap;function Tr(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function kr(n){return n.__v_skip||!Object.isExtensible(n)?0:Tr(Zo(n))}function bi(n){return ee(n)?n:vi(n,!1,fr,Sr,Js)}function Rr(n){return vi(n,!1,wr,Pr,Ys)}function Yt(n){return vi(n,!0,yr,Cr,Zs)}function vi(n,e,t,i,s){if(!q(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const o=kr(n);if(o===0)return n;const r=s.get(n);if(r)return r;const a=new Proxy(n,o===2?i:t);return s.set(n,a),a}function pe(n){return ee(n)?pe(n.__v_raw):!!(n&&n.__v_isReactive)}function ee(n){return!!(n&&n.__v_isReadonly)}function Rn(n){return!!(n&&n.__v_isShallow)}function Si(n){return n?!!n.__v_raw:!1}function K(n){const e=n&&n.__v_raw;return e?K(e):n}function Lr(n){return!z(n,"__v_skip")&&Object.isExtensible(n)&&Us(n,"__v_skip",!0),n}const Bn=n=>q(n)?bi(n):n,Re=n=>q(n)?Yt(n):n;function un(n){return n?n.__v_isRef===!0:!1}function Ee(n){return Gr(n,!1)}function Gr(n,e){return un(n)?n:new Dr(n,e)}class Dr{constructor(e,t){this.dep=new yi,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:K(e),this._value=t?e:Bn(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,i=this.__v_isShallow||Rn(e)||ee(e);e=i?e:K(e),re(e,t)&&(this._rawValue=e,this._value=i?e:Bn(e),this.dep.trigger())}}function Oe(n){return un(n)?n.value:n}const xr={get:(n,e,t)=>e==="__v_raw"?n:Oe(Reflect.get(n,e,t)),set:(n,e,t,i)=>{const s=n[e];return un(s)&&!un(t)?(s.value=t,!0):Reflect.set(n,e,t,i)}};function no(n){return pe(n)?n:new Proxy(n,xr)}class Br{constructor(e,t,i){this.fn=e,this.setter=t,this._value=void 0,this.dep=new yi(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Qe-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&tn!==this)return Vs(this,!0),!0}get value(){const e=this.dep.track();return Ks(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function Er(n,e,t=!1){let i,s;return N(n)?i=n:(i=n.get,s=n.set),new Br(i,s,t)}const lt={},ht=new WeakMap;let ge;function Ur(n,e=!1,t=ge){if(t){let i=ht.get(t);i||ht.set(t,i=[]),i.push(n)}}function Nr(n,e,t=Y){const{immediate:i,deep:s,once:o,scheduler:r,augmentJob:a,call:l}=t,c=G=>s?G:Rn(G)||s===!1||s===0?Jn(G,1):Jn(G);let A,g,p,d,k=!1,b=!1;if(un(n)?(g=()=>n.value,k=Rn(n)):pe(n)?(g=()=>c(n),k=!0):E(n)?(b=!0,k=n.some(G=>pe(G)||Rn(G)),g=()=>n.map(G=>{if(un(G))return G.value;if(pe(G))return c(G);if(N(G))return l?l(G,2):G()})):N(n)?e?g=l?()=>l(n,2):n:g=()=>{if(p){Zn();try{p()}finally{ne()}}const G=ge;ge=A;try{return l?l(n,3,[d]):n(d)}finally{ge=G}}:g=Vn,e&&s){const G=g,sn=s===!0?1/0:s;g=()=>Jn(G(),sn)}const x=Ar(),_=()=>{A.stop(),x&&x.active&&Ii(x.effects,A)};if(o&&e){const G=e;e=(...sn)=>{G(...sn),_()}}let F=b?new Array(n.length).fill(lt):lt;const V=G=>{if(!(!(A.flags&1)||!A.dirty&&!G))if(e){const sn=A.run();if(s||k||(b?sn.some((Mn,ln)=>re(Mn,F[ln])):re(sn,F))){p&&p();const Mn=ge;ge=A;try{const ln=[sn,F===lt?void 0:b&&F[0]===lt?[]:F,d];F=sn,l?l(e,3,ln):e(...ln)}finally{ge=Mn}}}else A.run()};return a&&a(V),A=new Ws(g),A.scheduler=r?()=>r(V,!1):V,d=G=>Ur(G,!1,A),p=A.onStop=()=>{const G=ht.get(A);if(G){if(l)l(G,4);else for(const sn of G)sn();ht.delete(A)}},e?i?V(!0):F=A.run():r?r(V.bind(null,!0),!0):A.run(),_.pause=A.pause.bind(A),_.resume=A.resume.bind(A),_.stop=_,_}function Jn(n,e=1/0,t){if(e<=0||!q(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,un(n))Jn(n.value,e,t);else if(E(n))for(let i=0;i<n.length;i++)Jn(n[i],e,t);else if(Gs(n)||Ce(n))n.forEach(i=>{Jn(i,e,t)});else if(Bs(n)){for(const i in n)Jn(n[i],e,t);for(const i of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,i)&&Jn(n[i],e,t)}return n}/**
* @vue/runtime-core v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function et(n,e,t,i){try{return i?n(...i):n()}catch(s){kt(s,e,t)}}function Hn(n,e,t,i){if(N(n)){const s=et(n,e,t,i);return s&&Ds(s)&&s.catch(o=>{kt(o,e,t)}),s}if(E(n)){const s=[];for(let o=0;o<n.length;o++)s.push(Hn(n[o],e,t,i));return s}}function kt(n,e,t,i=!0){const s=e?e.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=e&&e.appContext.config||Y;if(e){let a=e.parent;const l=e.proxy,c=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const A=a.ec;if(A){for(let g=0;g<A.length;g++)if(A[g](n,l,c)===!1)return}a=a.parent}if(o){Zn(),et(o,null,10,[n,l,c]),ne();return}}Fr(n,t,s,i,r)}function Fr(n,e,t,i=!0,s=!1){if(s)throw n;console.error(n)}const pn=[];let Wn=-1;const Te=[];let oe=null,ve=0;const eo=Promise.resolve();let pt=null;function Zt(n){const e=pt||eo;return n?e.then(this?n.bind(this):n):e}function Or(n){let e=Wn+1,t=pn.length;for(;e<t;){const i=e+t>>>1,s=pn[i],o=Je(s);o<n||o===n&&s.flags&2?e=i+1:t=i}return e}function Pi(n){if(!(n.flags&1)){const e=Je(n),t=pn[pn.length-1];!t||!(n.flags&2)&&e>=Je(t)?pn.push(n):pn.splice(Or(e),0,n),n.flags|=1,to()}}function to(){pt||(pt=eo.then(so))}function Wr(n){E(n)?Te.push(...n):oe&&n.id===-1?oe.splice(ve+1,0,n):n.flags&1||(Te.push(n),n.flags|=1),to()}function Xi(n,e,t=Wn+1){for(;t<pn.length;t++){const i=pn[t];if(i&&i.flags&2){if(n&&i.id!==n.uid)continue;pn.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function io(n){if(Te.length){const e=[...new Set(Te)].sort((t,i)=>Je(t)-Je(i));if(Te.length=0,oe){oe.push(...e);return}for(oe=e,ve=0;ve<oe.length;ve++){const t=oe[ve];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}oe=null,ve=0}}const Je=n=>n.id==null?n.flags&2?-1:1/0:n.id;function so(n){try{for(Wn=0;Wn<pn.length;Wn++){const e=pn[Wn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),et(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Wn<pn.length;Wn++){const e=pn[Wn];e&&(e.flags&=-2)}Wn=-1,pn.length=0,io(),pt=null,(pn.length||Te.length)&&so()}}let kn=null,oo=null;function mt(n){const e=kn;return kn=n,oo=n&&n.type.__scopeId||null,e}function _r(n,e=kn,t){if(!e||n._n)return n;const i=(...s)=>{i._d&&os(-1);const o=mt(e);let r;try{r=n(...s)}finally{mt(o),i._d&&os(1)}return r};return i._n=!0,i._c=!0,i._d=!0,i}function Vr(n,e){if(kn===null)return n;const t=Dt(kn),i=n.dirs||(n.dirs=[]);for(let s=0;s<e.length;s++){let[o,r,a,l=Y]=e[s];o&&(N(o)&&(o={mounted:o,updated:o}),o.deep&&Jn(r),i.push({dir:o,instance:t,value:r,oldValue:void 0,arg:a,modifiers:l}))}return n}function Ie(n,e,t,i){const s=n.dirs,o=e&&e.dirs;for(let r=0;r<s.length;r++){const a=s[r];o&&(a.oldValue=o[r].value);let l=a.dir[i];l&&(Zn(),Hn(l,t,8,[n.el,a,n,e]),ne())}}function $r(n,e){if(mn){let t=mn.provides;const i=mn.parent&&mn.parent.provides;i===t&&(t=mn.provides=Object.create(i)),t[n]=e}}function ut(n,e,t=!1){const i=Va();if(i||ke){let s=ke?ke._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&n in s)return s[n];if(arguments.length>1)return t&&N(e)?e.call(i&&i.proxy):e}}const Hr=Symbol.for("v-scx"),Kr=()=>ut(Hr);function _t(n,e,t){return ro(n,e,t)}function ro(n,e,t=Y){const{immediate:i,deep:s,flush:o,once:r}=t,a=gn({},t),l=e&&i||!e&&o!=="post";let c;if(Ze){if(o==="sync"){const d=Kr();c=d.__watcherHandles||(d.__watcherHandles=[])}else if(!l){const d=()=>{};return d.stop=Vn,d.resume=Vn,d.pause=Vn,d}}const A=mn;a.call=(d,k,b)=>Hn(d,A,k,b);let g=!1;o==="post"?a.scheduler=d=>{bn(d,A&&A.suspense)}:o!=="sync"&&(g=!0,a.scheduler=(d,k)=>{k?d():Pi(d)}),a.augmentJob=d=>{e&&(d.flags|=4),g&&(d.flags|=2,A&&(d.id=A.uid,d.i=A))};const p=Nr(n,e,a);return Ze&&(c?c.push(p):l&&p()),p}function zr(n,e,t){const i=this.proxy,s=an(n)?n.includes(".")?ao(i,n):()=>i[n]:n.bind(i,i);let o;N(e)?o=e:(o=e.handler,t=e);const r=tt(this),a=ro(s,o.bind(i),t);return r(),a}function ao(n,e){const t=e.split(".");return()=>{let i=n;for(let s=0;s<t.length&&i;s++)i=i[t[s]];return i}}const jr=Symbol("_vte"),Xr=n=>n.__isTeleport,Qr=Symbol("_leaveCb");function Ci(n,e){n.shapeFlag&6&&n.component?(n.transition=e,Ci(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function lo(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Qi(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const ft=new WeakMap;function Ke(n,e,t,i,s=!1){if(E(n)){n.forEach((b,x)=>Ke(b,e&&(E(e)?e[x]:e),t,i,s));return}if(ze(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&Ke(n,e,t,i.component.subTree);return}const o=i.shapeFlag&4?Dt(i.component):i.el,r=s?null:o,{i:a,r:l}=n,c=e&&e.r,A=a.refs===Y?a.refs={}:a.refs,g=a.setupState,p=K(g),d=g===Y?Ls:b=>Qi(A,b)?!1:z(p,b),k=(b,x)=>!(x&&Qi(A,x));if(c!=null&&c!==l){if(qi(e),an(c))A[c]=null,d(c)&&(g[c]=null);else if(un(c)){const b=e;k(c,b.k)&&(c.value=null),b.k&&(A[b.k]=null)}}if(N(l))et(l,a,12,[r,A]);else{const b=an(l),x=un(l);if(b||x){const _=()=>{if(n.f){const F=b?d(l)?g[l]:A[l]:k()||!n.k?l.value:A[n.k];if(s)E(F)&&Ii(F,o);else if(E(F))F.includes(o)||F.push(o);else if(b)A[l]=[o],d(l)&&(g[l]=A[l]);else{const V=[o];k(l,n.k)&&(l.value=V),n.k&&(A[n.k]=V)}}else b?(A[l]=r,d(l)&&(g[l]=r)):x&&(k(l,n.k)&&(l.value=r),n.k&&(A[n.k]=r))};if(r){const F=()=>{_(),ft.delete(n)};F.id=-1,ft.set(n,F),bn(F,t)}else qi(n),_()}}}function qi(n){const e=ft.get(n);e&&(e.flags|=8,ft.delete(n))}Mt().requestIdleCallback;Mt().cancelIdleCallback;const ze=n=>!!n.type.__asyncLoader,co=n=>n.type.__isKeepAlive;function qr(n,e){Ao(n,"a",e)}function Jr(n,e){Ao(n,"da",e)}function Ao(n,e,t=mn){const i=n.__wdc||(n.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return n()});if(Rt(e,i,t),t){let s=t.parent;for(;s&&s.parent;)co(s.parent.vnode)&&Yr(i,e,t,s),s=s.parent}}function Yr(n,e,t,i){const s=Rt(e,n,i,!0);Mi(()=>{Ii(i[e],s)},t)}function Rt(n,e,t=mn,i=!1){if(t){const s=t[n]||(t[n]=[]),o=e.__weh||(e.__weh=(...r)=>{Zn();const a=tt(t),l=Hn(e,t,n,r);return a(),ne(),l});return i?s.unshift(o):s.push(o),o}}const te=n=>(e,t=mn)=>{(!Ze||n==="sp")&&Rt(n,(...i)=>e(...i),t)},Zr=te("bm"),Io=te("m"),na=te("bu"),ea=te("u"),ta=te("bum"),Mi=te("um"),ia=te("sp"),sa=te("rtg"),oa=te("rtc");function ra(n,e=mn){Rt("ec",n,e)}const aa=Symbol.for("v-ndc");function be(n,e,t,i){let s;const o=t,r=E(n);if(r||an(n)){const a=r&&pe(n);let l=!1,c=!1;a&&(l=!Rn(n),c=ee(n),n=Tt(n)),s=new Array(n.length);for(let A=0,g=n.length;A<g;A++)s[A]=e(l?c?Re(Bn(n[A])):Bn(n[A]):n[A],A,void 0,o)}else if(typeof n=="number"){s=new Array(n);for(let a=0;a<n;a++)s[a]=e(a+1,a,void 0,o)}else if(q(n))if(n[Symbol.iterator])s=Array.from(n,(a,l)=>e(a,l,void 0,o));else{const a=Object.keys(n);s=new Array(a.length);for(let l=0,c=a.length;l<c;l++){const A=a[l];s[l]=e(n[A],A,l,o)}}else s=[];return s}const ni=n=>n?xo(n)?Dt(n):ni(n.parent):null,je=gn(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>ni(n.parent),$root:n=>ni(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>go(n),$forceUpdate:n=>n.f||(n.f=()=>{Pi(n.update)}),$nextTick:n=>n.n||(n.n=Zt.bind(n.proxy)),$watch:n=>zr.bind(n)}),Vt=(n,e)=>n!==Y&&!n.__isScriptSetup&&z(n,e),la={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:i,data:s,props:o,accessCache:r,type:a,appContext:l}=n;if(e[0]!=="$"){const p=r[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return s[e];case 4:return t[e];case 3:return o[e]}else{if(Vt(i,e))return r[e]=1,i[e];if(s!==Y&&z(s,e))return r[e]=2,s[e];if(z(o,e))return r[e]=3,o[e];if(t!==Y&&z(t,e))return r[e]=4,t[e];ei&&(r[e]=0)}}const c=je[e];let A,g;if(c)return e==="$attrs"&&In(n.attrs,"get",""),c(n);if((A=a.__cssModules)&&(A=A[e]))return A;if(t!==Y&&z(t,e))return r[e]=4,t[e];if(g=l.config.globalProperties,z(g,e))return g[e]},set({_:n},e,t){const{data:i,setupState:s,ctx:o}=n;return Vt(s,e)?(s[e]=t,!0):i!==Y&&z(i,e)?(i[e]=t,!0):z(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(o[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:i,appContext:s,props:o,type:r}},a){let l;return!!(t[a]||n!==Y&&a[0]!=="$"&&z(n,a)||Vt(e,a)||z(o,a)||z(i,a)||z(je,a)||z(s.config.globalProperties,a)||(l=r.__cssModules)&&l[a])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:z(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Ji(n){return E(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let ei=!0;function ca(n){const e=go(n),t=n.proxy,i=n.ctx;ei=!1,e.beforeCreate&&Yi(e.beforeCreate,n,"bc");const{data:s,computed:o,methods:r,watch:a,provide:l,inject:c,created:A,beforeMount:g,mounted:p,beforeUpdate:d,updated:k,activated:b,deactivated:x,beforeDestroy:_,beforeUnmount:F,destroyed:V,unmounted:G,render:sn,renderTracked:Mn,renderTriggered:ln,errorCaptured:cn,serverPrefetch:T,expose:C,inheritAttrs:J,components:Tn,directives:U,filters:dn}=e;if(c&&Aa(c,i,null),r)for(const on in r){const Z=r[on];N(Z)&&(i[on]=Z.bind(t))}if(s){const on=s.call(t,t);q(on)&&(n.data=bi(on))}if(ei=!0,o)for(const on in o){const Z=o[on],ce=N(Z)?Z.bind(t,t):N(Z.get)?Z.get.bind(t,t):Vn,st=!N(Z)&&N(Z.set)?Z.set.bind(t):Vn,Ae=ie({get:ce,set:st});Object.defineProperty(i,on,{enumerable:!0,configurable:!0,get:()=>Ae.value,set:En=>Ae.value=En})}if(a)for(const on in a)uo(a[on],i,t,on);if(l){const on=N(l)?l.call(t):l;Reflect.ownKeys(on).forEach(Z=>{$r(Z,on[Z])})}A&&Yi(A,n,"c");function An(on,Z){E(Z)?Z.forEach(ce=>on(ce.bind(t))):Z&&on(Z.bind(t))}if(An(Zr,g),An(Io,p),An(na,d),An(ea,k),An(qr,b),An(Jr,x),An(ra,cn),An(oa,Mn),An(sa,ln),An(ta,F),An(Mi,G),An(ia,T),E(C))if(C.length){const on=n.exposed||(n.exposed={});C.forEach(Z=>{Object.defineProperty(on,Z,{get:()=>t[Z],set:ce=>t[Z]=ce,enumerable:!0})})}else n.exposed||(n.exposed={});sn&&n.render===Vn&&(n.render=sn),J!=null&&(n.inheritAttrs=J),Tn&&(n.components=Tn),U&&(n.directives=U),T&&lo(n)}function Aa(n,e,t=Vn){E(n)&&(n=ti(n));for(const i in n){const s=n[i];let o;q(s)?"default"in s?o=ut(s.from||i,s.default,!0):o=ut(s.from||i):o=ut(s),un(o)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):e[i]=o}}function Yi(n,e,t){Hn(E(n)?n.map(i=>i.bind(e.proxy)):n.bind(e.proxy),e,t)}function uo(n,e,t,i){let s=i.includes(".")?ao(t,i):()=>t[i];if(an(n)){const o=e[n];N(o)&&_t(s,o)}else if(N(n))_t(s,n.bind(t));else if(q(n))if(E(n))n.forEach(o=>uo(o,e,t,i));else{const o=N(n.handler)?n.handler.bind(t):e[n.handler];N(o)&&_t(s,o,n)}}function go(n){const e=n.type,{mixins:t,extends:i}=e,{mixins:s,optionsCache:o,config:{optionMergeStrategies:r}}=n.appContext,a=o.get(e);let l;return a?l=a:!s.length&&!t&&!i?l=e:(l={},s.length&&s.forEach(c=>yt(l,c,r,!0)),yt(l,e,r)),q(e)&&o.set(e,l),l}function yt(n,e,t,i=!1){const{mixins:s,extends:o}=e;o&&yt(n,o,t,!0),s&&s.forEach(r=>yt(n,r,t,!0));for(const r in e)if(!(i&&r==="expose")){const a=Ia[r]||t&&t[r];n[r]=a?a(n[r],e[r]):e[r]}return n}const Ia={data:Zi,props:ns,emits:ns,methods:We,computed:We,beforeCreate:hn,created:hn,beforeMount:hn,mounted:hn,beforeUpdate:hn,updated:hn,beforeDestroy:hn,beforeUnmount:hn,destroyed:hn,unmounted:hn,activated:hn,deactivated:hn,errorCaptured:hn,serverPrefetch:hn,components:We,directives:We,watch:ga,provide:Zi,inject:ua};function Zi(n,e){return e?n?function(){return gn(N(n)?n.call(this,this):n,N(e)?e.call(this,this):e)}:e:n}function ua(n,e){return We(ti(n),ti(e))}function ti(n){if(E(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function hn(n,e){return n?[...new Set([].concat(n,e))]:e}function We(n,e){return n?gn(Object.create(null),n,e):e}function ns(n,e){return n?E(n)&&E(e)?[...new Set([...n,...e])]:gn(Object.create(null),Ji(n),Ji(e??{})):e}function ga(n,e){if(!n)return e;if(!e)return n;const t=gn(Object.create(null),n);for(const i in e)t[i]=hn(n[i],e[i]);return t}function ho(){return{app:null,config:{isNativeTag:Ls,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let da=0;function ha(n,e){return function(i,s=null){N(i)||(i=gn({},i)),s!=null&&!q(s)&&(s=null);const o=ho(),r=new WeakSet,a=[];let l=!1;const c=o.app={_uid:da++,_component:i,_props:s,_container:null,_context:o,_instance:null,version:Xa,get config(){return o.config},set config(A){},use(A,...g){return r.has(A)||(A&&N(A.install)?(r.add(A),A.install(c,...g)):N(A)&&(r.add(A),A(c,...g))),c},mixin(A){return o.mixins.includes(A)||o.mixins.push(A),c},component(A,g){return g?(o.components[A]=g,c):o.components[A]},directive(A,g){return g?(o.directives[A]=g,c):o.directives[A]},mount(A,g,p){if(!l){const d=c._ceVNode||Yn(i,s);return d.appContext=o,p===!0?p="svg":p===!1&&(p=void 0),n(d,A,p),l=!0,c._container=A,A.__vue_app__=c,Dt(d.component)}},onUnmount(A){a.push(A)},unmount(){l&&(Hn(a,c._instance,16),n(null,c._container),delete c._container.__vue_app__)},provide(A,g){return o.provides[A]=g,c},runWithContext(A){const g=ke;ke=c;try{return A()}finally{ke=g}}};return c}}let ke=null;const pa=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${ae(e)}Modifiers`]||n[`${fe(e)}Modifiers`];function ma(n,e,...t){if(n.isUnmounted)return;const i=n.vnode.props||Y;let s=t;const o=e.startsWith("update:"),r=o&&pa(i,e.slice(7));r&&(r.trim&&(s=t.map(A=>an(A)?A.trim():A)),r.number&&(s=t.map(gi)));let a,l=i[a=Ut(e)]||i[a=Ut(ae(e))];!l&&o&&(l=i[a=Ut(fe(e))]),l&&Hn(l,n,6,s);const c=i[a+"Once"];if(c){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,Hn(c,n,6,s)}}const fa=new WeakMap;function po(n,e,t=!1){const i=t?fa:e.emitsCache,s=i.get(n);if(s!==void 0)return s;const o=n.emits;let r={},a=!1;if(!N(n)){const l=c=>{const A=po(c,e,!0);A&&(a=!0,gn(r,A))};!t&&e.mixins.length&&e.mixins.forEach(l),n.extends&&l(n.extends),n.mixins&&n.mixins.forEach(l)}return!o&&!a?(q(n)&&i.set(n,null),null):(E(o)?o.forEach(l=>r[l]=null):gn(r,o),q(n)&&i.set(n,r),r)}function Lt(n,e){return!n||!Pt(e)?!1:(e=e.slice(2).replace(/Once$/,""),z(n,e[0].toLowerCase()+e.slice(1))||z(n,fe(e))||z(n,e))}function es(n){const{type:e,vnode:t,proxy:i,withProxy:s,propsOptions:[o],slots:r,attrs:a,emit:l,render:c,renderCache:A,props:g,data:p,setupState:d,ctx:k,inheritAttrs:b}=n,x=mt(n);let _,F;try{if(t.shapeFlag&4){const G=s||i,sn=G;_=_n(c.call(sn,G,A,g,d,p,k)),F=a}else{const G=e;_=_n(G.length>1?G(g,{attrs:a,slots:r,emit:l}):G(g,null)),F=e.props?a:ya(a)}}catch(G){Xe.length=0,kt(G,n,1),_=Yn(le)}let V=_;if(F&&b!==!1){const G=Object.keys(F),{shapeFlag:sn}=V;G.length&&sn&7&&(o&&G.some(Ai)&&(F=wa(F,o)),V=Le(V,F,!1,!0))}return t.dirs&&(V=Le(V,null,!1,!0),V.dirs=V.dirs?V.dirs.concat(t.dirs):t.dirs),t.transition&&Ci(V,t.transition),_=V,mt(x),_}const ya=n=>{let e;for(const t in n)(t==="class"||t==="style"||Pt(t))&&((e||(e={}))[t]=n[t]);return e},wa=(n,e)=>{const t={};for(const i in n)(!Ai(i)||!(i.slice(9)in e))&&(t[i]=n[i]);return t};function ba(n,e,t){const{props:i,children:s,component:o}=n,{props:r,children:a,patchFlag:l}=e,c=o.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?ts(i,r,c):!!r;if(l&8){const A=e.dynamicProps;for(let g=0;g<A.length;g++){const p=A[g];if(mo(r,i,p)&&!Lt(c,p))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:i===r?!1:i?r?ts(i,r,c):!0:!!r;return!1}function ts(n,e,t){const i=Object.keys(e);if(i.length!==Object.keys(n).length)return!0;for(let s=0;s<i.length;s++){const o=i[s];if(mo(e,n,o)&&!Lt(t,o))return!0}return!1}function mo(n,e,t){const i=n[t],s=e[t];return t==="style"&&q(i)&&q(s)?!hi(i,s):i!==s}function va({vnode:n,parent:e},t){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.el=n.el),i===n)(n=e.vnode).el=t,e=e.parent;else break}}const fo={},yo=()=>Object.create(fo),wo=n=>Object.getPrototypeOf(n)===fo;function Sa(n,e,t,i=!1){const s={},o=yo();n.propsDefaults=Object.create(null),bo(n,e,s,o);for(const r in n.propsOptions[0])r in s||(s[r]=void 0);t?n.props=i?s:Rr(s):n.type.props?n.props=s:n.props=o,n.attrs=o}function Pa(n,e,t,i){const{props:s,attrs:o,vnode:{patchFlag:r}}=n,a=K(s),[l]=n.propsOptions;let c=!1;if((i||r>0)&&!(r&16)){if(r&8){const A=n.vnode.dynamicProps;for(let g=0;g<A.length;g++){let p=A[g];if(Lt(n.emitsOptions,p))continue;const d=e[p];if(l)if(z(o,p))d!==o[p]&&(o[p]=d,c=!0);else{const k=ae(p);s[k]=ii(l,a,k,d,n,!1)}else d!==o[p]&&(o[p]=d,c=!0)}}}else{bo(n,e,s,o)&&(c=!0);let A;for(const g in a)(!e||!z(e,g)&&((A=fe(g))===g||!z(e,A)))&&(l?t&&(t[g]!==void 0||t[A]!==void 0)&&(s[g]=ii(l,a,g,void 0,n,!0)):delete s[g]);if(o!==a)for(const g in o)(!e||!z(e,g))&&(delete o[g],c=!0)}c&&qn(n.attrs,"set","")}function bo(n,e,t,i){const[s,o]=n.propsOptions;let r=!1,a;if(e)for(let l in e){if(Ve(l))continue;const c=e[l];let A;s&&z(s,A=ae(l))?!o||!o.includes(A)?t[A]=c:(a||(a={}))[A]=c:Lt(n.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,r=!0)}if(o){const l=K(t),c=a||Y;for(let A=0;A<o.length;A++){const g=o[A];t[g]=ii(s,l,g,c[g],n,!z(c,g))}}return r}function ii(n,e,t,i,s,o){const r=n[t];if(r!=null){const a=z(r,"default");if(a&&i===void 0){const l=r.default;if(r.type!==Function&&!r.skipFactory&&N(l)){const{propsDefaults:c}=s;if(t in c)i=c[t];else{const A=tt(s);i=c[t]=l.call(null,e),A()}}else i=l;s.ce&&s.ce._setProp(t,i)}r[0]&&(o&&!a?i=!1:r[1]&&(i===""||i===fe(t))&&(i=!0))}return i}const Ca=new WeakMap;function vo(n,e,t=!1){const i=t?Ca:e.propsCache,s=i.get(n);if(s)return s;const o=n.props,r={},a=[];let l=!1;if(!N(n)){const A=g=>{l=!0;const[p,d]=vo(g,e,!0);gn(r,p),d&&a.push(...d)};!t&&e.mixins.length&&e.mixins.forEach(A),n.extends&&A(n.extends),n.mixins&&n.mixins.forEach(A)}if(!o&&!l)return q(n)&&i.set(n,Pe),Pe;if(E(o))for(let A=0;A<o.length;A++){const g=ae(o[A]);is(g)&&(r[g]=Y)}else if(o)for(const A in o){const g=ae(A);if(is(g)){const p=o[A],d=r[g]=E(p)||N(p)?{type:p}:gn({},p),k=d.type;let b=!1,x=!0;if(E(k))for(let _=0;_<k.length;++_){const F=k[_],V=N(F)&&F.name;if(V==="Boolean"){b=!0;break}else V==="String"&&(x=!1)}else b=N(k)&&k.name==="Boolean";d[0]=b,d[1]=x,(b||z(d,"default"))&&a.push(g)}}const c=[r,a];return q(n)&&i.set(n,c),c}function is(n){return n[0]!=="$"&&!Ve(n)}const Ti=n=>n==="_"||n==="_ctx"||n==="$stable",ki=n=>E(n)?n.map(_n):[_n(n)],Ma=(n,e,t)=>{if(e._n)return e;const i=_r((...s)=>ki(e(...s)),t);return i._c=!1,i},So=(n,e,t)=>{const i=n._ctx;for(const s in n){if(Ti(s))continue;const o=n[s];if(N(o))e[s]=Ma(s,o,i);else if(o!=null){const r=ki(o);e[s]=()=>r}}},Po=(n,e)=>{const t=ki(e);n.slots.default=()=>t},Co=(n,e,t)=>{for(const i in e)(t||!Ti(i))&&(n[i]=e[i])},Ta=(n,e,t)=>{const i=n.slots=yo();if(n.vnode.shapeFlag&32){const s=e._;s?(Co(i,e,t),t&&Us(i,"_",s,!0)):So(e,i)}else e&&Po(n,e)},ka=(n,e,t)=>{const{vnode:i,slots:s}=n;let o=!0,r=Y;if(i.shapeFlag&32){const a=e._;a?t&&a===1?o=!1:Co(s,e,t):(o=!e.$stable,So(e,s)),r=e}else e&&(Po(n,e),r={default:1});if(o)for(const a in s)!Ti(a)&&r[a]==null&&delete s[a]},bn=xa;function Ra(n){return La(n)}function La(n,e){const t=Mt();t.__VUE__=!0;const{insert:i,remove:s,patchProp:o,createElement:r,createText:a,createComment:l,setText:c,setElementText:A,parentNode:g,nextSibling:p,setScopeId:d=Vn,insertStaticContent:k}=n,b=(I,u,h,w=null,m=null,f=null,P=void 0,S=null,v=!!u.dynamicChildren)=>{if(I===u)return;I&&!Ue(I,u)&&(w=ot(I),En(I,m,f,!0),I=null),u.patchFlag===-2&&(v=!1,u.dynamicChildren=null);const{type:y,ref:D,shapeFlag:M}=u;switch(y){case Gt:x(I,u,h,w);break;case le:_(I,u,h,w);break;case Ht:I==null&&F(u,h,w,P);break;case rn:Tn(I,u,h,w,m,f,P,S,v);break;default:M&1?sn(I,u,h,w,m,f,P,S,v):M&6?U(I,u,h,w,m,f,P,S,v):(M&64||M&128)&&y.process(I,u,h,w,m,f,P,S,v,De)}D!=null&&m?Ke(D,I&&I.ref,f,u||I,!u):D==null&&I&&I.ref!=null&&Ke(I.ref,null,f,I,!0)},x=(I,u,h,w)=>{if(I==null)i(u.el=a(u.children),h,w);else{const m=u.el=I.el;u.children!==I.children&&c(m,u.children)}},_=(I,u,h,w)=>{I==null?i(u.el=l(u.children||""),h,w):u.el=I.el},F=(I,u,h,w)=>{[I.el,I.anchor]=k(I.children,u,h,w,I.el,I.anchor)},V=({el:I,anchor:u},h,w)=>{let m;for(;I&&I!==u;)m=p(I),i(I,h,w),I=m;i(u,h,w)},G=({el:I,anchor:u})=>{let h;for(;I&&I!==u;)h=p(I),s(I),I=h;s(u)},sn=(I,u,h,w,m,f,P,S,v)=>{if(u.type==="svg"?P="svg":u.type==="math"&&(P="mathml"),I==null)Mn(u,h,w,m,f,P,S,v);else{const y=I.el&&I.el._isVueCE?I.el:null;try{y&&y._beginPatch(),T(I,u,m,f,P,S,v)}finally{y&&y._endPatch()}}},Mn=(I,u,h,w,m,f,P,S)=>{let v,y;const{props:D,shapeFlag:M,transition:L,dirs:B}=I;if(v=I.el=r(I.type,f,D&&D.is,D),M&8?A(v,I.children):M&16&&cn(I.children,v,null,w,m,$t(I,f),P,S),B&&Ie(I,null,w,"created"),ln(v,I,I.scopeId,P,w),D){for(const nn in D)nn!=="value"&&!Ve(nn)&&o(v,nn,null,D[nn],f,w);"value"in D&&o(v,"value",null,D.value,f),(y=D.onVnodeBeforeMount)&&On(y,w,I)}B&&Ie(I,null,w,"beforeMount");const O=Ga(m,L);O&&L.beforeEnter(v),i(v,u,h),((y=D&&D.onVnodeMounted)||O||B)&&bn(()=>{y&&On(y,w,I),O&&L.enter(v),B&&Ie(I,null,w,"mounted")},m)},ln=(I,u,h,w,m)=>{if(h&&d(I,h),w)for(let f=0;f<w.length;f++)d(I,w[f]);if(m){let f=m.subTree;if(u===f||Ro(f.type)&&(f.ssContent===u||f.ssFallback===u)){const P=m.vnode;ln(I,P,P.scopeId,P.slotScopeIds,m.parent)}}},cn=(I,u,h,w,m,f,P,S,v=0)=>{for(let y=v;y<I.length;y++){const D=I[y]=S?Qn(I[y]):_n(I[y]);b(null,D,u,h,w,m,f,P,S)}},T=(I,u,h,w,m,f,P)=>{const S=u.el=I.el;let{patchFlag:v,dynamicChildren:y,dirs:D}=u;v|=I.patchFlag&16;const M=I.props||Y,L=u.props||Y;let B;if(h&&ue(h,!1),(B=L.onVnodeBeforeUpdate)&&On(B,h,u,I),D&&Ie(u,I,h,"beforeUpdate"),h&&ue(h,!0),(M.innerHTML&&L.innerHTML==null||M.textContent&&L.textContent==null)&&A(S,""),y?C(I.dynamicChildren,y,S,h,w,$t(u,m),f):P||Z(I,u,S,null,h,w,$t(u,m),f,!1),v>0){if(v&16)J(S,M,L,h,m);else if(v&2&&M.class!==L.class&&o(S,"class",null,L.class,m),v&4&&o(S,"style",M.style,L.style,m),v&8){const O=u.dynamicProps;for(let nn=0;nn<O.length;nn++){const X=O[nn],yn=M[X],wn=L[X];(wn!==yn||X==="value")&&o(S,X,yn,wn,m,h)}}v&1&&I.children!==u.children&&A(S,u.children)}else!P&&y==null&&J(S,M,L,h,m);((B=L.onVnodeUpdated)||D)&&bn(()=>{B&&On(B,h,u,I),D&&Ie(u,I,h,"updated")},w)},C=(I,u,h,w,m,f,P)=>{for(let S=0;S<u.length;S++){const v=I[S],y=u[S],D=v.el&&(v.type===rn||!Ue(v,y)||v.shapeFlag&198)?g(v.el):h;b(v,y,D,null,w,m,f,P,!0)}},J=(I,u,h,w,m)=>{if(u!==h){if(u!==Y)for(const f in u)!Ve(f)&&!(f in h)&&o(I,f,u[f],null,m,w);for(const f in h){if(Ve(f))continue;const P=h[f],S=u[f];P!==S&&f!=="value"&&o(I,f,S,P,m,w)}"value"in h&&o(I,"value",u.value,h.value,m)}},Tn=(I,u,h,w,m,f,P,S,v)=>{const y=u.el=I?I.el:a(""),D=u.anchor=I?I.anchor:a("");let{patchFlag:M,dynamicChildren:L,slotScopeIds:B}=u;B&&(S=S?S.concat(B):B),I==null?(i(y,h,w),i(D,h,w),cn(u.children||[],h,D,m,f,P,S,v)):M>0&&M&64&&L&&I.dynamicChildren&&I.dynamicChildren.length===L.length?(C(I.dynamicChildren,L,h,m,f,P,S),(u.key!=null||m&&u===m.subTree)&&Mo(I,u,!0)):Z(I,u,h,D,m,f,P,S,v)},U=(I,u,h,w,m,f,P,S,v)=>{u.slotScopeIds=S,I==null?u.shapeFlag&512?m.ctx.activate(u,h,w,P,v):dn(u,h,w,m,f,P,v):Sn(I,u,v)},dn=(I,u,h,w,m,f,P)=>{const S=I.component=_a(I,w,m);if(co(I)&&(S.ctx.renderer=De),$a(S,!1,P),S.asyncDep){if(m&&m.registerDep(S,An,P),!I.el){const v=S.subTree=Yn(le);_(null,v,u,h),I.placeholder=v.el}}else An(S,I,u,h,m,f,P)},Sn=(I,u,h)=>{const w=u.component=I.component;if(ba(I,u,h))if(w.asyncDep&&!w.asyncResolved){on(w,u,h);return}else w.next=u,w.update();else u.el=I.el,w.vnode=u},An=(I,u,h,w,m,f,P)=>{const S=()=>{if(I.isMounted){let{next:M,bu:L,u:B,parent:O,vnode:nn}=I;{const Nn=To(I);if(Nn){M&&(M.el=nn.el,on(I,M,P)),Nn.asyncDep.then(()=>{bn(()=>{I.isUnmounted||y()},m)});return}}let X=M,yn;ue(I,!1),M?(M.el=nn.el,on(I,M,P)):M=nn,L&&It(L),(yn=M.props&&M.props.onVnodeBeforeUpdate)&&On(yn,O,M,nn),ue(I,!0);const wn=es(I),Un=I.subTree;I.subTree=wn,b(Un,wn,g(Un.el),ot(Un),I,m,f),M.el=wn.el,X===null&&va(I,wn.el),B&&bn(B,m),(yn=M.props&&M.props.onVnodeUpdated)&&bn(()=>On(yn,O,M,nn),m)}else{let M;const{el:L,props:B}=u,{bm:O,m:nn,parent:X,root:yn,type:wn}=I,Un=ze(u);ue(I,!1),O&&It(O),!Un&&(M=B&&B.onVnodeBeforeMount)&&On(M,X,u),ue(I,!0);{yn.ce&&yn.ce._hasShadowRoot()&&yn.ce._injectChildStyle(wn);const Nn=I.subTree=es(I);b(null,Nn,h,w,I,m,f),u.el=Nn.el}if(nn&&bn(nn,m),!Un&&(M=B&&B.onVnodeMounted)){const Nn=u;bn(()=>On(M,X,Nn),m)}(u.shapeFlag&256||X&&ze(X.vnode)&&X.vnode.shapeFlag&256)&&I.a&&bn(I.a,m),I.isMounted=!0,u=h=w=null}};I.scope.on();const v=I.effect=new Ws(S);I.scope.off();const y=I.update=v.run.bind(v),D=I.job=v.runIfDirty.bind(v);D.i=I,D.id=I.uid,v.scheduler=()=>Pi(D),ue(I,!0),y()},on=(I,u,h)=>{u.component=I;const w=I.vnode.props;I.vnode=u,I.next=null,Pa(I,u.props,w,h),ka(I,u.children,h),Zn(),Xi(I),ne()},Z=(I,u,h,w,m,f,P,S,v=!1)=>{const y=I&&I.children,D=I?I.shapeFlag:0,M=u.children,{patchFlag:L,shapeFlag:B}=u;if(L>0){if(L&128){st(y,M,h,w,m,f,P,S,v);return}else if(L&256){ce(y,M,h,w,m,f,P,S,v);return}}B&8?(D&16&&Ge(y,m,f),M!==y&&A(h,M)):D&16?B&16?st(y,M,h,w,m,f,P,S,v):Ge(y,m,f,!0):(D&8&&A(h,""),B&16&&cn(M,h,w,m,f,P,S,v))},ce=(I,u,h,w,m,f,P,S,v)=>{I=I||Pe,u=u||Pe;const y=I.length,D=u.length,M=Math.min(y,D);let L;for(L=0;L<M;L++){const B=u[L]=v?Qn(u[L]):_n(u[L]);b(I[L],B,h,null,m,f,P,S,v)}y>D?Ge(I,m,f,!0,!1,M):cn(u,h,w,m,f,P,S,v,M)},st=(I,u,h,w,m,f,P,S,v)=>{let y=0;const D=u.length;let M=I.length-1,L=D-1;for(;y<=M&&y<=L;){const B=I[y],O=u[y]=v?Qn(u[y]):_n(u[y]);if(Ue(B,O))b(B,O,h,null,m,f,P,S,v);else break;y++}for(;y<=M&&y<=L;){const B=I[M],O=u[L]=v?Qn(u[L]):_n(u[L]);if(Ue(B,O))b(B,O,h,null,m,f,P,S,v);else break;M--,L--}if(y>M){if(y<=L){const B=L+1,O=B<D?u[B].el:w;for(;y<=L;)b(null,u[y]=v?Qn(u[y]):_n(u[y]),h,O,m,f,P,S,v),y++}}else if(y>L)for(;y<=M;)En(I[y],m,f,!0),y++;else{const B=y,O=y,nn=new Map;for(y=O;y<=L;y++){const Pn=u[y]=v?Qn(u[y]):_n(u[y]);Pn.key!=null&&nn.set(Pn.key,y)}let X,yn=0;const wn=L-O+1;let Un=!1,Nn=0;const xe=new Array(wn);for(y=0;y<wn;y++)xe[y]=0;for(y=B;y<=M;y++){const Pn=I[y];if(yn>=wn){En(Pn,m,f,!0);continue}let Fn;if(Pn.key!=null)Fn=nn.get(Pn.key);else for(X=O;X<=L;X++)if(xe[X-O]===0&&Ue(Pn,u[X])){Fn=X;break}Fn===void 0?En(Pn,m,f,!0):(xe[Fn-O]=y+1,Fn>=Nn?Nn=Fn:Un=!0,b(Pn,u[Fn],h,null,m,f,P,S,v),yn++)}const _i=Un?Da(xe):Pe;for(X=_i.length-1,y=wn-1;y>=0;y--){const Pn=O+y,Fn=u[Pn],Vi=u[Pn+1],$i=Pn+1<D?Vi.el||ko(Vi):w;xe[y]===0?b(null,Fn,h,$i,m,f,P,S,v):Un&&(X<0||y!==_i[X]?Ae(Fn,h,$i,2):X--)}}},Ae=(I,u,h,w,m=null)=>{const{el:f,type:P,transition:S,children:v,shapeFlag:y}=I;if(y&6){Ae(I.component.subTree,u,h,w);return}if(y&128){I.suspense.move(u,h,w);return}if(y&64){P.move(I,u,h,De);return}if(P===rn){i(f,u,h);for(let M=0;M<v.length;M++)Ae(v[M],u,h,w);i(I.anchor,u,h);return}if(P===Ht){V(I,u,h);return}if(w!==2&&y&1&&S)if(w===0)S.beforeEnter(f),i(f,u,h),bn(()=>S.enter(f),m);else{const{leave:M,delayLeave:L,afterLeave:B}=S,O=()=>{I.ctx.isUnmounted?s(f):i(f,u,h)},nn=()=>{f._isLeaving&&f[Qr](!0),M(f,()=>{O(),B&&B()})};L?L(f,O,nn):nn()}else i(f,u,h)},En=(I,u,h,w=!1,m=!1)=>{const{type:f,props:P,ref:S,children:v,dynamicChildren:y,shapeFlag:D,patchFlag:M,dirs:L,cacheIndex:B}=I;if(M===-2&&(m=!1),S!=null&&(Zn(),Ke(S,null,h,I,!0),ne()),B!=null&&(u.renderCache[B]=void 0),D&256){u.ctx.deactivate(I);return}const O=D&1&&L,nn=!ze(I);let X;if(nn&&(X=P&&P.onVnodeBeforeUnmount)&&On(X,u,I),D&6)Qo(I.component,h,w);else{if(D&128){I.suspense.unmount(h,w);return}O&&Ie(I,null,u,"beforeUnmount"),D&64?I.type.remove(I,u,h,De,w):y&&!y.hasOnce&&(f!==rn||M>0&&M&64)?Ge(y,u,h,!1,!0):(f===rn&&M&384||!m&&D&16)&&Ge(v,u,h),w&&Oi(I)}(nn&&(X=P&&P.onVnodeUnmounted)||O)&&bn(()=>{X&&On(X,u,I),O&&Ie(I,null,u,"unmounted")},h)},Oi=I=>{const{type:u,el:h,anchor:w,transition:m}=I;if(u===rn){Xo(h,w);return}if(u===Ht){G(I);return}const f=()=>{s(h),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(I.shapeFlag&1&&m&&!m.persisted){const{leave:P,delayLeave:S}=m,v=()=>P(h,f);S?S(I.el,f,v):v()}else f()},Xo=(I,u)=>{let h;for(;I!==u;)h=p(I),s(I),I=h;s(u)},Qo=(I,u,h)=>{const{bum:w,scope:m,job:f,subTree:P,um:S,m:v,a:y}=I;ss(v),ss(y),w&&It(w),m.stop(),f&&(f.flags|=8,En(P,I,u,h)),S&&bn(S,u),bn(()=>{I.isUnmounted=!0},u)},Ge=(I,u,h,w=!1,m=!1,f=0)=>{for(let P=f;P<I.length;P++)En(I[P],u,h,w,m)},ot=I=>{if(I.shapeFlag&6)return ot(I.component.subTree);if(I.shapeFlag&128)return I.suspense.next();const u=p(I.anchor||I.el),h=u&&u[jr];return h?p(h):u};let Et=!1;const Wi=(I,u,h)=>{let w;I==null?u._vnode&&(En(u._vnode,null,null,!0),w=u._vnode.component):b(u._vnode||null,I,u,null,null,null,h),u._vnode=I,Et||(Et=!0,Xi(w),io(),Et=!1)},De={p:b,um:En,m:Ae,r:Oi,mt:dn,mc:cn,pc:Z,pbc:C,n:ot,o:n};return{render:Wi,hydrate:void 0,createApp:ha(Wi)}}function $t({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function ue({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function Ga(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function Mo(n,e,t=!1){const i=n.children,s=e.children;if(E(i)&&E(s))for(let o=0;o<i.length;o++){const r=i[o];let a=s[o];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[o]=Qn(s[o]),a.el=r.el),!t&&a.patchFlag!==-2&&Mo(r,a)),a.type===Gt&&(a.patchFlag===-1&&(a=s[o]=Qn(a)),a.el=r.el),a.type===le&&!a.el&&(a.el=r.el)}}function Da(n){const e=n.slice(),t=[0];let i,s,o,r,a;const l=n.length;for(i=0;i<l;i++){const c=n[i];if(c!==0){if(s=t[t.length-1],n[s]<c){e[i]=s,t.push(i);continue}for(o=0,r=t.length-1;o<r;)a=o+r>>1,n[t[a]]<c?o=a+1:r=a;c<n[t[o]]&&(o>0&&(e[i]=t[o-1]),t[o]=i)}}for(o=t.length,r=t[o-1];o-- >0;)t[o]=r,r=e[r];return t}function To(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:To(e)}function ss(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function ko(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?ko(e.subTree):null}const Ro=n=>n.__isSuspense;function xa(n,e){e&&e.pendingBranch?E(n)?e.effects.push(...n):e.effects.push(n):Wr(n)}const rn=Symbol.for("v-fgt"),Gt=Symbol.for("v-txt"),le=Symbol.for("v-cmt"),Ht=Symbol.for("v-stc"),Xe=[];let Cn=null;function $(n=!1){Xe.push(Cn=n?null:[])}function Ba(){Xe.pop(),Cn=Xe[Xe.length-1]||null}let Ye=1;function os(n,e=!1){Ye+=n,n<0&&Cn&&e&&(Cn.hasOnce=!0)}function Lo(n){return n.dynamicChildren=Ye>0?Cn||Pe:null,Ba(),Ye>0&&Cn&&Cn.push(n),n}function H(n,e,t,i,s,o){return Lo(R(n,e,t,i,s,o,!0))}function Ea(n,e,t,i,s){return Lo(Yn(n,e,t,i,s,!0))}function Go(n){return n?n.__v_isVNode===!0:!1}function Ue(n,e){return n.type===e.type&&n.key===e.key}const Do=({key:n})=>n??null,gt=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?an(n)||un(n)||N(n)?{i:kn,r:n,k:e,f:!!t}:n:null);function R(n,e=null,t=null,i=0,s=null,o=n===rn?0:1,r=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Do(e),ref:e&&gt(e),scopeId:oo,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:kn};return a?(Ri(l,t),o&128&&n.normalize(l)):t&&(l.shapeFlag|=an(t)?8:16),Ye>0&&!r&&Cn&&(l.patchFlag>0||o&6)&&l.patchFlag!==32&&Cn.push(l),l}const Yn=Ua;function Ua(n,e=null,t=null,i=0,s=null,o=!1){if((!n||n===aa)&&(n=le),Go(n)){const a=Le(n,e,!0);return t&&Ri(a,t),Ye>0&&!o&&Cn&&(a.shapeFlag&6?Cn[Cn.indexOf(n)]=a:Cn.push(a)),a.patchFlag=-2,a}if(ja(n)&&(n=n.__vccOpts),e){e=Na(e);let{class:a,style:l}=e;a&&!an(a)&&(e.class=Me(a)),q(l)&&(Si(l)&&!E(l)&&(l=gn({},l)),e.style=di(l))}const r=an(n)?1:Ro(n)?128:Xr(n)?64:q(n)?4:N(n)?2:0;return R(n,e,t,i,s,r,o,!0)}function Na(n){return n?Si(n)||wo(n)?gn({},n):n:null}function Le(n,e,t=!1,i=!1){const{props:s,ref:o,patchFlag:r,children:a,transition:l}=n,c=e?Fa(s||{},e):s,A={__v_isVNode:!0,__v_skip:!0,type:n.type,props:c,key:c&&Do(c),ref:e&&e.ref?t&&o?E(o)?o.concat(gt(e)):[o,gt(e)]:gt(e):o,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:a,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==rn?r===-1?16:r|16:r,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:l,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Le(n.ssContent),ssFallback:n.ssFallback&&Le(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return l&&i&&Ci(A,l.clone(A)),A}function zn(n=" ",e=0){return Yn(Gt,null,n,e)}function Ln(n="",e=!1){return e?($(),Ea(le,null,n)):Yn(le,null,n)}function _n(n){return n==null||typeof n=="boolean"?Yn(le):E(n)?Yn(rn,null,n.slice()):Go(n)?Qn(n):Yn(Gt,null,String(n))}function Qn(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Le(n)}function Ri(n,e){let t=0;const{shapeFlag:i}=n;if(e==null)e=null;else if(E(e))t=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),Ri(n,s()),s._c&&(s._d=!0));return}else{t=32;const s=e._;!s&&!wo(e)?e._ctx=kn:s===3&&kn&&(kn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else N(e)?(e={default:e,_ctx:kn},t=32):(e=String(e),i&64?(t=16,e=[zn(e)]):t=8);n.children=e,n.shapeFlag|=t}function Fa(...n){const e={};for(let t=0;t<n.length;t++){const i=n[t];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=Me([e.class,i.class]));else if(s==="style")e.style=di([e.style,i.style]);else if(Pt(s)){const o=e[s],r=i[s];r&&o!==r&&!(E(o)&&o.includes(r))&&(e[s]=o?[].concat(o,r):r)}else s!==""&&(e[s]=i[s])}return e}function On(n,e,t,i=null){Hn(n,e,7,[t,i])}const Oa=ho();let Wa=0;function _a(n,e,t){const i=n.type,s=(e?e.appContext:n.appContext)||Oa,o={uid:Wa++,vnode:n,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new cr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:vo(i,s),emitsOptions:po(i,s),emit:null,emitted:null,propsDefaults:Y,inheritAttrs:i.inheritAttrs,ctx:Y,data:Y,props:Y,attrs:Y,slots:Y,refs:Y,setupState:Y,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=e?e.root:o,o.emit=ma.bind(null,o),n.ce&&n.ce(o),o}let mn=null;const Va=()=>mn||kn;let wt,si;{const n=Mt(),e=(t,i)=>{let s;return(s=n[t])||(s=n[t]=[]),s.push(i),o=>{s.length>1?s.forEach(r=>r(o)):s[0](o)}};wt=e("__VUE_INSTANCE_SETTERS__",t=>mn=t),si=e("__VUE_SSR_SETTERS__",t=>Ze=t)}const tt=n=>{const e=mn;return wt(n),n.scope.on(),()=>{n.scope.off(),wt(e)}},rs=()=>{mn&&mn.scope.off(),wt(null)};function xo(n){return n.vnode.shapeFlag&4}let Ze=!1;function $a(n,e=!1,t=!1){e&&si(e);const{props:i,children:s}=n.vnode,o=xo(n);Sa(n,i,o,e),Ta(n,s,t||e);const r=o?Ha(n,e):void 0;return e&&si(!1),r}function Ha(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,la);const{setup:i}=t;if(i){Zn();const s=n.setupContext=i.length>1?za(n):null,o=tt(n),r=et(i,n,0,[n.props,s]),a=Ds(r);if(ne(),o(),(a||n.sp)&&!ze(n)&&lo(n),a){if(r.then(rs,rs),e)return r.then(l=>{as(n,l)}).catch(l=>{kt(l,n,0)});n.asyncDep=r}else as(n,r)}else Bo(n)}function as(n,e,t){N(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:q(e)&&(n.setupState=no(e)),Bo(n)}function Bo(n,e,t){const i=n.type;n.render||(n.render=i.render||Vn);{const s=tt(n);Zn();try{ca(n)}finally{ne(),s()}}}const Ka={get(n,e){return In(n,"get",""),n[e]}};function za(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,Ka),slots:n.slots,emit:n.emit,expose:e}}function Dt(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(no(Lr(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in je)return je[t](n)},has(e,t){return t in e||t in je}})):n.proxy}function ja(n){return N(n)&&"__vccOpts"in n}const ie=(n,e)=>Er(n,e,Ze),Xa="3.5.28";/**
* @vue/runtime-dom v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let oi;const ls=typeof window<"u"&&window.trustedTypes;if(ls)try{oi=ls.createPolicy("vue",{createHTML:n=>n})}catch{}const Eo=oi?n=>oi.createHTML(n):n=>n,Qa="http://www.w3.org/2000/svg",qa="http://www.w3.org/1998/Math/MathML",Xn=typeof document<"u"?document:null,cs=Xn&&Xn.createElement("template"),Ja={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,i)=>{const s=e==="svg"?Xn.createElementNS(Qa,n):e==="mathml"?Xn.createElementNS(qa,n):t?Xn.createElement(n,{is:t}):Xn.createElement(n);return n==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:n=>Xn.createTextNode(n),createComment:n=>Xn.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>Xn.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,i,s,o){const r=t?t.previousSibling:e.lastChild;if(s&&(s===o||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),t),!(s===o||!(s=s.nextSibling)););else{cs.innerHTML=Eo(i==="svg"?`<svg>${n}</svg>`:i==="mathml"?`<math>${n}</math>`:n);const a=cs.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,t)}return[r?r.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Ya=Symbol("_vtc");function Za(n,e,t){const i=n[Ya];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const As=Symbol("_vod"),nl=Symbol("_vsh"),el=Symbol(""),tl=/(?:^|;)\s*display\s*:/;function il(n,e,t){const i=n.style,s=an(t);let o=!1;if(t&&!s){if(e)if(an(e))for(const r of e.split(";")){const a=r.slice(0,r.indexOf(":")).trim();t[a]==null&&dt(i,a,"")}else for(const r in e)t[r]==null&&dt(i,r,"");for(const r in t)r==="display"&&(o=!0),dt(i,r,t[r])}else if(s){if(e!==t){const r=i[el];r&&(t+=";"+r),i.cssText=t,o=tl.test(t)}}else e&&n.removeAttribute("style");As in n&&(n[As]=o?i.display:"",n[nl]&&(i.display="none"))}const Is=/\s*!important$/;function dt(n,e,t){if(E(t))t.forEach(i=>dt(n,e,i));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const i=sl(n,e);Is.test(t)?n.setProperty(fe(i),t.replace(Is,""),"important"):n[i]=t}}const us=["Webkit","Moz","ms"],Kt={};function sl(n,e){const t=Kt[e];if(t)return t;let i=ae(e);if(i!=="filter"&&i in n)return Kt[e]=i;i=Es(i);for(let s=0;s<us.length;s++){const o=us[s]+i;if(o in n)return Kt[e]=o}return e}const gs="http://www.w3.org/1999/xlink";function ds(n,e,t,i,s,o=ar(e)){i&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(gs,e.slice(6,e.length)):n.setAttributeNS(gs,e,t):t==null||o&&!Ns(t)?n.removeAttribute(e):n.setAttribute(e,o?"":$n(t)?String(t):t)}function hs(n,e,t,i,s){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Eo(t):t);return}const o=n.tagName;if(e==="value"&&o!=="PROGRESS"&&!o.includes("-")){const a=o==="OPTION"?n.getAttribute("value")||"":n.value,l=t==null?n.type==="checkbox"?"on":"":String(t);(a!==l||!("_value"in n))&&(n.value=l),t==null&&n.removeAttribute(e),n._value=t;return}let r=!1;if(t===""||t==null){const a=typeof n[e];a==="boolean"?t=Ns(t):t==null&&a==="string"?(t="",r=!0):a==="number"&&(t=0,r=!0)}try{n[e]=t}catch{}r&&n.removeAttribute(s||e)}function Se(n,e,t,i){n.addEventListener(e,t,i)}function ol(n,e,t,i){n.removeEventListener(e,t,i)}const ps=Symbol("_vei");function rl(n,e,t,i,s=null){const o=n[ps]||(n[ps]={}),r=o[e];if(i&&r)r.value=i;else{const[a,l]=al(e);if(i){const c=o[e]=Al(i,s);Se(n,a,c,l)}else r&&(ol(n,a,r,l),o[e]=void 0)}}const ms=/(?:Once|Passive|Capture)$/;function al(n){let e;if(ms.test(n)){e={};let i;for(;i=n.match(ms);)n=n.slice(0,n.length-i[0].length),e[i[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):fe(n.slice(2)),e]}let zt=0;const ll=Promise.resolve(),cl=()=>zt||(ll.then(()=>zt=0),zt=Date.now());function Al(n,e){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;Hn(Il(i,t.value),e,5,[i])};return t.value=n,t.attached=cl(),t}function Il(n,e){if(E(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const fs=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,ul=(n,e,t,i,s,o)=>{const r=s==="svg";e==="class"?Za(n,i,r):e==="style"?il(n,t,i):Pt(e)?Ai(e)||rl(n,e,t,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):gl(n,e,i,r))?(hs(n,e,i),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&ds(n,e,i,r,o,e!=="value")):n._isVueCE&&(/[A-Z]/.test(e)||!an(i))?hs(n,ae(e),i,o,e):(e==="true-value"?n._trueValue=i:e==="false-value"&&(n._falseValue=i),ds(n,e,i,r))};function gl(n,e,t,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in n&&fs(e)&&N(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=n.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return fs(e)&&an(t)?!1:e in n}const ys=n=>{const e=n.props["onUpdate:modelValue"]||!1;return E(e)?t=>It(e,t):e};function dl(n){n.target.composing=!0}function ws(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const jt=Symbol("_assign");function bs(n,e,t){return e&&(n=n.trim()),t&&(n=gi(n)),n}const hl={created(n,{modifiers:{lazy:e,trim:t,number:i}},s){n[jt]=ys(s);const o=i||s.props&&s.props.type==="number";Se(n,e?"change":"input",r=>{r.target.composing||n[jt](bs(n.value,t,o))}),(t||o)&&Se(n,"change",()=>{n.value=bs(n.value,t,o)}),e||(Se(n,"compositionstart",dl),Se(n,"compositionend",ws),Se(n,"change",ws))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:i,trim:s,number:o}},r){if(n[jt]=ys(r),n.composing)return;const a=(o||n.type==="number")&&!/^0\d/.test(n.value)?gi(n.value):n.value,l=e??"";a!==l&&(document.activeElement===n&&n.type!=="range"&&(i&&e===t||s&&n.value.trim()===l)||(n.value=l))}},pl=gn({patchProp:ul},Ja);let vs;function ml(){return vs||(vs=Ra(pl))}const fl=((...n)=>{const e=ml().createApp(...n),{mount:t}=e;return e.mount=i=>{const s=wl(i);if(!s)return;const o=e._component;!N(o)&&!o.render&&!o.template&&(o.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const r=t(s,!1,yl(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),r},e});function yl(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function wl(n){return an(n)?document.querySelector(n):n}function Li(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ye=Li();function Uo(n){ye=n}var de={exec:()=>null};function W(n,e=""){let t=typeof n=="string"?n:n.source,i={replace:(s,o)=>{let r=typeof o=="string"?o:o.source;return r=r.replace(fn.caret,"$1"),t=t.replace(s,r),i},getRegex:()=>new RegExp(t,e)};return i}var bl=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),fn={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}>`)},vl=/^(?:[ \t]*(?:\n|$))+/,Sl=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Pl=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,it=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Cl=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Gi=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,No=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Fo=W(No).replace(/bull/g,Gi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ml=W(No).replace(/bull/g,Gi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Di=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Tl=/^[^\n]+/,xi=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,kl=W(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",xi).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Rl=W(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Gi).getRegex(),xt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Bi=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ll=W("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Bi).replace("tag",xt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Oo=W(Di).replace("hr",it).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",xt).getRegex(),Gl=W(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Oo).getRegex(),Ei={blockquote:Gl,code:Sl,def:kl,fences:Pl,heading:Cl,hr:it,html:Ll,lheading:Fo,list:Rl,newline:vl,paragraph:Oo,table:de,text:Tl},Ss=W("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",it).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",xt).getRegex(),Dl={...Ei,lheading:Ml,table:Ss,paragraph:W(Di).replace("hr",it).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ss).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",xt).getRegex()},xl={...Ei,html:W(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Bi).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:de,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:W(Di).replace("hr",it).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Fo).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Bl=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,El=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Wo=/^( {2,}|\\)\n(?!\s*$)/,Ul=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Bt=/[\p{P}\p{S}]/u,Ui=/[\s\p{P}\p{S}]/u,_o=/[^\s\p{P}\p{S}]/u,Nl=W(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ui).getRegex(),Vo=/(?!~)[\p{P}\p{S}]/u,Fl=/(?!~)[\s\p{P}\p{S}]/u,Ol=/(?:[^\s\p{P}\p{S}]|~)/u,$o=/(?![*_])[\p{P}\p{S}]/u,Wl=/(?![*_])[\s\p{P}\p{S}]/u,_l=/(?:[^\s\p{P}\p{S}]|[*_])/u,Vl=W(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",bl?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ho=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,$l=W(Ho,"u").replace(/punct/g,Bt).getRegex(),Hl=W(Ho,"u").replace(/punct/g,Vo).getRegex(),Ko="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Kl=W(Ko,"gu").replace(/notPunctSpace/g,_o).replace(/punctSpace/g,Ui).replace(/punct/g,Bt).getRegex(),zl=W(Ko,"gu").replace(/notPunctSpace/g,Ol).replace(/punctSpace/g,Fl).replace(/punct/g,Vo).getRegex(),jl=W("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,_o).replace(/punctSpace/g,Ui).replace(/punct/g,Bt).getRegex(),Xl=W(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,$o).getRegex(),Ql="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",ql=W(Ql,"gu").replace(/notPunctSpace/g,_l).replace(/punctSpace/g,Wl).replace(/punct/g,$o).getRegex(),Jl=W(/\\(punct)/,"gu").replace(/punct/g,Bt).getRegex(),Yl=W(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Zl=W(Bi).replace("(?:-->|$)","-->").getRegex(),nc=W("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Zl).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),bt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,ec=W(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",bt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),zo=W(/^!?\[(label)\]\[(ref)\]/).replace("label",bt).replace("ref",xi).getRegex(),jo=W(/^!?\[(ref)\](?:\[\])?/).replace("ref",xi).getRegex(),tc=W("reflink|nolink(?!\\()","g").replace("reflink",zo).replace("nolink",jo).getRegex(),Ps=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ni={_backpedal:de,anyPunctuation:Jl,autolink:Yl,blockSkip:Vl,br:Wo,code:El,del:de,delLDelim:de,delRDelim:de,emStrongLDelim:$l,emStrongRDelimAst:Kl,emStrongRDelimUnd:jl,escape:Bl,link:ec,nolink:jo,punctuation:Nl,reflink:zo,reflinkSearch:tc,tag:nc,text:Ul,url:de},ic={...Ni,link:W(/^!?\[(label)\]\((.*?)\)/).replace("label",bt).getRegex(),reflink:W(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",bt).getRegex()},ri={...Ni,emStrongRDelimAst:zl,emStrongLDelim:Hl,delLDelim:Xl,delRDelim:ql,url:W(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Ps).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:W(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Ps).getRegex()},sc={...ri,br:W(Wo).replace("{2,}","*").getRegex(),text:W(ri.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ct={normal:Ei,gfm:Dl,pedantic:xl},Ne={normal:Ni,gfm:ri,breaks:sc,pedantic:ic},oc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Cs=n=>oc[n];function jn(n,e){if(e){if(fn.escapeTest.test(n))return n.replace(fn.escapeReplace,Cs)}else if(fn.escapeTestNoEncode.test(n))return n.replace(fn.escapeReplaceNoEncode,Cs);return n}function Ms(n){try{n=encodeURI(n).replace(fn.percentDecode,"%")}catch{return null}return n}function Ts(n,e){var o;let t=n.replace(fn.findPipe,(r,a,l)=>{let c=!1,A=a;for(;--A>=0&&l[A]==="\\";)c=!c;return c?"|":" |"}),i=t.split(fn.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!((o=i.at(-1))!=null&&o.trim())&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(fn.slashPipe,"|");return i}function Fe(n,e,t){let i=n.length;if(i===0)return"";let s=0;for(;s<i&&n.charAt(i-s-1)===e;)s++;return n.slice(0,i-s)}function rc(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let i=0;i<n.length;i++)if(n[i]==="\\")i++;else if(n[i]===e[0])t++;else if(n[i]===e[1]&&(t--,t<0))return i;return t>0?-2:-1}function ac(n,e=0){let t=e,i="";for(let s of n)if(s==="	"){let o=4-t%4;i+=" ".repeat(o),t+=o}else i+=s,t++;return i}function ks(n,e,t,i,s){let o=e.href,r=e.title||null,a=n[1].replace(s.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:o,title:r,text:a,tokens:i.inlineTokens(a)};return i.state.inLink=!1,l}function lc(n,e,t){let i=n.match(t.other.indentCodeCompensation);if(i===null)return e;let s=i[1];return e.split(`
`).map(o=>{let r=o.match(t.other.beginningSpace);if(r===null)return o;let[a]=r;return a.length>=s.length?o.slice(s.length):o}).join(`
`)}var vt=class{constructor(n){Q(this,"options");Q(this,"rules");Q(this,"lexer");this.options=n||ye}space(n){let e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){let e=this.rules.block.code.exec(n);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:Fe(t,`
...
`).split(`
`),i="",s="",o=[];for(;t.length>0;){let r=!1,a=[],l;for(l=0;l<t.length;l++)if(this.rules.other.blockquoteStart.test(t[l]))a.push(t[l]),r=!0;else if(!r)a.push(t[l]);else break;t=t.slice(l);let c=a.join(`
`),A=c.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");i=i?`${i}
${c}`:c,s=s?`${s}
${A}`:A;let g=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(A,o,!0),this.lexer.state.top=g,t.length===0)break;let p=o.at(-1);if((p==null?void 0:p.type)==="code")break;if((p==null?void 0:p.type)==="blockquote"){let d=p,k=d.raw+`
`+t.join(`
`),b=this.blockquote(k);o[o.length-1]=b,i=i.substring(0,i.length-d.raw.length)+b.raw,s=s.substring(0,s.length-d.text.length)+b.text;break}else if((p==null?void 0:p.type)==="list"){let d=p,k=d.raw+`
`+t.join(`
`),b=this.list(k);o[o.length-1]=b,i=i.substring(0,i.length-p.raw.length)+b.raw,s=s.substring(0,s.length-d.raw.length)+b.raw,t=k.substring(o.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:i,tokens:o,text:s}}}list(n){var t,i;let e=this.rules.block.list.exec(n);if(e){let s=e[1].trim(),o=s.length>1,r={type:"list",raw:"",ordered:o,start:o?+s.slice(0,-1):"",loose:!1,items:[]};s=o?`\\d{1,9}\\${s.slice(-1)}`:`\\${s}`,this.options.pedantic&&(s=o?s:"[*+-]");let a=this.rules.other.listItemRegex(s),l=!1;for(;n;){let A=!1,g="",p="";if(!(e=a.exec(n))||this.rules.block.hr.test(n))break;g=e[0],n=n.substring(g.length);let d=ac(e[2].split(`
`,1)[0],e[1].length),k=n.split(`
`,1)[0],b=!d.trim(),x=0;if(this.options.pedantic?(x=2,p=d.trimStart()):b?x=e[1].length+1:(x=d.search(this.rules.other.nonSpaceChar),x=x>4?1:x,p=d.slice(x),x+=e[1].length),b&&this.rules.other.blankLine.test(k)&&(g+=k+`
`,n=n.substring(k.length+1),A=!0),!A){let _=this.rules.other.nextBulletRegex(x),F=this.rules.other.hrRegex(x),V=this.rules.other.fencesBeginRegex(x),G=this.rules.other.headingBeginRegex(x),sn=this.rules.other.htmlBeginRegex(x),Mn=this.rules.other.blockquoteBeginRegex(x);for(;n;){let ln=n.split(`
`,1)[0],cn;if(k=ln,this.options.pedantic?(k=k.replace(this.rules.other.listReplaceNesting,"  "),cn=k):cn=k.replace(this.rules.other.tabCharGlobal,"    "),V.test(k)||G.test(k)||sn.test(k)||Mn.test(k)||_.test(k)||F.test(k))break;if(cn.search(this.rules.other.nonSpaceChar)>=x||!k.trim())p+=`
`+cn.slice(x);else{if(b||d.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||V.test(d)||G.test(d)||F.test(d))break;p+=`
`+k}b=!k.trim(),g+=ln+`
`,n=n.substring(ln.length+1),d=cn.slice(x)}}r.loose||(l?r.loose=!0:this.rules.other.doubleBlankLine.test(g)&&(l=!0)),r.items.push({type:"list_item",raw:g,task:!!this.options.gfm&&this.rules.other.listIsTask.test(p),loose:!1,text:p,tokens:[]}),r.raw+=g}let c=r.items.at(-1);if(c)c.raw=c.raw.trimEnd(),c.text=c.text.trimEnd();else return;r.raw=r.raw.trimEnd();for(let A of r.items){if(this.lexer.state.top=!1,A.tokens=this.lexer.blockTokens(A.text,[]),A.task){if(A.text=A.text.replace(this.rules.other.listReplaceTask,""),((t=A.tokens[0])==null?void 0:t.type)==="text"||((i=A.tokens[0])==null?void 0:i.type)==="paragraph"){A.tokens[0].raw=A.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),A.tokens[0].text=A.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let p=this.lexer.inlineQueue.length-1;p>=0;p--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[p].src)){this.lexer.inlineQueue[p].src=this.lexer.inlineQueue[p].src.replace(this.rules.other.listReplaceTask,"");break}}let g=this.rules.other.listTaskCheckbox.exec(A.raw);if(g){let p={type:"checkbox",raw:g[0]+" ",checked:g[0]!=="[ ]"};A.checked=p.checked,r.loose?A.tokens[0]&&["paragraph","text"].includes(A.tokens[0].type)&&"tokens"in A.tokens[0]&&A.tokens[0].tokens?(A.tokens[0].raw=p.raw+A.tokens[0].raw,A.tokens[0].text=p.raw+A.tokens[0].text,A.tokens[0].tokens.unshift(p)):A.tokens.unshift({type:"paragraph",raw:p.raw,text:p.raw,tokens:[p]}):A.tokens.unshift(p)}}if(!r.loose){let g=A.tokens.filter(d=>d.type==="space"),p=g.length>0&&g.some(d=>this.rules.other.anyLine.test(d.raw));r.loose=p}}if(r.loose)for(let A of r.items){A.loose=!0;for(let g of A.tokens)g.type==="text"&&(g.type="paragraph")}return r}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),i=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",s=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:i,title:s}}}table(n){var r;let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=Ts(e[1]),i=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),s=(r=e[3])!=null&&r.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],o={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===i.length){for(let a of i)this.rules.other.tableAlignRight.test(a)?o.align.push("right"):this.rules.other.tableAlignCenter.test(a)?o.align.push("center"):this.rules.other.tableAlignLeft.test(a)?o.align.push("left"):o.align.push(null);for(let a=0;a<t.length;a++)o.header.push({text:t[a],tokens:this.lexer.inline(t[a]),header:!0,align:o.align[a]});for(let a of s)o.rows.push(Ts(a,o.header.length).map((l,c)=>({text:l,tokens:this.lexer.inline(l),header:!1,align:o.align[c]})));return o}}lheading(n){let e=this.rules.block.lheading.exec(n);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(n){let e=this.rules.block.paragraph.exec(n);if(e){let t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(n){let e=this.rules.block.text.exec(n);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(n){let e=this.rules.inline.escape.exec(n);if(e)return{type:"escape",raw:e[0],text:e[1]}}tag(n){let e=this.rules.inline.tag.exec(n);if(e)return!this.lexer.state.inLink&&this.rules.other.startATag.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(n){let e=this.rules.inline.link.exec(n);if(e){let t=e[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(t)){if(!this.rules.other.endAngleBracket.test(t))return;let o=Fe(t.slice(0,-1),"\\");if((t.length-o.length)%2===0)return}else{let o=rc(e[2],"()");if(o===-2)return;if(o>-1){let r=(e[0].indexOf("!")===0?5:4)+e[1].length+o;e[2]=e[2].substring(0,o),e[0]=e[0].substring(0,r).trim(),e[3]=""}}let i=e[2],s="";if(this.options.pedantic){let o=this.rules.other.pedanticHrefTitle.exec(i);o&&(i=o[1],s=o[3])}else s=e[3]?e[3].slice(1,-1):"";return i=i.trim(),this.rules.other.startAngleBracket.test(i)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(t)?i=i.slice(1):i=i.slice(1,-1)),ks(e,{href:i&&i.replace(this.rules.inline.anyPunctuation,"$1"),title:s&&s.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer,this.rules)}}reflink(n,e){let t;if((t=this.rules.inline.reflink.exec(n))||(t=this.rules.inline.nolink.exec(n))){let i=(t[2]||t[1]).replace(this.rules.other.multipleSpaceGlobal," "),s=e[i.toLowerCase()];if(!s){let o=t[0].charAt(0);return{type:"text",raw:o,text:o}}return ks(t,s,t[0],this.lexer,this.rules)}}emStrong(n,e,t=""){let i=this.rules.inline.emStrongLDelim.exec(n);if(!(!i||i[3]&&t.match(this.rules.other.unicodeAlphaNumeric))&&(!(i[1]||i[2])||!t||this.rules.inline.punctuation.exec(t))){let s=[...i[0]].length-1,o,r,a=s,l=0,c=i[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,e=e.slice(-1*n.length+s);(i=c.exec(e))!=null;){if(o=i[1]||i[2]||i[3]||i[4]||i[5]||i[6],!o)continue;if(r=[...o].length,i[3]||i[4]){a+=r;continue}else if((i[5]||i[6])&&s%3&&!((s+r)%3)){l+=r;continue}if(a-=r,a>0)continue;r=Math.min(r,r+a+l);let A=[...i[0]][0].length,g=n.slice(0,s+i.index+A+r);if(Math.min(s,r)%2){let d=g.slice(1,-1);return{type:"em",raw:g,text:d,tokens:this.lexer.inlineTokens(d)}}let p=g.slice(2,-2);return{type:"strong",raw:g,text:p,tokens:this.lexer.inlineTokens(p)}}}}codespan(n){let e=this.rules.inline.code.exec(n);if(e){let t=e[2].replace(this.rules.other.newLineCharGlobal," "),i=this.rules.other.nonSpaceChar.test(t),s=this.rules.other.startingSpaceChar.test(t)&&this.rules.other.endingSpaceChar.test(t);return i&&s&&(t=t.substring(1,t.length-1)),{type:"codespan",raw:e[0],text:t}}}br(n){let e=this.rules.inline.br.exec(n);if(e)return{type:"br",raw:e[0]}}del(n,e,t=""){let i=this.rules.inline.delLDelim.exec(n);if(i&&(!i[1]||!t||this.rules.inline.punctuation.exec(t))){let s=[...i[0]].length-1,o,r,a=s,l=this.rules.inline.delRDelim;for(l.lastIndex=0,e=e.slice(-1*n.length+s);(i=l.exec(e))!=null;){if(o=i[1]||i[2]||i[3]||i[4]||i[5]||i[6],!o||(r=[...o].length,r!==s))continue;if(i[3]||i[4]){a+=r;continue}if(a-=r,a>0)continue;r=Math.min(r,r+a);let c=[...i[0]][0].length,A=n.slice(0,s+i.index+c+r),g=A.slice(s,-s);return{type:"del",raw:A,text:g,tokens:this.lexer.inlineTokens(g)}}}}autolink(n){let e=this.rules.inline.autolink.exec(n);if(e){let t,i;return e[2]==="@"?(t=e[1],i="mailto:"+t):(t=e[1],i=t),{type:"link",raw:e[0],text:t,href:i,tokens:[{type:"text",raw:t,text:t}]}}}url(n){var t;let e;if(e=this.rules.inline.url.exec(n)){let i,s;if(e[2]==="@")i=e[0],s="mailto:"+i;else{let o;do o=e[0],e[0]=((t=this.rules.inline._backpedal.exec(e[0]))==null?void 0:t[0])??"";while(o!==e[0]);i=e[0],e[1]==="www."?s="http://"+e[0]:s=e[0]}return{type:"link",raw:e[0],text:i,href:s,tokens:[{type:"text",raw:i,text:i}]}}}inlineText(n){let e=this.rules.inline.text.exec(n);if(e){let t=this.lexer.state.inRawBlock;return{type:"text",raw:e[0],text:e[0],escaped:t}}}},Gn=class ai{constructor(e){Q(this,"tokens");Q(this,"options");Q(this,"state");Q(this,"inlineQueue");Q(this,"tokenizer");this.tokens=[],this.tokens.links=Object.create(null),this.options=e||ye,this.options.tokenizer=this.options.tokenizer||new vt,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:fn,block:ct.normal,inline:Ne.normal};this.options.pedantic?(t.block=ct.pedantic,t.inline=Ne.pedantic):this.options.gfm&&(t.block=ct.gfm,this.options.breaks?t.inline=Ne.breaks:t.inline=Ne.gfm),this.tokenizer.rules=t}static get rules(){return{block:ct,inline:Ne}}static lex(e,t){return new ai(t).lex(e)}static lexInline(e,t){return new ai(t).inlineTokens(e)}lex(e){e=e.replace(fn.carriageReturn,`
`),this.blockTokens(e,this.tokens);for(let t=0;t<this.inlineQueue.length;t++){let i=this.inlineQueue[t];this.inlineTokens(i.src,i.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(e,t=[],i=!1){var s,o,r;for(this.options.pedantic&&(e=e.replace(fn.tabCharGlobal,"    ").replace(fn.spaceLine,""));e;){let a;if((o=(s=this.options.extensions)==null?void 0:s.block)!=null&&o.some(c=>(a=c.call({lexer:this},e,t))?(e=e.substring(a.raw.length),t.push(a),!0):!1))continue;if(a=this.tokenizer.space(e)){e=e.substring(a.raw.length);let c=t.at(-1);a.raw.length===1&&c!==void 0?c.raw+=`
...
`)?"":`
`)+a.raw,c.text+=`
`+a.raw,this.inlineQueue.at(-1).src=c.text):this.tokens.links[a.tag]||(this.tokens.links[a.tag]={href:a.href,title:a.title},t.push(a));continue}if(a=this.tokenizer.table(e)){e=e.substring(a.raw.length),t.push(a);continue}if(a=this.tokenizer.lheading(e)){e=e.substring(a.raw.length),t.push(a);continue}let l=e;if((r=this.options.extensions)!=null&&r.startBlock){let c=1/0,A=e.slice(1),g;this.options.extensions.startBlock.forEach(p=>{g=p.call({lexer:this},A),typeof g=="number"&&g>=0&&(c=Math.min(c,g))}),c<1/0&&c>=0&&(l=e.substring(0,c+1))}if(this.state.top&&(a=this.tokenizer.paragraph(l))){let c=t.at(-1);i&&(c==null?void 0:c.type)==="paragraph"?(c.raw+=(c.raw.endsWith(`
`)?"":`
`)+a.raw,c.text+=`
...
`)?"":`
`)+a.raw,c.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=c.text):t.push(a);continue}if(e){let c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var l,c,A,g,p;let i=e,s=null;if(this.tokens.links){let d=Object.keys(this.tokens.links);if(d.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)d.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)o=s[2]?s[2].length:0,i=i.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((c=(l=this.options.hooks)==null?void 0:l.emStrongMask)==null?void 0:c.call({lexer:this},i))??i;let r=!1,a="";for(;e;){r||(a=""),r=!1;let d;if((g=(A=this.options.extensions)==null?void 0:A.inline)!=null&&g.some(b=>(d=b.call({lexer:this},e,t))?(e=e.substring(d.raw.length),t.push(d),!0):!1))continue;if(d=this.tokenizer.escape(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.tag(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.link(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(d.raw.length);let b=t.at(-1);d.type==="text"&&(b==null?void 0:b.type)==="text"?(b.raw+=d.raw,b.text+=d.text):t.push(d);continue}if(d=this.tokenizer.emStrong(e,i,a)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.codespan(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.br(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.del(e,i,a)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.autolink(e)){e=e.substring(d.raw.length),t.push(d);continue}if(!this.state.inLink&&(d=this.tokenizer.url(e))){e=e.substring(d.raw.length),t.push(d);continue}let k=e;if((p=this.options.extensions)!=null&&p.startInline){let b=1/0,x=e.slice(1),_;this.options.extensions.startInline.forEach(F=>{_=F.call({lexer:this},x),typeof _=="number"&&_>=0&&(b=Math.min(b,_))}),b<1/0&&b>=0&&(k=e.substring(0,b+1))}if(d=this.tokenizer.inlineText(k)){e=e.substring(d.raw.length),d.raw.slice(-1)!=="_"&&(a=d.raw.slice(-1)),r=!0;let b=t.at(-1);(b==null?void 0:b.type)==="text"?(b.raw+=d.raw,b.text+=d.text):t.push(d);continue}if(e){let b="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(b);break}else throw new Error(b)}}return t}},St=class{constructor(n){Q(this,"options");Q(this,"parser");this.options=n||ye}space(n){return""}code({text:n,lang:e,escaped:t}){var o;let i=(o=(e||"").match(fn.notSpaceStart))==null?void 0:o[0],s=n.replace(fn.endingNewline,"")+`
...
`}hr(n){return`<hr>
`}list(n){let e=n.ordered,t=n.start,i="";for(let r=0;r<n.items.length;r++){let a=n.items[r];i+=this.listitem(a)}let s=e?"ol":"ul",o=e&&t!==1?' start="'+t+'"':"";return"<"+s+o+`>
`+i+"</"+s+`>
`}listitem(n){return`<li>${this.parser.parse(n.tokens)}</li>
`}checkbox({checked:n}){return"<input "+(n?'checked="" ':"")+'disabled="" type="checkbox"> '}paragraph({tokens:n}){return`<p>${this.parser.parseInline(n)}</p>
`}table(n){let e="",t="";for(let s=0;s<n.header.length;s++)t+=this.tablecell(n.header[s]);e+=this.tablerow({text:t});let i="";for(let s=0;s<n.rows.length;s++){let o=n.rows[s];t="";for(let r=0;r<o.length;r++)t+=this.tablecell(o[r]);i+=this.tablerow({text:t})}return i&&(i=`<tbody>${i}</tbody>`),`<table>
<thead>
`+e+`</thead>
`+i+`</table>
...
`}strong({tokens:n}){return`<strong>${this.parser.parseInline(n)}</strong>`}em({tokens:n}){return`<em>${this.parser.parseInline(n)}</em>`}codespan({text:n}){return`<code>${jn(n,!0)}</code>`}br(n){return"<br>"}del({tokens:n}){return`<del>${this.parser.parseInline(n)}</del>`}link({href:n,title:e,tokens:t}){let i=this.parser.parseInline(t),s=Ms(n);if(s===null)return i;n=s;let o='<a href="'+n+'"';return e&&(o+=' title="'+jn(e)+'"'),o+=">"+i+"</a>",o}image({href:n,title:e,text:t,tokens:i}){i&&(t=this.parser.parseInline(i,this.parser.textRenderer));let s=Ms(n);if(s===null)return jn(t);n=s;let o=`<img src="${n}" alt="${t}"`;return e&&(o+=` title="${jn(e)}"`),o+=">",o}text(n){return"tokens"in n&&n.tokens?this.parser.parseInline(n.tokens):"escaped"in n&&n.escaped?n.text:jn(n.text)}},Fi=class{strong({text:n}){return n}em({text:n}){return n}codespan({text:n}){return n}del({text:n}){return n}html({text:n}){return n}text({text:n}){return n}link({text:n}){return""+n}image({text:n}){return""+n}br(){return""}checkbox({raw:n}){return n}},Dn=class li{constructor(e){Q(this,"options");Q(this,"renderer");Q(this,"textRenderer");this.options=e||ye,this.options.renderer=this.options.renderer||new St,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Fi}static parse(e,t){return new li(t).parse(e)}static parseInline(e,t){return new li(t).parseInline(e)}parse(e){var i,s;let t="";for(let o=0;o<e.length;o++){let r=e[o];if((s=(i=this.options.extensions)==null?void 0:i.renderers)!=null&&s[r.type]){let l=r,c=this.options.extensions.renderers[l.type].call({parser:this},l);if(c!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(l.type)){t+=c||"";continue}}let a=r;switch(a.type){case"space":{t+=this.renderer.space(a);break}case"hr":{t+=this.renderer.hr(a);break}case"heading":{t+=this.renderer.heading(a);break}case"code":{t+=this.renderer.code(a);break}case"table":{t+=this.renderer.table(a);break}case"blockquote":{t+=this.renderer.blockquote(a);break}case"list":{t+=this.renderer.list(a);break}case"checkbox":{t+=this.renderer.checkbox(a);break}case"html":{t+=this.renderer.html(a);break}case"def":{t+=this.renderer.def(a);break}case"paragraph":{t+=this.renderer.paragraph(a);break}case"text":{t+=this.renderer.text(a);break}default:{let l='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return t}parseInline(e,t=this.renderer){var s,o;let i="";for(let r=0;r<e.length;r++){let a=e[r];if((o=(s=this.options.extensions)==null?void 0:s.renderers)!=null&&o[a.type]){let c=this.options.extensions.renderers[a.type].call({parser:this},a);if(c!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(a.type)){i+=c||"";continue}}let l=a;switch(l.type){case"escape":{i+=t.text(l);break}case"html":{i+=t.html(l);break}case"link":{i+=t.link(l);break}case"image":{i+=t.image(l);break}case"checkbox":{i+=t.checkbox(l);break}case"strong":{i+=t.strong(l);break}case"em":{i+=t.em(l);break}case"codespan":{i+=t.codespan(l);break}case"br":{i+=t.br(l);break}case"del":{i+=t.del(l);break}case"text":{i+=t.text(l);break}default:{let c='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(c),"";throw new Error(c)}}}return i}},At,_e=(At=class{constructor(n){Q(this,"options");Q(this,"block");this.options=n||ye}preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}emStrongMask(n){return n}provideLexer(){return this.block?Gn.lex:Gn.lexInline}provideParser(){return this.block?Dn.parse:Dn.parseInline}},Q(At,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),Q(At,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),At),cc=class{constructor(...n){Q(this,"defaults",Li());Q(this,"options",this.setOptions);Q(this,"parse",this.parseMarkdown(!0));Q(this,"parseInline",this.parseMarkdown(!1));Q(this,"Parser",Dn);Q(this,"Renderer",St);Q(this,"TextRenderer",Fi);Q(this,"Lexer",Gn);Q(this,"Tokenizer",vt);Q(this,"Hooks",_e);this.use(...n)}walkTokens(n,e){var i,s;let t=[];for(let o of n)switch(t=t.concat(e.call(this,o)),o.type){case"table":{let r=o;for(let a of r.header)t=t.concat(this.walkTokens(a.tokens,e));for(let a of r.rows)for(let l of a)t=t.concat(this.walkTokens(l.tokens,e));break}case"list":{let r=o;t=t.concat(this.walkTokens(r.items,e));break}default:{let r=o;(s=(i=this.defaults.extensions)==null?void 0:i.childTokens)!=null&&s[r.type]?this.defaults.extensions.childTokens[r.type].forEach(a=>{let l=r[a].flat(1/0);t=t.concat(this.walkTokens(l,e))}):r.tokens&&(t=t.concat(this.walkTokens(r.tokens,e)))}}return t}use(...n){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach(t=>{let i={...t};if(i.async=this.defaults.async||i.async||!1,t.extensions&&(t.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if("renderer"in s){let o=e.renderers[s.name];o?e.renderers[s.name]=function(...r){let a=s.renderer.apply(this,r);return a===!1&&(a=o.apply(this,r)),a}:e.renderers[s.name]=s.renderer}if("tokenizer"in s){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let o=e[s.level];o?o.unshift(s.tokenizer):e[s.level]=[s.tokenizer],s.start&&(s.level==="block"?e.startBlock?e.startBlock.push(s.start):e.startBlock=[s.start]:s.level==="inline"&&(e.startInline?e.startInline.push(s.start):e.startInline=[s.start]))}"childTokens"in s&&s.childTokens&&(e.childTokens[s.name]=s.childTokens)}),i.extensions=e),t.renderer){let s=this.defaults.renderer||new St(this.defaults);for(let o in t.renderer){if(!(o in s))throw new Error(`renderer '${o}' does not exist`);if(["options","parser"].includes(o))continue;let r=o,a=t.renderer[r],l=s[r];s[r]=(...c)=>{let A=a.apply(s,c);return A===!1&&(A=l.apply(s,c)),A||""}}i.renderer=s}if(t.tokenizer){let s=this.defaults.tokenizer||new vt(this.defaults);for(let o in t.tokenizer){if(!(o in s))throw new Error(`tokenizer '${o}' does not exist`);if(["options","rules","lexer"].includes(o))continue;let r=o,a=t.tokenizer[r],l=s[r];s[r]=(...c)=>{let A=a.apply(s,c);return A===!1&&(A=l.apply(s,c)),A}}i.tokenizer=s}if(t.hooks){let s=this.defaults.hooks||new _e;for(let o in t.hooks){if(!(o in s))throw new Error(`hook '${o}' does not exist`);if(["options","block"].includes(o))continue;let r=o,a=t.hooks[r],l=s[r];_e.passThroughHooks.has(o)?s[r]=c=>{if(this.defaults.async&&_e.passThroughHooksRespectAsync.has(o))return(async()=>{let g=await a.call(s,c);return l.call(s,g)})();let A=a.call(s,c);return l.call(s,A)}:s[r]=(...c)=>{if(this.defaults.async)return(async()=>{let g=await a.apply(s,c);return g===!1&&(g=await l.apply(s,c)),g})();let A=a.apply(s,c);return A===!1&&(A=l.apply(s,c)),A}}i.hooks=s}if(t.walkTokens){let s=this.defaults.walkTokens,o=t.walkTokens;i.walkTokens=function(r){let a=[];return a.push(o.call(this,r)),s&&(a=a.concat(s.call(this,r))),a}}this.defaults={...this.defaults,...i}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return Gn.lex(n,e??this.defaults)}parser(n,e){return Dn.parse(n,e??this.defaults)}parseMarkdown(n){return(e,t)=>{let i={...t},s={...this.defaults,...i},o=this.onError(!!s.silent,!!s.async);if(this.defaults.async===!0&&i.async===!1)return o(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return o(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return o(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(s.hooks&&(s.hooks.options=s,s.hooks.block=n),s.async)return(async()=>{let r=s.hooks?await s.hooks.preprocess(e):e,a=await(s.hooks?await s.hooks.provideLexer():n?Gn.lex:Gn.lexInline)(r,s),l=s.hooks?await s.hooks.processAllTokens(a):a;s.walkTokens&&await Promise.all(this.walkTokens(l,s.walkTokens));let c=await(s.hooks?await s.hooks.provideParser():n?Dn.parse:Dn.parseInline)(l,s);return s.hooks?await s.hooks.postprocess(c):c})().catch(o);try{s.hooks&&(e=s.hooks.preprocess(e));let r=(s.hooks?s.hooks.provideLexer():n?Gn.lex:Gn.lexInline)(e,s);s.hooks&&(r=s.hooks.processAllTokens(r)),s.walkTokens&&this.walkTokens(r,s.walkTokens);let a=(s.hooks?s.hooks.provideParser():n?Dn.parse:Dn.parseInline)(r,s);return s.hooks&&(a=s.hooks.postprocess(a)),a}catch(r){return o(r)}}}onError(n,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){let i="<p>An error occurred:</p><pre>"+jn(t.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(t);throw t}}},me=new cc;function j(n,e){return me.parse(n,e)}j.options=j.setOptions=function(n){return me.setOptions(n),j.defaults=me.defaults,Uo(j.defaults),j};j.getDefaults=Li;j.defaults=ye;j.use=function(...n){return me.use(...n),j.defaults=me.defaults,Uo(j.defaults),j};j.walkTokens=function(n,e){return me.walkTokens(n,e)};j.parseInline=me.parseInline;j.Parser=Dn;j.parser=Dn.parse;j.Renderer=St;j.TextRenderer=Fi;j.Lexer=Gn;j.lexer=Gn.lex;j.Tokenizer=vt;j.Hooks=_e;j.parse=j;j.options;j.setOptions;j.use;j.walkTokens;j.parseInline;Dn.parse;Gn.lex;const Rs={notes:[{id:"2026-02-17-AI-Agent-Memory架构2026",title:"AI Agent Memory 架构 2026：从「上下文窗口」到「记忆系统」的范式转变",category:"tech",date:"2026-02-17",summary:'1. **从「窗口」到「系统」**：2026 年的核心转变是从"扩大上下文窗口"到"构建结构化记忆系统"，后者是 Agent 智能化的必要条件。',content:`# AI Agent Memory 架构 2026：从「上下文窗口」到「记忆系统」的范式转变
...
`,source:"",tags:["知识阅读/认知科学","知识阅读/学习理论","知识阅读/技术哲学"]}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},insights:{label:"洞见报告",color:"#f59e0b",priority:5},diary:{label:"二子日记",color:"#e879a0",priority:6}}},Ac={class:"container"},Ic={class:"site-header"},uc={class:"stats"},gc={class:"stat"},dc={class:"stat-num"},hc={class:"stat"},pc={class:"stat-num"},mc={class:"stat"},fc={class:"stat-num"},yc={key:0,class:"insights-section"},wc={class:"section-header"},bc={class:"section-count"},vc={class:"insights-grid"},Sc=["onClick"],Pc={class:"insight-date"},Cc={class:"insight-title"},Mc={key:0,class:"insight-summary"},Tc={key:1,class:"insight-tags"},kc={class:"main-layout"},Rc={key:0,class:"tag-sidebar"},Lc={class:"tag-groups"},Gc={class:"tag-group-title"},Dc={class:"tag-list"},xc=["onClick"],Bc={class:"content-area"},Ec={class:"search-bar"},Uc={key:0,class:"diary-featured"},Nc={class:"diary-header"},Fc={class:"diary-count"},Oc={class:"diary-preview"},Wc={class:"diary-date"},_c={class:"diary-title"},Vc={key:1,class:"note-list"},$c={key:0,class:"list-header"},Hc={class:"list-filter-label"},Kc=["onClick"],zc={class:"note-meta"},jc={class:"note-date"},Xc={class:"note-title"},Qc={key:0,class:"note-summary"},qc={key:1,class:"note-tags"},Jc={key:2,class:"empty-state"},Yc={class:"detail-header"},Zc={class:"detail-title"},n2={class:"detail-meta"},e2={class:"note-date"},t2=["innerHTML"],i2={__name:"App",setup(n){j.setOptions({breaks:!1,gfm:!0});const e=Rs.notes,t=Ee(null),i=Ee(null),s=Ee("加载中..."),o=Ee(""),r=Ee(null),a=Rs.categories,l=ie(()=>new Set(e.map(C=>C.date)).size),c=ie(()=>e.filter(T=>T.category==="insights").sort((T,C)=>new Date(C.date)-new Date(T.date))),A=ie(()=>e.filter(T=>T.category==="diary").sort((T,C)=>new Date(C.date)-new Date(T.date))),g=ie(()=>e.filter(T=>T.category!=="insights"&&T.category!=="diary")),p=ie(()=>{const T={};e.forEach(C=>{C.tags&&C.tags.forEach(J=>{const Tn=J.split("/");if(Tn.length===2){const U=Tn[0];T[U]||(T[U]=[]),T[U].includes(J)||T[U].push(J)}})});for(const C in T)T[C].sort();return T}),d=ie(()=>{let T;if(t.value||r.value||o.value.trim()?T=e:T=g.value,t.value&&(T=T.filter(C=>C.category===t.value)),r.value&&(T=T.filter(C=>C.tags?C.tags.includes(r.value):!1)),o.value.trim()){const C=o.value.toLowerCase();T=T.filter(J=>{const Tn=J.title.toLowerCase().includes(C),U=J.content.toLowerCase().includes(C),dn=J.tags&&J.tags.some(Sn=>Sn.toLowerCase().includes(C));return Tn||U||dn})}return T});function k(T){r.value===T?r.value=null:r.value=T}function b(){t.value=null,r.value=null,o.value=""}function x(T){const C=T.split("/");return C.length===2?C[1]:T}const _=ie(()=>i.value?j(i.value.content):"");function F(T){const J=(T.replace(/^#/,"")||"/").split("/").filter(Boolean);return J.length===0?{view:"list",category:null}:J[0]==="category"&&J[1]?{view:"list",category:J[1]}:J[0]==="note"&&J[1]?{view:"detail",noteId:J[1]}:{view:"list",category:null}}function V(){const T=F(window.location.hash);if(T.view==="list")i.value=null,t.value=T.category;else if(T.view==="detail"){const C=e.find(J=>J.id===T.noteId);C?(i.value=C,t.value=null):window.location.hash="#/"}}function G(T){return`#/note/${T.id}`}function sn(T){return T?`#/category/${T}`:"#/"}async function Mn(){try{const T=localStorage.getItem("erzi-knowledge-visits");T?s.value=parseInt(T):s.value=1;const C=(parseInt(T)||0)+1;localStorage.setItem("erzi-knowledge-visits",C.toString()),s.value=C}catch(T){console.error("访问统计加载失败:",T),s.value="统计不可用"}}Io(()=>{Mn(),window.addEventListener("hashchange",V),V()}),Mi(()=>{window.removeEventListener("hashchange",V)});function ln(T){window.location.hash=G(T),Zt(()=>window.scrollTo(0,0))}function cn(){window.location.hash=sn(t.value),Zt(()=>window.scrollTo(0,0))}return(T,C)=>{var J,Tn;return $(),H("div",Ac,[i.value?($(),H(rn,{key:1},[R("div",Yc,[R("button",{class:"back-btn",onClick:cn},[...C[15]||(C[15]=[R("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[R("polyline",{points:"15 18 9 12 15 6"})],-1),zn(" 返回 ",-1)])]),R("h1",Zc,en(i.value.title),1),R("div",n2,[R("span",{class:Me(["note-category","note-category--"+i.value.category])},en((Tn=Oe(a)[i.value.category])==null?void 0:Tn.label),3),R("span",e2,en(i.value.date),1)])]),R("div",{class:"note-content",innerHTML:_.value},null,8,t2),R("footer",{class:"site-footer"},[R("button",{class:"back-btn",onClick:cn},[...C[16]||(C[16]=[R("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[R("polyline",{points:"15 18 9 12 15 6"})],-1),zn(" 返回列表 ",-1)])])])],64)):($(),H(rn,{key:0},[R("header",Ic,[C[8]||(C[8]=R("div",{class:"site-title"},"二子的知识库",-1)),C[9]||(C[9]=R("div",{class:"site-subtitle"},"跟二子一起学习",-1)),R("div",uc,[R("span",gc,[R("span",dc,en(Oe(e).length),1),C[5]||(C[5]=zn(" 篇笔记",-1))]),R("span",hc,[R("span",pc,en(l.value),1),C[6]||(C[6]=zn(" 天探索",-1))]),R("span",mc,[R("span",fc,en(s.value),1),C[7]||(C[7]=zn(" 次访问",-1))])])]),c.value.length>0&&!t.value&&!r.value&&!o.value?($(),H("section",yc,[R("div",wc,[C[10]||(C[10]=R("h2",{class:"section-title"},"💡 洞见报告",-1)),R("span",bc,en(c.value.length)+" 篇",1)]),R("div",vc,[($(!0),H(rn,null,be(c.value.slice(0,3),U=>($(),H("div",{key:U.id,class:"insight-card",onClick:dn=>ln(U)},[R("div",Pc,en(U.date),1),R("h3",Cc,en(U.title),1),U.summary?($(),H("p",Mc,en(U.summary),1)):Ln("",!0),U.tags&&U.tags.length>0?($(),H("div",Tc,[($(!0),H(rn,null,be(U.tags.slice(0,2),dn=>($(),H("span",{key:dn,class:"tag"},en(x(dn)),1))),128))])):Ln("",!0)],8,Sc))),128))]),c.value.length>3?($(),H("button",{key:0,class:"view-all-btn",onClick:C[0]||(C[0]=U=>t.value="insights")}," 查看全部 "+en(c.value.length)+" 篇洞见 → ",1)):Ln("",!0)])):Ln("",!0),R("div",kc,[Object.keys(p.value).length>0?($(),H("aside",Rc,[C[11]||(C[11]=R("div",{class:"sidebar-title"},"标签",-1)),R("div",Lc,[($(!0),H(rn,null,be(p.value,(U,dn)=>($(),H("div",{key:dn,class:"tag-group"},[R("div",Gc,en(dn),1),R("div",Dc,[($(!0),H(rn,null,be(U,Sn=>($(),H("button",{key:Sn,class:Me(["tag-btn",{active:r.value===Sn}]),onClick:An=>k(Sn)},en(x(Sn)),11,xc))),128))])]))),128))]),r.value?($(),H("button",{key:0,class:"clear-tags-btn",onClick:C[1]||(C[1]=U=>r.value=null)},"清除筛选")):Ln("",!0)])):Ln("",!0),R("div",Bc,[R("div",Ec,[Vr(R("input",{"onUpdate:modelValue":C[2]||(C[2]=U=>o.value=U),type:"text",placeholder:"搜索标题、内容或标签...",class:"search-input"},null,512),[[hl,o.value]])]),A.value.length>0&&!t.value&&!r.value&&!o.value?($(),H("div",Uc,[R("div",Nc,[C[12]||(C[12]=R("span",{class:"diary-icon"},"📔",-1)),C[13]||(C[13]=R("span",{class:"diary-label"},"二子日记",-1)),R("span",Fc,en(A.value.length)+" 篇",1)]),R("div",Oc,[R("div",{class:"diary-latest",onClick:C[3]||(C[3]=U=>ln(A.value[0]))},[R("span",Wc,en(A.value[0].date),1),R("span",_c,en(A.value[0].title),1)]),R("button",{class:"diary-more",onClick:C[4]||(C[4]=U=>t.value="diary")},"全部日记 →")])])):Ln("",!0),d.value.length?($(),H("div",Vc,[t.value||r.value||o.value?($(),H("div",$c,[R("span",Hc,[t.value?($(),H(rn,{key:0},[zn(en((J=Oe(a)[t.value])==null?void 0:J.label),1)],64)):r.value?($(),H(rn,{key:1},[zn(en(x(r.value)),1)],64)):o.value?($(),H(rn,{key:2},[zn("搜索: "+en(o.value),1)],64)):Ln("",!0)]),R("button",{class:"clear-filter-btn",onClick:b},"清除筛选")])):Ln("",!0),($(!0),H(rn,null,be(d.value,U=>{var dn;return $(),H("div",{key:U.id+U.category,class:"note-item",onClick:Sn=>ln(U)},[R("div",zc,[R("span",{class:Me(["note-category","note-category--"+U.category])},en((dn=Oe(a)[U.category])==null?void 0:dn.label),3),R("span",jc,en(U.date),1)]),R("div",Xc,en(U.title),1),U.summary?($(),H("div",Qc,en(U.summary),1)):Ln("",!0),U.tags&&U.tags.length>0?($(),H("div",qc,[($(!0),H(rn,null,be(U.tags,Sn=>($(),H("span",{key:Sn,class:"tag"},en(x(Sn)),1))),128))])):Ln("",!0)],8,Kc)}),128))])):($(),H("div",Jc," 暂无笔记 "))])]),C[14]||(C[14]=R("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};fl(i2).mount("#app");
