var Gi=Object.defineProperty;var zi=(e,n,t)=>n in e?Gi(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var W=(e,n,t)=>zi(e,typeof n!="symbol"?n+"":n,t);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();/**
* @vue/shared v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ts(e){const n=Object.create(null);for(const t of e.split(","))n[t]=1;return t=>t in n}const K={},pn=[],Me=()=>{},wr=()=>!1,mt=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),ss=e=>e.startsWith("onUpdate:"),te=Object.assign,rs=(e,n)=>{const t=e.indexOf(n);t>-1&&e.splice(t,1)},$i=Object.prototype.hasOwnProperty,F=(e,n)=>$i.call(e,n),D=Array.isArray,dn=e=>bt(e)==="[object Map]",yr=e=>bt(e)==="[object Set]",E=e=>typeof e=="function",Q=e=>typeof e=="string",Ze=e=>typeof e=="symbol",J=e=>e!==null&&typeof e=="object",kr=e=>(J(e)||E(e))&&E(e.then)&&E(e.catch),vr=Object.prototype.toString,bt=e=>vr.call(e),ji=e=>bt(e).slice(8,-1),Ar=e=>bt(e)==="[object Object]",is=e=>Q(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Dn=ts(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),xt=e=>{const n=Object.create(null);return(t=>n[t]||(n[t]=e(t)))},Fi=/-\w/g,Je=xt(e=>e.replace(Fi,n=>n.slice(1).toUpperCase())),Bi=/\B([A-Z])/g,cn=xt(e=>e.replace(Bi,"-$1").toLowerCase()),Sr=xt(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ct=xt(e=>e?`on${Sr(e)}`:""),qe=(e,n)=>!Object.is(e,n),Rt=(e,...n)=>{for(let t=0;t<e.length;t++)e[t](...n)},_r=(e,n,t,s=!1)=>{Object.defineProperty(e,n,{configurable:!0,enumerable:!1,writable:s,value:t})},Ui=e=>{const n=parseFloat(e);return isNaN(n)?e:n};let Gs;const wt=()=>Gs||(Gs=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function os(e){if(D(e)){const n={};for(let t=0;t<e.length;t++){const s=e[t],r=Q(s)?Vi(s):os(s);if(r)for(const i in r)n[i]=r[i]}return n}else if(Q(e)||J(e))return e}const Wi=/;(?![^(]*\))/g,Hi=/:([^]+)/,Ni=/\/\*[^]*?\*\//g;function Vi(e){const n={};return e.replace(Ni,"").split(Wi).forEach(t=>{if(t){const s=t.split(Hi);s.length>1&&(n[s[0].trim()]=s[1].trim())}}),n}function rn(e){let n="";if(Q(e))n=e;else if(D(e))for(let t=0;t<e.length;t++){const s=rn(e[t]);s&&(n+=s+" ")}else if(J(e))for(const t in e)e[t]&&(n+=t+" ");return n.trim()}const Ki="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",qi=ts(Ki);function Tr(e){return!!e||e===""}const Ir=e=>!!(e&&e.__v_isRef===!0),be=e=>Q(e)?e:e==null?"":D(e)||J(e)&&(e.toString===vr||!E(e.toString))?Ir(e)?be(e.value):JSON.stringify(e,Pr,2):String(e),Pr=(e,n)=>Ir(n)?Pr(e,n.value):dn(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((t,[s,r],i)=>(t[Dt(s,i)+" =>"]=r,t),{})}:yr(n)?{[`Set(${n.size})`]:[...n.values()].map(t=>Dt(t))}:Ze(n)?Dt(n):J(n)&&!D(n)&&!Ar(n)?String(n):n,Dt=(e,n="")=>{var t;return Ze(e)?`Symbol(${(t=e.description)!=null?t:n})`:e};/**
* @vue/reactivity v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ue;class Ji{constructor(n=!1){this.detached=n,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=ue,!n&&ue&&(this.index=(ue.scopes||(ue.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].pause();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].resume();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].resume()}}run(n){if(this._active){const t=ue;try{return ue=this,n()}finally{ue=t}}}on(){++this._on===1&&(this.prevScope=ue,ue=this)}off(){this._on>0&&--this._on===0&&(ue=this.prevScope,this.prevScope=void 0)}stop(n){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!n){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Yi(){return ue}let V;const Mt=new WeakSet;class Cr{constructor(n){this.fn=n,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ue&&ue.active&&ue.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Mt.has(this)&&(Mt.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Dr(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,zs(this),Mr(this);const n=V,t=ke;V=this,ke=!0;try{return this.fn()}finally{Er(this),V=n,ke=t,this.flags&=-3}}stop(){if(this.flags&1){for(let n=this.deps;n;n=n.nextDep)cs(n);this.deps=this.depsTail=void 0,zs(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Mt.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Bt(this)&&this.run()}get dirty(){return Bt(this)}}let Rr=0,Mn,En;function Dr(e,n=!1){if(e.flags|=8,n){e.next=En,En=e;return}e.next=Mn,Mn=e}function ls(){Rr++}function as(){if(--Rr>0)return;if(En){let n=En;for(En=void 0;n;){const t=n.next;n.next=void 0,n.flags&=-9,n=t}}let e;for(;Mn;){let n=Mn;for(Mn=void 0;n;){const t=n.next;if(n.next=void 0,n.flags&=-9,n.flags&1)try{n.trigger()}catch(s){e||(e=s)}n=t}}if(e)throw e}function Mr(e){for(let n=e.deps;n;n=n.nextDep)n.version=-1,n.prevActiveLink=n.dep.activeLink,n.dep.activeLink=n}function Er(e){let n,t=e.depsTail,s=t;for(;s;){const r=s.prevDep;s.version===-1?(s===t&&(t=r),cs(s),Zi(s)):n=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=r}e.deps=n,e.depsTail=t}function Bt(e){for(let n=e.deps;n;n=n.nextDep)if(n.dep.version!==n.version||n.dep.computed&&(Lr(n.dep.computed)||n.dep.version!==n.version))return!0;return!!e._dirty}function Lr(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===jn)||(e.globalVersion=jn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Bt(e))))return;e.flags|=2;const n=e.dep,t=V,s=ke;V=e,ke=!0;try{Mr(e);const r=e.fn(e._value);(n.version===0||qe(r,e._value))&&(e.flags|=128,e._value=r,n.version++)}catch(r){throw n.version++,r}finally{V=t,ke=s,Er(e),e.flags&=-3}}function cs(e,n=!1){const{dep:t,prevSub:s,nextSub:r}=e;if(s&&(s.nextSub=r,e.prevSub=void 0),r&&(r.prevSub=s,e.nextSub=void 0),t.subs===e&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let i=t.computed.deps;i;i=i.nextDep)cs(i,!0)}!n&&!--t.sc&&t.map&&t.map.delete(t.key)}function Zi(e){const{prevDep:n,nextDep:t}=e;n&&(n.nextDep=t,e.prevDep=void 0),t&&(t.prevDep=n,e.nextDep=void 0)}let ke=!0;const Or=[];function je(){Or.push(ke),ke=!1}function Fe(){const e=Or.pop();ke=e===void 0?!0:e}function zs(e){const{cleanup:n}=e;if(e.cleanup=void 0,n){const t=V;V=void 0;try{n()}finally{V=t}}}let jn=0;class Qi{constructor(n,t){this.sub=n,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class us{constructor(n){this.computed=n,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(n){if(!V||!ke||V===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==V)t=this.activeLink=new Qi(V,this),V.deps?(t.prevDep=V.depsTail,V.depsTail.nextDep=t,V.depsTail=t):V.deps=V.depsTail=t,Gr(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=V.depsTail,t.nextDep=void 0,V.depsTail.nextDep=t,V.depsTail=t,V.deps===t&&(V.deps=s)}return t}trigger(n){this.version++,jn++,this.notify(n)}notify(n){ls();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{as()}}}function Gr(e){if(e.dep.sc++,e.sub.flags&4){const n=e.dep.computed;if(n&&!e.dep.subs){n.flags|=20;for(let s=n.deps;s;s=s.nextDep)Gr(s)}const t=e.dep.subs;t!==e&&(e.prevSub=t,t&&(t.nextSub=e)),e.dep.subs=e}}const Ut=new WeakMap,on=Symbol(""),Wt=Symbol(""),Fn=Symbol("");function ee(e,n,t){if(ke&&V){let s=Ut.get(e);s||Ut.set(e,s=new Map);let r=s.get(t);r||(s.set(t,r=new us),r.map=s,r.key=t),r.track()}}function ze(e,n,t,s,r,i){const l=Ut.get(e);if(!l){jn++;return}const o=a=>{a&&a.trigger()};if(ls(),n==="clear")l.forEach(o);else{const a=D(e),u=a&&is(t);if(a&&t==="length"){const f=Number(s);l.forEach((p,m)=>{(m==="length"||m===Fn||!Ze(m)&&m>=f)&&o(p)})}else switch((t!==void 0||l.has(void 0))&&o(l.get(t)),u&&o(l.get(Fn)),n){case"add":a?u&&o(l.get("length")):(o(l.get(on)),dn(e)&&o(l.get(Wt)));break;case"delete":a||(o(l.get(on)),dn(e)&&o(l.get(Wt)));break;case"set":dn(e)&&o(l.get(on));break}}as()}function fn(e){const n=j(e);return n===e?n:(ee(n,"iterate",Fn),me(e)?n:n.map(ve))}function yt(e){return ee(e=j(e),"iterate",Fn),e}function He(e,n){return Be(e)?bn(ln(e)?ve(n):n):ve(n)}const Xi={__proto__:null,[Symbol.iterator](){return Et(this,Symbol.iterator,e=>He(this,e))},concat(...e){return fn(this).concat(...e.map(n=>D(n)?fn(n):n))},entries(){return Et(this,"entries",e=>(e[1]=He(this,e[1]),e))},every(e,n){return Le(this,"every",e,n,void 0,arguments)},filter(e,n){return Le(this,"filter",e,n,t=>t.map(s=>He(this,s)),arguments)},find(e,n){return Le(this,"find",e,n,t=>He(this,t),arguments)},findIndex(e,n){return Le(this,"findIndex",e,n,void 0,arguments)},findLast(e,n){return Le(this,"findLast",e,n,t=>He(this,t),arguments)},findLastIndex(e,n){return Le(this,"findLastIndex",e,n,void 0,arguments)},forEach(e,n){return Le(this,"forEach",e,n,void 0,arguments)},includes(...e){return Lt(this,"includes",e)},indexOf(...e){return Lt(this,"indexOf",e)},join(e){return fn(this).join(e)},lastIndexOf(...e){return Lt(this,"lastIndexOf",e)},map(e,n){return Le(this,"map",e,n,void 0,arguments)},pop(){return An(this,"pop")},push(...e){return An(this,"push",e)},reduce(e,...n){return $s(this,"reduce",e,n)},reduceRight(e,...n){return $s(this,"reduceRight",e,n)},shift(){return An(this,"shift")},some(e,n){return Le(this,"some",e,n,void 0,arguments)},splice(...e){return An(this,"splice",e)},toReversed(){return fn(this).toReversed()},toSorted(e){return fn(this).toSorted(e)},toSpliced(...e){return fn(this).toSpliced(...e)},unshift(...e){return An(this,"unshift",e)},values(){return Et(this,"values",e=>He(this,e))}};function Et(e,n,t){const s=yt(e),r=s[n]();return s!==e&&!me(e)&&(r._next=r.next,r.next=()=>{const i=r._next();return i.done||(i.value=t(i.value)),i}),r}const eo=Array.prototype;function Le(e,n,t,s,r,i){const l=yt(e),o=l!==e&&!me(e),a=l[n];if(a!==eo[n]){const p=a.apply(e,i);return o?ve(p):p}let u=t;l!==e&&(o?u=function(p,m){return t.call(this,He(e,p),m,e)}:t.length>2&&(u=function(p,m){return t.call(this,p,m,e)}));const f=a.call(l,u,s);return o&&r?r(f):f}function $s(e,n,t,s){const r=yt(e);let i=t;return r!==e&&(me(e)?t.length>3&&(i=function(l,o,a){return t.call(this,l,o,a,e)}):i=function(l,o,a){return t.call(this,l,He(e,o),a,e)}),r[n](i,...s)}function Lt(e,n,t){const s=j(e);ee(s,"iterate",Fn);const r=s[n](...t);return(r===-1||r===!1)&&ds(t[0])?(t[0]=j(t[0]),s[n](...t)):r}function An(e,n,t=[]){je(),ls();const s=j(e)[n].apply(e,t);return as(),Fe(),s}const no=ts("__proto__,__v_isRef,__isVue"),zr=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ze));function to(e){Ze(e)||(e=String(e));const n=j(this);return ee(n,"has",e),n.hasOwnProperty(e)}class $r{constructor(n=!1,t=!1){this._isReadonly=n,this._isShallow=t}get(n,t,s){if(t==="__v_skip")return n.__v_skip;const r=this._isReadonly,i=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return i;if(t==="__v_raw")return s===(r?i?ho:Ur:i?Br:Fr).get(n)||Object.getPrototypeOf(n)===Object.getPrototypeOf(s)?n:void 0;const l=D(n);if(!r){let a;if(l&&(a=Xi[t]))return a;if(t==="hasOwnProperty")return to}const o=Reflect.get(n,t,ne(n)?n:s);if((Ze(t)?zr.has(t):no(t))||(r||ee(n,"get",t),i))return o;if(ne(o)){const a=l&&is(t)?o:o.value;return r&&J(a)?Nt(a):a}return J(o)?r?Nt(o):hs(o):o}}class jr extends $r{constructor(n=!1){super(!1,n)}set(n,t,s,r){let i=n[t];const l=D(n)&&is(t);if(!this._isShallow){const u=Be(i);if(!me(s)&&!Be(s)&&(i=j(i),s=j(s)),!l&&ne(i)&&!ne(s))return u||(i.value=s),!0}const o=l?Number(t)<n.length:F(n,t),a=Reflect.set(n,t,s,ne(n)?n:r);return n===j(r)&&(o?qe(s,i)&&ze(n,"set",t,s):ze(n,"add",t,s)),a}deleteProperty(n,t){const s=F(n,t);n[t];const r=Reflect.deleteProperty(n,t);return r&&s&&ze(n,"delete",t,void 0),r}has(n,t){const s=Reflect.has(n,t);return(!Ze(t)||!zr.has(t))&&ee(n,"has",t),s}ownKeys(n){return ee(n,"iterate",D(n)?"length":on),Reflect.ownKeys(n)}}class so extends $r{constructor(n=!1){super(!0,n)}set(n,t){return!0}deleteProperty(n,t){return!0}}const ro=new jr,io=new so,oo=new jr(!0);const Ht=e=>e,Qn=e=>Reflect.getPrototypeOf(e);function lo(e,n,t){return function(...s){const r=this.__v_raw,i=j(r),l=dn(i),o=e==="entries"||e===Symbol.iterator&&l,a=e==="keys"&&l,u=r[e](...s),f=t?Ht:n?bn:ve;return!n&&ee(i,"iterate",a?Wt:on),te(Object.create(u),{next(){const{value:p,done:m}=u.next();return m?{value:p,done:m}:{value:o?[f(p[0]),f(p[1])]:f(p),done:m}}})}}function Xn(e){return function(...n){return e==="delete"?!1:e==="clear"?void 0:this}}function ao(e,n){const t={get(r){const i=this.__v_raw,l=j(i),o=j(r);e||(qe(r,o)&&ee(l,"get",r),ee(l,"get",o));const{has:a}=Qn(l),u=n?Ht:e?bn:ve;if(a.call(l,r))return u(i.get(r));if(a.call(l,o))return u(i.get(o));i!==l&&i.get(r)},get size(){const r=this.__v_raw;return!e&&ee(j(r),"iterate",on),r.size},has(r){const i=this.__v_raw,l=j(i),o=j(r);return e||(qe(r,o)&&ee(l,"has",r),ee(l,"has",o)),r===o?i.has(r):i.has(r)||i.has(o)},forEach(r,i){const l=this,o=l.__v_raw,a=j(o),u=n?Ht:e?bn:ve;return!e&&ee(a,"iterate",on),o.forEach((f,p)=>r.call(i,u(f),u(p),l))}};return te(t,e?{add:Xn("add"),set:Xn("set"),delete:Xn("delete"),clear:Xn("clear")}:{add(r){!n&&!me(r)&&!Be(r)&&(r=j(r));const i=j(this);return Qn(i).has.call(i,r)||(i.add(r),ze(i,"add",r,r)),this},set(r,i){!n&&!me(i)&&!Be(i)&&(i=j(i));const l=j(this),{has:o,get:a}=Qn(l);let u=o.call(l,r);u||(r=j(r),u=o.call(l,r));const f=a.call(l,r);return l.set(r,i),u?qe(i,f)&&ze(l,"set",r,i):ze(l,"add",r,i),this},delete(r){const i=j(this),{has:l,get:o}=Qn(i);let a=l.call(i,r);a||(r=j(r),a=l.call(i,r)),o&&o.call(i,r);const u=i.delete(r);return a&&ze(i,"delete",r,void 0),u},clear(){const r=j(this),i=r.size!==0,l=r.clear();return i&&ze(r,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=lo(r,e,n)}),t}function fs(e,n){const t=ao(e,n);return(s,r,i)=>r==="__v_isReactive"?!e:r==="__v_isReadonly"?e:r==="__v_raw"?s:Reflect.get(F(t,r)&&r in s?t:s,r,i)}const co={get:fs(!1,!1)},uo={get:fs(!1,!0)},fo={get:fs(!0,!1)};const Fr=new WeakMap,Br=new WeakMap,Ur=new WeakMap,ho=new WeakMap;function po(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function go(e){return e.__v_skip||!Object.isExtensible(e)?0:po(ji(e))}function hs(e){return Be(e)?e:ps(e,!1,ro,co,Fr)}function mo(e){return ps(e,!1,oo,uo,Br)}function Nt(e){return ps(e,!0,io,fo,Ur)}function ps(e,n,t,s,r){if(!J(e)||e.__v_raw&&!(n&&e.__v_isReactive))return e;const i=go(e);if(i===0)return e;const l=r.get(e);if(l)return l;const o=new Proxy(e,i===2?s:t);return r.set(e,o),o}function ln(e){return Be(e)?ln(e.__v_raw):!!(e&&e.__v_isReactive)}function Be(e){return!!(e&&e.__v_isReadonly)}function me(e){return!!(e&&e.__v_isShallow)}function ds(e){return e?!!e.__v_raw:!1}function j(e){const n=e&&e.__v_raw;return n?j(n):e}function bo(e){return!F(e,"__v_skip")&&Object.isExtensible(e)&&_r(e,"__v_skip",!0),e}const ve=e=>J(e)?hs(e):e,bn=e=>J(e)?Nt(e):e;function ne(e){return e?e.__v_isRef===!0:!1}function js(e){return xo(e,!1)}function xo(e,n){return ne(e)?e:new wo(e,n)}class wo{constructor(n,t){this.dep=new us,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?n:j(n),this._value=t?n:ve(n),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(n){const t=this._rawValue,s=this.__v_isShallow||me(n)||Be(n);n=s?n:j(n),qe(n,t)&&(this._rawValue=n,this._value=s?n:ve(n),this.dep.trigger())}}function In(e){return ne(e)?e.value:e}const yo={get:(e,n,t)=>n==="__v_raw"?e:In(Reflect.get(e,n,t)),set:(e,n,t,s)=>{const r=e[n];return ne(r)&&!ne(t)?(r.value=t,!0):Reflect.set(e,n,t,s)}};function Wr(e){return ln(e)?e:new Proxy(e,yo)}class ko{constructor(n,t,s){this.fn=n,this.setter=t,this._value=void 0,this.dep=new us(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=jn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&V!==this)return Dr(this,!0),!0}get value(){const n=this.dep.track();return Lr(this),n&&(n.version=this.dep.version),this._value}set value(n){this.setter&&this.setter(n)}}function vo(e,n,t=!1){let s,r;return E(e)?s=e:(s=e.get,r=e.set),new ko(s,r,t)}const et={},lt=new WeakMap;let sn;function Ao(e,n=!1,t=sn){if(t){let s=lt.get(t);s||lt.set(t,s=[]),s.push(e)}}function So(e,n,t=K){const{immediate:s,deep:r,once:i,scheduler:l,augmentJob:o,call:a}=t,u=C=>r?C:me(C)||r===!1||r===0?Ke(C,1):Ke(C);let f,p,m,d,T=!1,S=!1;if(ne(e)?(p=()=>e.value,T=me(e)):ln(e)?(p=()=>u(e),T=!0):D(e)?(S=!0,T=e.some(C=>ln(C)||me(C)),p=()=>e.map(C=>{if(ne(C))return C.value;if(ln(C))return u(C);if(E(C))return a?a(C,2):C()})):E(e)?n?p=a?()=>a(e,2):e:p=()=>{if(m){je();try{m()}finally{Fe()}}const C=sn;sn=f;try{return a?a(e,3,[d]):e(d)}finally{sn=C}}:p=Me,n&&r){const C=p,Z=r===!0?1/0:r;p=()=>Ke(C(),Z)}const L=Yi(),M=()=>{f.stop(),L&&L.active&&rs(L.effects,f)};if(i&&n){const C=n;n=(...Z)=>{C(...Z),M()}}let z=S?new Array(e.length).fill(et):et;const q=C=>{if(!(!(f.flags&1)||!f.dirty&&!C))if(n){const Z=f.run();if(r||T||(S?Z.some((ge,X)=>qe(ge,z[X])):qe(Z,z))){m&&m();const ge=sn;sn=f;try{const X=[Z,z===et?void 0:S&&z[0]===et?[]:z,d];z=Z,a?a(n,3,X):n(...X)}finally{sn=ge}}}else f.run()};return o&&o(q),f=new Cr(p),f.scheduler=l?()=>l(q,!1):q,d=C=>Ao(C,!1,f),m=f.onStop=()=>{const C=lt.get(f);if(C){if(a)a(C,4);else for(const Z of C)Z();lt.delete(f)}},n?s?q(!0):z=f.run():l?l(q.bind(null,!0),!0):f.run(),M.pause=f.pause.bind(f),M.resume=f.resume.bind(f),M.stop=M,M}function Ke(e,n=1/0,t){if(n<=0||!J(e)||e.__v_skip||(t=t||new Map,(t.get(e)||0)>=n))return e;if(t.set(e,n),n--,ne(e))Ke(e.value,n,t);else if(D(e))for(let s=0;s<e.length;s++)Ke(e[s],n,t);else if(yr(e)||dn(e))e.forEach(s=>{Ke(s,n,t)});else if(Ar(e)){for(const s in e)Ke(e[s],n,t);for(const s of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,s)&&Ke(e[s],n,t)}return e}/**
* @vue/runtime-core v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Hn(e,n,t,s){try{return s?e(...s):e()}catch(r){kt(r,n,t)}}function Ee(e,n,t,s){if(E(e)){const r=Hn(e,n,t,s);return r&&kr(r)&&r.catch(i=>{kt(i,n,t)}),r}if(D(e)){const r=[];for(let i=0;i<e.length;i++)r.push(Ee(e[i],n,t,s));return r}}function kt(e,n,t,s=!0){const r=n?n.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=n&&n.appContext.config||K;if(n){let o=n.parent;const a=n.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;o;){const f=o.ec;if(f){for(let p=0;p<f.length;p++)if(f[p](e,a,u)===!1)return}o=o.parent}if(i){je(),Hn(i,null,10,[e,a,u]),Fe();return}}_o(e,t,r,s,l)}function _o(e,n,t,s=!0,r=!1){if(r)throw e;console.error(e)}const ie=[];let Ce=-1;const gn=[];let Ne=null,hn=0;const Hr=Promise.resolve();let at=null;function Vt(e){const n=at||Hr;return e?n.then(this?e.bind(this):e):n}function To(e){let n=Ce+1,t=ie.length;for(;n<t;){const s=n+t>>>1,r=ie[s],i=Bn(r);i<e||i===e&&r.flags&2?n=s+1:t=s}return n}function gs(e){if(!(e.flags&1)){const n=Bn(e),t=ie[ie.length-1];!t||!(e.flags&2)&&n>=Bn(t)?ie.push(e):ie.splice(To(n),0,e),e.flags|=1,Nr()}}function Nr(){at||(at=Hr.then(Kr))}function Io(e){D(e)?gn.push(...e):Ne&&e.id===-1?Ne.splice(hn+1,0,e):e.flags&1||(gn.push(e),e.flags|=1),Nr()}function Fs(e,n,t=Ce+1){for(;t<ie.length;t++){const s=ie[t];if(s&&s.flags&2){if(e&&s.id!==e.uid)continue;ie.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function Vr(e){if(gn.length){const n=[...new Set(gn)].sort((t,s)=>Bn(t)-Bn(s));if(gn.length=0,Ne){Ne.push(...n);return}for(Ne=n,hn=0;hn<Ne.length;hn++){const t=Ne[hn];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Ne=null,hn=0}}const Bn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Kr(e){try{for(Ce=0;Ce<ie.length;Ce++){const n=ie[Ce];n&&!(n.flags&8)&&(n.flags&4&&(n.flags&=-2),Hn(n,n.i,n.i?15:14),n.flags&4||(n.flags&=-2))}}finally{for(;Ce<ie.length;Ce++){const n=ie[Ce];n&&(n.flags&=-2)}Ce=-1,ie.length=0,Vr(),at=null,(ie.length||gn.length)&&Kr()}}let De=null,qr=null;function ct(e){const n=De;return De=e,qr=e&&e.type.__scopeId||null,n}function Po(e,n=De,t){if(!n||e._n)return e;const s=(...r)=>{s._d&&Zs(-1);const i=ct(n);let l;try{l=e(...r)}finally{ct(i),s._d&&Zs(1)}return l};return s._n=!0,s._c=!0,s._d=!0,s}function nn(e,n,t,s){const r=e.dirs,i=n&&n.dirs;for(let l=0;l<r.length;l++){const o=r[l];i&&(o.oldValue=i[l].value);let a=o.dir[s];a&&(je(),Ee(a,t,8,[e.el,o,e,n]),Fe())}}function Co(e,n){if(oe){let t=oe.provides;const s=oe.parent&&oe.parent.provides;s===t&&(t=oe.provides=Object.create(s)),t[e]=n}}function st(e,n,t=!1){const s=Rl();if(s||mn){let r=mn?mn._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&e in r)return r[e];if(arguments.length>1)return t&&E(n)?n.call(s&&s.proxy):n}}const Ro=Symbol.for("v-scx"),Do=()=>st(Ro);function Ot(e,n,t){return Jr(e,n,t)}function Jr(e,n,t=K){const{immediate:s,deep:r,flush:i,once:l}=t,o=te({},t),a=n&&s||!n&&i!=="post";let u;if(Wn){if(i==="sync"){const d=Do();u=d.__watcherHandles||(d.__watcherHandles=[])}else if(!a){const d=()=>{};return d.stop=Me,d.resume=Me,d.pause=Me,d}}const f=oe;o.call=(d,T,S)=>Ee(d,f,T,S);let p=!1;i==="post"?o.scheduler=d=>{pe(d,f&&f.suspense)}:i!=="sync"&&(p=!0,o.scheduler=(d,T)=>{T?d():gs(d)}),o.augmentJob=d=>{n&&(d.flags|=4),p&&(d.flags|=2,f&&(d.id=f.uid,d.i=f))};const m=So(e,n,o);return Wn&&(u?u.push(m):a&&m()),m}function Mo(e,n,t){const s=this.proxy,r=Q(e)?e.includes(".")?Yr(s,e):()=>s[e]:e.bind(s,s);let i;E(n)?i=n:(i=n.handler,t=n);const l=Nn(this),o=Jr(r,i.bind(s),t);return l(),o}function Yr(e,n){const t=n.split(".");return()=>{let s=e;for(let r=0;r<t.length&&s;r++)s=s[t[r]];return s}}const Eo=Symbol("_vte"),Lo=e=>e.__isTeleport,Oo=Symbol("_leaveCb");function ms(e,n){e.shapeFlag&6&&e.component?(e.transition=n,ms(e.component.subTree,n)):e.shapeFlag&128?(e.ssContent.transition=n.clone(e.ssContent),e.ssFallback.transition=n.clone(e.ssFallback)):e.transition=n}function Zr(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}const ut=new WeakMap;function Ln(e,n,t,s,r=!1){if(D(e)){e.forEach((T,S)=>Ln(T,n&&(D(n)?n[S]:n),t,s,r));return}if(On(s)&&!r){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&Ln(e,n,t,s.component.subTree);return}const i=s.shapeFlag&4?ys(s.component):s.el,l=r?null:i,{i:o,r:a}=e,u=n&&n.r,f=o.refs===K?o.refs={}:o.refs,p=o.setupState,m=j(p),d=p===K?wr:T=>F(m,T);if(u!=null&&u!==a){if(Bs(n),Q(u))f[u]=null,d(u)&&(p[u]=null);else if(ne(u)){u.value=null;const T=n;T.k&&(f[T.k]=null)}}if(E(a))Hn(a,o,12,[l,f]);else{const T=Q(a),S=ne(a);if(T||S){const L=()=>{if(e.f){const M=T?d(a)?p[a]:f[a]:a.value;if(r)D(M)&&rs(M,i);else if(D(M))M.includes(i)||M.push(i);else if(T)f[a]=[i],d(a)&&(p[a]=f[a]);else{const z=[i];a.value=z,e.k&&(f[e.k]=z)}}else T?(f[a]=l,d(a)&&(p[a]=l)):S&&(a.value=l,e.k&&(f[e.k]=l))};if(l){const M=()=>{L(),ut.delete(e)};M.id=-1,ut.set(e,M),pe(M,t)}else Bs(e),L()}}}function Bs(e){const n=ut.get(e);n&&(n.flags|=8,ut.delete(e))}wt().requestIdleCallback;wt().cancelIdleCallback;const On=e=>!!e.type.__asyncLoader,Qr=e=>e.type.__isKeepAlive;function Go(e,n){Xr(e,"a",n)}function zo(e,n){Xr(e,"da",n)}function Xr(e,n,t=oe){const s=e.__wdc||(e.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return e()});if(vt(n,s,t),t){let r=t.parent;for(;r&&r.parent;)Qr(r.parent.vnode)&&$o(s,n,t,r),r=r.parent}}function $o(e,n,t,s){const r=vt(n,e,s,!0);ei(()=>{rs(s[n],r)},t)}function vt(e,n,t=oe,s=!1){if(t){const r=t[e]||(t[e]=[]),i=n.__weh||(n.__weh=(...l)=>{je();const o=Nn(t),a=Ee(n,t,e,l);return o(),Fe(),a});return s?r.unshift(i):r.push(i),i}}const Ue=e=>(n,t=oe)=>{(!Wn||e==="sp")&&vt(e,(...s)=>n(...s),t)},jo=Ue("bm"),Fo=Ue("m"),Bo=Ue("bu"),Uo=Ue("u"),Wo=Ue("bum"),ei=Ue("um"),Ho=Ue("sp"),No=Ue("rtg"),Vo=Ue("rtc");function Ko(e,n=oe){vt("ec",e,n)}const qo=Symbol.for("v-ndc");function Us(e,n,t,s){let r;const i=t,l=D(e);if(l||Q(e)){const o=l&&ln(e);let a=!1,u=!1;o&&(a=!me(e),u=Be(e),e=yt(e)),r=new Array(e.length);for(let f=0,p=e.length;f<p;f++)r[f]=n(a?u?bn(ve(e[f])):ve(e[f]):e[f],f,void 0,i)}else if(typeof e=="number"){r=new Array(e);for(let o=0;o<e;o++)r[o]=n(o+1,o,void 0,i)}else if(J(e))if(e[Symbol.iterator])r=Array.from(e,(o,a)=>n(o,a,void 0,i));else{const o=Object.keys(e);r=new Array(o.length);for(let a=0,u=o.length;a<u;a++){const f=o[a];r[a]=n(e[f],f,a,i)}}else r=[];return r}const Kt=e=>e?yi(e)?ys(e):Kt(e.parent):null,Gn=te(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Kt(e.parent),$root:e=>Kt(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>ti(e),$forceUpdate:e=>e.f||(e.f=()=>{gs(e.update)}),$nextTick:e=>e.n||(e.n=Vt.bind(e.proxy)),$watch:e=>Mo.bind(e)}),Gt=(e,n)=>e!==K&&!e.__isScriptSetup&&F(e,n),Jo={get({_:e},n){if(n==="__v_skip")return!0;const{ctx:t,setupState:s,data:r,props:i,accessCache:l,type:o,appContext:a}=e;if(n[0]!=="$"){const m=l[n];if(m!==void 0)switch(m){case 1:return s[n];case 2:return r[n];case 4:return t[n];case 3:return i[n]}else{if(Gt(s,n))return l[n]=1,s[n];if(r!==K&&F(r,n))return l[n]=2,r[n];if(F(i,n))return l[n]=3,i[n];if(t!==K&&F(t,n))return l[n]=4,t[n];qt&&(l[n]=0)}}const u=Gn[n];let f,p;if(u)return n==="$attrs"&&ee(e.attrs,"get",""),u(e);if((f=o.__cssModules)&&(f=f[n]))return f;if(t!==K&&F(t,n))return l[n]=4,t[n];if(p=a.config.globalProperties,F(p,n))return p[n]},set({_:e},n,t){const{data:s,setupState:r,ctx:i}=e;return Gt(r,n)?(r[n]=t,!0):s!==K&&F(s,n)?(s[n]=t,!0):F(e.props,n)||n[0]==="$"&&n.slice(1)in e?!1:(i[n]=t,!0)},has({_:{data:e,setupState:n,accessCache:t,ctx:s,appContext:r,props:i,type:l}},o){let a;return!!(t[o]||e!==K&&o[0]!=="$"&&F(e,o)||Gt(n,o)||F(i,o)||F(s,o)||F(Gn,o)||F(r.config.globalProperties,o)||(a=l.__cssModules)&&a[o])},defineProperty(e,n,t){return t.get!=null?e._.accessCache[n]=0:F(t,"value")&&this.set(e,n,t.value,null),Reflect.defineProperty(e,n,t)}};function Ws(e){return D(e)?e.reduce((n,t)=>(n[t]=null,n),{}):e}let qt=!0;function Yo(e){const n=ti(e),t=e.proxy,s=e.ctx;qt=!1,n.beforeCreate&&Hs(n.beforeCreate,e,"bc");const{data:r,computed:i,methods:l,watch:o,provide:a,inject:u,created:f,beforeMount:p,mounted:m,beforeUpdate:d,updated:T,activated:S,deactivated:L,beforeDestroy:M,beforeUnmount:z,destroyed:q,unmounted:C,render:Z,renderTracked:ge,renderTriggered:X,errorCaptured:We,serverPrefetch:Kn,expose:Qe,inheritAttrs:wn,components:qn,directives:Jn,filters:It}=n;if(u&&Zo(u,s,null),l)for(const Y in l){const H=l[Y];E(H)&&(s[Y]=H.bind(t))}if(r){const Y=r.call(t,t);J(Y)&&(e.data=hs(Y))}if(qt=!0,i)for(const Y in i){const H=i[Y],Xe=E(H)?H.bind(t,t):E(H.get)?H.get.bind(t,t):Me,Yn=!E(H)&&E(H.set)?H.set.bind(t):Me,en=it({get:Xe,set:Yn});Object.defineProperty(s,Y,{enumerable:!0,configurable:!0,get:()=>en.value,set:Ae=>en.value=Ae})}if(o)for(const Y in o)ni(o[Y],s,t,Y);if(a){const Y=E(a)?a.call(t):a;Reflect.ownKeys(Y).forEach(H=>{Co(H,Y[H])})}f&&Hs(f,e,"c");function se(Y,H){D(H)?H.forEach(Xe=>Y(Xe.bind(t))):H&&Y(H.bind(t))}if(se(jo,p),se(Fo,m),se(Bo,d),se(Uo,T),se(Go,S),se(zo,L),se(Ko,We),se(Vo,ge),se(No,X),se(Wo,z),se(ei,C),se(Ho,Kn),D(Qe))if(Qe.length){const Y=e.exposed||(e.exposed={});Qe.forEach(H=>{Object.defineProperty(Y,H,{get:()=>t[H],set:Xe=>t[H]=Xe,enumerable:!0})})}else e.exposed||(e.exposed={});Z&&e.render===Me&&(e.render=Z),wn!=null&&(e.inheritAttrs=wn),qn&&(e.components=qn),Jn&&(e.directives=Jn),Kn&&Zr(e)}function Zo(e,n,t=Me){D(e)&&(e=Jt(e));for(const s in e){const r=e[s];let i;J(r)?"default"in r?i=st(r.from||s,r.default,!0):i=st(r.from||s):i=st(r),ne(i)?Object.defineProperty(n,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):n[s]=i}}function Hs(e,n,t){Ee(D(e)?e.map(s=>s.bind(n.proxy)):e.bind(n.proxy),n,t)}function ni(e,n,t,s){let r=s.includes(".")?Yr(t,s):()=>t[s];if(Q(e)){const i=n[e];E(i)&&Ot(r,i)}else if(E(e))Ot(r,e.bind(t));else if(J(e))if(D(e))e.forEach(i=>ni(i,n,t,s));else{const i=E(e.handler)?e.handler.bind(t):n[e.handler];E(i)&&Ot(r,i,e)}}function ti(e){const n=e.type,{mixins:t,extends:s}=n,{mixins:r,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,o=i.get(n);let a;return o?a=o:!r.length&&!t&&!s?a=n:(a={},r.length&&r.forEach(u=>ft(a,u,l,!0)),ft(a,n,l)),J(n)&&i.set(n,a),a}function ft(e,n,t,s=!1){const{mixins:r,extends:i}=n;i&&ft(e,i,t,!0),r&&r.forEach(l=>ft(e,l,t,!0));for(const l in n)if(!(s&&l==="expose")){const o=Qo[l]||t&&t[l];e[l]=o?o(e[l],n[l]):n[l]}return e}const Qo={data:Ns,props:Vs,emits:Vs,methods:Pn,computed:Pn,beforeCreate:re,created:re,beforeMount:re,mounted:re,beforeUpdate:re,updated:re,beforeDestroy:re,beforeUnmount:re,destroyed:re,unmounted:re,activated:re,deactivated:re,errorCaptured:re,serverPrefetch:re,components:Pn,directives:Pn,watch:el,provide:Ns,inject:Xo};function Ns(e,n){return n?e?function(){return te(E(e)?e.call(this,this):e,E(n)?n.call(this,this):n)}:n:e}function Xo(e,n){return Pn(Jt(e),Jt(n))}function Jt(e){if(D(e)){const n={};for(let t=0;t<e.length;t++)n[e[t]]=e[t];return n}return e}function re(e,n){return e?[...new Set([].concat(e,n))]:n}function Pn(e,n){return e?te(Object.create(null),e,n):n}function Vs(e,n){return e?D(e)&&D(n)?[...new Set([...e,...n])]:te(Object.create(null),Ws(e),Ws(n??{})):n}function el(e,n){if(!e)return n;if(!n)return e;const t=te(Object.create(null),e);for(const s in n)t[s]=re(e[s],n[s]);return t}function si(){return{app:null,config:{isNativeTag:wr,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let nl=0;function tl(e,n){return function(s,r=null){E(s)||(s=te({},s)),r!=null&&!J(r)&&(r=null);const i=si(),l=new WeakSet,o=[];let a=!1;const u=i.app={_uid:nl++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:Gl,get config(){return i.config},set config(f){},use(f,...p){return l.has(f)||(f&&E(f.install)?(l.add(f),f.install(u,...p)):E(f)&&(l.add(f),f(u,...p))),u},mixin(f){return i.mixins.includes(f)||i.mixins.push(f),u},component(f,p){return p?(i.components[f]=p,u):i.components[f]},directive(f,p){return p?(i.directives[f]=p,u):i.directives[f]},mount(f,p,m){if(!a){const d=u._ceVNode||$e(s,r);return d.appContext=i,m===!0?m="svg":m===!1&&(m=void 0),e(d,f,m),a=!0,u._container=f,f.__vue_app__=u,ys(d.component)}},onUnmount(f){o.push(f)},unmount(){a&&(Ee(o,u._instance,16),e(null,u._container),delete u._container.__vue_app__)},provide(f,p){return i.provides[f]=p,u},runWithContext(f){const p=mn;mn=u;try{return f()}finally{mn=p}}};return u}}let mn=null;const sl=(e,n)=>n==="modelValue"||n==="model-value"?e.modelModifiers:e[`${n}Modifiers`]||e[`${Je(n)}Modifiers`]||e[`${cn(n)}Modifiers`];function rl(e,n,...t){if(e.isUnmounted)return;const s=e.vnode.props||K;let r=t;const i=n.startsWith("update:"),l=i&&sl(s,n.slice(7));l&&(l.trim&&(r=t.map(f=>Q(f)?f.trim():f)),l.number&&(r=t.map(Ui)));let o,a=s[o=Ct(n)]||s[o=Ct(Je(n))];!a&&i&&(a=s[o=Ct(cn(n))]),a&&Ee(a,e,6,r);const u=s[o+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[o])return;e.emitted[o]=!0,Ee(u,e,6,r)}}const il=new WeakMap;function ri(e,n,t=!1){const s=t?il:n.emitsCache,r=s.get(e);if(r!==void 0)return r;const i=e.emits;let l={},o=!1;if(!E(e)){const a=u=>{const f=ri(u,n,!0);f&&(o=!0,te(l,f))};!t&&n.mixins.length&&n.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!i&&!o?(J(e)&&s.set(e,null),null):(D(i)?i.forEach(a=>l[a]=null):te(l,i),J(e)&&s.set(e,l),l)}function At(e,n){return!e||!mt(n)?!1:(n=n.slice(2).replace(/Once$/,""),F(e,n[0].toLowerCase()+n.slice(1))||F(e,cn(n))||F(e,n))}function Ks(e){const{type:n,vnode:t,proxy:s,withProxy:r,propsOptions:[i],slots:l,attrs:o,emit:a,render:u,renderCache:f,props:p,data:m,setupState:d,ctx:T,inheritAttrs:S}=e,L=ct(e);let M,z;try{if(t.shapeFlag&4){const C=r||s,Z=C;M=Re(u.call(Z,C,f,p,d,m,T)),z=o}else{const C=n;M=Re(C.length>1?C(p,{attrs:o,slots:l,emit:a}):C(p,null)),z=n.props?o:ol(o)}}catch(C){zn.length=0,kt(C,e,1),M=$e(Ye)}let q=M;if(z&&S!==!1){const C=Object.keys(z),{shapeFlag:Z}=q;C.length&&Z&7&&(i&&C.some(ss)&&(z=ll(z,i)),q=xn(q,z,!1,!0))}return t.dirs&&(q=xn(q,null,!1,!0),q.dirs=q.dirs?q.dirs.concat(t.dirs):t.dirs),t.transition&&ms(q,t.transition),M=q,ct(L),M}const ol=e=>{let n;for(const t in e)(t==="class"||t==="style"||mt(t))&&((n||(n={}))[t]=e[t]);return n},ll=(e,n)=>{const t={};for(const s in e)(!ss(s)||!(s.slice(9)in n))&&(t[s]=e[s]);return t};function al(e,n,t){const{props:s,children:r,component:i}=e,{props:l,children:o,patchFlag:a}=n,u=i.emitsOptions;if(n.dirs||n.transition)return!0;if(t&&a>=0){if(a&1024)return!0;if(a&16)return s?qs(s,l,u):!!l;if(a&8){const f=n.dynamicProps;for(let p=0;p<f.length;p++){const m=f[p];if(l[m]!==s[m]&&!At(u,m))return!0}}}else return(r||o)&&(!o||!o.$stable)?!0:s===l?!1:s?l?qs(s,l,u):!0:!!l;return!1}function qs(e,n,t){const s=Object.keys(n);if(s.length!==Object.keys(e).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(n[i]!==e[i]&&!At(t,i))return!0}return!1}function cl({vnode:e,parent:n},t){for(;n;){const s=n.subTree;if(s.suspense&&s.suspense.activeBranch===e&&(s.el=e.el),s===e)(e=n.vnode).el=t,n=n.parent;else break}}const ii={},oi=()=>Object.create(ii),li=e=>Object.getPrototypeOf(e)===ii;function ul(e,n,t,s=!1){const r={},i=oi();e.propsDefaults=Object.create(null),ai(e,n,r,i);for(const l in e.propsOptions[0])l in r||(r[l]=void 0);t?e.props=s?r:mo(r):e.type.props?e.props=r:e.props=i,e.attrs=i}function fl(e,n,t,s){const{props:r,attrs:i,vnode:{patchFlag:l}}=e,o=j(r),[a]=e.propsOptions;let u=!1;if((s||l>0)&&!(l&16)){if(l&8){const f=e.vnode.dynamicProps;for(let p=0;p<f.length;p++){let m=f[p];if(At(e.emitsOptions,m))continue;const d=n[m];if(a)if(F(i,m))d!==i[m]&&(i[m]=d,u=!0);else{const T=Je(m);r[T]=Yt(a,o,T,d,e,!1)}else d!==i[m]&&(i[m]=d,u=!0)}}}else{ai(e,n,r,i)&&(u=!0);let f;for(const p in o)(!n||!F(n,p)&&((f=cn(p))===p||!F(n,f)))&&(a?t&&(t[p]!==void 0||t[f]!==void 0)&&(r[p]=Yt(a,o,p,void 0,e,!0)):delete r[p]);if(i!==o)for(const p in i)(!n||!F(n,p))&&(delete i[p],u=!0)}u&&ze(e.attrs,"set","")}function ai(e,n,t,s){const[r,i]=e.propsOptions;let l=!1,o;if(n)for(let a in n){if(Dn(a))continue;const u=n[a];let f;r&&F(r,f=Je(a))?!i||!i.includes(f)?t[f]=u:(o||(o={}))[f]=u:At(e.emitsOptions,a)||(!(a in s)||u!==s[a])&&(s[a]=u,l=!0)}if(i){const a=j(t),u=o||K;for(let f=0;f<i.length;f++){const p=i[f];t[p]=Yt(r,a,p,u[p],e,!F(u,p))}}return l}function Yt(e,n,t,s,r,i){const l=e[t];if(l!=null){const o=F(l,"default");if(o&&s===void 0){const a=l.default;if(l.type!==Function&&!l.skipFactory&&E(a)){const{propsDefaults:u}=r;if(t in u)s=u[t];else{const f=Nn(r);s=u[t]=a.call(null,n),f()}}else s=a;r.ce&&r.ce._setProp(t,s)}l[0]&&(i&&!o?s=!1:l[1]&&(s===""||s===cn(t))&&(s=!0))}return s}const hl=new WeakMap;function ci(e,n,t=!1){const s=t?hl:n.propsCache,r=s.get(e);if(r)return r;const i=e.props,l={},o=[];let a=!1;if(!E(e)){const f=p=>{a=!0;const[m,d]=ci(p,n,!0);te(l,m),d&&o.push(...d)};!t&&n.mixins.length&&n.mixins.forEach(f),e.extends&&f(e.extends),e.mixins&&e.mixins.forEach(f)}if(!i&&!a)return J(e)&&s.set(e,pn),pn;if(D(i))for(let f=0;f<i.length;f++){const p=Je(i[f]);Js(p)&&(l[p]=K)}else if(i)for(const f in i){const p=Je(f);if(Js(p)){const m=i[f],d=l[p]=D(m)||E(m)?{type:m}:te({},m),T=d.type;let S=!1,L=!0;if(D(T))for(let M=0;M<T.length;++M){const z=T[M],q=E(z)&&z.name;if(q==="Boolean"){S=!0;break}else q==="String"&&(L=!1)}else S=E(T)&&T.name==="Boolean";d[0]=S,d[1]=L,(S||F(d,"default"))&&o.push(p)}}const u=[l,o];return J(e)&&s.set(e,u),u}function Js(e){return e[0]!=="$"&&!Dn(e)}const bs=e=>e==="_"||e==="_ctx"||e==="$stable",xs=e=>D(e)?e.map(Re):[Re(e)],pl=(e,n,t)=>{if(n._n)return n;const s=Po((...r)=>xs(n(...r)),t);return s._c=!1,s},ui=(e,n,t)=>{const s=e._ctx;for(const r in e){if(bs(r))continue;const i=e[r];if(E(i))n[r]=pl(r,i,s);else if(i!=null){const l=xs(i);n[r]=()=>l}}},fi=(e,n)=>{const t=xs(n);e.slots.default=()=>t},hi=(e,n,t)=>{for(const s in n)(t||!bs(s))&&(e[s]=n[s])},dl=(e,n,t)=>{const s=e.slots=oi();if(e.vnode.shapeFlag&32){const r=n._;r?(hi(s,n,t),t&&_r(s,"_",r,!0)):ui(n,s)}else n&&fi(e,n)},gl=(e,n,t)=>{const{vnode:s,slots:r}=e;let i=!0,l=K;if(s.shapeFlag&32){const o=n._;o?t&&o===1?i=!1:hi(r,n,t):(i=!n.$stable,ui(n,r)),l=n}else n&&(fi(e,n),l={default:1});if(i)for(const o in r)!bs(o)&&l[o]==null&&delete r[o]},pe=yl;function ml(e){return bl(e)}function bl(e,n){const t=wt();t.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:l,createText:o,createComment:a,setText:u,setElementText:f,parentNode:p,nextSibling:m,setScopeId:d=Me,insertStaticContent:T}=e,S=(c,h,g,y=null,b=null,x=null,A=void 0,v=null,k=!!h.dynamicChildren)=>{if(c===h)return;c&&!Sn(c,h)&&(y=Zn(c),Ae(c,b,x,!0),c=null),h.patchFlag===-2&&(k=!1,h.dynamicChildren=null);const{type:w,ref:P,shapeFlag:_}=h;switch(w){case St:L(c,h,g,y);break;case Ye:M(c,h,g,y);break;case $t:c==null&&z(h,g,y,A);break;case fe:qn(c,h,g,y,b,x,A,v,k);break;default:_&1?Z(c,h,g,y,b,x,A,v,k):_&6?Jn(c,h,g,y,b,x,A,v,k):(_&64||_&128)&&w.process(c,h,g,y,b,x,A,v,k,kn)}P!=null&&b?Ln(P,c&&c.ref,x,h||c,!h):P==null&&c&&c.ref!=null&&Ln(c.ref,null,x,c,!0)},L=(c,h,g,y)=>{if(c==null)s(h.el=o(h.children),g,y);else{const b=h.el=c.el;h.children!==c.children&&u(b,h.children)}},M=(c,h,g,y)=>{c==null?s(h.el=a(h.children||""),g,y):h.el=c.el},z=(c,h,g,y)=>{[c.el,c.anchor]=T(c.children,h,g,y,c.el,c.anchor)},q=({el:c,anchor:h},g,y)=>{let b;for(;c&&c!==h;)b=m(c),s(c,g,y),c=b;s(h,g,y)},C=({el:c,anchor:h})=>{let g;for(;c&&c!==h;)g=m(c),r(c),c=g;r(h)},Z=(c,h,g,y,b,x,A,v,k)=>{if(h.type==="svg"?A="svg":h.type==="math"&&(A="mathml"),c==null)ge(h,g,y,b,x,A,v,k);else{const w=c.el&&c.el._isVueCE?c.el:null;try{w&&w._beginPatch(),Kn(c,h,b,x,A,v,k)}finally{w&&w._endPatch()}}},ge=(c,h,g,y,b,x,A,v)=>{let k,w;const{props:P,shapeFlag:_,transition:I,dirs:R}=c;if(k=c.el=l(c.type,x,P&&P.is,P),_&8?f(k,c.children):_&16&&We(c.children,k,null,y,b,zt(c,x),A,v),R&&nn(c,null,y,"created"),X(k,c,c.scopeId,A,y),P){for(const N in P)N!=="value"&&!Dn(N)&&i(k,N,null,P[N],x,y);"value"in P&&i(k,"value",null,P.value,x),(w=P.onVnodeBeforeMount)&&Pe(w,y,c)}R&&nn(c,null,y,"beforeMount");const O=xl(b,I);O&&I.beforeEnter(k),s(k,h,g),((w=P&&P.onVnodeMounted)||O||R)&&pe(()=>{w&&Pe(w,y,c),O&&I.enter(k),R&&nn(c,null,y,"mounted")},b)},X=(c,h,g,y,b)=>{if(g&&d(c,g),y)for(let x=0;x<y.length;x++)d(c,y[x]);if(b){let x=b.subTree;if(h===x||mi(x.type)&&(x.ssContent===h||x.ssFallback===h)){const A=b.vnode;X(c,A,A.scopeId,A.slotScopeIds,b.parent)}}},We=(c,h,g,y,b,x,A,v,k=0)=>{for(let w=k;w<c.length;w++){const P=c[w]=v?Ve(c[w]):Re(c[w]);S(null,P,h,g,y,b,x,A,v)}},Kn=(c,h,g,y,b,x,A)=>{const v=h.el=c.el;let{patchFlag:k,dynamicChildren:w,dirs:P}=h;k|=c.patchFlag&16;const _=c.props||K,I=h.props||K;let R;if(g&&tn(g,!1),(R=I.onVnodeBeforeUpdate)&&Pe(R,g,h,c),P&&nn(h,c,g,"beforeUpdate"),g&&tn(g,!0),(_.innerHTML&&I.innerHTML==null||_.textContent&&I.textContent==null)&&f(v,""),w?Qe(c.dynamicChildren,w,v,g,y,zt(h,b),x):A||H(c,h,v,null,g,y,zt(h,b),x,!1),k>0){if(k&16)wn(v,_,I,g,b);else if(k&2&&_.class!==I.class&&i(v,"class",null,I.class,b),k&4&&i(v,"style",_.style,I.style,b),k&8){const O=h.dynamicProps;for(let N=0;N<O.length;N++){const U=O[N],ae=_[U],ce=I[U];(ce!==ae||U==="value")&&i(v,U,ae,ce,b,g)}}k&1&&c.children!==h.children&&f(v,h.children)}else!A&&w==null&&wn(v,_,I,g,b);((R=I.onVnodeUpdated)||P)&&pe(()=>{R&&Pe(R,g,h,c),P&&nn(h,c,g,"updated")},y)},Qe=(c,h,g,y,b,x,A)=>{for(let v=0;v<h.length;v++){const k=c[v],w=h[v],P=k.el&&(k.type===fe||!Sn(k,w)||k.shapeFlag&198)?p(k.el):g;S(k,w,P,null,y,b,x,A,!0)}},wn=(c,h,g,y,b)=>{if(h!==g){if(h!==K)for(const x in h)!Dn(x)&&!(x in g)&&i(c,x,h[x],null,b,y);for(const x in g){if(Dn(x))continue;const A=g[x],v=h[x];A!==v&&x!=="value"&&i(c,x,v,A,b,y)}"value"in g&&i(c,"value",h.value,g.value,b)}},qn=(c,h,g,y,b,x,A,v,k)=>{const w=h.el=c?c.el:o(""),P=h.anchor=c?c.anchor:o("");let{patchFlag:_,dynamicChildren:I,slotScopeIds:R}=h;R&&(v=v?v.concat(R):R),c==null?(s(w,g,y),s(P,g,y),We(h.children||[],g,P,b,x,A,v,k)):_>0&&_&64&&I&&c.dynamicChildren&&c.dynamicChildren.length===I.length?(Qe(c.dynamicChildren,I,g,b,x,A,v),(h.key!=null||b&&h===b.subTree)&&pi(c,h,!0)):H(c,h,g,P,b,x,A,v,k)},Jn=(c,h,g,y,b,x,A,v,k)=>{h.slotScopeIds=v,c==null?h.shapeFlag&512?b.ctx.activate(h,g,y,A,k):It(h,g,y,b,x,A,k):Rs(c,h,k)},It=(c,h,g,y,b,x,A)=>{const v=c.component=Cl(c,y,b);if(Qr(c)&&(v.ctx.renderer=kn),Dl(v,!1,A),v.asyncDep){if(b&&b.registerDep(v,se,A),!c.el){const k=v.subTree=$e(Ye);M(null,k,h,g),c.placeholder=k.el}}else se(v,c,h,g,b,x,A)},Rs=(c,h,g)=>{const y=h.component=c.component;if(al(c,h,g))if(y.asyncDep&&!y.asyncResolved){Y(y,h,g);return}else y.next=h,y.update();else h.el=c.el,y.vnode=h},se=(c,h,g,y,b,x,A)=>{const v=()=>{if(c.isMounted){let{next:_,bu:I,u:R,parent:O,vnode:N}=c;{const _e=di(c);if(_e){_&&(_.el=N.el,Y(c,_,A)),_e.asyncDep.then(()=>{c.isUnmounted||v()});return}}let U=_,ae;tn(c,!1),_?(_.el=N.el,Y(c,_,A)):_=N,I&&Rt(I),(ae=_.props&&_.props.onVnodeBeforeUpdate)&&Pe(ae,O,_,N),tn(c,!0);const ce=Ks(c),Se=c.subTree;c.subTree=ce,S(Se,ce,p(Se.el),Zn(Se),c,b,x),_.el=ce.el,U===null&&cl(c,ce.el),R&&pe(R,b),(ae=_.props&&_.props.onVnodeUpdated)&&pe(()=>Pe(ae,O,_,N),b)}else{let _;const{el:I,props:R}=h,{bm:O,m:N,parent:U,root:ae,type:ce}=c,Se=On(h);tn(c,!1),O&&Rt(O),!Se&&(_=R&&R.onVnodeBeforeMount)&&Pe(_,U,h),tn(c,!0);{ae.ce&&ae.ce._def.shadowRoot!==!1&&ae.ce._injectChildStyle(ce);const _e=c.subTree=Ks(c);S(null,_e,g,y,c,b,x),h.el=_e.el}if(N&&pe(N,b),!Se&&(_=R&&R.onVnodeMounted)){const _e=h;pe(()=>Pe(_,U,_e),b)}(h.shapeFlag&256||U&&On(U.vnode)&&U.vnode.shapeFlag&256)&&c.a&&pe(c.a,b),c.isMounted=!0,h=g=y=null}};c.scope.on();const k=c.effect=new Cr(v);c.scope.off();const w=c.update=k.run.bind(k),P=c.job=k.runIfDirty.bind(k);P.i=c,P.id=c.uid,k.scheduler=()=>gs(P),tn(c,!0),w()},Y=(c,h,g)=>{h.component=c;const y=c.vnode.props;c.vnode=h,c.next=null,fl(c,h.props,y,g),gl(c,h.children,g),je(),Fs(c),Fe()},H=(c,h,g,y,b,x,A,v,k=!1)=>{const w=c&&c.children,P=c?c.shapeFlag:0,_=h.children,{patchFlag:I,shapeFlag:R}=h;if(I>0){if(I&128){Yn(w,_,g,y,b,x,A,v,k);return}else if(I&256){Xe(w,_,g,y,b,x,A,v,k);return}}R&8?(P&16&&yn(w,b,x),_!==w&&f(g,_)):P&16?R&16?Yn(w,_,g,y,b,x,A,v,k):yn(w,b,x,!0):(P&8&&f(g,""),R&16&&We(_,g,y,b,x,A,v,k))},Xe=(c,h,g,y,b,x,A,v,k)=>{c=c||pn,h=h||pn;const w=c.length,P=h.length,_=Math.min(w,P);let I;for(I=0;I<_;I++){const R=h[I]=k?Ve(h[I]):Re(h[I]);S(c[I],R,g,null,b,x,A,v,k)}w>P?yn(c,b,x,!0,!1,_):We(h,g,y,b,x,A,v,k,_)},Yn=(c,h,g,y,b,x,A,v,k)=>{let w=0;const P=h.length;let _=c.length-1,I=P-1;for(;w<=_&&w<=I;){const R=c[w],O=h[w]=k?Ve(h[w]):Re(h[w]);if(Sn(R,O))S(R,O,g,null,b,x,A,v,k);else break;w++}for(;w<=_&&w<=I;){const R=c[_],O=h[I]=k?Ve(h[I]):Re(h[I]);if(Sn(R,O))S(R,O,g,null,b,x,A,v,k);else break;_--,I--}if(w>_){if(w<=I){const R=I+1,O=R<P?h[R].el:y;for(;w<=I;)S(null,h[w]=k?Ve(h[w]):Re(h[w]),g,O,b,x,A,v,k),w++}}else if(w>I)for(;w<=_;)Ae(c[w],b,x,!0),w++;else{const R=w,O=w,N=new Map;for(w=O;w<=I;w++){const he=h[w]=k?Ve(h[w]):Re(h[w]);he.key!=null&&N.set(he.key,w)}let U,ae=0;const ce=I-O+1;let Se=!1,_e=0;const vn=new Array(ce);for(w=0;w<ce;w++)vn[w]=0;for(w=R;w<=_;w++){const he=c[w];if(ae>=ce){Ae(he,b,x,!0);continue}let Te;if(he.key!=null)Te=N.get(he.key);else for(U=O;U<=I;U++)if(vn[U-O]===0&&Sn(he,h[U])){Te=U;break}Te===void 0?Ae(he,b,x,!0):(vn[Te-O]=w+1,Te>=_e?_e=Te:Se=!0,S(he,h[Te],g,null,b,x,A,v,k),ae++)}const Es=Se?wl(vn):pn;for(U=Es.length-1,w=ce-1;w>=0;w--){const he=O+w,Te=h[he],Ls=h[he+1],Os=he+1<P?Ls.el||gi(Ls):y;vn[w]===0?S(null,Te,g,Os,b,x,A,v,k):Se&&(U<0||w!==Es[U]?en(Te,g,Os,2):U--)}}},en=(c,h,g,y,b=null)=>{const{el:x,type:A,transition:v,children:k,shapeFlag:w}=c;if(w&6){en(c.component.subTree,h,g,y);return}if(w&128){c.suspense.move(h,g,y);return}if(w&64){A.move(c,h,g,kn);return}if(A===fe){s(x,h,g);for(let _=0;_<k.length;_++)en(k[_],h,g,y);s(c.anchor,h,g);return}if(A===$t){q(c,h,g);return}if(y!==2&&w&1&&v)if(y===0)v.beforeEnter(x),s(x,h,g),pe(()=>v.enter(x),b);else{const{leave:_,delayLeave:I,afterLeave:R}=v,O=()=>{c.ctx.isUnmounted?r(x):s(x,h,g)},N=()=>{x._isLeaving&&x[Oo](!0),_(x,()=>{O(),R&&R()})};I?I(x,O,N):N()}else s(x,h,g)},Ae=(c,h,g,y=!1,b=!1)=>{const{type:x,props:A,ref:v,children:k,dynamicChildren:w,shapeFlag:P,patchFlag:_,dirs:I,cacheIndex:R}=c;if(_===-2&&(b=!1),v!=null&&(je(),Ln(v,null,g,c,!0),Fe()),R!=null&&(h.renderCache[R]=void 0),P&256){h.ctx.deactivate(c);return}const O=P&1&&I,N=!On(c);let U;if(N&&(U=A&&A.onVnodeBeforeUnmount)&&Pe(U,h,c),P&6)Oi(c.component,g,y);else{if(P&128){c.suspense.unmount(g,y);return}O&&nn(c,null,h,"beforeUnmount"),P&64?c.type.remove(c,h,g,kn,y):w&&!w.hasOnce&&(x!==fe||_>0&&_&64)?yn(w,h,g,!1,!0):(x===fe&&_&384||!b&&P&16)&&yn(k,h,g),y&&Ds(c)}(N&&(U=A&&A.onVnodeUnmounted)||O)&&pe(()=>{U&&Pe(U,h,c),O&&nn(c,null,h,"unmounted")},g)},Ds=c=>{const{type:h,el:g,anchor:y,transition:b}=c;if(h===fe){Li(g,y);return}if(h===$t){C(c);return}const x=()=>{r(g),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(c.shapeFlag&1&&b&&!b.persisted){const{leave:A,delayLeave:v}=b,k=()=>A(g,x);v?v(c.el,x,k):k()}else x()},Li=(c,h)=>{let g;for(;c!==h;)g=m(c),r(c),c=g;r(h)},Oi=(c,h,g)=>{const{bum:y,scope:b,job:x,subTree:A,um:v,m:k,a:w}=c;Ys(k),Ys(w),y&&Rt(y),b.stop(),x&&(x.flags|=8,Ae(A,c,h,g)),v&&pe(v,h),pe(()=>{c.isUnmounted=!0},h)},yn=(c,h,g,y=!1,b=!1,x=0)=>{for(let A=x;A<c.length;A++)Ae(c[A],h,g,y,b)},Zn=c=>{if(c.shapeFlag&6)return Zn(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const h=m(c.anchor||c.el),g=h&&h[Eo];return g?m(g):h};let Pt=!1;const Ms=(c,h,g)=>{let y;c==null?h._vnode&&(Ae(h._vnode,null,null,!0),y=h._vnode.component):S(h._vnode||null,c,h,null,null,null,g),h._vnode=c,Pt||(Pt=!0,Fs(y),Vr(),Pt=!1)},kn={p:S,um:Ae,m:en,r:Ds,mt:It,mc:We,pc:H,pbc:Qe,n:Zn,o:e};return{render:Ms,hydrate:void 0,createApp:tl(Ms)}}function zt({type:e,props:n},t){return t==="svg"&&e==="foreignObject"||t==="mathml"&&e==="annotation-xml"&&n&&n.encoding&&n.encoding.includes("html")?void 0:t}function tn({effect:e,job:n},t){t?(e.flags|=32,n.flags|=4):(e.flags&=-33,n.flags&=-5)}function xl(e,n){return(!e||e&&!e.pendingBranch)&&n&&!n.persisted}function pi(e,n,t=!1){const s=e.children,r=n.children;if(D(s)&&D(r))for(let i=0;i<s.length;i++){const l=s[i];let o=r[i];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=r[i]=Ve(r[i]),o.el=l.el),!t&&o.patchFlag!==-2&&pi(l,o)),o.type===St&&(o.patchFlag!==-1?o.el=l.el:o.__elIndex=i+(e.type===fe?1:0)),o.type===Ye&&!o.el&&(o.el=l.el)}}function wl(e){const n=e.slice(),t=[0];let s,r,i,l,o;const a=e.length;for(s=0;s<a;s++){const u=e[s];if(u!==0){if(r=t[t.length-1],e[r]<u){n[s]=r,t.push(s);continue}for(i=0,l=t.length-1;i<l;)o=i+l>>1,e[t[o]]<u?i=o+1:l=o;u<e[t[i]]&&(i>0&&(n[s]=t[i-1]),t[i]=s)}}for(i=t.length,l=t[i-1];i-- >0;)t[i]=l,l=n[l];return t}function di(e){const n=e.subTree.component;if(n)return n.asyncDep&&!n.asyncResolved?n:di(n)}function Ys(e){if(e)for(let n=0;n<e.length;n++)e[n].flags|=8}function gi(e){if(e.placeholder)return e.placeholder;const n=e.component;return n?gi(n.subTree):null}const mi=e=>e.__isSuspense;function yl(e,n){n&&n.pendingBranch?D(e)?n.effects.push(...e):n.effects.push(e):Io(e)}const fe=Symbol.for("v-fgt"),St=Symbol.for("v-txt"),Ye=Symbol.for("v-cmt"),$t=Symbol.for("v-stc"),zn=[];let de=null;function xe(e=!1){zn.push(de=e?null:[])}function kl(){zn.pop(),de=zn[zn.length-1]||null}let Un=1;function Zs(e,n=!1){Un+=e,e<0&&de&&n&&(de.hasOnce=!0)}function bi(e){return e.dynamicChildren=Un>0?de||pn:null,kl(),Un>0&&de&&de.push(e),e}function Ie(e,n,t,s,r,i){return bi($(e,n,t,s,r,i,!0))}function vl(e,n,t,s,r){return bi($e(e,n,t,s,r,!0))}function xi(e){return e?e.__v_isVNode===!0:!1}function Sn(e,n){return e.type===n.type&&e.key===n.key}const wi=({key:e})=>e??null,rt=({ref:e,ref_key:n,ref_for:t})=>(typeof e=="number"&&(e=""+e),e!=null?Q(e)||ne(e)||E(e)?{i:De,r:e,k:n,f:!!t}:e:null);function $(e,n=null,t=null,s=0,r=null,i=e===fe?0:1,l=!1,o=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:n,key:n&&wi(n),ref:n&&rt(n),scopeId:qr,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:De};return o?(ws(a,t),i&128&&e.normalize(a)):t&&(a.shapeFlag|=Q(t)?8:16),Un>0&&!l&&de&&(a.patchFlag>0||i&6)&&a.patchFlag!==32&&de.push(a),a}const $e=Al;function Al(e,n=null,t=null,s=0,r=null,i=!1){if((!e||e===qo)&&(e=Ye),xi(e)){const o=xn(e,n,!0);return t&&ws(o,t),Un>0&&!i&&de&&(o.shapeFlag&6?de[de.indexOf(e)]=o:de.push(o)),o.patchFlag=-2,o}if(Ol(e)&&(e=e.__vccOpts),n){n=Sl(n);let{class:o,style:a}=n;o&&!Q(o)&&(n.class=rn(o)),J(a)&&(ds(a)&&!D(a)&&(a=te({},a)),n.style=os(a))}const l=Q(e)?1:mi(e)?128:Lo(e)?64:J(e)?4:E(e)?2:0;return $(e,n,t,s,r,l,i,!0)}function Sl(e){return e?ds(e)||li(e)?te({},e):e:null}function xn(e,n,t=!1,s=!1){const{props:r,ref:i,patchFlag:l,children:o,transition:a}=e,u=n?Tl(r||{},n):r,f={__v_isVNode:!0,__v_skip:!0,type:e.type,props:u,key:u&&wi(u),ref:n&&n.ref?t&&i?D(i)?i.concat(rt(n)):[i,rt(n)]:rt(n):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:o,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:n&&e.type!==fe?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&xn(e.ssContent),ssFallback:e.ssFallback&&xn(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&s&&ms(f,a.clone(f)),f}function Cn(e=" ",n=0){return $e(St,null,e,n)}function _l(e="",n=!1){return n?(xe(),vl(Ye,null,e)):$e(Ye,null,e)}function Re(e){return e==null||typeof e=="boolean"?$e(Ye):D(e)?$e(fe,null,e.slice()):xi(e)?Ve(e):$e(St,null,String(e))}function Ve(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:xn(e)}function ws(e,n){let t=0;const{shapeFlag:s}=e;if(n==null)n=null;else if(D(n))t=16;else if(typeof n=="object")if(s&65){const r=n.default;r&&(r._c&&(r._d=!1),ws(e,r()),r._c&&(r._d=!0));return}else{t=32;const r=n._;!r&&!li(n)?n._ctx=De:r===3&&De&&(De.slots._===1?n._=1:(n._=2,e.patchFlag|=1024))}else E(n)?(n={default:n,_ctx:De},t=32):(n=String(n),s&64?(t=16,n=[Cn(n)]):t=8);e.children=n,e.shapeFlag|=t}function Tl(...e){const n={};for(let t=0;t<e.length;t++){const s=e[t];for(const r in s)if(r==="class")n.class!==s.class&&(n.class=rn([n.class,s.class]));else if(r==="style")n.style=os([n.style,s.style]);else if(mt(r)){const i=n[r],l=s[r];l&&i!==l&&!(D(i)&&i.includes(l))&&(n[r]=i?[].concat(i,l):l)}else r!==""&&(n[r]=s[r])}return n}function Pe(e,n,t,s=null){Ee(e,n,7,[t,s])}const Il=si();let Pl=0;function Cl(e,n,t){const s=e.type,r=(n?n.appContext:e.appContext)||Il,i={uid:Pl++,vnode:e,type:s,parent:n,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Ji(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(r.provides),ids:n?n.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ci(s,r),emitsOptions:ri(s,r),emit:null,emitted:null,propsDefaults:K,inheritAttrs:s.inheritAttrs,ctx:K,data:K,props:K,attrs:K,slots:K,refs:K,setupState:K,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=n?n.root:i,i.emit=rl.bind(null,i),e.ce&&e.ce(i),i}let oe=null;const Rl=()=>oe||De;let ht,Zt;{const e=wt(),n=(t,s)=>{let r;return(r=e[t])||(r=e[t]=[]),r.push(s),i=>{r.length>1?r.forEach(l=>l(i)):r[0](i)}};ht=n("__VUE_INSTANCE_SETTERS__",t=>oe=t),Zt=n("__VUE_SSR_SETTERS__",t=>Wn=t)}const Nn=e=>{const n=oe;return ht(e),e.scope.on(),()=>{e.scope.off(),ht(n)}},Qs=()=>{oe&&oe.scope.off(),ht(null)};function yi(e){return e.vnode.shapeFlag&4}let Wn=!1;function Dl(e,n=!1,t=!1){n&&Zt(n);const{props:s,children:r}=e.vnode,i=yi(e);ul(e,s,i,n),dl(e,r,t||n);const l=i?Ml(e,n):void 0;return n&&Zt(!1),l}function Ml(e,n){const t=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Jo);const{setup:s}=t;if(s){je();const r=e.setupContext=s.length>1?Ll(e):null,i=Nn(e),l=Hn(s,e,0,[e.props,r]),o=kr(l);if(Fe(),i(),(o||e.sp)&&!On(e)&&Zr(e),o){if(l.then(Qs,Qs),n)return l.then(a=>{Xs(e,a)}).catch(a=>{kt(a,e,0)});e.asyncDep=l}else Xs(e,l)}else ki(e)}function Xs(e,n,t){E(n)?e.type.__ssrInlineRender?e.ssrRender=n:e.render=n:J(n)&&(e.setupState=Wr(n)),ki(e)}function ki(e,n,t){const s=e.type;e.render||(e.render=s.render||Me);{const r=Nn(e);je();try{Yo(e)}finally{Fe(),r()}}}const El={get(e,n){return ee(e,"get",""),e[n]}};function Ll(e){const n=t=>{e.exposed=t||{}};return{attrs:new Proxy(e.attrs,El),slots:e.slots,emit:e.emit,expose:n}}function ys(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Wr(bo(e.exposed)),{get(n,t){if(t in n)return n[t];if(t in Gn)return Gn[t](e)},has(n,t){return t in n||t in Gn}})):e.proxy}function Ol(e){return E(e)&&"__vccOpts"in e}const it=(e,n)=>vo(e,n,Wn),Gl="3.5.27";/**
* @vue/runtime-dom v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Qt;const er=typeof window<"u"&&window.trustedTypes;if(er)try{Qt=er.createPolicy("vue",{createHTML:e=>e})}catch{}const vi=Qt?e=>Qt.createHTML(e):e=>e,zl="http://www.w3.org/2000/svg",$l="http://www.w3.org/1998/Math/MathML",Ge=typeof document<"u"?document:null,nr=Ge&&Ge.createElement("template"),jl={insert:(e,n,t)=>{n.insertBefore(e,t||null)},remove:e=>{const n=e.parentNode;n&&n.removeChild(e)},createElement:(e,n,t,s)=>{const r=n==="svg"?Ge.createElementNS(zl,e):n==="mathml"?Ge.createElementNS($l,e):t?Ge.createElement(e,{is:t}):Ge.createElement(e);return e==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:e=>Ge.createTextNode(e),createComment:e=>Ge.createComment(e),setText:(e,n)=>{e.nodeValue=n},setElementText:(e,n)=>{e.textContent=n},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ge.querySelector(e),setScopeId(e,n){e.setAttribute(n,"")},insertStaticContent(e,n,t,s,r,i){const l=t?t.previousSibling:n.lastChild;if(r&&(r===i||r.nextSibling))for(;n.insertBefore(r.cloneNode(!0),t),!(r===i||!(r=r.nextSibling)););else{nr.innerHTML=vi(s==="svg"?`<svg>${e}</svg>`:s==="mathml"?`<math>${e}</math>`:e);const o=nr.content;if(s==="svg"||s==="mathml"){const a=o.firstChild;for(;a.firstChild;)o.appendChild(a.firstChild);o.removeChild(a)}n.insertBefore(o,t)}return[l?l.nextSibling:n.firstChild,t?t.previousSibling:n.lastChild]}},Fl=Symbol("_vtc");function Bl(e,n,t){const s=e[Fl];s&&(n=(n?[n,...s]:[...s]).join(" ")),n==null?e.removeAttribute("class"):t?e.setAttribute("class",n):e.className=n}const tr=Symbol("_vod"),Ul=Symbol("_vsh"),Wl=Symbol(""),Hl=/(?:^|;)\s*display\s*:/;function Nl(e,n,t){const s=e.style,r=Q(t);let i=!1;if(t&&!r){if(n)if(Q(n))for(const l of n.split(";")){const o=l.slice(0,l.indexOf(":")).trim();t[o]==null&&ot(s,o,"")}else for(const l in n)t[l]==null&&ot(s,l,"");for(const l in t)l==="display"&&(i=!0),ot(s,l,t[l])}else if(r){if(n!==t){const l=s[Wl];l&&(t+=";"+l),s.cssText=t,i=Hl.test(t)}}else n&&e.removeAttribute("style");tr in e&&(e[tr]=i?s.display:"",e[Ul]&&(s.display="none"))}const sr=/\s*!important$/;function ot(e,n,t){if(D(t))t.forEach(s=>ot(e,n,s));else if(t==null&&(t=""),n.startsWith("--"))e.setProperty(n,t);else{const s=Vl(e,n);sr.test(t)?e.setProperty(cn(s),t.replace(sr,""),"important"):e[s]=t}}const rr=["Webkit","Moz","ms"],jt={};function Vl(e,n){const t=jt[n];if(t)return t;let s=Je(n);if(s!=="filter"&&s in e)return jt[n]=s;s=Sr(s);for(let r=0;r<rr.length;r++){const i=rr[r]+s;if(i in e)return jt[n]=i}return n}const ir="http://www.w3.org/1999/xlink";function or(e,n,t,s,r,i=qi(n)){s&&n.startsWith("xlink:")?t==null?e.removeAttributeNS(ir,n.slice(6,n.length)):e.setAttributeNS(ir,n,t):t==null||i&&!Tr(t)?e.removeAttribute(n):e.setAttribute(n,i?"":Ze(t)?String(t):t)}function lr(e,n,t,s,r){if(n==="innerHTML"||n==="textContent"){t!=null&&(e[n]=n==="innerHTML"?vi(t):t);return}const i=e.tagName;if(n==="value"&&i!=="PROGRESS"&&!i.includes("-")){const o=i==="OPTION"?e.getAttribute("value")||"":e.value,a=t==null?e.type==="checkbox"?"on":"":String(t);(o!==a||!("_value"in e))&&(e.value=a),t==null&&e.removeAttribute(n),e._value=t;return}let l=!1;if(t===""||t==null){const o=typeof e[n];o==="boolean"?t=Tr(t):t==null&&o==="string"?(t="",l=!0):o==="number"&&(t=0,l=!0)}try{e[n]=t}catch{}l&&e.removeAttribute(r||n)}function Kl(e,n,t,s){e.addEventListener(n,t,s)}function ql(e,n,t,s){e.removeEventListener(n,t,s)}const ar=Symbol("_vei");function Jl(e,n,t,s,r=null){const i=e[ar]||(e[ar]={}),l=i[n];if(s&&l)l.value=s;else{const[o,a]=Yl(n);if(s){const u=i[n]=Xl(s,r);Kl(e,o,u,a)}else l&&(ql(e,o,l,a),i[n]=void 0)}}const cr=/(?:Once|Passive|Capture)$/;function Yl(e){let n;if(cr.test(e)){n={};let s;for(;s=e.match(cr);)e=e.slice(0,e.length-s[0].length),n[s[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):cn(e.slice(2)),n]}let Ft=0;const Zl=Promise.resolve(),Ql=()=>Ft||(Zl.then(()=>Ft=0),Ft=Date.now());function Xl(e,n){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;Ee(ea(s,t.value),n,5,[s])};return t.value=e,t.attached=Ql(),t}function ea(e,n){if(D(n)){const t=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{t.call(e),e._stopped=!0},n.map(s=>r=>!r._stopped&&s&&s(r))}else return n}const ur=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,na=(e,n,t,s,r,i)=>{const l=r==="svg";n==="class"?Bl(e,s,l):n==="style"?Nl(e,t,s):mt(n)?ss(n)||Jl(e,n,t,s,i):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):ta(e,n,s,l))?(lr(e,n,s),!e.tagName.includes("-")&&(n==="value"||n==="checked"||n==="selected")&&or(e,n,s,l,i,n!=="value")):e._isVueCE&&(/[A-Z]/.test(n)||!Q(s))?lr(e,Je(n),s,i,n):(n==="true-value"?e._trueValue=s:n==="false-value"&&(e._falseValue=s),or(e,n,s,l))};function ta(e,n,t,s){if(s)return!!(n==="innerHTML"||n==="textContent"||n in e&&ur(n)&&E(t));if(n==="spellcheck"||n==="draggable"||n==="translate"||n==="autocorrect"||n==="sandbox"&&e.tagName==="IFRAME"||n==="form"||n==="list"&&e.tagName==="INPUT"||n==="type"&&e.tagName==="TEXTAREA")return!1;if(n==="width"||n==="height"){const r=e.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return ur(n)&&Q(t)?!1:n in e}const sa=te({patchProp:na},jl);let fr;function ra(){return fr||(fr=ml(sa))}const ia=((...e)=>{const n=ra().createApp(...e),{mount:t}=n;return n.mount=s=>{const r=la(s);if(!r)return;const i=n._component;!E(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const l=t(r,!1,oa(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),l},n});function oa(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function la(e){return Q(e)?document.querySelector(e):e}function ks(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var un=ks();function Ai(e){un=e}var $n={exec:()=>null};function G(e,n=""){let t=typeof e=="string"?e:e.source,s={replace:(r,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(le.caret,"$1"),t=t.replace(r,l),s},getRegex:()=>new RegExp(t,n)};return s}var aa=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),le={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},ca=/^(?:[ \t]*(?:\n|$))+/,ua=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fa=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Vn=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ha=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,vs=/(?:[*+-]|\d{1,9}[.)])/,Si=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_i=G(Si).replace(/bull/g,vs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),pa=G(Si).replace(/bull/g,vs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),As=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,da=/^[^\n]+/,Ss=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ga=G(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ss).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ma=G(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,vs).getRegex(),_t="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",_s=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ba=G("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",_s).replace("tag",_t).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ti=G(As).replace("hr",Vn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_t).getRegex(),xa=G(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ti).getRegex(),Ts={blockquote:xa,code:ua,def:ga,fences:fa,heading:ha,hr:Vn,html:ba,lheading:_i,list:ma,newline:ca,paragraph:Ti,table:$n,text:da},hr=G("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Vn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_t).getRegex(),wa={...Ts,lheading:pa,table:hr,paragraph:G(As).replace("hr",Vn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",hr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_t).getRegex()},ya={...Ts,html:G(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",_s).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:$n,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:G(As).replace("hr",Vn).replace("heading",` *#{1,6} *[^
]`).replace("lheading",_i).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ka=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,va=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ii=/^( {2,}|\\)\n(?!\s*$)/,Aa=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Tt=/[\p{P}\p{S}]/u,Is=/[\s\p{P}\p{S}]/u,Pi=/[^\s\p{P}\p{S}]/u,Sa=G(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Is).getRegex(),Ci=/(?!~)[\p{P}\p{S}]/u,_a=/(?!~)[\s\p{P}\p{S}]/u,Ta=/(?:[^\s\p{P}\p{S}]|~)/u,Ia=G(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",aa?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ri=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Pa=G(Ri,"u").replace(/punct/g,Tt).getRegex(),Ca=G(Ri,"u").replace(/punct/g,Ci).getRegex(),Di="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ra=G(Di,"gu").replace(/notPunctSpace/g,Pi).replace(/punctSpace/g,Is).replace(/punct/g,Tt).getRegex(),Da=G(Di,"gu").replace(/notPunctSpace/g,Ta).replace(/punctSpace/g,_a).replace(/punct/g,Ci).getRegex(),Ma=G("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Pi).replace(/punctSpace/g,Is).replace(/punct/g,Tt).getRegex(),Ea=G(/\\(punct)/,"gu").replace(/punct/g,Tt).getRegex(),La=G(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Oa=G(_s).replace("(?:-->|$)","-->").getRegex(),Ga=G("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Oa).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),pt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,za=G(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",pt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Mi=G(/^!?\[(label)\]\[(ref)\]/).replace("label",pt).replace("ref",Ss).getRegex(),Ei=G(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ss).getRegex(),$a=G("reflink|nolink(?!\\()","g").replace("reflink",Mi).replace("nolink",Ei).getRegex(),pr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ps={_backpedal:$n,anyPunctuation:Ea,autolink:La,blockSkip:Ia,br:Ii,code:va,del:$n,emStrongLDelim:Pa,emStrongRDelimAst:Ra,emStrongRDelimUnd:Ma,escape:ka,link:za,nolink:Ei,punctuation:Sa,reflink:Mi,reflinkSearch:$a,tag:Ga,text:Aa,url:$n},ja={...Ps,link:G(/^!?\[(label)\]\((.*?)\)/).replace("label",pt).getRegex(),reflink:G(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",pt).getRegex()},Xt={...Ps,emStrongRDelimAst:Da,emStrongLDelim:Ca,url:G(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",pr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:G(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",pr).getRegex()},Fa={...Xt,br:G(Ii).replace("{2,}","*").getRegex(),text:G(Xt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},nt={normal:Ts,gfm:wa,pedantic:ya},_n={normal:Ps,gfm:Xt,breaks:Fa,pedantic:ja},Ba={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},dr=e=>Ba[e];function Oe(e,n){if(n){if(le.escapeTest.test(e))return e.replace(le.escapeReplace,dr)}else if(le.escapeTestNoEncode.test(e))return e.replace(le.escapeReplaceNoEncode,dr);return e}function gr(e){try{e=encodeURI(e).replace(le.percentDecode,"%")}catch{return null}return e}function mr(e,n){var i;let t=e.replace(le.findPipe,(l,o,a)=>{let u=!1,f=o;for(;--f>=0&&a[f]==="\\";)u=!u;return u?"|":" |"}),s=t.split(le.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!((i=s.at(-1))!=null&&i.trim())&&s.pop(),n)if(s.length>n)s.splice(n);else for(;s.length<n;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(le.slashPipe,"|");return s}function Tn(e,n,t){let s=e.length;if(s===0)return"";let r=0;for(;r<s&&e.charAt(s-r-1)===n;)r++;return e.slice(0,s-r)}function Ua(e,n){if(e.indexOf(n[1])===-1)return-1;let t=0;for(let s=0;s<e.length;s++)if(e[s]==="\\")s++;else if(e[s]===n[0])t++;else if(e[s]===n[1]&&(t--,t<0))return s;return t>0?-2:-1}function br(e,n,t,s,r){let i=n.href,l=n.title||null,o=e[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let a={type:e[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:l,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,a}function Wa(e,n,t){let s=e.match(t.other.indentCodeCompensation);if(s===null)return n;let r=s[1];return n.split(`
...
`+t.join(`
`),S=this.blockquote(T);i[i.length-1]=S,s=s.substring(0,s.length-d.raw.length)+S.raw,r=r.substring(0,r.length-d.text.length)+S.text;break}else if((m==null?void 0:m.type)==="list"){let d=m,T=d.raw+`
`+t.join(`
`),S=this.list(T);i[i.length-1]=S,s=s.substring(0,s.length-m.raw.length)+S.raw,r=r.substring(0,r.length-d.raw.length)+S.raw,t=T.substring(i.at(-1).raw.length).split(`
...
`,1)[0].replace(this.rules.other.listReplaceTabs,M=>" ".repeat(3*M.length)),T=e.split(`
`,1)[0],S=!d.trim(),L=0;if(this.options.pedantic?(L=2,m=d.trimStart()):S?L=n[1].length+1:(L=n[2].search(this.rules.other.nonSpaceChar),L=L>4?1:L,m=d.slice(L),L+=n[1].length),S&&this.rules.other.blankLine.test(T)&&(p+=T+`
`,e=e.substring(T.length+1),f=!0),!f){let M=this.rules.other.nextBulletRegex(L),z=this.rules.other.hrRegex(L),q=this.rules.other.fencesBeginRegex(L),C=this.rules.other.headingBeginRegex(L),Z=this.rules.other.htmlBeginRegex(L);for(;e;){let ge=e.split(`
`,1)[0],X;if(T=ge,this.options.pedantic?(T=T.replace(this.rules.other.listReplaceNesting,"  "),X=T):X=T.replace(this.rules.other.tabCharGlobal,"    "),q.test(T)||C.test(T)||Z.test(T)||M.test(T)||z.test(T))break;if(X.search(this.rules.other.nonSpaceChar)>=L||!T.trim())m+=`
`+X.slice(L);else{if(S||d.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||q.test(d)||C.test(d)||z.test(d))break;m+=`
`+T}!S&&!T.trim()&&(S=!0),p+=ge+`
...
`)?"":`
`)+o.raw,u.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):t.push(o);continue}if(n){let u="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(u);break}else throw new Error(u)}}return this.state.top=!0,t}inline(n,t=[]){return this.inlineQueue.push({src:n,tokens:t}),t}inlineTokens(n,t=[]){var a,u,f,p,m;let s=n,r=null;if(this.tokens.links){let d=Object.keys(this.tokens.links);if(d.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)d.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,r.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(r=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=r[2]?r[2].length:0,s=s.slice(0,r.index+i)+"["+"a".repeat(r[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=((u=(a=this.options.hooks)==null?void 0:a.emStrongMask)==null?void 0:u.call({lexer:this},s))??s;let l=!1,o="";for(;n;){l||(o=""),l=!1;let d;if((p=(f=this.options.extensions)==null?void 0:f.inline)!=null&&p.some(S=>(d=S.call({lexer:this},n,t))?(n=n.substring(d.raw.length),t.push(d),!0):!1))continue;if(d=this.tokenizer.escape(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.tag(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.link(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.reflink(n,this.tokens.links)){n=n.substring(d.raw.length);let S=t.at(-1);d.type==="text"&&(S==null?void 0:S.type)==="text"?(S.raw+=d.raw,S.text+=d.text):t.push(d);continue}if(d=this.tokenizer.emStrong(n,s,o)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.codespan(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.br(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.del(n)){n=n.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.autolink(n)){n=n.substring(d.raw.length),t.push(d);continue}if(!this.state.inLink&&(d=this.tokenizer.url(n))){n=n.substring(d.raw.length),t.push(d);continue}let T=n;if((m=this.options.extensions)!=null&&m.startInline){let S=1/0,L=n.slice(1),M;this.options.extensions.startInline.forEach(z=>{M=z.call({lexer:this},L),typeof M=="number"&&M>=0&&(S=Math.min(S,M))}),S<1/0&&S>=0&&(T=n.substring(0,S+1))}if(d=this.tokenizer.inlineText(T)){n=n.substring(d.raw.length),d.raw.slice(-1)!=="_"&&(o=d.raw.slice(-1)),l=!0;let S=t.at(-1);(S==null?void 0:S.type)==="text"?(S.raw+=d.raw,S.text+=d.text):t.push(d);continue}if(n){let S="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(S);break}else throw new Error(S)}}return t}},gt=class{constructor(e){W(this,"options");W(this,"parser");this.options=e||un}space(e){return""}code({text:e,lang:n,escaped:t}){var i;let s=(i=(n||"").match(le.notSpaceStart))==null?void 0:i[0],r=e.replace(le.endingNewline,"")+`
`;return s?'<pre><code class="language-'+Oe(s)+'">'+(t?r:Oe(r,!0))+`</code></pre>
`:"<pre><code>"+(t?r:Oe(r,!0))+`</code></pre>
