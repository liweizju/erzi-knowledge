...
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5},insights:{label:"洞见报告",color:"#f59e0b",priority:6}}},ic={class:"container"},sc={class:"site-header"},oc={class:"stats"},rc={class:"stat"},ac={class:"stat-num"},lc={class:"stat"},cc={class:"stat-num"},Ac={class:"stat"},uc={class:"stat-num"},Ic={class:"filter-bar"},dc=["onClick"],hc={key:0,class:"note-list"},gc=["onClick"],pc={class:"note-meta"},fc={class:"note-date"},mc={class:"note-title"},yc={key:0,class:"note-summary"},bc={key:1,class:"empty-state"},wc={class:"detail-header"},vc={class:"detail-title"},Sc={class:"detail-meta"},Pc={class:"note-date"},Cc=["innerHTML"],kc={__name:"App",setup(n){_.setOptions({breaks:!1,gfm:!0});const e=ws.notes,t=ws.categories,i=Et(null),s=Et(null),o=Et("加载中..."),a=rt(()=>new Set(e.map(d=>d.date)).size),r=rt(()=>i.value?e.filter(p=>p.category===i.value):e),l=rt(()=>s.value?_(s.value.content):"");async function A(){try{const p=localStorage.getItem("erzi-knowledge-visits");p?o.value=parseInt(p):o.value=1;const d=(parseInt(p)||0)+1;localStorage.setItem("erzi-knowledge-visits",d.toString()),o.value=d}catch(p){console.error("访问统计加载失败:",p),o.value="统计不可用"}}io(()=>{A()});function u(p){s.value=p,jt(()=>window.scrollTo(0,0))}function h(){s.value=null,jt(()=>window.scrollTo(0,0))}return(p,d)=>{var k;return yn(),Rn("div",ic,[s.value?(yn(),Rn(gn,{key:1},[W("div",wc,[W("button",{class:"back-btn",onClick:h},[...d[7]||(d[7]=[W("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[W("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回 ",-1)])]),W("h1",vc,fn(s.value.title),1),W("div",Sc,[W("span",{class:re(["note-category","note-category--"+s.value.category])},fn((k=Re(t)[s.value.category])==null?void 0:k.label),3),W("span",Pc,fn(s.value.date),1)])]),W("div",{class:"note-content",innerHTML:l.value},null,8,Cc),W("footer",{class:"site-footer"},[W("button",{class:"back-btn",onClick:h},[...d[8]||(d[8]=[W("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[W("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回列表 ",-1)])])])],64)):(yn(),Rn(gn,{key:0},[W("header",sc,[d[4]||(d[4]=W("div",{class:"site-title"},"二子的知识库",-1)),d[5]||(d[5]=W("div",{class:"site-subtitle"},"跟二子一起学习",-1)),W("div",oc,[W("span",rc,[W("span",ac,fn(Re(e).length),1),d[1]||(d[1]=he(" 篇笔记",-1))]),W("span",lc,[W("span",cc,fn(a.value),1),d[2]||(d[2]=he(" 天探索",-1))]),W("span",Ac,[W("span",uc,fn(o.value),1),d[3]||(d[3]=he(" 次访问",-1))])])]),W("div",Ic,[W("button",{class:re(["filter-btn",{active:i.value===null}]),onClick:d[0]||(d[0]=w=>i.value=null)},"全部",2),(yn(!0),Rn(gn,null,Ki(Re(t),(w,x)=>(yn(),Rn("button",{key:x,class:re(["filter-btn",{active:i.value===x}]),onClick:F=>i.value=x},fn(w.label),11,dc))),128))]),r.value.length?(yn(),Rn("div",hc,[(yn(!0),Rn(gn,null,Ki(r.value,w=>{var x;return yn(),Rn("div",{key:w.id+w.category,class:"note-item",onClick:F=>u(w)},[W("div",pc,[W("span",{class:re(["note-category","note-category--"+w.category])},fn((x=Re(t)[w.category])==null?void 0:x.label),3),W("span",fc,fn(w.date),1)]),W("div",mc,fn(w.title),1),w.summary?(yn(),Rn("div",yc,fn(w.summary),1)):La("",!0)],8,gc)}),128))])):(yn(),Rn("div",bc," 暂无笔记 ")),d[6]||(d[6]=W("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};ul(kc).mount("#app");
