...
* @license MIT
**/function ss(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const K={},de=[],Ln=()=>{},Ir=()=>!1,mt=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),rs=n=>n.startsWith("onUpdate:"),tn=Object.assign,is=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Fi=Object.prototype.hasOwnProperty,B=(n,e)=>Fi.call(n,e),D=Array.isArray,ge=n=>At(n)==="[object Map]",wr=n=>At(n)==="[object Set]",E=n=>typeof n=="function",Z=n=>typeof n=="string",Zn=n=>typeof n=="symbol",J=n=>n!==null&&typeof n=="object",yr=n=>(J(n)||E(n))&&E(n.then)&&E(n.catch),xr=Object.prototype.toString,At=n=>xr.call(n),Bi=n=>At(n).slice(8,-1),kr=n=>At(n)==="[object Object]",os=n=>Z(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,Me=ss(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),bt=n=>{const e=Object.create(null);return(t=>e[t]||(e[t]=n(t)))},ji=/-\w/g,Yn=bt(n=>n.replace(ji,e=>e.slice(1).toUpperCase())),Ui=/\B([A-Z])/g,ce=bt(n=>n.replace(Ui,"-$1").toLowerCase()),Sr=bt(n=>n.charAt(0).toUpperCase()+n.slice(1)),Ct=bt(n=>n?`on${Sr(n)}`:""),Jn=(n,e)=>!Object.is(n,e),Rt=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},vr=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},Ni=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let $s;const It=()=>$s||($s=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function ls(n){if(D(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],r=Z(s)?Ki(s):ls(s);if(r)for(const i in r)e[i]=r[i]}return e}else if(Z(n)||J(n))return n}const Wi=/;(?![^(]*\))/g,Hi=/:([^]+)/,Vi=/\/\*[^]*?\*\//g;function Ki(n){const e={};return n.replace(Vi,"").split(Wi).forEach(t=>{if(t){const s=t.split(Hi);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function ie(n){let e="";if(Z(n))e=n;else if(D(n))for(let t=0;t<n.length;t++){const s=ie(n[t]);s&&(e+=s+" ")}else if(J(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const qi="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Ji=ss(qi);function Pr(n){return!!n||n===""}const Tr=n=>!!(n&&n.__v_isRef===!0),An=n=>Z(n)?n:n==null?"":D(n)||J(n)&&(n.toString===xr||!E(n.toString))?Tr(n)?An(n.value):JSON.stringify(n,_r,2):String(n),_r=(n,e)=>Tr(e)?_r(n,e.value):ge(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,r],i)=>(t[Mt(s,i)+" =>"]=r,t),{})}:wr(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>Mt(t))}:Zn(e)?Mt(e):J(e)&&!D(e)&&!kr(e)?String(e):e,Mt=(n,e="")=>{var t;return Zn(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let fn;class Yi{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=fn,!e&&fn&&(this.index=(fn.scopes||(fn.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=fn;try{return fn=this,e()}finally{fn=t}}}on(){++this._on===1&&(this.prevScope=fn,fn=this)}off(){this._on>0&&--this._on===0&&(fn=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Qi(){return fn}let V;const Dt=new WeakSet;class Cr{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,fn&&fn.active&&fn.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Dt.has(this)&&(Dt.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Mr(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,zs(this),Dr(this);const e=V,t=xn;V=this,xn=!0;try{return this.fn()}finally{Lr(this),V=e,xn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)us(e);this.deps=this.depsTail=void 0,zs(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Dt.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ut(this)&&this.run()}get dirty(){return Ut(this)}}let Rr=0,De,Le;function Mr(n,e=!1){if(n.flags|=8,e){n.next=Le,Le=n;return}n.next=De,De=n}function as(){Rr++}function cs(){if(--Rr>0)return;if(Le){let e=Le;for(Le=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;De;){let e=De;for(De=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function Dr(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Lr(n){let e,t=n.depsTail,s=t;for(;s;){const r=s.prevDep;s.version===-1?(s===t&&(t=r),us(s),Zi(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=r}n.deps=e,n.depsTail=t}function Ut(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Er(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function Er(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Fe)||(n.globalVersion=Fe,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Ut(n))))return;n.flags|=2;const e=n.dep,t=V,s=xn;V=n,xn=!0;try{Dr(n);const r=n.fn(n._value);(e.version===0||Jn(r,n._value))&&(n.flags|=128,n._value=r,e.version++)}catch(r){throw e.version++,r}finally{V=t,xn=s,Lr(n),n.flags&=-3}}function us(n,e=!1){const{dep:t,prevSub:s,nextSub:r}=n;if(s&&(s.nextSub=r,n.prevSub=void 0),r&&(r.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let i=t.computed.deps;i;i=i.nextDep)us(i,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Zi(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let xn=!0;const Gr=[];function Bn(){Gr.push(xn),xn=!1}function jn(){const n=Gr.pop();xn=n===void 0?!0:n}function zs(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=V;V=void 0;try{e()}finally{V=t}}}let Fe=0;class Xi{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class fs{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!V||!xn||V===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==V)t=this.activeLink=new Xi(V,this),V.deps?(t.prevDep=V.depsTail,V.depsTail.nextDep=t,V.depsTail=t):V.deps=V.depsTail=t,Or(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=V.depsTail,t.nextDep=void 0,V.depsTail.nextDep=t,V.depsTail=t,V.deps===t&&(V.deps=s)}return t}trigger(e){this.version++,Fe++,this.notify(e)}notify(e){as();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{cs()}}}function Or(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)Or(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Nt=new WeakMap,oe=Symbol(""),Wt=Symbol(""),Be=Symbol("");function nn(n,e,t){if(xn&&V){let s=Nt.get(n);s||Nt.set(n,s=new Map);let r=s.get(t);r||(s.set(t,r=new fs),r.map=s,r.key=t),r.track()}}function zn(n,e,t,s,r,i){const l=Nt.get(n);if(!l){Fe++;return}const o=a=>{a&&a.trigger()};if(as(),e==="clear")l.forEach(o);else{const a=D(n),u=a&&os(t);if(a&&t==="length"){const f=Number(s);l.forEach((d,m)=>{(m==="length"||m===Be||!Zn(m)&&m>=f)&&o(d)})}else switch((t!==void 0||l.has(void 0))&&o(l.get(t)),u&&o(l.get(Be)),e){case"add":a?u&&o(l.get("length")):(o(l.get(oe)),ge(n)&&o(l.get(Wt)));break;case"delete":a||(o(l.get(oe)),ge(n)&&o(l.get(Wt)));break;case"set":ge(n)&&o(l.get(oe));break}}cs()}function fe(n){const e=F(n);return e===n?e:(nn(e,"iterate",Be),bn(n)?e:e.map(kn))}function wt(n){return nn(n=F(n),"iterate",Be),n}function Hn(n,e){return Un(n)?be(le(n)?kn(e):e):kn(e)}const no={__proto__:null,[Symbol.iterator](){return Lt(this,Symbol.iterator,n=>Hn(this,n))},concat(...n){return fe(this).concat(...n.map(e=>D(e)?fe(e):e))},entries(){return Lt(this,"entries",n=>(n[1]=Hn(this,n[1]),n))},every(n,e){return Gn(this,"every",n,e,void 0,arguments)},filter(n,e){return Gn(this,"filter",n,e,t=>t.map(s=>Hn(this,s)),arguments)},find(n,e){return Gn(this,"find",n,e,t=>Hn(this,t),arguments)},findIndex(n,e){return Gn(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return Gn(this,"findLast",n,e,t=>Hn(this,t),arguments)},findLastIndex(n,e){return Gn(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return Gn(this,"forEach",n,e,void 0,arguments)},includes(...n){return Et(this,"includes",n)},indexOf(...n){return Et(this,"indexOf",n)},join(n){return fe(this).join(n)},lastIndexOf(...n){return Et(this,"lastIndexOf",n)},map(n,e){return Gn(this,"map",n,e,void 0,arguments)},pop(){return Se(this,"pop")},push(...n){return Se(this,"push",n)},reduce(n,...e){return Fs(this,"reduce",n,e)},reduceRight(n,...e){return Fs(this,"reduceRight",n,e)},shift(){return Se(this,"shift")},some(n,e){return Gn(this,"some",n,e,void 0,arguments)},splice(...n){return Se(this,"splice",n)},toReversed(){return fe(this).toReversed()},toSorted(n){return fe(this).toSorted(n)},toSpliced(...n){return fe(this).toSpliced(...n)},unshift(...n){return Se(this,"unshift",n)},values(){return Lt(this,"values",n=>Hn(this,n))}};function Lt(n,e,t){const s=wt(n),r=s[e]();return s!==n&&!bn(n)&&(r._next=r.next,r.next=()=>{const i=r._next();return i.done||(i.value=t(i.value)),i}),r}const eo=Array.prototype;function Gn(n,e,t,s,r,i){const l=wt(n),o=l!==n&&!bn(n),a=l[e];if(a!==eo[e]){const d=a.apply(n,i);return o?kn(d):d}let u=t;l!==n&&(o?u=function(d,m){return t.call(this,Hn(n,d),m,n)}:t.length>2&&(u=function(d,m){return t.call(this,d,m,n)}));const f=a.call(l,u,s);return o&&r?r(f):f}function Fs(n,e,t,s){const r=wt(n);let i=t;return r!==n&&(bn(n)?t.length>3&&(i=function(l,o,a){return t.call(this,l,o,a,n)}):i=function(l,o,a){return t.call(this,l,Hn(n,o),a,n)}),r[e](i,...s)}function Et(n,e,t){const s=F(n);nn(s,"iterate",Be);const r=s[e](...t);return(r===-1||r===!1)&&gs(t[0])?(t[0]=F(t[0]),s[e](...t)):r}function Se(n,e,t=[]){Bn(),as();const s=F(n)[e].apply(n,t);return cs(),jn(),s}const to=ss("__proto__,__v_isRef,__isVue"),$r=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(Zn));function so(n){Zn(n)||(n=String(n));const e=F(this);return nn(e,"has",n),e.hasOwnProperty(n)}class zr{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const r=this._isReadonly,i=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return i;if(t==="__v_raw")return s===(r?i?po:Ur:i?jr:Br).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const l=D(e);if(!r){let a;if(l&&(a=no[t]))return a;if(t==="hasOwnProperty")return so}const o=Reflect.get(e,t,en(e)?e:s);if((Zn(t)?$r.has(t):to(t))||(r||nn(e,"get",t),i))return o;if(en(o)){const a=l&&os(t)?o:o.value;return r&&J(a)?Vt(a):a}return J(o)?r?Vt(o):ps(o):o}}class Fr extends zr{constructor(e=!1){super(!1,e)}set(e,t,s,r){let i=e[t];const l=D(e)&&os(t);if(!this._isShallow){const u=Un(i);if(!bn(s)&&!Un(s)&&(i=F(i),s=F(s)),!l&&en(i)&&!en(s))return u||(i.value=s),!0}const o=l?Number(t)<e.length:B(e,t),a=Reflect.set(e,t,s,en(e)?e:r);return e===F(r)&&(o?Jn(s,i)&&zn(e,"set",t,s):zn(e,"add",t,s)),a}deleteProperty(e,t){const s=B(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&s&&zn(e,"delete",t,void 0),r}has(e,t){const s=Reflect.has(e,t);return(!Zn(t)||!$r.has(t))&&nn(e,"has",t),s}ownKeys(e){return nn(e,"iterate",D(e)?"length":oe),Reflect.ownKeys(e)}}class ro extends zr{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const io=new Fr,oo=new ro,lo=new Fr(!0);const Ht=n=>n,Ze=n=>Reflect.getPrototypeOf(n);function ao(n,e,t){return function(...s){const r=this.__v_raw,i=F(r),l=ge(i),o=n==="entries"||n===Symbol.iterator&&l,a=n==="keys"&&l,u=r[n](...s),f=t?Ht:e?be:kn;return!e&&nn(i,"iterate",a?Wt:oe),tn(Object.create(u),{next(){const{value:d,done:m}=u.next();return m?{value:d,done:m}:{value:o?[f(d[0]),f(d[1])]:f(d),done:m}}})}}function Xe(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function co(n,e){const t={get(r){const i=this.__v_raw,l=F(i),o=F(r);n||(Jn(r,o)&&nn(l,"get",r),nn(l,"get",o));const{has:a}=Ze(l),u=e?Ht:n?be:kn;if(a.call(l,r))return u(i.get(r));if(a.call(l,o))return u(i.get(o));i!==l&&i.get(r)},get size(){const r=this.__v_raw;return!n&&nn(F(r),"iterate",oe),r.size},has(r){const i=this.__v_raw,l=F(i),o=F(r);return n||(Jn(r,o)&&nn(l,"has",r),nn(l,"has",o)),r===o?i.has(r):i.has(r)||i.has(o)},forEach(r,i){const l=this,o=l.__v_raw,a=F(o),u=e?Ht:n?be:kn;return!n&&nn(a,"iterate",oe),o.forEach((f,d)=>r.call(i,u(f),u(d),l))}};return tn(t,n?{add:Xe("add"),set:Xe("set"),delete:Xe("delete"),clear:Xe("clear")}:{add(r){!e&&!bn(r)&&!Un(r)&&(r=F(r));const i=F(this);return Ze(i).has.call(i,r)||(i.add(r),zn(i,"add",r,r)),this},set(r,i){!e&&!bn(i)&&!Un(i)&&(i=F(i));const l=F(this),{has:o,get:a}=Ze(l);let u=o.call(l,r);u||(r=F(r),u=o.call(l,r));const f=a.call(l,r);return l.set(r,i),u?Jn(i,f)&&zn(l,"set",r,i):zn(l,"add",r,i),this},delete(r){const i=F(this),{has:l,get:o}=Ze(i);let a=l.call(i,r);a||(r=F(r),a=l.call(i,r)),o&&o.call(i,r);const u=i.delete(r);return a&&zn(i,"delete",r,void 0),u},clear(){const r=F(this),i=r.size!==0,l=r.clear();return i&&zn(r,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=ao(r,n,e)}),t}function hs(n,e){const t=co(n,e);return(s,r,i)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?s:Reflect.get(B(t,r)&&r in s?t:s,r,i)}const uo={get:hs(!1,!1)},fo={get:hs(!1,!0)},ho={get:hs(!0,!1)};const Br=new WeakMap,jr=new WeakMap,Ur=new WeakMap,po=new WeakMap;function go(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function mo(n){return n.__v_skip||!Object.isExtensible(n)?0:go(Bi(n))}function ps(n){return Un(n)?n:ds(n,!1,io,uo,Br)}function Ao(n){return ds(n,!1,lo,fo,jr)}function Vt(n){return ds(n,!0,oo,ho,Ur)}function ds(n,e,t,s,r){if(!J(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const i=mo(n);if(i===0)return n;const l=r.get(n);if(l)return l;const o=new Proxy(n,i===2?s:t);return r.set(n,o),o}function le(n){return Un(n)?le(n.__v_raw):!!(n&&n.__v_isReactive)}function Un(n){return!!(n&&n.__v_isReadonly)}function bn(n){return!!(n&&n.__v_isShallow)}function gs(n){return n?!!n.__v_raw:!1}function F(n){const e=n&&n.__v_raw;return e?F(e):n}function bo(n){return!B(n,"__v_skip")&&Object.isExtensible(n)&&vr(n,"__v_skip",!0),n}const kn=n=>J(n)?ps(n):n,be=n=>J(n)?Vt(n):n;function en(n){return n?n.__v_isRef===!0:!1}function Gt(n){return Io(n,!1)}function Io(n,e){return en(n)?n:new wo(n,e)}class wo{constructor(e,t){this.dep=new fs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:F(e),this._value=t?e:kn(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||bn(e)||Un(e);e=s?e:F(e),Jn(e,t)&&(this._rawValue=e,this._value=s?e:kn(e),this.dep.trigger())}}function _e(n){return en(n)?n.value:n}const yo={get:(n,e,t)=>e==="__v_raw"?n:_e(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const r=n[e];return en(r)&&!en(t)?(r.value=t,!0):Reflect.set(n,e,t,s)}};function Nr(n){return le(n)?n:new Proxy(n,yo)}class xo{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new fs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Fe-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&V!==this)return Mr(this,!0),!0}get value(){const e=this.dep.track();return Er(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function ko(n,e,t=!1){let s,r;return E(n)?s=n:(s=n.get,r=n.set),new xo(s,r,t)}const nt={},lt=new WeakMap;let re;function So(n,e=!1,t=re){if(t){let s=lt.get(t);s||lt.set(t,s=[]),s.push(n)}}function vo(n,e,t=K){const{immediate:s,deep:r,once:i,scheduler:l,augmentJob:o,call:a}=t,u=C=>r?C:bn(C)||r===!1||r===0?qn(C,1):qn(C);let f,d,m,p,P=!1,y=!1;if(en(n)?(d=()=>n.value,P=bn(n)):le(n)?(d=()=>u(n),P=!0):D(n)?(y=!0,P=n.some(C=>le(C)||bn(C)),d=()=>n.map(C=>{if(en(C))return C.value;if(le(C))return u(C);if(E(C))return a?a(C,2):C()})):E(n)?e?d=a?()=>a(n,2):n:d=()=>{if(m){Bn();try{m()}finally{jn()}}const C=re;re=f;try{return a?a(n,3,[p]):n(p)}finally{re=C}}:d=Ln,e&&r){const C=d,Q=r===!0?1/0:r;d=()=>qn(C(),Q)}const L=Qi(),M=()=>{f.stop(),L&&L.active&&is(L.effects,f)};if(i&&e){const C=e;e=(...Q)=>{C(...Q),M()}}let z=y?new Array(n.length).fill(nt):nt;const q=C=>{if(!(!(f.flags&1)||!f.dirty&&!C))if(e){const Q=f.run();if(r||P||(y?Q.some((mn,X)=>Jn(mn,z[X])):Jn(Q,z))){m&&m();const mn=re;re=f;try{const X=[Q,z===nt?void 0:y&&z[0]===nt?[]:z,p];z=Q,a?a(e,3,X):e(...X)}finally{re=mn}}}else f.run()};return o&&o(q),f=new Cr(d),f.scheduler=l?()=>l(q,!1):q,p=C=>So(C,!1,f),m=f.onStop=()=>{const C=lt.get(f);if(C){if(a)a(C,4);else for(const Q of C)Q();lt.delete(f)}},e?s?q(!0):z=f.run():l?l(q.bind(null,!0),!0):f.run(),M.pause=f.pause.bind(f),M.resume=f.resume.bind(f),M.stop=M,M}function qn(n,e=1/0,t){if(e<=0||!J(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,en(n))qn(n.value,e,t);else if(D(n))for(let s=0;s<n.length;s++)qn(n[s],e,t);else if(wr(n)||ge(n))n.forEach(s=>{qn(s,e,t)});else if(kr(n)){for(const s in n)qn(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&qn(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function We(n,e,t,s){try{return s?n(...s):n()}catch(r){yt(r,e,t)}}function En(n,e,t,s){if(E(n)){const r=We(n,e,t,s);return r&&yr(r)&&r.catch(i=>{yt(i,e,t)}),r}if(D(n)){const r=[];for(let i=0;i<n.length;i++)r.push(En(n[i],e,t,s));return r}}function yt(n,e,t,s=!0){const r=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=e&&e.appContext.config||K;if(e){let o=e.parent;const a=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;o;){const f=o.ec;if(f){for(let d=0;d<f.length;d++)if(f[d](n,a,u)===!1)return}o=o.parent}if(i){Bn(),We(i,null,10,[n,a,u]),jn();return}}Po(n,t,r,s,l)}function Po(n,e,t,s=!0,r=!1){if(r)throw n;console.error(n)}const on=[];let Rn=-1;const me=[];let Vn=null,he=0;const Wr=Promise.resolve();let at=null;function Kt(n){const e=at||Wr;return n?e.then(this?n.bind(this):n):e}function To(n){let e=Rn+1,t=on.length;for(;e<t;){const s=e+t>>>1,r=on[s],i=je(r);i<n||i===n&&r.flags&2?e=s+1:t=s}return e}function ms(n){if(!(n.flags&1)){const e=je(n),t=on[on.length-1];!t||!(n.flags&2)&&e>=je(t)?on.push(n):on.splice(To(e),0,n),n.flags|=1,Hr()}}function Hr(){at||(at=Wr.then(Kr))}function _o(n){D(n)?me.push(...n):Vn&&n.id===-1?Vn.splice(he+1,0,n):n.flags&1||(me.push(n),n.flags|=1),Hr()}function Bs(n,e,t=Rn+1){for(;t<on.length;t++){const s=on[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;on.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function Vr(n){if(me.length){const e=[...new Set(me)].sort((t,s)=>je(t)-je(s));if(me.length=0,Vn){Vn.push(...e);return}for(Vn=e,he=0;he<Vn.length;he++){const t=Vn[he];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Vn=null,he=0}}const je=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Kr(n){try{for(Rn=0;Rn<on.length;Rn++){const e=on[Rn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),We(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Rn<on.length;Rn++){const e=on[Rn];e&&(e.flags&=-2)}Rn=-1,on.length=0,Vr(),at=null,(on.length||me.length)&&Kr()}}let Dn=null,qr=null;function ct(n){const e=Dn;return Dn=n,qr=n&&n.type.__scopeId||null,e}function Co(n,e=Dn,t){if(!e||n._n)return n;const s=(...r)=>{s._d&&Qs(-1);const i=ct(e);let l;try{l=n(...r)}finally{ct(i),s._d&&Qs(1)}return l};return s._n=!0,s._c=!0,s._d=!0,s}function te(n,e,t,s){const r=n.dirs,i=e&&e.dirs;for(let l=0;l<r.length;l++){const o=r[l];i&&(o.oldValue=i[l].value);let a=o.dir[s];a&&(Bn(),En(a,t,8,[n.el,o,n,e]),jn())}}function Ro(n,e){if(ln){let t=ln.provides;const s=ln.parent&&ln.parent.provides;s===t&&(t=ln.provides=Object.create(s)),t[n]=e}}function st(n,e,t=!1){const s=Rl();if(s||Ae){let r=Ae?Ae._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&n in r)return r[n];if(arguments.length>1)return t&&E(e)?e.call(s&&s.proxy):e}}const Mo=Symbol.for("v-scx"),Do=()=>st(Mo);function Ot(n,e,t){return Jr(n,e,t)}function Jr(n,e,t=K){const{immediate:s,deep:r,flush:i,once:l}=t,o=tn({},t),a=e&&s||!e&&i!=="post";let u;if(Ne){if(i==="sync"){const p=Do();u=p.__watcherHandles||(p.__watcherHandles=[])}else if(!a){const p=()=>{};return p.stop=Ln,p.resume=Ln,p.pause=Ln,p}}const f=ln;o.call=(p,P,y)=>En(p,f,P,y);let d=!1;i==="post"?o.scheduler=p=>{dn(p,f&&f.suspense)}:i!=="sync"&&(d=!0,o.scheduler=(p,P)=>{P?p():ms(p)}),o.augmentJob=p=>{e&&(p.flags|=4),d&&(p.flags|=2,f&&(p.id=f.uid,p.i=f))};const m=vo(n,e,o);return Ne&&(u?u.push(m):a&&m()),m}function Lo(n,e,t){const s=this.proxy,r=Z(n)?n.includes(".")?Yr(s,n):()=>s[n]:n.bind(s,s);let i;E(e)?i=e:(i=e.handler,t=e);const l=He(this),o=Jr(r,i.bind(s),t);return l(),o}function Yr(n,e){const t=e.split(".");return()=>{let s=n;for(let r=0;r<t.length&&s;r++)s=s[t[r]];return s}}const Eo=Symbol("_vte"),Go=n=>n.__isTeleport,Oo=Symbol("_leaveCb");function As(n,e){n.shapeFlag&6&&n.component?(n.transition=e,As(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function Qr(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}const ut=new WeakMap;function Ee(n,e,t,s,r=!1){if(D(n)){n.forEach((P,y)=>Ee(P,e&&(D(e)?e[y]:e),t,s,r));return}if(Ge(s)&&!r){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&Ee(n,e,t,s.component.subTree);return}const i=s.shapeFlag&4?ys(s.component):s.el,l=r?null:i,{i:o,r:a}=n,u=e&&e.r,f=o.refs===K?o.refs={}:o.refs,d=o.setupState,m=F(d),p=d===K?Ir:P=>B(m,P);if(u!=null&&u!==a){if(js(e),Z(u))f[u]=null,p(u)&&(d[u]=null);else if(en(u)){u.value=null;const P=e;P.k&&(f[P.k]=null)}}if(E(a))We(a,o,12,[l,f]);else{const P=Z(a),y=en(a);if(P||y){const L=()=>{if(n.f){const M=P?p(a)?d[a]:f[a]:a.value;if(r)D(M)&&is(M,i);else if(D(M))M.includes(i)||M.push(i);else if(P)f[a]=[i],p(a)&&(d[a]=f[a]);else{const z=[i];a.value=z,n.k&&(f[n.k]=z)}}else P?(f[a]=l,p(a)&&(d[a]=l)):y&&(a.value=l,n.k&&(f[n.k]=l))};if(l){const M=()=>{L(),ut.delete(n)};M.id=-1,ut.set(n,M),dn(M,t)}else js(n),L()}}}function js(n){const e=ut.get(n);e&&(e.flags|=8,ut.delete(n))}It().requestIdleCallback;It().cancelIdleCallback;const Ge=n=>!!n.type.__asyncLoader,Zr=n=>n.type.__isKeepAlive;function $o(n,e){Xr(n,"a",e)}function zo(n,e){Xr(n,"da",e)}function Xr(n,e,t=ln){const s=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(xt(e,s,t),t){let r=t.parent;for(;r&&r.parent;)Zr(r.parent.vnode)&&Fo(s,e,t,r),r=r.parent}}function Fo(n,e,t,s){const r=xt(e,n,s,!0);ei(()=>{is(s[e],r)},t)}function xt(n,e,t=ln,s=!1){if(t){const r=t[n]||(t[n]=[]),i=e.__weh||(e.__weh=(...l)=>{Bn();const o=He(t),a=En(e,t,n,l);return o(),jn(),a});return s?r.unshift(i):r.push(i),i}}const Nn=n=>(e,t=ln)=>{(!Ne||n==="sp")&&xt(n,(...s)=>e(...s),t)},Bo=Nn("bm"),ni=Nn("m"),jo=Nn("bu"),Uo=Nn("u"),No=Nn("bum"),ei=Nn("um"),Wo=Nn("sp"),Ho=Nn("rtg"),Vo=Nn("rtc");function Ko(n,e=ln){xt("ec",n,e)}const qo=Symbol.for("v-ndc");function Us(n,e,t,s){let r;const i=t,l=D(n);if(l||Z(n)){const o=l&&le(n);let a=!1,u=!1;o&&(a=!bn(n),u=Un(n),n=wt(n)),r=new Array(n.length);for(let f=0,d=n.length;f<d;f++)r[f]=e(a?u?be(kn(n[f])):kn(n[f]):n[f],f,void 0,i)}else if(typeof n=="number"){r=new Array(n);for(let o=0;o<n;o++)r[o]=e(o+1,o,void 0,i)}else if(J(n))if(n[Symbol.iterator])r=Array.from(n,(o,a)=>e(o,a,void 0,i));else{const o=Object.keys(n);r=new Array(o.length);for(let a=0,u=o.length;a<u;a++){const f=o[a];r[a]=e(n[f],f,a,i)}}else r=[];return r}const qt=n=>n?yi(n)?ys(n):qt(n.parent):null,Oe=tn(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>qt(n.parent),$root:n=>qt(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>si(n),$forceUpdate:n=>n.f||(n.f=()=>{ms(n.update)}),$nextTick:n=>n.n||(n.n=Kt.bind(n.proxy)),$watch:n=>Lo.bind(n)}),$t=(n,e)=>n!==K&&!n.__isScriptSetup&&B(n,e),Jo={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:r,props:i,accessCache:l,type:o,appContext:a}=n;if(e[0]!=="$"){const m=l[e];if(m!==void 0)switch(m){case 1:return s[e];case 2:return r[e];case 4:return t[e];case 3:return i[e]}else{if($t(s,e))return l[e]=1,s[e];if(r!==K&&B(r,e))return l[e]=2,r[e];if(B(i,e))return l[e]=3,i[e];if(t!==K&&B(t,e))return l[e]=4,t[e];Jt&&(l[e]=0)}}const u=Oe[e];let f,d;if(u)return e==="$attrs"&&nn(n.attrs,"get",""),u(n);if((f=o.__cssModules)&&(f=f[e]))return f;if(t!==K&&B(t,e))return l[e]=4,t[e];if(d=a.config.globalProperties,B(d,e))return d[e]},set({_:n},e,t){const{data:s,setupState:r,ctx:i}=n;return $t(r,e)?(r[e]=t,!0):s!==K&&B(s,e)?(s[e]=t,!0):B(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(i[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:r,props:i,type:l}},o){let a;return!!(t[o]||n!==K&&o[0]!=="$"&&B(n,o)||$t(e,o)||B(i,o)||B(s,o)||B(Oe,o)||B(r.config.globalProperties,o)||(a=l.__cssModules)&&a[o])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:B(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Ns(n){return D(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Jt=!0;function Yo(n){const e=si(n),t=n.proxy,s=n.ctx;Jt=!1,e.beforeCreate&&Ws(e.beforeCreate,n,"bc");const{data:r,computed:i,methods:l,watch:o,provide:a,inject:u,created:f,beforeMount:d,mounted:m,beforeUpdate:p,updated:P,activated:y,deactivated:L,beforeDestroy:M,beforeUnmount:z,destroyed:q,unmounted:C,render:Q,renderTracked:mn,renderTriggered:X,errorCaptured:Wn,serverPrefetch:Ke,expose:Xn,inheritAttrs:we,components:qe,directives:Je,filters:Tt}=e;if(u&&Qo(u,s,null),l)for(const Y in l){const W=l[Y];E(W)&&(s[Y]=W.bind(t))}if(r){const Y=r.call(t,t);J(Y)&&(n.data=ps(Y))}if(Jt=!0,i)for(const Y in i){const W=i[Y],ne=E(W)?W.bind(t,t):E(W.get)?W.get.bind(t,t):Ln,Ye=!E(W)&&E(W.set)?W.set.bind(t):Ln,ee=it({get:ne,set:Ye});Object.defineProperty(s,Y,{enumerable:!0,configurable:!0,get:()=>ee.value,set:Sn=>ee.value=Sn})}if(o)for(const Y in o)ti(o[Y],s,t,Y);if(a){const Y=E(a)?a.call(t):a;Reflect.ownKeys(Y).forEach(W=>{Ro(W,Y[W])})}f&&Ws(f,n,"c");function sn(Y,W){D(W)?W.forEach(ne=>Y(ne.bind(t))):W&&Y(W.bind(t))}if(sn(Bo,d),sn(ni,m),sn(jo,p),sn(Uo,P),sn($o,y),sn(zo,L),sn(Ko,Wn),sn(Vo,mn),sn(Ho,X),sn(No,z),sn(ei,C),sn(Wo,Ke),D(Xn))if(Xn.length){const Y=n.exposed||(n.exposed={});Xn.forEach(W=>{Object.defineProperty(Y,W,{get:()=>t[W],set:ne=>t[W]=ne,enumerable:!0})})}else n.exposed||(n.exposed={});Q&&n.render===Ln&&(n.render=Q),we!=null&&(n.inheritAttrs=we),qe&&(n.components=qe),Je&&(n.directives=Je),Ke&&Qr(n)}function Qo(n,e,t=Ln){D(n)&&(n=Yt(n));for(const s in n){const r=n[s];let i;J(r)?"default"in r?i=st(r.from||s,r.default,!0):i=st(r.from||s):i=st(r),en(i)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):e[s]=i}}function Ws(n,e,t){En(D(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function ti(n,e,t,s){let r=s.includes(".")?Yr(t,s):()=>t[s];if(Z(n)){const i=e[n];E(i)&&Ot(r,i)}else if(E(n))Ot(r,n.bind(t));else if(J(n))if(D(n))n.forEach(i=>ti(i,e,t,s));else{const i=E(n.handler)?n.handler.bind(t):e[n.handler];E(i)&&Ot(r,i,n)}}function si(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:r,optionsCache:i,config:{optionMergeStrategies:l}}=n.appContext,o=i.get(e);let a;return o?a=o:!r.length&&!t&&!s?a=e:(a={},r.length&&r.forEach(u=>ft(a,u,l,!0)),ft(a,e,l)),J(e)&&i.set(e,a),a}function ft(n,e,t,s=!1){const{mixins:r,extends:i}=e;i&&ft(n,i,t,!0),r&&r.forEach(l=>ft(n,l,t,!0));for(const l in e)if(!(s&&l==="expose")){const o=Zo[l]||t&&t[l];n[l]=o?o(n[l],e[l]):e[l]}return n}const Zo={data:Hs,props:Vs,emits:Vs,methods:Ce,computed:Ce,beforeCreate:rn,created:rn,beforeMount:rn,mounted:rn,beforeUpdate:rn,updated:rn,beforeDestroy:rn,beforeUnmount:rn,destroyed:rn,unmounted:rn,activated:rn,deactivated:rn,errorCaptured:rn,serverPrefetch:rn,components:Ce,directives:Ce,watch:nl,provide:Hs,inject:Xo};function Hs(n,e){return e?n?function(){return tn(E(n)?n.call(this,this):n,E(e)?e.call(this,this):e)}:e:n}function Xo(n,e){return Ce(Yt(n),Yt(e))}function Yt(n){if(D(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function rn(n,e){return n?[...new Set([].concat(n,e))]:e}function Ce(n,e){return n?tn(Object.create(null),n,e):e}function Vs(n,e){return n?D(n)&&D(e)?[...new Set([...n,...e])]:tn(Object.create(null),Ns(n),Ns(e??{})):e}function nl(n,e){if(!n)return e;if(!e)return n;const t=tn(Object.create(null),n);for(const s in e)t[s]=rn(n[s],e[s]);return t}function ri(){return{app:null,config:{isNativeTag:Ir,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let el=0;function tl(n,e){return function(s,r=null){E(s)||(s=tn({},s)),r!=null&&!J(r)&&(r=null);const i=ri(),l=new WeakSet,o=[];let a=!1;const u=i.app={_uid:el++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:Ol,get config(){return i.config},set config(f){},use(f,...d){return l.has(f)||(f&&E(f.install)?(l.add(f),f.install(u,...d)):E(f)&&(l.add(f),f(u,...d))),u},mixin(f){return i.mixins.includes(f)||i.mixins.push(f),u},component(f,d){return d?(i.components[f]=d,u):i.components[f]},directive(f,d){return d?(i.directives[f]=d,u):i.directives[f]},mount(f,d,m){if(!a){const p=u._ceVNode||Fn(s,r);return p.appContext=i,m===!0?m="svg":m===!1&&(m=void 0),n(p,f,m),a=!0,u._container=f,f.__vue_app__=u,ys(p.component)}},onUnmount(f){o.push(f)},unmount(){a&&(En(o,u._instance,16),n(null,u._container),delete u._container.__vue_app__)},provide(f,d){return i.provides[f]=d,u},runWithContext(f){const d=Ae;Ae=u;try{return f()}finally{Ae=d}}};return u}}let Ae=null;const sl=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${Yn(e)}Modifiers`]||n[`${ce(e)}Modifiers`];function rl(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||K;let r=t;const i=e.startsWith("update:"),l=i&&sl(s,e.slice(7));l&&(l.trim&&(r=t.map(f=>Z(f)?f.trim():f)),l.number&&(r=t.map(Ni)));let o,a=s[o=Ct(e)]||s[o=Ct(Yn(e))];!a&&i&&(a=s[o=Ct(ce(e))]),a&&En(a,n,6,r);const u=s[o+"Once"];if(u){if(!n.emitted)n.emitted={};else if(n.emitted[o])return;n.emitted[o]=!0,En(u,n,6,r)}}const il=new WeakMap;function ii(n,e,t=!1){const s=t?il:e.emitsCache,r=s.get(n);if(r!==void 0)return r;const i=n.emits;let l={},o=!1;if(!E(n)){const a=u=>{const f=ii(u,e,!0);f&&(o=!0,tn(l,f))};!t&&e.mixins.length&&e.mixins.forEach(a),n.extends&&a(n.extends),n.mixins&&n.mixins.forEach(a)}return!i&&!o?(J(n)&&s.set(n,null),null):(D(i)?i.forEach(a=>l[a]=null):tn(l,i),J(n)&&s.set(n,l),l)}function kt(n,e){return!n||!mt(e)?!1:(e=e.slice(2).replace(/Once$/,""),B(n,e[0].toLowerCase()+e.slice(1))||B(n,ce(e))||B(n,e))}function Ks(n){const{type:e,vnode:t,proxy:s,withProxy:r,propsOptions:[i],slots:l,attrs:o,emit:a,render:u,renderCache:f,props:d,data:m,setupState:p,ctx:P,inheritAttrs:y}=n,L=ct(n);let M,z;try{if(t.shapeFlag&4){const C=r||s,Q=C;M=Mn(u.call(Q,C,f,d,p,m,P)),z=o}else{const C=e;M=Mn(C.length>1?C(d,{attrs:o,slots:l,emit:a}):C(d,null)),z=e.props?o:ol(o)}}catch(C){$e.length=0,yt(C,n,1),M=Fn(Qn)}let q=M;if(z&&y!==!1){const C=Object.keys(z),{shapeFlag:Q}=q;C.length&&Q&7&&(i&&C.some(rs)&&(z=ll(z,i)),q=Ie(q,z,!1,!0))}return t.dirs&&(q=Ie(q,null,!1,!0),q.dirs=q.dirs?q.dirs.concat(t.dirs):t.dirs),t.transition&&As(q,t.transition),M=q,ct(L),M}const ol=n=>{let e;for(const t in n)(t==="class"||t==="style"||mt(t))&&((e||(e={}))[t]=n[t]);return e},ll=(n,e)=>{const t={};for(const s in n)(!rs(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function al(n,e,t){const{props:s,children:r,component:i}=n,{props:l,children:o,patchFlag:a}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&a>=0){if(a&1024)return!0;if(a&16)return s?qs(s,l,u):!!l;if(a&8){const f=e.dynamicProps;for(let d=0;d<f.length;d++){const m=f[d];if(l[m]!==s[m]&&!kt(u,m))return!0}}}else return(r||o)&&(!o||!o.$stable)?!0:s===l?!1:s?l?qs(s,l,u):!0:!!l;return!1}function qs(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(e[i]!==n[i]&&!kt(t,i))return!0}return!1}function cl({vnode:n,parent:e},t){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===n&&(s.el=n.el),s===n)(n=e.vnode).el=t,e=e.parent;else break}}const oi={},li=()=>Object.create(oi),ai=n=>Object.getPrototypeOf(n)===oi;function ul(n,e,t,s=!1){const r={},i=li();n.propsDefaults=Object.create(null),ci(n,e,r,i);for(const l in n.propsOptions[0])l in r||(r[l]=void 0);t?n.props=s?r:Ao(r):n.type.props?n.props=r:n.props=i,n.attrs=i}function fl(n,e,t,s){const{props:r,attrs:i,vnode:{patchFlag:l}}=n,o=F(r),[a]=n.propsOptions;let u=!1;if((s||l>0)&&!(l&16)){if(l&8){const f=n.vnode.dynamicProps;for(let d=0;d<f.length;d++){let m=f[d];if(kt(n.emitsOptions,m))continue;const p=e[m];if(a)if(B(i,m))p!==i[m]&&(i[m]=p,u=!0);else{const P=Yn(m);r[P]=Qt(a,o,P,p,n,!1)}else p!==i[m]&&(i[m]=p,u=!0)}}}else{ci(n,e,r,i)&&(u=!0);let f;for(const d in o)(!e||!B(e,d)&&((f=ce(d))===d||!B(e,f)))&&(a?t&&(t[d]!==void 0||t[f]!==void 0)&&(r[d]=Qt(a,o,d,void 0,n,!0)):delete r[d]);if(i!==o)for(const d in i)(!e||!B(e,d))&&(delete i[d],u=!0)}u&&zn(n.attrs,"set","")}function ci(n,e,t,s){const[r,i]=n.propsOptions;let l=!1,o;if(e)for(let a in e){if(Me(a))continue;const u=e[a];let f;r&&B(r,f=Yn(a))?!i||!i.includes(f)?t[f]=u:(o||(o={}))[f]=u:kt(n.emitsOptions,a)||(!(a in s)||u!==s[a])&&(s[a]=u,l=!0)}if(i){const a=F(t),u=o||K;for(let f=0;f<i.length;f++){const d=i[f];t[d]=Qt(r,a,d,u[d],n,!B(u,d))}}return l}function Qt(n,e,t,s,r,i){const l=n[t];if(l!=null){const o=B(l,"default");if(o&&s===void 0){const a=l.default;if(l.type!==Function&&!l.skipFactory&&E(a)){const{propsDefaults:u}=r;if(t in u)s=u[t];else{const f=He(r);s=u[t]=a.call(null,e),f()}}else s=a;r.ce&&r.ce._setProp(t,s)}l[0]&&(i&&!o?s=!1:l[1]&&(s===""||s===ce(t))&&(s=!0))}return s}const hl=new WeakMap;function ui(n,e,t=!1){const s=t?hl:e.propsCache,r=s.get(n);if(r)return r;const i=n.props,l={},o=[];let a=!1;if(!E(n)){const f=d=>{a=!0;const[m,p]=ui(d,e,!0);tn(l,m),p&&o.push(...p)};!t&&e.mixins.length&&e.mixins.forEach(f),n.extends&&f(n.extends),n.mixins&&n.mixins.forEach(f)}if(!i&&!a)return J(n)&&s.set(n,de),de;if(D(i))for(let f=0;f<i.length;f++){const d=Yn(i[f]);Js(d)&&(l[d]=K)}else if(i)for(const f in i){const d=Yn(f);if(Js(d)){const m=i[f],p=l[d]=D(m)||E(m)?{type:m}:tn({},m),P=p.type;let y=!1,L=!0;if(D(P))for(let M=0;M<P.length;++M){const z=P[M],q=E(z)&&z.name;if(q==="Boolean"){y=!0;break}else q==="String"&&(L=!1)}else y=E(P)&&P.name==="Boolean";p[0]=y,p[1]=L,(y||B(p,"default"))&&o.push(d)}}const u=[l,o];return J(n)&&s.set(n,u),u}function Js(n){return n[0]!=="$"&&!Me(n)}const bs=n=>n==="_"||n==="_ctx"||n==="$stable",Is=n=>D(n)?n.map(Mn):[Mn(n)],pl=(n,e,t)=>{if(e._n)return e;const s=Co((...r)=>Is(e(...r)),t);return s._c=!1,s},fi=(n,e,t)=>{const s=n._ctx;for(const r in n){if(bs(r))continue;const i=n[r];if(E(i))e[r]=pl(r,i,s);else if(i!=null){const l=Is(i);e[r]=()=>l}}},hi=(n,e)=>{const t=Is(e);n.slots.default=()=>t},pi=(n,e,t)=>{for(const s in e)(t||!bs(s))&&(n[s]=e[s])},dl=(n,e,t)=>{const s=n.slots=li();if(n.vnode.shapeFlag&32){const r=e._;r?(pi(s,e,t),t&&vr(s,"_",r,!0)):fi(e,s)}else e&&hi(n,e)},gl=(n,e,t)=>{const{vnode:s,slots:r}=n;let i=!0,l=K;if(s.shapeFlag&32){const o=e._;o?t&&o===1?i=!1:pi(r,e,t):(i=!e.$stable,fi(e,r)),l=e}else e&&(hi(n,e),l={default:1});if(i)for(const o in r)!bs(o)&&l[o]==null&&delete r[o]},dn=wl;function ml(n){return Al(n)}function Al(n,e){const t=It();t.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:l,createText:o,createComment:a,setText:u,setElementText:f,parentNode:d,nextSibling:m,setScopeId:p=Ln,insertStaticContent:P}=n,y=(c,h,g,w=null,A=null,b=null,S=void 0,k=null,x=!!h.dynamicChildren)=>{if(c===h)return;c&&!ve(c,h)&&(w=Qe(c),Sn(c,A,b,!0),c=null),h.patchFlag===-2&&(x=!1,h.dynamicChildren=null);const{type:I,ref:_,shapeFlag:v}=h;switch(I){case St:L(c,h,g,w);break;case Qn:M(c,h,g,w);break;case Ft:c==null&&z(h,g,w,S);break;case hn:qe(c,h,g,w,A,b,S,k,x);break;default:v&1?Q(c,h,g,w,A,b,S,k,x):v&6?Je(c,h,g,w,A,b,S,k,x):(v&64||v&128)&&I.process(c,h,g,w,A,b,S,k,x,xe)}_!=null&&A?Ee(_,c&&c.ref,b,h||c,!h):_==null&&c&&c.ref!=null&&Ee(c.ref,null,b,c,!0)},L=(c,h,g,w)=>{if(c==null)s(h.el=o(h.children),g,w);else{const A=h.el=c.el;h.children!==c.children&&u(A,h.children)}},M=(c,h,g,w)=>{c==null?s(h.el=a(h.children||""),g,w):h.el=c.el},z=(c,h,g,w)=>{[c.el,c.anchor]=P(c.children,h,g,w,c.el,c.anchor)},q=({el:c,anchor:h},g,w)=>{let A;for(;c&&c!==h;)A=m(c),s(c,g,w),c=A;s(h,g,w)},C=({el:c,anchor:h})=>{let g;for(;c&&c!==h;)g=m(c),r(c),c=g;r(h)},Q=(c,h,g,w,A,b,S,k,x)=>{if(h.type==="svg"?S="svg":h.type==="math"&&(S="mathml"),c==null)mn(h,g,w,A,b,S,k,x);else{const I=c.el&&c.el._isVueCE?c.el:null;try{I&&I._beginPatch(),Ke(c,h,A,b,S,k,x)}finally{I&&I._endPatch()}}},mn=(c,h,g,w,A,b,S,k)=>{let x,I;const{props:_,shapeFlag:v,transition:T,dirs:R}=c;if(x=c.el=l(c.type,b,_&&_.is,_),v&8?f(x,c.children):v&16&&Wn(c.children,x,null,w,A,zt(c,b),S,k),R&&te(c,null,w,"created"),X(x,c,c.scopeId,S,w),_){for(const H in _)H!=="value"&&!Me(H)&&i(x,H,null,_[H],b,w);"value"in _&&i(x,"value",null,_.value,b),(I=_.onVnodeBeforeMount)&&Cn(I,w,c)}R&&te(c,null,w,"beforeMount");const G=bl(A,T);G&&T.beforeEnter(x),s(x,h,g),((I=_&&_.onVnodeMounted)||G||R)&&dn(()=>{I&&Cn(I,w,c),G&&T.enter(x),R&&te(c,null,w,"mounted")},A)},X=(c,h,g,w,A)=>{if(g&&p(c,g),w)for(let b=0;b<w.length;b++)p(c,w[b]);if(A){let b=A.subTree;if(h===b||Ai(b.type)&&(b.ssContent===h||b.ssFallback===h)){const S=A.vnode;X(c,S,S.scopeId,S.slotScopeIds,A.parent)}}},Wn=(c,h,g,w,A,b,S,k,x=0)=>{for(let I=x;I<c.length;I++){const _=c[I]=k?Kn(c[I]):Mn(c[I]);y(null,_,h,g,w,A,b,S,k)}},Ke=(c,h,g,w,A,b,S)=>{const k=h.el=c.el;let{patchFlag:x,dynamicChildren:I,dirs:_}=h;x|=c.patchFlag&16;const v=c.props||K,T=h.props||K;let R;if(g&&se(g,!1),(R=T.onVnodeBeforeUpdate)&&Cn(R,g,h,c),_&&te(h,c,g,"beforeUpdate"),g&&se(g,!0),(v.innerHTML&&T.innerHTML==null||v.textContent&&T.textContent==null)&&f(k,""),I?Xn(c.dynamicChildren,I,k,g,w,zt(h,A),b):S||W(c,h,k,null,g,w,zt(h,A),b,!1),x>0){if(x&16)we(k,v,T,g,A);else if(x&2&&v.class!==T.class&&i(k,"class",null,T.class,A),x&4&&i(k,"style",v.style,T.style,A),x&8){const G=h.dynamicProps;for(let H=0;H<G.length;H++){const U=G[H],cn=v[U],un=T[U];(un!==cn||U==="value")&&i(k,U,cn,un,A,g)}}x&1&&c.children!==h.children&&f(k,h.children)}else!S&&I==null&&we(k,v,T,g,A);((R=T.onVnodeUpdated)||_)&&dn(()=>{R&&Cn(R,g,h,c),_&&te(h,c,g,"updated")},w)},Xn=(c,h,g,w,A,b,S)=>{for(let k=0;k<h.length;k++){const x=c[k],I=h[k],_=x.el&&(x.type===hn||!ve(x,I)||x.shapeFlag&198)?d(x.el):g;y(x,I,_,null,w,A,b,S,!0)}},we=(c,h,g,w,A)=>{if(h!==g){if(h!==K)for(const b in h)!Me(b)&&!(b in g)&&i(c,b,h[b],null,A,w);for(const b in g){if(Me(b))continue;const S=g[b],k=h[b];S!==k&&b!=="value"&&i(c,b,k,S,A,w)}"value"in g&&i(c,"value",h.value,g.value,A)}},qe=(c,h,g,w,A,b,S,k,x)=>{const I=h.el=c?c.el:o(""),_=h.anchor=c?c.anchor:o("");let{patchFlag:v,dynamicChildren:T,slotScopeIds:R}=h;R&&(k=k?k.concat(R):R),c==null?(s(I,g,w),s(_,g,w),Wn(h.children||[],g,_,A,b,S,k,x)):v>0&&v&64&&T&&c.dynamicChildren&&c.dynamicChildren.length===T.length?(Xn(c.dynamicChildren,T,g,A,b,S,k),(h.key!=null||A&&h===A.subTree)&&di(c,h,!0)):W(c,h,g,_,A,b,S,k,x)},Je=(c,h,g,w,A,b,S,k,x)=>{h.slotScopeIds=k,c==null?h.shapeFlag&512?A.ctx.activate(h,g,w,S,x):Tt(h,g,w,A,b,S,x):Ms(c,h,x)},Tt=(c,h,g,w,A,b,S)=>{const k=c.component=Cl(c,w,A);if(Zr(c)&&(k.ctx.renderer=xe),Ml(k,!1,S),k.asyncDep){if(A&&A.registerDep(k,sn,S),!c.el){const x=k.subTree=Fn(Qn);M(null,x,h,g),c.placeholder=x.el}}else sn(k,c,h,g,A,b,S)},Ms=(c,h,g)=>{const w=h.component=c.component;if(al(c,h,g))if(w.asyncDep&&!w.asyncResolved){Y(w,h,g);return}else w.next=h,w.update();else h.el=c.el,w.vnode=h},sn=(c,h,g,w,A,b,S)=>{const k=()=>{if(c.isMounted){let{next:v,bu:T,u:R,parent:G,vnode:H}=c;{const Pn=gi(c);if(Pn){v&&(v.el=H.el,Y(c,v,S)),Pn.asyncDep.then(()=>{c.isUnmounted||k()});return}}let U=v,cn;se(c,!1),v?(v.el=H.el,Y(c,v,S)):v=H,T&&Rt(T),(cn=v.props&&v.props.onVnodeBeforeUpdate)&&Cn(cn,G,v,H),se(c,!0);const un=Ks(c),vn=c.subTree;c.subTree=un,y(vn,un,d(vn.el),Qe(vn),c,A,b),v.el=un.el,U===null&&cl(c,un.el),R&&dn(R,A),(cn=v.props&&v.props.onVnodeUpdated)&&dn(()=>Cn(cn,G,v,H),A)}else{let v;const{el:T,props:R}=h,{bm:G,m:H,parent:U,root:cn,type:un}=c,vn=Ge(h);se(c,!1),G&&Rt(G),!vn&&(v=R&&R.onVnodeBeforeMount)&&Cn(v,U,h),se(c,!0);{cn.ce&&cn.ce._def.shadowRoot!==!1&&cn.ce._injectChildStyle(un);const Pn=c.subTree=Ks(c);y(null,Pn,g,w,c,A,b),h.el=Pn.el}if(H&&dn(H,A),!vn&&(v=R&&R.onVnodeMounted)){const Pn=h;dn(()=>Cn(v,U,Pn),A)}(h.shapeFlag&256||U&&Ge(U.vnode)&&U.vnode.shapeFlag&256)&&c.a&&dn(c.a,A),c.isMounted=!0,h=g=w=null}};c.scope.on();const x=c.effect=new Cr(k);c.scope.off();const I=c.update=x.run.bind(x),_=c.job=x.runIfDirty.bind(x);_.i=c,_.id=c.uid,x.scheduler=()=>ms(_),se(c,!0),I()},Y=(c,h,g)=>{h.component=c;const w=c.vnode.props;c.vnode=h,c.next=null,fl(c,h.props,w,g),gl(c,h.children,g),Bn(),Bs(c),jn()},W=(c,h,g,w,A,b,S,k,x=!1)=>{const I=c&&c.children,_=c?c.shapeFlag:0,v=h.children,{patchFlag:T,shapeFlag:R}=h;if(T>0){if(T&128){Ye(I,v,g,w,A,b,S,k,x);return}else if(T&256){ne(I,v,g,w,A,b,S,k,x);return}}R&8?(_&16&&ye(I,A,b),v!==I&&f(g,v)):_&16?R&16?Ye(I,v,g,w,A,b,S,k,x):ye(I,A,b,!0):(_&8&&f(g,""),R&16&&Wn(v,g,w,A,b,S,k,x))},ne=(c,h,g,w,A,b,S,k,x)=>{c=c||de,h=h||de;const I=c.length,_=h.length,v=Math.min(I,_);let T;for(T=0;T<v;T++){const R=h[T]=x?Kn(h[T]):Mn(h[T]);y(c[T],R,g,null,A,b,S,k,x)}I>_?ye(c,A,b,!0,!1,v):Wn(h,g,w,A,b,S,k,x,v)},Ye=(c,h,g,w,A,b,S,k,x)=>{let I=0;const _=h.length;let v=c.length-1,T=_-1;for(;I<=v&&I<=T;){const R=c[I],G=h[I]=x?Kn(h[I]):Mn(h[I]);if(ve(R,G))y(R,G,g,null,A,b,S,k,x);else break;I++}for(;I<=v&&I<=T;){const R=c[v],G=h[T]=x?Kn(h[T]):Mn(h[T]);if(ve(R,G))y(R,G,g,null,A,b,S,k,x);else break;v--,T--}if(I>v){if(I<=T){const R=T+1,G=R<_?h[R].el:w;for(;I<=T;)y(null,h[I]=x?Kn(h[I]):Mn(h[I]),g,G,A,b,S,k,x),I++}}else if(I>T)for(;I<=v;)Sn(c[I],A,b,!0),I++;else{const R=I,G=I,H=new Map;for(I=G;I<=T;I++){const pn=h[I]=x?Kn(h[I]):Mn(h[I]);pn.key!=null&&H.set(pn.key,I)}let U,cn=0;const un=T-G+1;let vn=!1,Pn=0;const ke=new Array(un);for(I=0;I<un;I++)ke[I]=0;for(I=R;I<=v;I++){const pn=c[I];if(cn>=un){Sn(pn,A,b,!0);continue}let Tn;if(pn.key!=null)Tn=H.get(pn.key);else for(U=G;U<=T;U++)if(ke[U-G]===0&&ve(pn,h[U])){Tn=U;break}Tn===void 0?Sn(pn,A,b,!0):(ke[Tn-G]=I+1,Tn>=Pn?Pn=Tn:vn=!0,y(pn,h[Tn],g,null,A,b,S,k,x),cn++)}const Es=vn?Il(ke):de;for(U=Es.length-1,I=un-1;I>=0;I--){const pn=G+I,Tn=h[pn],Gs=h[pn+1],Os=pn+1<_?Gs.el||mi(Gs):w;ke[I]===0?y(null,Tn,g,Os,A,b,S,k,x):vn&&(U<0||I!==Es[U]?ee(Tn,g,Os,2):U--)}}},ee=(c,h,g,w,A=null)=>{const{el:b,type:S,transition:k,children:x,shapeFlag:I}=c;if(I&6){ee(c.component.subTree,h,g,w);return}if(I&128){c.suspense.move(h,g,w);return}if(I&64){S.move(c,h,g,xe);return}if(S===hn){s(b,h,g);for(let v=0;v<x.length;v++)ee(x[v],h,g,w);s(c.anchor,h,g);return}if(S===Ft){q(c,h,g);return}if(w!==2&&I&1&&k)if(w===0)k.beforeEnter(b),s(b,h,g),dn(()=>k.enter(b),A);else{const{leave:v,delayLeave:T,afterLeave:R}=k,G=()=>{c.ctx.isUnmounted?r(b):s(b,h,g)},H=()=>{b._isLeaving&&b[Oo](!0),v(b,()=>{G(),R&&R()})};T?T(b,G,H):H()}else s(b,h,g)},Sn=(c,h,g,w=!1,A=!1)=>{const{type:b,props:S,ref:k,children:x,dynamicChildren:I,shapeFlag:_,patchFlag:v,dirs:T,cacheIndex:R}=c;if(v===-2&&(A=!1),k!=null&&(Bn(),Ee(k,null,g,c,!0),jn()),R!=null&&(h.renderCache[R]=void 0),_&256){h.ctx.deactivate(c);return}const G=_&1&&T,H=!Ge(c);let U;if(H&&(U=S&&S.onVnodeBeforeUnmount)&&Cn(U,h,c),_&6)Oi(c.component,g,w);else{if(_&128){c.suspense.unmount(g,w);return}G&&te(c,null,h,"beforeUnmount"),_&64?c.type.remove(c,h,g,xe,w):I&&!I.hasOnce&&(b!==hn||v>0&&v&64)?ye(I,h,g,!1,!0):(b===hn&&v&384||!A&&_&16)&&ye(x,h,g),w&&Ds(c)}(H&&(U=S&&S.onVnodeUnmounted)||G)&&dn(()=>{U&&Cn(U,h,c),G&&te(c,null,h,"unmounted")},g)},Ds=c=>{const{type:h,el:g,anchor:w,transition:A}=c;if(h===hn){Gi(g,w);return}if(h===Ft){C(c);return}const b=()=>{r(g),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(c.shapeFlag&1&&A&&!A.persisted){const{leave:S,delayLeave:k}=A,x=()=>S(g,b);k?k(c.el,b,x):x()}else b()},Gi=(c,h)=>{let g;for(;c!==h;)g=m(c),r(c),c=g;r(h)},Oi=(c,h,g)=>{const{bum:w,scope:A,job:b,subTree:S,um:k,m:x,a:I}=c;Ys(x),Ys(I),w&&Rt(w),A.stop(),b&&(b.flags|=8,Sn(S,c,h,g)),k&&dn(k,h),dn(()=>{c.isUnmounted=!0},h)},ye=(c,h,g,w=!1,A=!1,b=0)=>{for(let S=b;S<c.length;S++)Sn(c[S],h,g,w,A)},Qe=c=>{if(c.shapeFlag&6)return Qe(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const h=m(c.anchor||c.el),g=h&&h[Eo];return g?m(g):h};let _t=!1;const Ls=(c,h,g)=>{let w;c==null?h._vnode&&(Sn(h._vnode,null,null,!0),w=h._vnode.component):y(h._vnode||null,c,h,null,null,null,g),h._vnode=c,_t||(_t=!0,Bs(w),Vr(),_t=!1)},xe={p:y,um:Sn,m:ee,r:Ds,mt:Tt,mc:Wn,pc:W,pbc:Xn,n:Qe,o:n};return{render:Ls,hydrate:void 0,createApp:tl(Ls)}}function zt({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function se({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function bl(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function di(n,e,t=!1){const s=n.children,r=e.children;if(D(s)&&D(r))for(let i=0;i<s.length;i++){const l=s[i];let o=r[i];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=r[i]=Kn(r[i]),o.el=l.el),!t&&o.patchFlag!==-2&&di(l,o)),o.type===St&&(o.patchFlag!==-1?o.el=l.el:o.__elIndex=i+(n.type===hn?1:0)),o.type===Qn&&!o.el&&(o.el=l.el)}}function Il(n){const e=n.slice(),t=[0];let s,r,i,l,o;const a=n.length;for(s=0;s<a;s++){const u=n[s];if(u!==0){if(r=t[t.length-1],n[r]<u){e[s]=r,t.push(s);continue}for(i=0,l=t.length-1;i<l;)o=i+l>>1,n[t[o]]<u?i=o+1:l=o;u<n[t[i]]&&(i>0&&(e[s]=t[i-1]),t[i]=s)}}for(i=t.length,l=t[i-1];i-- >0;)t[i]=l,l=e[l];return t}function gi(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:gi(e)}function Ys(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function mi(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?mi(e.subTree):null}const Ai=n=>n.__isSuspense;function wl(n,e){e&&e.pendingBranch?D(n)?e.effects.push(...n):e.effects.push(n):_o(n)}const hn=Symbol.for("v-fgt"),St=Symbol.for("v-txt"),Qn=Symbol.for("v-cmt"),Ft=Symbol.for("v-stc"),$e=[];let gn=null;function In(n=!1){$e.push(gn=n?null:[])}function yl(){$e.pop(),gn=$e[$e.length-1]||null}let Ue=1;function Qs(n,e=!1){Ue+=n,n<0&&gn&&e&&(gn.hasOnce=!0)}function bi(n){return n.dynamicChildren=Ue>0?gn||de:null,yl(),Ue>0&&gn&&gn.push(n),n}function _n(n,e,t,s,r,i){return bi(O(n,e,t,s,r,i,!0))}function xl(n,e,t,s,r){return bi(Fn(n,e,t,s,r,!0))}function Ii(n){return n?n.__v_isVNode===!0:!1}function ve(n,e){return n.type===e.type&&n.key===e.key}const wi=({key:n})=>n??null,rt=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Z(n)||en(n)||E(n)?{i:Dn,r:n,k:e,f:!!t}:n:null);function O(n,e=null,t=null,s=0,r=null,i=n===hn?0:1,l=!1,o=!1){const a={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&wi(e),ref:e&&rt(e),scopeId:qr,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Dn};return o?(ws(a,t),i&128&&n.normalize(a)):t&&(a.shapeFlag|=Z(t)?8:16),Ue>0&&!l&&gn&&(a.patchFlag>0||i&6)&&a.patchFlag!==32&&gn.push(a),a}const Fn=kl;function kl(n,e=null,t=null,s=0,r=null,i=!1){if((!n||n===qo)&&(n=Qn),Ii(n)){const o=Ie(n,e,!0);return t&&ws(o,t),Ue>0&&!i&&gn&&(o.shapeFlag&6?gn[gn.indexOf(n)]=o:gn.push(o)),o.patchFlag=-2,o}if(Gl(n)&&(n=n.__vccOpts),e){e=Sl(e);let{class:o,style:a}=e;o&&!Z(o)&&(e.class=ie(o)),J(a)&&(gs(a)&&!D(a)&&(a=tn({},a)),e.style=ls(a))}const l=Z(n)?1:Ai(n)?128:Go(n)?64:J(n)?4:E(n)?2:0;return O(n,e,t,s,r,l,i,!0)}function Sl(n){return n?gs(n)||ai(n)?tn({},n):n:null}function Ie(n,e,t=!1,s=!1){const{props:r,ref:i,patchFlag:l,children:o,transition:a}=n,u=e?Pl(r||{},e):r,f={__v_isVNode:!0,__v_skip:!0,type:n.type,props:u,key:u&&wi(u),ref:e&&e.ref?t&&i?D(i)?i.concat(rt(e)):[i,rt(e)]:rt(e):i,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:o,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==hn?l===-1?16:l|16:l,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:a,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Ie(n.ssContent),ssFallback:n.ssFallback&&Ie(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return a&&s&&As(f,a.clone(f)),f}function pe(n=" ",e=0){return Fn(St,null,n,e)}function vl(n="",e=!1){return e?(In(),xl(Qn,null,n)):Fn(Qn,null,n)}function Mn(n){return n==null||typeof n=="boolean"?Fn(Qn):D(n)?Fn(hn,null,n.slice()):Ii(n)?Kn(n):Fn(St,null,String(n))}function Kn(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Ie(n)}function ws(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(D(e))t=16;else if(typeof e=="object")if(s&65){const r=e.default;r&&(r._c&&(r._d=!1),ws(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!ai(e)?e._ctx=Dn:r===3&&Dn&&(Dn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else E(e)?(e={default:e,_ctx:Dn},t=32):(e=String(e),s&64?(t=16,e=[pe(e)]):t=8);n.children=e,n.shapeFlag|=t}function Pl(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const r in s)if(r==="class")e.class!==s.class&&(e.class=ie([e.class,s.class]));else if(r==="style")e.style=ls([e.style,s.style]);else if(mt(r)){const i=e[r],l=s[r];l&&i!==l&&!(D(i)&&i.includes(l))&&(e[r]=i?[].concat(i,l):l)}else r!==""&&(e[r]=s[r])}return e}function Cn(n,e,t,s=null){En(n,e,7,[t,s])}const Tl=ri();let _l=0;function Cl(n,e,t){const s=n.type,r=(e?e.appContext:n.appContext)||Tl,i={uid:_l++,vnode:n,type:s,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Yi(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ui(s,r),emitsOptions:ii(s,r),emit:null,emitted:null,propsDefaults:K,inheritAttrs:s.inheritAttrs,ctx:K,data:K,props:K,attrs:K,slots:K,refs:K,setupState:K,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=rl.bind(null,i),n.ce&&n.ce(i),i}let ln=null;const Rl=()=>ln||Dn;let ht,Zt;{const n=It(),e=(t,s)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(s),i=>{r.length>1?r.forEach(l=>l(i)):r[0](i)}};ht=e("__VUE_INSTANCE_SETTERS__",t=>ln=t),Zt=e("__VUE_SSR_SETTERS__",t=>Ne=t)}const He=n=>{const e=ln;return ht(n),n.scope.on(),()=>{n.scope.off(),ht(e)}},Zs=()=>{ln&&ln.scope.off(),ht(null)};function yi(n){return n.vnode.shapeFlag&4}let Ne=!1;function Ml(n,e=!1,t=!1){e&&Zt(e);const{props:s,children:r}=n.vnode,i=yi(n);ul(n,s,i,e),dl(n,r,t||e);const l=i?Dl(n,e):void 0;return e&&Zt(!1),l}function Dl(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Jo);const{setup:s}=t;if(s){Bn();const r=n.setupContext=s.length>1?El(n):null,i=He(n),l=We(s,n,0,[n.props,r]),o=yr(l);if(jn(),i(),(o||n.sp)&&!Ge(n)&&Qr(n),o){if(l.then(Zs,Zs),e)return l.then(a=>{Xs(n,a)}).catch(a=>{yt(a,n,0)});n.asyncDep=l}else Xs(n,l)}else xi(n)}function Xs(n,e,t){E(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:J(e)&&(n.setupState=Nr(e)),xi(n)}function xi(n,e,t){const s=n.type;n.render||(n.render=s.render||Ln);{const r=He(n);Bn();try{Yo(n)}finally{jn(),r()}}}const Ll={get(n,e){return nn(n,"get",""),n[e]}};function El(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,Ll),slots:n.slots,emit:n.emit,expose:e}}function ys(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Nr(bo(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in Oe)return Oe[t](n)},has(e,t){return t in e||t in Oe}})):n.proxy}function Gl(n){return E(n)&&"__vccOpts"in n}const it=(n,e)=>ko(n,e,Ne),Ol="3.5.27";/**
* @vue/runtime-dom v3.5.27
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Xt;const nr=typeof window<"u"&&window.trustedTypes;if(nr)try{Xt=nr.createPolicy("vue",{createHTML:n=>n})}catch{}const ki=Xt?n=>Xt.createHTML(n):n=>n,$l="http://www.w3.org/2000/svg",zl="http://www.w3.org/1998/Math/MathML",$n=typeof document<"u"?document:null,er=$n&&$n.createElement("template"),Fl={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,s)=>{const r=e==="svg"?$n.createElementNS($l,n):e==="mathml"?$n.createElementNS(zl,n):t?$n.createElement(n,{is:t}):$n.createElement(n);return n==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:n=>$n.createTextNode(n),createComment:n=>$n.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>$n.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,s,r,i){const l=t?t.previousSibling:e.lastChild;if(r&&(r===i||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===i||!(r=r.nextSibling)););else{er.innerHTML=ki(s==="svg"?`<svg>${n}</svg>`:s==="mathml"?`<math>${n}</math>`:n);const o=er.content;if(s==="svg"||s==="mathml"){const a=o.firstChild;for(;a.firstChild;)o.appendChild(a.firstChild);o.removeChild(a)}e.insertBefore(o,t)}return[l?l.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Bl=Symbol("_vtc");function jl(n,e,t){const s=n[Bl];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const tr=Symbol("_vod"),Ul=Symbol("_vsh"),Nl=Symbol(""),Wl=/(?:^|;)\s*display\s*:/;function Hl(n,e,t){const s=n.style,r=Z(t);let i=!1;if(t&&!r){if(e)if(Z(e))for(const l of e.split(";")){const o=l.slice(0,l.indexOf(":")).trim();t[o]==null&&ot(s,o,"")}else for(const l in e)t[l]==null&&ot(s,l,"");for(const l in t)l==="display"&&(i=!0),ot(s,l,t[l])}else if(r){if(e!==t){const l=s[Nl];l&&(t+=";"+l),s.cssText=t,i=Wl.test(t)}}else e&&n.removeAttribute("style");tr in n&&(n[tr]=i?s.display:"",n[Ul]&&(s.display="none"))}const sr=/\s*!important$/;function ot(n,e,t){if(D(t))t.forEach(s=>ot(n,e,s));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const s=Vl(n,e);sr.test(t)?n.setProperty(ce(s),t.replace(sr,""),"important"):n[s]=t}}const rr=["Webkit","Moz","ms"],Bt={};function Vl(n,e){const t=Bt[e];if(t)return t;let s=Yn(e);if(s!=="filter"&&s in n)return Bt[e]=s;s=Sr(s);for(let r=0;r<rr.length;r++){const i=rr[r]+s;if(i in n)return Bt[e]=i}return e}const ir="http://www.w3.org/1999/xlink";function or(n,e,t,s,r,i=Ji(e)){s&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(ir,e.slice(6,e.length)):n.setAttributeNS(ir,e,t):t==null||i&&!Pr(t)?n.removeAttribute(e):n.setAttribute(e,i?"":Zn(t)?String(t):t)}function lr(n,e,t,s,r){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?ki(t):t);return}const i=n.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const o=i==="OPTION"?n.getAttribute("value")||"":n.value,a=t==null?n.type==="checkbox"?"on":"":String(t);(o!==a||!("_value"in n))&&(n.value=a),t==null&&n.removeAttribute(e),n._value=t;return}let l=!1;if(t===""||t==null){const o=typeof n[e];o==="boolean"?t=Pr(t):t==null&&o==="string"?(t="",l=!0):o==="number"&&(t=0,l=!0)}try{n[e]=t}catch{}l&&n.removeAttribute(r||e)}function Kl(n,e,t,s){n.addEventListener(e,t,s)}function ql(n,e,t,s){n.removeEventListener(e,t,s)}const ar=Symbol("_vei");function Jl(n,e,t,s,r=null){const i=n[ar]||(n[ar]={}),l=i[e];if(s&&l)l.value=s;else{const[o,a]=Yl(e);if(s){const u=i[e]=Xl(s,r);Kl(n,o,u,a)}else l&&(ql(n,o,l,a),i[e]=void 0)}}const cr=/(?:Once|Passive|Capture)$/;function Yl(n){let e;if(cr.test(n)){e={};let s;for(;s=n.match(cr);)n=n.slice(0,n.length-s[0].length),e[s[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):ce(n.slice(2)),e]}let jt=0;const Ql=Promise.resolve(),Zl=()=>jt||(Ql.then(()=>jt=0),jt=Date.now());function Xl(n,e){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;En(na(s,t.value),e,5,[s])};return t.value=n,t.attached=Zl(),t}function na(n,e){if(D(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(s=>r=>!r._stopped&&s&&s(r))}else return e}const ur=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,ea=(n,e,t,s,r,i)=>{const l=r==="svg";e==="class"?jl(n,s,l):e==="style"?Hl(n,t,s):mt(e)?rs(e)||Jl(n,e,t,s,i):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):ta(n,e,s,l))?(lr(n,e,s),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&or(n,e,s,l,i,e!=="value")):n._isVueCE&&(/[A-Z]/.test(e)||!Z(s))?lr(n,Yn(e),s,i,e):(e==="true-value"?n._trueValue=s:e==="false-value"&&(n._falseValue=s),or(n,e,s,l))};function ta(n,e,t,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in n&&ur(e)&&E(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return ur(e)&&Z(t)?!1:e in n}const sa=tn({patchProp:ea},Fl);let fr;function ra(){return fr||(fr=ml(sa))}const ia=((...n)=>{const e=ra().createApp(...n),{mount:t}=e;return e.mount=s=>{const r=la(s);if(!r)return;const i=e._component;!E(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const l=t(r,!1,oa(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),l},e});function oa(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function la(n){return Z(n)?document.querySelector(n):n}function xs(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ue=xs();function Si(n){ue=n}var ze={exec:()=>null};function $(n,e=""){let t=typeof n=="string"?n:n.source,s={replace:(r,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(an.caret,"$1"),t=t.replace(r,l),s},getRegex:()=>new RegExp(t,e)};return s}var aa=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),an={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},ca=/^(?:[ \t]*(?:\n|$))+/,ua=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fa=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ve=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ha=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ks=/(?:[*+-]|\d{1,9}[.)])/,vi=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Pi=$(vi).replace(/bull/g,ks).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),pa=$(vi).replace(/bull/g,ks).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ss=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,da=/^[^\n]+/,vs=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ga=$(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",vs).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ma=$(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ks).getRegex(),vt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ps=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Aa=$("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Ps).replace("tag",vt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ti=$(Ss).replace("hr",Ve).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",vt).getRegex(),ba=$(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ti).getRegex(),Ts={blockquote:ba,code:ua,def:ga,fences:fa,heading:ha,hr:Ve,html:Aa,lheading:Pi,list:ma,newline:ca,paragraph:Ti,table:ze,text:da},hr=$("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ve).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",vt).getRegex(),Ia={...Ts,lheading:pa,table:hr,paragraph:$(Ss).replace("hr",Ve).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",hr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",vt).getRegex()},wa={...Ts,html:$(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ps).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ze,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:$(Ss).replace("hr",Ve).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Pi).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ya=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,xa=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,_i=/^( {2,}|\\)\n(?!\s*$)/,ka=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Pt=/[\p{P}\p{S}]/u,_s=/[\s\p{P}\p{S}]/u,Ci=/[^\s\p{P}\p{S}]/u,Sa=$(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,_s).getRegex(),Ri=/(?!~)[\p{P}\p{S}]/u,va=/(?!~)[\s\p{P}\p{S}]/u,Pa=/(?:[^\s\p{P}\p{S}]|~)/u,Ta=$(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",aa?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Mi=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,_a=$(Mi,"u").replace(/punct/g,Pt).getRegex(),Ca=$(Mi,"u").replace(/punct/g,Ri).getRegex(),Di="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ra=$(Di,"gu").replace(/notPunctSpace/g,Ci).replace(/punctSpace/g,_s).replace(/punct/g,Pt).getRegex(),Ma=$(Di,"gu").replace(/notPunctSpace/g,Pa).replace(/punctSpace/g,va).replace(/punct/g,Ri).getRegex(),Da=$("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ci).replace(/punctSpace/g,_s).replace(/punct/g,Pt).getRegex(),La=$(/\\(punct)/,"gu").replace(/punct/g,Pt).getRegex(),Ea=$(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ga=$(Ps).replace("(?:-->|$)","-->").getRegex(),Oa=$("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ga).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),pt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,$a=$(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",pt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Li=$(/^!?\[(label)\]\[(ref)\]/).replace("label",pt).replace("ref",vs).getRegex(),Ei=$(/^!?\[(ref)\](?:\[\])?/).replace("ref",vs).getRegex(),za=$("reflink|nolink(?!\\()","g").replace("reflink",Li).replace("nolink",Ei).getRegex(),pr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Cs={_backpedal:ze,anyPunctuation:La,autolink:Ea,blockSkip:Ta,br:_i,code:xa,del:ze,emStrongLDelim:_a,emStrongRDelimAst:Ra,emStrongRDelimUnd:Da,escape:ya,link:$a,nolink:Ei,punctuation:Sa,reflink:Li,reflinkSearch:za,tag:Oa,text:ka,url:ze},Fa={...Cs,link:$(/^!?\[(label)\]\((.*?)\)/).replace("label",pt).getRegex(),reflink:$(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",pt).getRegex()},ns={...Cs,emStrongRDelimAst:Ma,emStrongLDelim:Ca,url:$(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",pr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:$(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",pr).getRegex()},Ba={...ns,br:$(_i).replace("{2,}","*").getRegex(),text:$(ns.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},et={normal:Ts,gfm:Ia,pedantic:wa},Pe={normal:Cs,gfm:ns,breaks:Ba,pedantic:Fa},ja={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},dr=n=>ja[n];function On(n,e){if(e){if(an.escapeTest.test(n))return n.replace(an.escapeReplace,dr)}else if(an.escapeTestNoEncode.test(n))return n.replace(an.escapeReplaceNoEncode,dr);return n}function gr(n){try{n=encodeURI(n).replace(an.percentDecode,"%")}catch{return null}return n}function mr(n,e){var i;let t=n.replace(an.findPipe,(l,o,a)=>{let u=!1,f=o;for(;--f>=0&&a[f]==="\\";)u=!u;return u?"|":" |"}),s=t.split(an.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!((i=s.at(-1))!=null&&i.trim())&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(an.slashPipe,"|");return s}function Te(n,e,t){let s=n.length;if(s===0)return"";let r=0;for(;r<s&&n.charAt(s-r-1)===e;)r++;return n.slice(0,s-r)}function Ua(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<n.length;s++)if(n[s]==="\\")s++;else if(n[s]===e[0])t++;else if(n[s]===e[1]&&(t--,t<0))return s;return t>0?-2:-1}function Ar(n,e,t,s,r){let i=e.href,l=e.title||null,o=n[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let a={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:l,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,a}function Na(n,e,t){let s=n.match(t.other.indentCodeCompensation);if(s===null)return e;let r=s[1];return e.split(`
...
${u}`:u,r=r?`${r}
${f}`:f;let d=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(f,i,!0),this.lexer.state.top=d,t.length===0)break;let m=i.at(-1);if((m==null?void 0:m.type)==="code")break;if((m==null?void 0:m.type)==="blockquote"){let p=m,P=p.raw+`
`+t.join(`
`),y=this.blockquote(P);i[i.length-1]=y,s=s.substring(0,s.length-p.raw.length)+y.raw,r=r.substring(0,r.length-p.text.length)+y.text;break}else if((m==null?void 0:m.type)==="list"){let p=m,P=p.raw+`
`+t.join(`
`),y=this.list(P);i[i.length-1]=y,s=s.substring(0,s.length-m.raw.length)+y.raw,r=r.substring(0,r.length-p.raw.length)+y.raw,t=P.substring(i.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:s,tokens:i,text:r}}}list(n){var t,s;let e=this.rules.block.list.exec(n);if(e){let r=e[1].trim(),i=r.length>1,l={type:"list",raw:"",ordered:i,start:i?+r.slice(0,-1):"",loose:!1,items:[]};r=i?`\\d{1,9}\\${r.slice(-1)}`:`\\${r}`,this.options.pedantic&&(r=i?r:"[*+-]");let o=this.rules.other.listItemRegex(r),a=!1;for(;n;){let f=!1,d="",m="";if(!(e=o.exec(n))||this.rules.block.hr.test(n))break;d=e[0],n=n.substring(d.length);let p=e[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,M=>" ".repeat(3*M.length)),P=n.split(`
`,1)[0],y=!p.trim(),L=0;if(this.options.pedantic?(L=2,m=p.trimStart()):y?L=e[1].length+1:(L=e[2].search(this.rules.other.nonSpaceChar),L=L>4?1:L,m=p.slice(L),L+=e[1].length),y&&this.rules.other.blankLine.test(P)&&(d+=P+`
`,n=n.substring(P.length+1),f=!0),!f){let M=this.rules.other.nextBulletRegex(L),z=this.rules.other.hrRegex(L),q=this.rules.other.fencesBeginRegex(L),C=this.rules.other.headingBeginRegex(L),Q=this.rules.other.htmlBeginRegex(L);for(;n;){let mn=n.split(`
`,1)[0],X;if(P=mn,this.options.pedantic?(P=P.replace(this.rules.other.listReplaceNesting,"  "),X=P):X=P.replace(this.rules.other.tabCharGlobal,"    "),q.test(P)||C.test(P)||Q.test(P)||M.test(P)||z.test(P))break;if(X.search(this.rules.other.nonSpaceChar)>=L||!P.trim())m+=`
`+X.slice(L);else{if(y||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||q.test(p)||C.test(p)||z.test(p))break;m+=`
`+P}!y&&!P.trim()&&(y=!0),d+=mn+`
`,n=n.substring(mn.length+1),p=X.slice(L)}}l.loose||(a?l.loose=!0:this.rules.other.doubleBlankLine.test(d)&&(a=!0)),l.items.push({type:"list_item",raw:d,task:!!this.options.gfm&&this.rules.other.listIsTask.test(m),loose:!1,text:m,tokens:[]}),l.raw+=d}let u=l.items.at(-1);if(u)u.raw=u.raw.trimEnd(),u.text=u.text.trimEnd();else return;l.raw=l.raw.trimEnd();for(let f of l.items){if(this.lexer.state.top=!1,f.tokens=this.lexer.blockTokens(f.text,[]),f.task){if(f.text=f.text.replace(this.rules.other.listReplaceTask,""),((t=f.tokens[0])==null?void 0:t.type)==="text"||((s=f.tokens[0])==null?void 0:s.type)==="paragraph"){f.tokens[0].raw=f.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),f.tokens[0].text=f.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let m=this.lexer.inlineQueue.length-1;m>=0;m--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[m].src)){this.lexer.inlineQueue[m].src=this.lexer.inlineQueue[m].src.replace(this.rules.other.listReplaceTask,"");break}}let d=this.rules.other.listTaskCheckbox.exec(f.raw);if(d){let m={type:"checkbox",raw:d[0]+" ",checked:d[0]!=="[ ]"};f.checked=m.checked,l.loose?f.tokens[0]&&["paragraph","text"].includes(f.tokens[0].type)&&"tokens"in f.tokens[0]&&f.tokens[0].tokens?(f.tokens[0].raw=m.raw+f.tokens[0].raw,f.tokens[0].text=m.raw+f.tokens[0].text,f.tokens[0].tokens.unshift(m)):f.tokens.unshift({type:"paragraph",raw:m.raw,text:m.raw,tokens:[m]}):f.tokens.unshift(m)}}if(!l.loose){let d=f.tokens.filter(p=>p.type==="space"),m=d.length>0&&d.some(p=>this.rules.other.anyLine.test(p.raw));l.loose=m}}if(l.loose)for(let f of l.items){f.loose=!0;for(let d of f.tokens)d.type==="text"&&(d.type="paragraph")}return l}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),s=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",r=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:s,title:r}}}table(n){var l;let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=mr(e[1]),s=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),r=(l=e[3])!=null&&l.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+o.raw,u.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):t.push(o);continue}if(e){let u="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(u);break}else throw new Error(u)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var a,u,f,d,m;let s=e,r=null;if(this.tokens.links){let p=Object.keys(this.tokens.links);if(p.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)p.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,r.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(r=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=r[2]?r[2].length:0,s=s.slice(0,r.index+i)+"["+"a".repeat(r[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=((u=(a=this.options.hooks)==null?void 0:a.emStrongMask)==null?void 0:u.call({lexer:this},s))??s;let l=!1,o="";for(;e;){l||(o=""),l=!1;let p;if((d=(f=this.options.extensions)==null?void 0:f.inline)!=null&&d.some(y=>(p=y.call({lexer:this},e,t))?(e=e.substring(p.raw.length),t.push(p),!0):!1))continue;if(p=this.tokenizer.escape(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.tag(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.link(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(p.raw.length);let y=t.at(-1);p.type==="text"&&(y==null?void 0:y.type)==="text"?(y.raw+=p.raw,y.text+=p.text):t.push(p);continue}if(p=this.tokenizer.emStrong(e,s,o)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.codespan(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.br(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.del(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.autolink(e)){e=e.substring(p.raw.length),t.push(p);continue}if(!this.state.inLink&&(p=this.tokenizer.url(e))){e=e.substring(p.raw.length),t.push(p);continue}let P=e;if((m=this.options.extensions)!=null&&m.startInline){let y=1/0,L=e.slice(1),M;this.options.extensions.startInline.forEach(z=>{M=z.call({lexer:this},L),typeof M=="number"&&M>=0&&(y=Math.min(y,M))}),y<1/0&&y>=0&&(P=e.substring(0,y+1))}if(p=this.tokenizer.inlineText(P)){e=e.substring(p.raw.length),p.raw.slice(-1)!=="_"&&(o=p.raw.slice(-1)),l=!0;let y=t.at(-1);(y==null?void 0:y.type)==="text"?(y.raw+=p.raw,y.text+=p.text):t.push(p);continue}if(e){let y="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(y);break}else throw new Error(y)}}return t}},gt=class{constructor(n){N(this,"options");N(this,"parser");this.options=n||ue}space(n){return""}code({text:n,lang:e,escaped:t}){var i;let s=(i=(e||"").match(an.notSpaceStart))==null?void 0:i[0],r=n.replace(an.endingNewline,"")+`
...
## 记录时间
2026-02-07 22:45
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5}}},Ha={class:"container"},Va={class:"site-header"},Ka={class:"stats"},qa={class:"stat"},Ja={class:"stat-num"},Ya={class:"stat"},Qa={class:"stat-num"},Za={class:"stat"},Xa={class:"stat-num"},nc={class:"filter-bar"},ec=["onClick"],tc={key:0,class:"note-list"},sc=["onClick"],rc={class:"note-meta"},ic={class:"note-date"},oc={class:"note-title"},lc={key:0,class:"note-summary"},ac={key:1,class:"empty-state"},cc={class:"detail-header"},uc={class:"detail-title"},fc={class:"detail-meta"},hc={class:"note-date"},pc=["innerHTML"],dc={__name:"App",setup(n){j.setOptions({breaks:!1,gfm:!0});const e=br.notes,t=br.categories,s=Gt(null),r=Gt(null),i=Gt("加载中..."),l=it(()=>new Set(e.map(p=>p.date)).size),o=it(()=>s.value?e.filter(m=>m.category===s.value):e),a=it(()=>r.value?j(r.value.content):"");async function u(){try{const m=await fetch("https://api.countapi.xyz/get/erzi-knowledge/visits");if(m.ok){const p=await m.json();i.value=p.value}else{const p=await fetch("https://api.countapi.xyz/hit/erzi-knowledge/visits");if(p.ok){const P=await p.json();i.value=P.value}}}catch(m){console.error("访问统计加载失败:",m),i.value="统计不可用"}}ni(()=>{u(),fetch("https://api.countapi.xyz/hit/erzi-knowledge/visits").catch(()=>{})});function f(m){r.value=m,Kt(()=>window.scrollTo(0,0))}function d(){r.value=null,Kt(()=>window.scrollTo(0,0))}return(m,p)=>{var P;return In(),_n("div",Ha,[r.value?(In(),_n(hn,{key:1},[O("div",cc,[O("button",{class:"back-btn",onClick:d},[...p[7]||(p[7]=[O("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[O("polyline",{points:"15 18 9 12 15 6"})],-1),pe(" 返回 ",-1)])]),O("h1",uc,An(r.value.title),1),O("div",fc,[O("span",{class:ie(["note-category","note-category--"+r.value.category])},An((P=_e(t)[r.value.category])==null?void 0:P.label),3),O("span",hc,An(r.value.date),1)])]),O("div",{class:"note-content",innerHTML:a.value},null,8,pc),O("footer",{class:"site-footer"},[O("button",{class:"back-btn",onClick:d},[...p[8]||(p[8]=[O("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[O("polyline",{points:"15 18 9 12 15 6"})],-1),pe(" 返回列表 ",-1)])])])],64)):(In(),_n(hn,{key:0},[O("header",Va,[p[4]||(p[4]=O("div",{class:"site-title"},"二子的知识库",-1)),p[5]||(p[5]=O("div",{class:"site-subtitle"},"跟二子一起学习",-1)),O("div",Ka,[O("span",qa,[O("span",Ja,An(_e(e).length),1),p[1]||(p[1]=pe(" 篇笔记",-1))]),O("span",Ya,[O("span",Qa,An(l.value),1),p[2]||(p[2]=pe(" 天探索",-1))]),O("span",Za,[O("span",Xa,An(i.value),1),p[3]||(p[3]=pe(" 次访问",-1))])])]),O("div",nc,[O("button",{class:ie(["filter-btn",{active:s.value===null}]),onClick:p[0]||(p[0]=y=>s.value=null)},"全部",2),(In(!0),_n(hn,null,Us(_e(t),(y,L)=>(In(),_n("button",{key:L,class:ie(["filter-btn",{active:s.value===L}]),onClick:M=>s.value=L},An(y.label),11,ec))),128))]),o.value.length?(In(),_n("div",tc,[(In(!0),_n(hn,null,Us(o.value,y=>{var L;return In(),_n("div",{key:y.id+y.category,class:"note-item",onClick:M=>f(y)},[O("div",rc,[O("span",{class:ie(["note-category","note-category--"+y.category])},An((L=_e(t)[y.category])==null?void 0:L.label),3),O("span",ic,An(y.date),1)]),O("div",oc,An(y.title),1),y.summary?(In(),_n("div",lc,An(y.summary),1)):vl("",!0)],8,sc)}),128))])):(In(),_n("div",ac," 暂无笔记 ")),p[6]||(p[6]=O("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};ia(dc).mount("#app");
