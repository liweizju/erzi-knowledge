...
* @license MIT
**/function ii(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const J={},ge=[],Bn=()=>{},vs=()=>!1,ft=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),si=n=>n.startsWith("onUpdate:"),en=Object.assign,ri=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},zr=Object.prototype.hasOwnProperty,N=(n,e)=>zr.call(n,e),D=Array.isArray,pe=n=>ze(n)==="[object Map]",Ss=n=>ze(n)==="[object Set]",Fi=n=>ze(n)==="[object Date]",G=n=>typeof n=="function",Y=n=>typeof n=="string",En=n=>typeof n=="symbol",$=n=>n!==null&&typeof n=="object",Ps=n=>($(n)||G(n))&&G(n.then)&&G(n.catch),ks=Object.prototype.toString,ze=n=>ks.call(n),$r=n=>ze(n).slice(8,-1),Cs=n=>ze(n)==="[object Object]",oi=n=>Y(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,De=ii(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),mt=n=>{const e=Object.create(null);return(t=>e[t]||(e[t]=n(t)))},jr=/-\w/g,Qn=mt(n=>n.replace(jr,e=>e.slice(1).toUpperCase())),Kr=/\B([A-Z])/g,Ae=mt(n=>n.replace(Kr,"-$1").toLowerCase()),Ts=mt(n=>n.charAt(0).toUpperCase()+n.slice(1)),Rt=mt(n=>n?`on${Ts(n)}`:""),qn=(n,e)=>!Object.is(n,e),xt=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},Ms=(n,e,t,i=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:i,value:t})},Xr=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Wi;const yt=()=>Wi||(Wi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function ai(n){if(D(n)){const e={};for(let t=0;t<n.length;t++){const i=n[t],s=Y(i)?Yr(i):ai(i);if(s)for(const r in s)e[r]=s[r]}return e}else if(Y(n)||$(n))return n}const Jr=/;(?![^(]*\))/g,qr=/:([^]+)/,Qr=/\/\*[^]*?\*\//g;function Yr(n){const e={};return n.replace(Qr,"").split(Jr).forEach(t=>{if(t){const i=t.split(qr);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function oe(n){let e="";if(Y(n))e=n;else if(D(n))for(let t=0;t<n.length;t++){const i=oe(n[t]);i&&(e+=i+" ")}else if($(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const Zr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",no=ii(Zr);function Rs(n){return!!n||n===""}function eo(n,e){if(n.length!==e.length)return!1;let t=!0;for(let i=0;t&&i<n.length;i++)t=li(n[i],e[i]);return t}function li(n,e){if(n===e)return!0;let t=Fi(n),i=Fi(e);if(t||i)return t&&i?n.getTime()===e.getTime():!1;if(t=En(n),i=En(e),t||i)return n===e;if(t=D(n),i=D(e),t||i)return t&&i?eo(n,e):!1;if(t=$(n),i=$(e),t||i){if(!t||!i)return!1;const s=Object.keys(n).length,r=Object.keys(e).length;if(s!==r)return!1;for(const a in n){const o=n.hasOwnProperty(a),l=e.hasOwnProperty(a);if(o&&!l||!o&&l||!li(n[a],e[a]))return!1}}return String(n)===String(e)}const xs=n=>!!(n&&n.__v_isRef===!0),fn=n=>Y(n)?n:n==null?"":D(n)||$(n)&&(n.toString===ks||!G(n.toString))?xs(n)?fn(n.value):JSON.stringify(n,Ls,2):String(n),Ls=(n,e)=>xs(e)?Ls(n,e.value):pe(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[i,s],r)=>(t[Lt(i,r)+" =>"]=s,t),{})}:Ss(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>Lt(t))}:En(e)?Lt(e):$(e)&&!D(e)&&!Cs(e)?String(e):e,Lt=(n,e="")=>{var t;return En(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let dn;class to{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=dn,!e&&dn&&(this.index=(dn.scopes||(dn.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=dn;try{return dn=this,e()}finally{dn=t}}}on(){++this._on===1&&(this.prevScope=dn,dn=this)}off(){this._on>0&&--this._on===0&&(dn=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function io(){return dn}let X;const Dt=new WeakSet;class Ds{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,dn&&dn.active&&dn.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Dt.has(this)&&(Dt.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Bs(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Ni(this),Es(this);const e=X,t=vn;X=this,vn=!0;try{return this.fn()}finally{Us(this),X=e,vn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ui(e);this.deps=this.depsTail=void 0,Ni(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Dt.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ht(this)&&this.run()}get dirty(){return Ht(this)}}let Gs=0,Ge,Be;function Bs(n,e=!1){if(n.flags|=8,e){n.next=Be,Be=n;return}n.next=Ge,Ge=n}function ci(){Gs++}function Ai(){if(--Gs>0)return;if(Be){let e=Be;for(Be=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;Ge;){let e=Ge;for(Ge=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(i){n||(n=i)}e=t}}if(n)throw n}function Es(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Us(n){let e,t=n.depsTail,i=t;for(;i;){const s=i.prevDep;i.version===-1?(i===t&&(t=s),ui(i),so(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}n.deps=e,n.depsTail=t}function Ht(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(_s(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function _s(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===We)||(n.globalVersion=We,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Ht(n))))return;n.flags|=2;const e=n.dep,t=X,i=vn;X=n,vn=!0;try{Es(n);const s=n.fn(n._value);(e.version===0||qn(s,n._value))&&(n.flags|=128,n._value=s,e.version++)}catch(s){throw e.version++,s}finally{X=t,vn=i,Us(n),n.flags&=-3}}function ui(n,e=!1){const{dep:t,prevSub:i,nextSub:s}=n;if(i&&(i.nextSub=s,n.prevSub=void 0),s&&(s.prevSub=i,n.nextSub=void 0),t.subs===n&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)ui(r,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function so(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let vn=!0;const Fs=[];function Vn(){Fs.push(vn),vn=!1}function zn(){const n=Fs.pop();vn=n===void 0?!0:n}function Ni(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=X;X=void 0;try{e()}finally{X=t}}}let We=0;class ro{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Ii{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!X||!vn||X===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==X)t=this.activeLink=new ro(X,this),X.deps?(t.prevDep=X.depsTail,X.depsTail.nextDep=t,X.depsTail=t):X.deps=X.depsTail=t,Ws(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=X.depsTail,t.nextDep=void 0,X.depsTail.nextDep=t,X.depsTail=t,X.deps===t&&(X.deps=i)}return t}trigger(e){this.version++,We++,this.notify(e)}notify(e){ci();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{Ai()}}}function Ws(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)Ws(i)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Vt=new WeakMap,ae=Symbol(""),zt=Symbol(""),Ne=Symbol("");function Z(n,e,t){if(vn&&X){let i=Vt.get(n);i||Vt.set(n,i=new Map);let s=i.get(t);s||(i.set(t,s=new Ii),s.map=i,s.key=t),s.track()}}function On(n,e,t,i,s,r){const a=Vt.get(n);if(!a){We++;return}const o=l=>{l&&l.trigger()};if(ci(),e==="clear")a.forEach(o);else{const l=D(n),A=l&&oi(t);if(l&&t==="length"){const u=Number(i);a.forEach((h,p)=>{(p==="length"||p===Ne||!En(p)&&p>=u)&&o(h)})}else switch((t!==void 0||a.has(void 0))&&o(a.get(t)),A&&o(a.get(Ne)),e){case"add":l?A&&o(a.get("length")):(o(a.get(ae)),pe(n)&&o(a.get(zt)));break;case"delete":l||(o(a.get(ae)),pe(n)&&o(a.get(zt)));break;case"set":pe(n)&&o(a.get(ae));break}}Ai()}function Ie(n){const e=W(n);return e===n?e:(Z(e,"iterate",Ne),mn(n)?e:e.map(Sn))}function bt(n){return Z(n=W(n),"iterate",Ne),n}function Kn(n,e){return $n(n)?ye(le(n)?Sn(e):e):Sn(e)}const oo={__proto__:null,[Symbol.iterator](){return Gt(this,Symbol.iterator,n=>Kn(this,n))},concat(...n){return Ie(this).concat(...n.map(e=>D(e)?Ie(e):e))},entries(){return Gt(this,"entries",n=>(n[1]=Kn(this,n[1]),n))},every(n,e){return _n(this,"every",n,e,void 0,arguments)},filter(n,e){return _n(this,"filter",n,e,t=>t.map(i=>Kn(this,i)),arguments)},find(n,e){return _n(this,"find",n,e,t=>Kn(this,t),arguments)},findIndex(n,e){return _n(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return _n(this,"findLast",n,e,t=>Kn(this,t),arguments)},findLastIndex(n,e){return _n(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return _n(this,"forEach",n,e,void 0,arguments)},includes(...n){return Bt(this,"includes",n)},indexOf(...n){return Bt(this,"indexOf",n)},join(n){return Ie(this).join(n)},lastIndexOf(...n){return Bt(this,"lastIndexOf",n)},map(n,e){return _n(this,"map",n,e,void 0,arguments)},pop(){return ke(this,"pop")},push(...n){return ke(this,"push",n)},reduce(n,...e){return Oi(this,"reduce",n,e)},reduceRight(n,...e){return Oi(this,"reduceRight",n,e)},shift(){return ke(this,"shift")},some(n,e){return _n(this,"some",n,e,void 0,arguments)},splice(...n){return ke(this,"splice",n)},toReversed(){return Ie(this).toReversed()},toSorted(n){return Ie(this).toSorted(n)},toSpliced(...n){return Ie(this).toSpliced(...n)},unshift(...n){return ke(this,"unshift",n)},values(){return Gt(this,"values",n=>Kn(this,n))}};function Gt(n,e,t){const i=bt(n),s=i[e]();return i!==n&&!mn(n)&&(s._next=s.next,s.next=()=>{const r=s._next();return r.done||(r.value=t(r.value)),r}),s}const ao=Array.prototype;function _n(n,e,t,i,s,r){const a=bt(n),o=a!==n&&!mn(n),l=a[e];if(l!==ao[e]){const h=l.apply(n,r);return o?Sn(h):h}let A=t;a!==n&&(o?A=function(h,p){return t.call(this,Kn(n,h),p,n)}:t.length>2&&(A=function(h,p){return t.call(this,h,p,n)}));const u=l.call(a,A,i);return o&&s?s(u):u}function Oi(n,e,t,i){const s=bt(n);let r=t;return s!==n&&(mn(n)?t.length>3&&(r=function(a,o,l){return t.call(this,a,o,l,n)}):r=function(a,o,l){return t.call(this,a,Kn(n,o),l,n)}),s[e](r,...i)}function Bt(n,e,t){const i=W(n);Z(i,"iterate",Ne);const s=i[e](...t);return(s===-1||s===!1)&&pi(t[0])?(t[0]=W(t[0]),i[e](...t)):s}function ke(n,e,t=[]){Vn(),ci();const i=W(n)[e].apply(n,t);return Ai(),zn(),i}const lo=ii("__proto__,__v_isRef,__isVue"),Ns=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(En));function co(n){En(n)||(n=String(n));const e=W(this);return Z(e,"has",n),e.hasOwnProperty(n)}class Os{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,i){if(t==="__v_skip")return e.__v_skip;const s=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return r;if(t==="__v_raw")return i===(s?r?bo:$s:r?zs:Vs).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const a=D(e);if(!s){let l;if(a&&(l=oo[t]))return l;if(t==="hasOwnProperty")return co}const o=Reflect.get(e,t,nn(e)?e:i);if((En(t)?Ns.has(t):lo(t))||(s||Z(e,"get",t),r))return o;if(nn(o)){const l=a&&oi(t)?o:o.value;return s&&$(l)?jt(l):l}return $(o)?s?jt(o):hi(o):o}}class Hs extends Os{constructor(e=!1){super(!1,e)}set(e,t,i,s){let r=e[t];const a=D(e)&&oi(t);if(!this._isShallow){const A=$n(r);if(!mn(i)&&!$n(i)&&(r=W(r),i=W(i)),!a&&nn(r)&&!nn(i))return A||(r.value=i),!0}const o=a?Number(t)<e.length:N(e,t),l=Reflect.set(e,t,i,nn(e)?e:s);return e===W(s)&&(o?qn(i,r)&&On(e,"set",t,i):On(e,"add",t,i)),l}deleteProperty(e,t){const i=N(e,t);e[t];const s=Reflect.deleteProperty(e,t);return s&&i&&On(e,"delete",t,void 0),s}has(e,t){const i=Reflect.has(e,t);return(!En(t)||!Ns.has(t))&&Z(e,"has",t),i}ownKeys(e){return Z(e,"iterate",D(e)?"length":ae),Reflect.ownKeys(e)}}class Ao extends Os{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const uo=new Hs,Io=new Ao,ho=new Hs(!0);const $t=n=>n,Ze=n=>Reflect.getPrototypeOf(n);function go(n,e,t){return function(...i){const s=this.__v_raw,r=W(s),a=pe(r),o=n==="entries"||n===Symbol.iterator&&a,l=n==="keys"&&a,A=s[n](...i),u=t?$t:e?ye:Sn;return!e&&Z(r,"iterate",l?zt:ae),en(Object.create(A),{next(){const{value:h,done:p}=A.next();return p?{value:h,done:p}:{value:o?[u(h[0]),u(h[1])]:u(h),done:p}}})}}function nt(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function po(n,e){const t={get(s){const r=this.__v_raw,a=W(r),o=W(s);n||(qn(s,o)&&Z(a,"get",s),Z(a,"get",o));const{has:l}=Ze(a),A=e?$t:n?ye:Sn;if(l.call(a,s))return A(r.get(s));if(l.call(a,o))return A(r.get(o));r!==a&&r.get(s)},get size(){const s=this.__v_raw;return!n&&Z(W(s),"iterate",ae),s.size},has(s){const r=this.__v_raw,a=W(r),o=W(s);return n||(qn(s,o)&&Z(a,"has",s),Z(a,"has",o)),s===o?r.has(s):r.has(s)||r.has(o)},forEach(s,r){const a=this,o=a.__v_raw,l=W(o),A=e?$t:n?ye:Sn;return!n&&Z(l,"iterate",ae),o.forEach((u,h)=>s.call(r,A(u),A(h),a))}};return en(t,n?{add:nt("add"),set:nt("set"),delete:nt("delete"),clear:nt("clear")}:{add(s){!e&&!mn(s)&&!$n(s)&&(s=W(s));const r=W(this);return Ze(r).has.call(r,s)||(r.add(s),On(r,"add",s,s)),this},set(s,r){!e&&!mn(r)&&!$n(r)&&(r=W(r));const a=W(this),{has:o,get:l}=Ze(a);let A=o.call(a,s);A||(s=W(s),A=o.call(a,s));const u=l.call(a,s);return a.set(s,r),A?qn(r,u)&&On(a,"set",s,r):On(a,"add",s,r),this},delete(s){const r=W(this),{has:a,get:o}=Ze(r);let l=a.call(r,s);l||(s=W(s),l=a.call(r,s)),o&&o.call(r,s);const A=r.delete(s);return l&&On(r,"delete",s,void 0),A},clear(){const s=W(this),r=s.size!==0,a=s.clear();return r&&On(s,"clear",void 0,void 0),a}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=go(s,n,e)}),t}function di(n,e){const t=po(n,e);return(i,s,r)=>s==="__v_isReactive"?!n:s==="__v_isReadonly"?n:s==="__v_raw"?i:Reflect.get(N(t,s)&&s in i?t:i,s,r)}const fo={get:di(!1,!1)},mo={get:di(!1,!0)},yo={get:di(!0,!1)};const Vs=new WeakMap,zs=new WeakMap,$s=new WeakMap,bo=new WeakMap;function wo(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function vo(n){return n.__v_skip||!Object.isExtensible(n)?0:wo($r(n))}function hi(n){return $n(n)?n:gi(n,!1,uo,fo,Vs)}function So(n){return gi(n,!1,ho,mo,zs)}function jt(n){return gi(n,!0,Io,yo,$s)}function gi(n,e,t,i,s){if(!$(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const r=vo(n);if(r===0)return n;const a=s.get(n);if(a)return a;const o=new Proxy(n,r===2?i:t);return s.set(n,o),o}function le(n){return $n(n)?le(n.__v_raw):!!(n&&n.__v_isReactive)}function $n(n){return!!(n&&n.__v_isReadonly)}function mn(n){return!!(n&&n.__v_isShallow)}function pi(n){return n?!!n.__v_raw:!1}function W(n){const e=n&&n.__v_raw;return e?W(e):n}function Po(n){return!N(n,"__v_skip")&&Object.isExtensible(n)&&Ms(n,"__v_skip",!0),n}const Sn=n=>$(n)?hi(n):n,ye=n=>$(n)?jt(n):n;function nn(n){return n?n.__v_isRef===!0:!1}function Et(n){return ko(n,!1)}function ko(n,e){return nn(n)?n:new Co(n,e)}class Co{constructor(e,t){this.dep=new Ii,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:W(e),this._value=t?e:Sn(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,i=this.__v_isShallow||mn(e)||$n(e);e=i?e:W(e),qn(e,t)&&(this._rawValue=e,this._value=i?e:Sn(e),this.dep.trigger())}}function Re(n){return nn(n)?n.value:n}const To={get:(n,e,t)=>e==="__v_raw"?n:Re(Reflect.get(n,e,t)),set:(n,e,t,i)=>{const s=n[e];return nn(s)&&!nn(t)?(s.value=t,!0):Reflect.set(n,e,t,i)}};function js(n){return le(n)?n:new Proxy(n,To)}class Mo{constructor(e,t,i){this.fn=e,this.setter=t,this._value=void 0,this.dep=new Ii(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=We-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&X!==this)return Bs(this,!0),!0}get value(){const e=this.dep.track();return _s(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function Ro(n,e,t=!1){let i,s;return G(n)?i=n:(i=n.get,s=n.set),new Mo(i,s,t)}const et={},lt=new WeakMap;let se;function xo(n,e=!1,t=se){if(t){let i=lt.get(t);i||lt.set(t,i=[]),i.push(n)}}function Lo(n,e,t=J){const{immediate:i,deep:s,once:r,scheduler:a,augmentJob:o,call:l}=t,A=R=>s?R:mn(R)||s===!1||s===0?Jn(R,1):Jn(R);let u,h,p,d,C=!1,w=!1;if(nn(n)?(h=()=>n.value,C=mn(n)):le(n)?(h=()=>A(n),C=!0):D(n)?(w=!0,C=n.some(R=>le(R)||mn(R)),h=()=>n.map(R=>{if(nn(R))return R.value;if(le(R))return A(R);if(G(R))return l?l(R,2):R()})):G(n)?e?h=l?()=>l(n,2):n:h=()=>{if(p){Vn();try{p()}finally{zn()}}const R=se;se=u;try{return l?l(n,3,[d]):n(d)}finally{se=R}}:h=Bn,e&&s){const R=h,Q=s===!0?1/0:s;h=()=>Jn(R(),Q)}const x=io(),_=()=>{u.stop(),x&&x.active&&ri(x.effects,u)};if(r&&e){const R=e;e=(...Q)=>{R(...Q),_()}}let B=w?new Array(n.length).fill(et):et;const V=R=>{if(!(!(u.flags&1)||!u.dirty&&!R))if(e){const Q=u.run();if(s||C||(w?Q.some((Pn,ln)=>qn(Pn,B[ln])):qn(Q,B))){p&&p();const Pn=se;se=u;try{const ln=[Q,B===et?void 0:w&&B[0]===et?[]:B,d];B=Q,l?l(e,3,ln):e(...ln)}finally{se=Pn}}}else u.run()};return o&&o(V),u=new Ds(h),u.scheduler=a?()=>a(V,!1):V,d=R=>xo(R,!1,u),p=u.onStop=()=>{const R=lt.get(u);if(R){if(l)l(R,4);else for(const Q of R)Q();lt.delete(u)}},e?i?V(!0):B=u.run():a?a(V.bind(null,!0),!0):u.run(),_.pause=u.pause.bind(u),_.resume=u.resume.bind(u),_.stop=_,_}function Jn(n,e=1/0,t){if(e<=0||!$(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,nn(n))Jn(n.value,e,t);else if(D(n))for(let i=0;i<n.length;i++)Jn(n[i],e,t);else if(Ss(n)||pe(n))n.forEach(i=>{Jn(i,e,t)});else if(Cs(n)){for(const i in n)Jn(n[i],e,t);for(const i of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,i)&&Jn(n[i],e,t)}return n}/**
* @vue/runtime-core v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function $e(n,e,t,i){try{return i?n(...i):n()}catch(s){wt(s,e,t)}}function Un(n,e,t,i){if(G(n)){const s=$e(n,e,t,i);return s&&Ps(s)&&s.catch(r=>{wt(r,e,t)}),s}if(D(n)){const s=[];for(let r=0;r<n.length;r++)s.push(Un(n[r],e,t,i));return s}}function wt(n,e,t,i=!0){const s=e?e.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:a}=e&&e.appContext.config||J;if(e){let o=e.parent;const l=e.proxy,A=`https://vuejs.org/error-reference/#runtime-${t}`;for(;o;){const u=o.ec;if(u){for(let h=0;h<u.length;h++)if(u[h](n,l,A)===!1)return}o=o.parent}if(r){Vn(),$e(r,null,10,[n,l,A]),zn();return}}Do(n,t,s,i,a)}function Do(n,e,t,i=!0,s=!1){if(s)throw n;console.error(n)}const rn=[];let Ln=-1;const fe=[];let Xn=null,de=0;const Ks=Promise.resolve();let ct=null;function Kt(n){const e=ct||Ks;return n?e.then(this?n.bind(this):n):e}function Go(n){let e=Ln+1,t=rn.length;for(;e<t;){const i=e+t>>>1,s=rn[i],r=Oe(s);r<n||r===n&&s.flags&2?e=i+1:t=i}return e}function fi(n){if(!(n.flags&1)){const e=Oe(n),t=rn[rn.length-1];!t||!(n.flags&2)&&e>=Oe(t)?rn.push(n):rn.splice(Go(e),0,n),n.flags|=1,Xs()}}function Xs(){ct||(ct=Ks.then(qs))}function Bo(n){D(n)?fe.push(...n):Xn&&n.id===-1?Xn.splice(de+1,0,n):n.flags&1||(fe.push(n),n.flags|=1),Xs()}function Hi(n,e,t=Ln+1){for(;t<rn.length;t++){const i=rn[t];if(i&&i.flags&2){if(n&&i.id!==n.uid)continue;rn.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Js(n){if(fe.length){const e=[...new Set(fe)].sort((t,i)=>Oe(t)-Oe(i));if(fe.length=0,Xn){Xn.push(...e);return}for(Xn=e,de=0;de<Xn.length;de++){const t=Xn[de];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Xn=null,de=0}}const Oe=n=>n.id==null?n.flags&2?-1:1/0:n.id;function qs(n){try{for(Ln=0;Ln<rn.length;Ln++){const e=rn[Ln];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),$e(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Ln<rn.length;Ln++){const e=rn[Ln];e&&(e.flags&=-2)}Ln=-1,rn.length=0,Js(),ct=null,(rn.length||fe.length)&&qs()}}let Gn=null,Qs=null;function At(n){const e=Gn;return Gn=n,Qs=n&&n.type.__scopeId||null,e}function Eo(n,e=Gn,t){if(!e||n._n)return n;const i=(...s)=>{i._d&&ns(-1);const r=At(e);let a;try{a=n(...s)}finally{At(r),i._d&&ns(1)}return a};return i._n=!0,i._c=!0,i._d=!0,i}function te(n,e,t,i){const s=n.dirs,r=e&&e.dirs;for(let a=0;a<s.length;a++){const o=s[a];r&&(o.oldValue=r[a].value);let l=o.dir[i];l&&(Vn(),Un(l,t,8,[n.el,o,n,e]),zn())}}function Uo(n,e){if(on){let t=on.provides;const i=on.parent&&on.parent.provides;i===t&&(t=on.provides=Object.create(i)),t[n]=e}}function st(n,e,t=!1){const i=Ua();if(i||me){let s=me?me._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&n in s)return s[n];if(arguments.length>1)return t&&G(e)?e.call(i&&i.proxy):e}}const _o=Symbol.for("v-scx"),Fo=()=>st(_o);function Ut(n,e,t){return Ys(n,e,t)}function Ys(n,e,t=J){const{immediate:i,deep:s,flush:r,once:a}=t,o=en({},t),l=e&&i||!e&&r!=="post";let A;if(Ve){if(r==="sync"){const d=Fo();A=d.__watcherHandles||(d.__watcherHandles=[])}else if(!l){const d=()=>{};return d.stop=Bn,d.resume=Bn,d.pause=Bn,d}}const u=on;o.call=(d,C,w)=>Un(d,u,C,w);let h=!1;r==="post"?o.scheduler=d=>{In(d,u&&u.suspense)}:r!=="sync"&&(h=!0,o.scheduler=(d,C)=>{C?d():fi(d)}),o.augmentJob=d=>{e&&(d.flags|=4),h&&(d.flags|=2,u&&(d.id=u.uid,d.i=u))};const p=Lo(n,e,o);return Ve&&(A?A.push(p):l&&p()),p}function Wo(n,e,t){const i=this.proxy,s=Y(n)?n.includes(".")?Zs(i,n):()=>i[n]:n.bind(i,i);let r;G(e)?r=e:(r=e.handler,t=e);const a=je(this),o=Ys(s,r.bind(i),t);return a(),o}function Zs(n,e){const t=e.split(".");return()=>{let i=n;for(let s=0;s<t.length&&i;s++)i=i[t[s]];return i}}const No=Symbol("_vte"),Oo=n=>n.__isTeleport,Ho=Symbol("_leaveCb");function mi(n,e){n.shapeFlag&6&&n.component?(n.transition=e,mi(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function nr(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Vi(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const ut=new WeakMap;function Ee(n,e,t,i,s=!1){if(D(n)){n.forEach((w,x)=>Ee(w,e&&(D(e)?e[x]:e),t,i,s));return}if(Ue(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&Ee(n,e,t,i.component.subTree);return}const r=i.shapeFlag&4?vi(i.component):i.el,a=s?null:r,{i:o,r:l}=n,A=e&&e.r,u=o.refs===J?o.refs={}:o.refs,h=o.setupState,p=W(h),d=h===J?vs:w=>Vi(u,w)?!1:N(p,w),C=(w,x)=>!(x&&Vi(u,x));if(A!=null&&A!==l){if(zi(e),Y(A))u[A]=null,d(A)&&(h[A]=null);else if(nn(A)){const w=e;C(A,w.k)&&(A.value=null),w.k&&(u[w.k]=null)}}if(G(l))$e(l,o,12,[a,u]);else{const w=Y(l),x=nn(l);if(w||x){const _=()=>{if(n.f){const B=w?d(l)?h[l]:u[l]:C()||!n.k?l.value:u[n.k];if(s)D(B)&&ri(B,r);else if(D(B))B.includes(r)||B.push(r);else if(w)u[l]=[r],d(l)&&(h[l]=u[l]);else{const V=[r];C(l,n.k)&&(l.value=V),n.k&&(u[n.k]=V)}}else w?(u[l]=a,d(l)&&(h[l]=a)):x&&(C(l,n.k)&&(l.value=a),n.k&&(u[n.k]=a))};if(a){const B=()=>{_(),ut.delete(n)};B.id=-1,ut.set(n,B),In(B,t)}else zi(n),_()}}}function zi(n){const e=ut.get(n);e&&(e.flags|=8,ut.delete(n))}yt().requestIdleCallback;yt().cancelIdleCallback;const Ue=n=>!!n.type.__asyncLoader,er=n=>n.type.__isKeepAlive;function Vo(n,e){tr(n,"a",e)}function zo(n,e){tr(n,"da",e)}function tr(n,e,t=on){const i=n.__wdc||(n.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return n()});if(vt(e,i,t),t){let s=t.parent;for(;s&&s.parent;)er(s.parent.vnode)&&$o(i,e,t,s),s=s.parent}}function $o(n,e,t,i){const s=vt(e,n,i,!0);sr(()=>{ri(i[e],s)},t)}function vt(n,e,t=on,i=!1){if(t){const s=t[n]||(t[n]=[]),r=e.__weh||(e.__weh=(...a)=>{Vn();const o=je(t),l=Un(e,t,n,a);return o(),zn(),l});return i?s.unshift(r):s.push(r),r}}const jn=n=>(e,t=on)=>{(!Ve||n==="sp")&&vt(n,(...i)=>e(...i),t)},jo=jn("bm"),ir=jn("m"),Ko=jn("bu"),Xo=jn("u"),Jo=jn("bum"),sr=jn("um"),qo=jn("sp"),Qo=jn("rtg"),Yo=jn("rtc");function Zo(n,e=on){vt("ec",n,e)}const na=Symbol.for("v-ndc");function $i(n,e,t,i){let s;const r=t,a=D(n);if(a||Y(n)){const o=a&&le(n);let l=!1,A=!1;o&&(l=!mn(n),A=$n(n),n=bt(n)),s=new Array(n.length);for(let u=0,h=n.length;u<h;u++)s[u]=e(l?A?ye(Sn(n[u])):Sn(n[u]):n[u],u,void 0,r)}else if(typeof n=="number"){s=new Array(n);for(let o=0;o<n;o++)s[o]=e(o+1,o,void 0,r)}else if($(n))if(n[Symbol.iterator])s=Array.from(n,(o,l)=>e(o,l,void 0,r));else{const o=Object.keys(n);s=new Array(o.length);for(let l=0,A=o.length;l<A;l++){const u=o[l];s[l]=e(n[u],u,l,r)}}else s=[];return s}const Xt=n=>n?kr(n)?vi(n):Xt(n.parent):null,_e=en(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Xt(n.parent),$root:n=>Xt(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>or(n),$forceUpdate:n=>n.f||(n.f=()=>{fi(n.update)}),$nextTick:n=>n.n||(n.n=Kt.bind(n.proxy)),$watch:n=>Wo.bind(n)}),_t=(n,e)=>n!==J&&!n.__isScriptSetup&&N(n,e),ea={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:i,data:s,props:r,accessCache:a,type:o,appContext:l}=n;if(e[0]!=="$"){const p=a[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return s[e];case 4:return t[e];case 3:return r[e]}else{if(_t(i,e))return a[e]=1,i[e];if(s!==J&&N(s,e))return a[e]=2,s[e];if(N(r,e))return a[e]=3,r[e];if(t!==J&&N(t,e))return a[e]=4,t[e];Jt&&(a[e]=0)}}const A=_e[e];let u,h;if(A)return e==="$attrs"&&Z(n.attrs,"get",""),A(n);if((u=o.__cssModules)&&(u=u[e]))return u;if(t!==J&&N(t,e))return a[e]=4,t[e];if(h=l.config.globalProperties,N(h,e))return h[e]},set({_:n},e,t){const{data:i,setupState:s,ctx:r}=n;return _t(s,e)?(s[e]=t,!0):i!==J&&N(i,e)?(i[e]=t,!0):N(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(r[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:i,appContext:s,props:r,type:a}},o){let l;return!!(t[o]||n!==J&&o[0]!=="$"&&N(n,o)||_t(e,o)||N(r,o)||N(i,o)||N(_e,o)||N(s.config.globalProperties,o)||(l=a.__cssModules)&&l[o])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:N(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function ji(n){return D(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Jt=!0;function ta(n){const e=or(n),t=n.proxy,i=n.ctx;Jt=!1,e.beforeCreate&&Ki(e.beforeCreate,n,"bc");const{data:s,computed:r,methods:a,watch:o,provide:l,inject:A,created:u,beforeMount:h,mounted:p,beforeUpdate:d,updated:C,activated:w,deactivated:x,beforeDestroy:_,beforeUnmount:B,destroyed:V,unmounted:R,render:Q,renderTracked:Pn,renderTriggered:ln,errorCaptured:cn,serverPrefetch:Xe,expose:Zn,inheritAttrs:we,components:Je,directives:qe,filters:Tt}=e;if(A&&ia(A,i,null),a)for(const q in a){const j=a[q];G(j)&&(i[q]=j.bind(t))}if(s){const q=s.call(t,t);$(q)&&(n.data=hi(q))}if(Jt=!0,r)for(const q in r){const j=r[q],ne=G(j)?j.bind(t,t):G(j.get)?j.get.bind(t,t):Bn,Qe=!G(j)&&G(j.set)?j.set.bind(t):Bn,ee=ot({get:ne,set:Qe});Object.defineProperty(i,q,{enumerable:!0,configurable:!0,get:()=>ee.value,set:kn=>ee.value=kn})}if(o)for(const q in o)rr(o[q],i,t,q);if(l){const q=G(l)?l.call(t):l;Reflect.ownKeys(q).forEach(j=>{Uo(j,q[j])})}u&&Ki(u,n,"c");function tn(q,j){D(j)?j.forEach(ne=>q(ne.bind(t))):j&&q(j.bind(t))}if(tn(jo,h),tn(ir,p),tn(Ko,d),tn(Xo,C),tn(Vo,w),tn(zo,x),tn(Zo,cn),tn(Yo,Pn),tn(Qo,ln),tn(Jo,B),tn(sr,R),tn(qo,Xe),D(Zn))if(Zn.length){const q=n.exposed||(n.exposed={});Zn.forEach(j=>{Object.defineProperty(q,j,{get:()=>t[j],set:ne=>t[j]=ne,enumerable:!0})})}else n.exposed||(n.exposed={});Q&&n.render===Bn&&(n.render=Q),we!=null&&(n.inheritAttrs=we),Je&&(n.components=Je),qe&&(n.directives=qe),Xe&&nr(n)}function ia(n,e,t=Bn){D(n)&&(n=qt(n));for(const i in n){const s=n[i];let r;$(s)?"default"in s?r=st(s.from||i,s.default,!0):r=st(s.from||i):r=st(s),nn(r)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:a=>r.value=a}):e[i]=r}}function Ki(n,e,t){Un(D(n)?n.map(i=>i.bind(e.proxy)):n.bind(e.proxy),e,t)}function rr(n,e,t,i){let s=i.includes(".")?Zs(t,i):()=>t[i];if(Y(n)){const r=e[n];G(r)&&Ut(s,r)}else if(G(n))Ut(s,n.bind(t));else if($(n))if(D(n))n.forEach(r=>rr(r,e,t,i));else{const r=G(n.handler)?n.handler.bind(t):e[n.handler];G(r)&&Ut(s,r,n)}}function or(n){const e=n.type,{mixins:t,extends:i}=e,{mixins:s,optionsCache:r,config:{optionMergeStrategies:a}}=n.appContext,o=r.get(e);let l;return o?l=o:!s.length&&!t&&!i?l=e:(l={},s.length&&s.forEach(A=>It(l,A,a,!0)),It(l,e,a)),$(e)&&r.set(e,l),l}function It(n,e,t,i=!1){const{mixins:s,extends:r}=e;r&&It(n,r,t,!0),s&&s.forEach(a=>It(n,a,t,!0));for(const a in e)if(!(i&&a==="expose")){const o=sa[a]||t&&t[a];n[a]=o?o(n[a],e[a]):e[a]}return n}const sa={data:Xi,props:Ji,emits:Ji,methods:xe,computed:xe,beforeCreate:sn,created:sn,beforeMount:sn,mounted:sn,beforeUpdate:sn,updated:sn,beforeDestroy:sn,beforeUnmount:sn,destroyed:sn,unmounted:sn,activated:sn,deactivated:sn,errorCaptured:sn,serverPrefetch:sn,components:xe,directives:xe,watch:oa,provide:Xi,inject:ra};function Xi(n,e){return e?n?function(){return en(G(n)?n.call(this,this):n,G(e)?e.call(this,this):e)}:e:n}function ra(n,e){return xe(qt(n),qt(e))}function qt(n){if(D(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function sn(n,e){return n?[...new Set([].concat(n,e))]:e}function xe(n,e){return n?en(Object.create(null),n,e):e}function Ji(n,e){return n?D(n)&&D(e)?[...new Set([...n,...e])]:en(Object.create(null),ji(n),ji(e??{})):e}function oa(n,e){if(!n)return e;if(!e)return n;const t=en(Object.create(null),n);for(const i in e)t[i]=sn(n[i],e[i]);return t}function ar(){return{app:null,config:{isNativeTag:vs,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let aa=0;function la(n,e){return function(i,s=null){G(i)||(i=en({},i)),s!=null&&!$(s)&&(s=null);const r=ar(),a=new WeakSet,o=[];let l=!1;const A=r.app={_uid:aa++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:Ha,get config(){return r.config},set config(u){},use(u,...h){return a.has(u)||(u&&G(u.install)?(a.add(u),u.install(A,...h)):G(u)&&(a.add(u),u(A,...h))),A},mixin(u){return r.mixins.includes(u)||r.mixins.push(u),A},component(u,h){return h?(r.components[u]=h,A):r.components[u]},directive(u,h){return h?(r.directives[u]=h,A):r.directives[u]},mount(u,h,p){if(!l){const d=A._ceVNode||Hn(i,s);return d.appContext=r,p===!0?p="svg":p===!1&&(p=void 0),n(d,u,p),l=!0,A._container=u,u.__vue_app__=A,vi(d.component)}},onUnmount(u){o.push(u)},unmount(){l&&(Un(o,A._instance,16),n(null,A._container),delete A._container.__vue_app__)},provide(u,h){return r.provides[u]=h,A},runWithContext(u){const h=me;me=A;try{return u()}finally{me=h}}};return A}}let me=null;const ca=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${Qn(e)}Modifiers`]||n[`${Ae(e)}Modifiers`];function Aa(n,e,...t){if(n.isUnmounted)return;const i=n.vnode.props||J;let s=t;const r=e.startsWith("update:"),a=r&&ca(i,e.slice(7));a&&(a.trim&&(s=t.map(u=>Y(u)?u.trim():u)),a.number&&(s=t.map(Xr)));let o,l=i[o=Rt(e)]||i[o=Rt(Qn(e))];!l&&r&&(l=i[o=Rt(Ae(e))]),l&&Un(l,n,6,s);const A=i[o+"Once"];if(A){if(!n.emitted)n.emitted={};else if(n.emitted[o])return;n.emitted[o]=!0,Un(A,n,6,s)}}const ua=new WeakMap;function lr(n,e,t=!1){const i=t?ua:e.emitsCache,s=i.get(n);if(s!==void 0)return s;const r=n.emits;let a={},o=!1;if(!G(n)){const l=A=>{const u=lr(A,e,!0);u&&(o=!0,en(a,u))};!t&&e.mixins.length&&e.mixins.forEach(l),n.extends&&l(n.extends),n.mixins&&n.mixins.forEach(l)}return!r&&!o?($(n)&&i.set(n,null),null):(D(r)?r.forEach(l=>a[l]=null):en(a,r),$(n)&&i.set(n,a),a)}function St(n,e){return!n||!ft(e)?!1:(e=e.slice(2).replace(/Once$/,""),N(n,e[0].toLowerCase()+e.slice(1))||N(n,Ae(e))||N(n,e))}function qi(n){const{type:e,vnode:t,proxy:i,withProxy:s,propsOptions:[r],slots:a,attrs:o,emit:l,render:A,renderCache:u,props:h,data:p,setupState:d,ctx:C,inheritAttrs:w}=n,x=At(n);let _,B;try{if(t.shapeFlag&4){const R=s||i,Q=R;_=Dn(A.call(Q,R,u,h,d,p,C)),B=o}else{const R=e;_=Dn(R.length>1?R(h,{attrs:o,slots:a,emit:l}):R(h,null)),B=e.props?o:Ia(o)}}catch(R){Fe.length=0,wt(R,n,1),_=Hn(Yn)}let V=_;if(B&&w!==!1){const R=Object.keys(B),{shapeFlag:Q}=V;R.length&&Q&7&&(r&&R.some(si)&&(B=da(B,r)),V=be(V,B,!1,!0))}return t.dirs&&(V=be(V,null,!1,!0),V.dirs=V.dirs?V.dirs.concat(t.dirs):t.dirs),t.transition&&mi(V,t.transition),_=V,At(x),_}const Ia=n=>{let e;for(const t in n)(t==="class"||t==="style"||ft(t))&&((e||(e={}))[t]=n[t]);return e},da=(n,e)=>{const t={};for(const i in n)(!si(i)||!(i.slice(9)in e))&&(t[i]=n[i]);return t};function ha(n,e,t){const{props:i,children:s,component:r}=n,{props:a,children:o,patchFlag:l}=e,A=r.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?Qi(i,a,A):!!a;if(l&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const p=u[h];if(cr(a,i,p)&&!St(A,p))return!0}}}else return(s||o)&&(!o||!o.$stable)?!0:i===a?!1:i?a?Qi(i,a,A):!0:!!a;return!1}function Qi(n,e,t){const i=Object.keys(e);if(i.length!==Object.keys(n).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(cr(e,n,r)&&!St(t,r))return!0}return!1}function cr(n,e,t){const i=n[t],s=e[t];return t==="style"&&$(i)&&$(s)?!li(i,s):i!==s}function ga({vnode:n,parent:e},t){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.el=n.el),i===n)(n=e.vnode).el=t,e=e.parent;else break}}const Ar={},ur=()=>Object.create(Ar),Ir=n=>Object.getPrototypeOf(n)===Ar;function pa(n,e,t,i=!1){const s={},r=ur();n.propsDefaults=Object.create(null),dr(n,e,s,r);for(const a in n.propsOptions[0])a in s||(s[a]=void 0);t?n.props=i?s:So(s):n.type.props?n.props=s:n.props=r,n.attrs=r}function fa(n,e,t,i){const{props:s,attrs:r,vnode:{patchFlag:a}}=n,o=W(s),[l]=n.propsOptions;let A=!1;if((i||a>0)&&!(a&16)){if(a&8){const u=n.vnode.dynamicProps;for(let h=0;h<u.length;h++){let p=u[h];if(St(n.emitsOptions,p))continue;const d=e[p];if(l)if(N(r,p))d!==r[p]&&(r[p]=d,A=!0);else{const C=Qn(p);s[C]=Qt(l,o,C,d,n,!1)}else d!==r[p]&&(r[p]=d,A=!0)}}}else{dr(n,e,s,r)&&(A=!0);let u;for(const h in o)(!e||!N(e,h)&&((u=Ae(h))===h||!N(e,u)))&&(l?t&&(t[h]!==void 0||t[u]!==void 0)&&(s[h]=Qt(l,o,h,void 0,n,!0)):delete s[h]);if(r!==o)for(const h in r)(!e||!N(e,h))&&(delete r[h],A=!0)}A&&On(n.attrs,"set","")}function dr(n,e,t,i){const[s,r]=n.propsOptions;let a=!1,o;if(e)for(let l in e){if(De(l))continue;const A=e[l];let u;s&&N(s,u=Qn(l))?!r||!r.includes(u)?t[u]=A:(o||(o={}))[u]=A:St(n.emitsOptions,l)||(!(l in i)||A!==i[l])&&(i[l]=A,a=!0)}if(r){const l=W(t),A=o||J;for(let u=0;u<r.length;u++){const h=r[u];t[h]=Qt(s,l,h,A[h],n,!N(A,h))}}return a}function Qt(n,e,t,i,s,r){const a=n[t];if(a!=null){const o=N(a,"default");if(o&&i===void 0){const l=a.default;if(a.type!==Function&&!a.skipFactory&&G(l)){const{propsDefaults:A}=s;if(t in A)i=A[t];else{const u=je(s);i=A[t]=l.call(null,e),u()}}else i=l;s.ce&&s.ce._setProp(t,i)}a[0]&&(r&&!o?i=!1:a[1]&&(i===""||i===Ae(t))&&(i=!0))}return i}const ma=new WeakMap;function hr(n,e,t=!1){const i=t?ma:e.propsCache,s=i.get(n);if(s)return s;const r=n.props,a={},o=[];let l=!1;if(!G(n)){const u=h=>{l=!0;const[p,d]=hr(h,e,!0);en(a,p),d&&o.push(...d)};!t&&e.mixins.length&&e.mixins.forEach(u),n.extends&&u(n.extends),n.mixins&&n.mixins.forEach(u)}if(!r&&!l)return $(n)&&i.set(n,ge),ge;if(D(r))for(let u=0;u<r.length;u++){const h=Qn(r[u]);Yi(h)&&(a[h]=J)}else if(r)for(const u in r){const h=Qn(u);if(Yi(h)){const p=r[u],d=a[h]=D(p)||G(p)?{type:p}:en({},p),C=d.type;let w=!1,x=!0;if(D(C))for(let _=0;_<C.length;++_){const B=C[_],V=G(B)&&B.name;if(V==="Boolean"){w=!0;break}else V==="String"&&(x=!1)}else w=G(C)&&C.name==="Boolean";d[0]=w,d[1]=x,(w||N(d,"default"))&&o.push(h)}}const A=[a,o];return $(n)&&i.set(n,A),A}function Yi(n){return n[0]!=="$"&&!De(n)}const yi=n=>n==="_"||n==="_ctx"||n==="$stable",bi=n=>D(n)?n.map(Dn):[Dn(n)],ya=(n,e,t)=>{if(e._n)return e;const i=Eo((...s)=>bi(e(...s)),t);return i._c=!1,i},gr=(n,e,t)=>{const i=n._ctx;for(const s in n){if(yi(s))continue;const r=n[s];if(G(r))e[s]=ya(s,r,i);else if(r!=null){const a=bi(r);e[s]=()=>a}}},pr=(n,e)=>{const t=bi(e);n.slots.default=()=>t},fr=(n,e,t)=>{for(const i in e)(t||!yi(i))&&(n[i]=e[i])},ba=(n,e,t)=>{const i=n.slots=ur();if(n.vnode.shapeFlag&32){const s=e._;s?(fr(i,e,t),t&&Ms(i,"_",s,!0)):gr(e,i)}else e&&pr(n,e)},wa=(n,e,t)=>{const{vnode:i,slots:s}=n;let r=!0,a=J;if(i.shapeFlag&32){const o=e._;o?t&&o===1?r=!1:fr(s,e,t):(r=!e.$stable,gr(e,s)),a=e}else e&&(pr(n,e),a={default:1});if(r)for(const o in s)!yi(o)&&a[o]==null&&delete s[o]},In=Ca;function va(n){return Sa(n)}function Sa(n,e){const t=yt();t.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:a,createText:o,createComment:l,setText:A,setElementText:u,parentNode:h,nextSibling:p,setScopeId:d=Bn,insertStaticContent:C}=n,w=(c,I,g,b=null,f=null,m=null,P=void 0,S=null,v=!!I.dynamicChildren)=>{if(c===I)return;c&&!Ce(c,I)&&(b=Ye(c),kn(c,f,m,!0),c=null),I.patchFlag===-2&&(v=!1,I.dynamicChildren=null);const{type:y,ref:M,shapeFlag:k}=I;switch(y){case Pt:x(c,I,g,b);break;case Yn:_(c,I,g,b);break;case Wt:c==null&&B(I,g,b,P);break;case gn:Je(c,I,g,b,f,m,P,S,v);break;default:k&1?Q(c,I,g,b,f,m,P,S,v):k&6?qe(c,I,g,b,f,m,P,S,v):(k&64||k&128)&&y.process(c,I,g,b,f,m,P,S,v,Se)}M!=null&&f?Ee(M,c&&c.ref,m,I||c,!I):M==null&&c&&c.ref!=null&&Ee(c.ref,null,m,c,!0)},x=(c,I,g,b)=>{if(c==null)i(I.el=o(I.children),g,b);else{const f=I.el=c.el;I.children!==c.children&&A(f,I.children)}},_=(c,I,g,b)=>{c==null?i(I.el=l(I.children||""),g,b):I.el=c.el},B=(c,I,g,b)=>{[c.el,c.anchor]=C(c.children,I,g,b,c.el,c.anchor)},V=({el:c,anchor:I},g,b)=>{let f;for(;c&&c!==I;)f=p(c),i(c,g,b),c=f;i(I,g,b)},R=({el:c,anchor:I})=>{let g;for(;c&&c!==I;)g=p(c),s(c),c=g;s(I)},Q=(c,I,g,b,f,m,P,S,v)=>{if(I.type==="svg"?P="svg":I.type==="math"&&(P="mathml"),c==null)Pn(I,g,b,f,m,P,S,v);else{const y=c.el&&c.el._isVueCE?c.el:null;try{y&&y._beginPatch(),Xe(c,I,f,m,P,S,v)}finally{y&&y._endPatch()}}},Pn=(c,I,g,b,f,m,P,S)=>{let v,y;const{props:M,shapeFlag:k,transition:T,dirs:L}=c;if(v=c.el=a(c.type,m,M&&M.is,M),k&8?u(v,c.children):k&16&&cn(c.children,v,null,b,f,Ft(c,m),P,S),L&&te(c,null,b,"created"),ln(v,c,c.scopeId,P,b),M){for(const K in M)K!=="value"&&!De(K)&&r(v,K,null,M[K],m,b);"value"in M&&r(v,"value",null,M.value,m),(y=M.onVnodeBeforeMount)&&xn(y,b,c)}L&&te(c,null,b,"beforeMount");const E=Pa(f,T);E&&T.beforeEnter(v),i(v,I,g),((y=M&&M.onVnodeMounted)||E||L)&&In(()=>{y&&xn(y,b,c),E&&T.enter(v),L&&te(c,null,b,"mounted")},f)},ln=(c,I,g,b,f)=>{if(g&&d(c,g),b)for(let m=0;m<b.length;m++)d(c,b[m]);if(f){let m=f.subTree;if(I===m||wr(m.type)&&(m.ssContent===I||m.ssFallback===I)){const P=f.vnode;ln(c,P,P.scopeId,P.slotScopeIds,f.parent)}}},cn=(c,I,g,b,f,m,P,S,v=0)=>{for(let y=v;y<c.length;y++){const M=c[y]=S?Nn(c[y]):Dn(c[y]);w(null,M,I,g,b,f,m,P,S)}},Xe=(c,I,g,b,f,m,P)=>{const S=I.el=c.el;let{patchFlag:v,dynamicChildren:y,dirs:M}=I;v|=c.patchFlag&16;const k=c.props||J,T=I.props||J;let L;if(g&&ie(g,!1),(L=T.onVnodeBeforeUpdate)&&xn(L,g,I,c),M&&te(I,c,g,"beforeUpdate"),g&&ie(g,!0),(k.innerHTML&&T.innerHTML==null||k.textContent&&T.textContent==null)&&u(S,""),y?Zn(c.dynamicChildren,y,S,g,b,Ft(I,f),m):P||j(c,I,S,null,g,b,Ft(I,f),m,!1),v>0){if(v&16)we(S,k,T,g,f);else if(v&2&&k.class!==T.class&&r(S,"class",null,T.class,f),v&4&&r(S,"style",k.style,T.style,f),v&8){const E=I.dynamicProps;for(let K=0;K<E.length;K++){const H=E[K],An=k[H],un=T[H];(un!==An||H==="value")&&r(S,H,An,un,f,g)}}v&1&&c.children!==I.children&&u(S,I.children)}else!P&&y==null&&we(S,k,T,g,f);((L=T.onVnodeUpdated)||M)&&In(()=>{L&&xn(L,g,I,c),M&&te(I,c,g,"updated")},b)},Zn=(c,I,g,b,f,m,P)=>{for(let S=0;S<I.length;S++){const v=c[S],y=I[S],M=v.el&&(v.type===gn||!Ce(v,y)||v.shapeFlag&198)?h(v.el):g;w(v,y,M,null,b,f,m,P,!0)}},we=(c,I,g,b,f)=>{if(I!==g){if(I!==J)for(const m in I)!De(m)&&!(m in g)&&r(c,m,I[m],null,f,b);for(const m in g){if(De(m))continue;const P=g[m],S=I[m];P!==S&&m!=="value"&&r(c,m,S,P,f,b)}"value"in g&&r(c,"value",I.value,g.value,f)}},Je=(c,I,g,b,f,m,P,S,v)=>{const y=I.el=c?c.el:o(""),M=I.anchor=c?c.anchor:o("");let{patchFlag:k,dynamicChildren:T,slotScopeIds:L}=I;L&&(S=S?S.concat(L):L),c==null?(i(y,g,b),i(M,g,b),cn(I.children||[],g,M,f,m,P,S,v)):k>0&&k&64&&T&&c.dynamicChildren&&c.dynamicChildren.length===T.length?(Zn(c.dynamicChildren,T,g,f,m,P,S),(I.key!=null||f&&I===f.subTree)&&mr(c,I,!0)):j(c,I,g,M,f,m,P,S,v)},qe=(c,I,g,b,f,m,P,S,v)=>{I.slotScopeIds=S,c==null?I.shapeFlag&512?f.ctx.activate(I,g,b,P,v):Tt(I,g,b,f,m,P,v):Di(c,I,v)},Tt=(c,I,g,b,f,m,P)=>{const S=c.component=Ea(c,b,f);if(er(c)&&(S.ctx.renderer=Se),_a(S,!1,P),S.asyncDep){if(f&&f.registerDep(S,tn,P),!c.el){const v=S.subTree=Hn(Yn);_(null,v,I,g),c.placeholder=v.el}}else tn(S,c,I,g,f,m,P)},Di=(c,I,g)=>{const b=I.component=c.component;if(ha(c,I,g))if(b.asyncDep&&!b.asyncResolved){q(b,I,g);return}else b.next=I,b.update();else I.el=c.el,b.vnode=I},tn=(c,I,g,b,f,m,P)=>{const S=()=>{if(c.isMounted){let{next:k,bu:T,u:L,parent:E,vnode:K}=c;{const Tn=yr(c);if(Tn){k&&(k.el=K.el,q(c,k,P)),Tn.asyncDep.then(()=>{In(()=>{c.isUnmounted||y()},f)});return}}let H=k,An;ie(c,!1),k?(k.el=K.el,q(c,k,P)):k=K,T&&xt(T),(An=k.props&&k.props.onVnodeBeforeUpdate)&&xn(An,E,k,K),ie(c,!0);const un=qi(c),Cn=c.subTree;c.subTree=un,w(Cn,un,h(Cn.el),Ye(Cn),c,f,m),k.el=un.el,H===null&&ga(c,un.el),L&&In(L,f),(An=k.props&&k.props.onVnodeUpdated)&&In(()=>xn(An,E,k,K),f)}else{let k;const{el:T,props:L}=I,{bm:E,m:K,parent:H,root:An,type:un}=c,Cn=Ue(I);ie(c,!1),E&&xt(E),!Cn&&(k=L&&L.onVnodeBeforeMount)&&xn(k,H,I),ie(c,!0);{An.ce&&An.ce._hasShadowRoot()&&An.ce._injectChildStyle(un);const Tn=c.subTree=qi(c);w(null,Tn,g,b,c,f,m),I.el=Tn.el}if(K&&In(K,f),!Cn&&(k=L&&L.onVnodeMounted)){const Tn=I;In(()=>xn(k,H,Tn),f)}(I.shapeFlag&256||H&&Ue(H.vnode)&&H.vnode.shapeFlag&256)&&c.a&&In(c.a,f),c.isMounted=!0,I=g=b=null}};c.scope.on();const v=c.effect=new Ds(S);c.scope.off();const y=c.update=v.run.bind(v),M=c.job=v.runIfDirty.bind(v);M.i=c,M.id=c.uid,v.scheduler=()=>fi(M),ie(c,!0),y()},q=(c,I,g)=>{I.component=c;const b=c.vnode.props;c.vnode=I,c.next=null,fa(c,I.props,b,g),wa(c,I.children,g),Vn(),Hi(c),zn()},j=(c,I,g,b,f,m,P,S,v=!1)=>{const y=c&&c.children,M=c?c.shapeFlag:0,k=I.children,{patchFlag:T,shapeFlag:L}=I;if(T>0){if(T&128){Qe(y,k,g,b,f,m,P,S,v);return}else if(T&256){ne(y,k,g,b,f,m,P,S,v);return}}L&8?(M&16&&ve(y,f,m),k!==y&&u(g,k)):M&16?L&16?Qe(y,k,g,b,f,m,P,S,v):ve(y,f,m,!0):(M&8&&u(g,""),L&16&&cn(k,g,b,f,m,P,S,v))},ne=(c,I,g,b,f,m,P,S,v)=>{c=c||ge,I=I||ge;const y=c.length,M=I.length,k=Math.min(y,M);let T;for(T=0;T<k;T++){const L=I[T]=v?Nn(I[T]):Dn(I[T]);w(c[T],L,g,null,f,m,P,S,v)}y>M?ve(c,f,m,!0,!1,k):cn(I,g,b,f,m,P,S,v,k)},Qe=(c,I,g,b,f,m,P,S,v)=>{let y=0;const M=I.length;let k=c.length-1,T=M-1;for(;y<=k&&y<=T;){const L=c[y],E=I[y]=v?Nn(I[y]):Dn(I[y]);if(Ce(L,E))w(L,E,g,null,f,m,P,S,v);else break;y++}for(;y<=k&&y<=T;){const L=c[k],E=I[T]=v?Nn(I[T]):Dn(I[T]);if(Ce(L,E))w(L,E,g,null,f,m,P,S,v);else break;k--,T--}if(y>k){if(y<=T){const L=T+1,E=L<M?I[L].el:b;for(;y<=T;)w(null,I[y]=v?Nn(I[y]):Dn(I[y]),g,E,f,m,P,S,v),y++}}else if(y>T)for(;y<=k;)kn(c[y],f,m,!0),y++;else{const L=y,E=y,K=new Map;for(y=E;y<=T;y++){const hn=I[y]=v?Nn(I[y]):Dn(I[y]);hn.key!=null&&K.set(hn.key,y)}let H,An=0;const un=T-E+1;let Cn=!1,Tn=0;const Pe=new Array(un);for(y=0;y<un;y++)Pe[y]=0;for(y=L;y<=k;y++){const hn=c[y];if(An>=un){kn(hn,f,m,!0);continue}let Mn;if(hn.key!=null)Mn=K.get(hn.key);else for(H=E;H<=T;H++)if(Pe[H-E]===0&&Ce(hn,I[H])){Mn=H;break}Mn===void 0?kn(hn,f,m,!0):(Pe[Mn-E]=y+1,Mn>=Tn?Tn=Mn:Cn=!0,w(hn,I[Mn],g,null,f,m,P,S,v),An++)}const Ei=Cn?ka(Pe):ge;for(H=Ei.length-1,y=un-1;y>=0;y--){const hn=E+y,Mn=I[hn],Ui=I[hn+1],_i=hn+1<M?Ui.el||br(Ui):b;Pe[y]===0?w(null,Mn,g,_i,f,m,P,S,v):Cn&&(H<0||y!==Ei[H]?ee(Mn,g,_i,2):H--)}}},ee=(c,I,g,b,f=null)=>{const{el:m,type:P,transition:S,children:v,shapeFlag:y}=c;if(y&6){ee(c.component.subTree,I,g,b);return}if(y&128){c.suspense.move(I,g,b);return}if(y&64){P.move(c,I,g,Se);return}if(P===gn){i(m,I,g);for(let k=0;k<v.length;k++)ee(v[k],I,g,b);i(c.anchor,I,g);return}if(P===Wt){V(c,I,g);return}if(b!==2&&y&1&&S)if(b===0)S.beforeEnter(m),i(m,I,g),In(()=>S.enter(m),f);else{const{leave:k,delayLeave:T,afterLeave:L}=S,E=()=>{c.ctx.isUnmounted?s(m):i(m,I,g)},K=()=>{m._isLeaving&&m[Ho](!0),k(m,()=>{E(),L&&L()})};T?T(m,E,K):K()}else i(m,I,g)},kn=(c,I,g,b=!1,f=!1)=>{const{type:m,props:P,ref:S,children:v,dynamicChildren:y,shapeFlag:M,patchFlag:k,dirs:T,cacheIndex:L}=c;if(k===-2&&(f=!1),S!=null&&(Vn(),Ee(S,null,g,c,!0),zn()),L!=null&&(I.renderCache[L]=void 0),M&256){I.ctx.deactivate(c);return}const E=M&1&&T,K=!Ue(c);let H;if(K&&(H=P&&P.onVnodeBeforeUnmount)&&xn(H,I,c),M&6)Or(c.component,g,b);else{if(M&128){c.suspense.unmount(g,b);return}E&&te(c,null,I,"beforeUnmount"),M&64?c.type.remove(c,I,g,Se,b):y&&!y.hasOnce&&(m!==gn||k>0&&k&64)?ve(y,I,g,!1,!0):(m===gn&&k&384||!f&&M&16)&&ve(v,I,g),b&&Gi(c)}(K&&(H=P&&P.onVnodeUnmounted)||E)&&In(()=>{H&&xn(H,I,c),E&&te(c,null,I,"unmounted")},g)},Gi=c=>{const{type:I,el:g,anchor:b,transition:f}=c;if(I===gn){Nr(g,b);return}if(I===Wt){R(c);return}const m=()=>{s(g),f&&!f.persisted&&f.afterLeave&&f.afterLeave()};if(c.shapeFlag&1&&f&&!f.persisted){const{leave:P,delayLeave:S}=f,v=()=>P(g,m);S?S(c.el,m,v):v()}else m()},Nr=(c,I)=>{let g;for(;c!==I;)g=p(c),s(c),c=g;s(I)},Or=(c,I,g)=>{const{bum:b,scope:f,job:m,subTree:P,um:S,m:v,a:y}=c;Zi(v),Zi(y),b&&xt(b),f.stop(),m&&(m.flags|=8,kn(P,c,I,g)),S&&In(S,I),In(()=>{c.isUnmounted=!0},I)},ve=(c,I,g,b=!1,f=!1,m=0)=>{for(let P=m;P<c.length;P++)kn(c[P],I,g,b,f)},Ye=c=>{if(c.shapeFlag&6)return Ye(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const I=p(c.anchor||c.el),g=I&&I[No];return g?p(g):I};let Mt=!1;const Bi=(c,I,g)=>{let b;c==null?I._vnode&&(kn(I._vnode,null,null,!0),b=I._vnode.component):w(I._vnode||null,c,I,null,null,null,g),I._vnode=c,Mt||(Mt=!0,Hi(b),Js(),Mt=!1)},Se={p:w,um:kn,m:ee,r:Gi,mt:Tt,mc:cn,pc:j,pbc:Zn,n:Ye,o:n};return{render:Bi,hydrate:void 0,createApp:la(Bi)}}function Ft({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function ie({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function Pa(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function mr(n,e,t=!1){const i=n.children,s=e.children;if(D(i)&&D(s))for(let r=0;r<i.length;r++){const a=i[r];let o=s[r];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=s[r]=Nn(s[r]),o.el=a.el),!t&&o.patchFlag!==-2&&mr(a,o)),o.type===Pt&&(o.patchFlag===-1&&(o=s[r]=Nn(o)),o.el=a.el),o.type===Yn&&!o.el&&(o.el=a.el)}}function ka(n){const e=n.slice(),t=[0];let i,s,r,a,o;const l=n.length;for(i=0;i<l;i++){const A=n[i];if(A!==0){if(s=t[t.length-1],n[s]<A){e[i]=s,t.push(i);continue}for(r=0,a=t.length-1;r<a;)o=r+a>>1,n[t[o]]<A?r=o+1:a=o;A<n[t[r]]&&(r>0&&(e[i]=t[r-1]),t[r]=i)}}for(r=t.length,a=t[r-1];r-- >0;)t[r]=a,a=e[a];return t}function yr(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:yr(e)}function Zi(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function br(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?br(e.subTree):null}const wr=n=>n.__isSuspense;function Ca(n,e){e&&e.pendingBranch?D(n)?e.effects.push(...n):e.effects.push(n):Bo(n)}const gn=Symbol.for("v-fgt"),Pt=Symbol.for("v-txt"),Yn=Symbol.for("v-cmt"),Wt=Symbol.for("v-stc"),Fe=[];let pn=null;function yn(n=!1){Fe.push(pn=n?null:[])}function Ta(){Fe.pop(),pn=Fe[Fe.length-1]||null}let He=1;function ns(n,e=!1){He+=n,n<0&&pn&&e&&(pn.hasOnce=!0)}function vr(n){return n.dynamicChildren=He>0?pn||ge:null,Ta(),He>0&&pn&&pn.push(n),n}function Rn(n,e,t,i,s,r){return vr(F(n,e,t,i,s,r,!0))}function Ma(n,e,t,i,s){return vr(Hn(n,e,t,i,s,!0))}function Sr(n){return n?n.__v_isVNode===!0:!1}function Ce(n,e){return n.type===e.type&&n.key===e.key}const Pr=({key:n})=>n??null,rt=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Y(n)||nn(n)||G(n)?{i:Gn,r:n,k:e,f:!!t}:n:null);function F(n,e=null,t=null,i=0,s=null,r=n===gn?0:1,a=!1,o=!1){const l={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Pr(e),ref:e&&rt(e),scopeId:Qs,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:Gn};return o?(wi(l,t),r&128&&n.normalize(l)):t&&(l.shapeFlag|=Y(t)?8:16),He>0&&!a&&pn&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&pn.push(l),l}const Hn=Ra;function Ra(n,e=null,t=null,i=0,s=null,r=!1){if((!n||n===na)&&(n=Yn),Sr(n)){const o=be(n,e,!0);return t&&wi(o,t),He>0&&!r&&pn&&(o.shapeFlag&6?pn[pn.indexOf(n)]=o:pn.push(o)),o.patchFlag=-2,o}if(Oa(n)&&(n=n.__vccOpts),e){e=xa(e);let{class:o,style:l}=e;o&&!Y(o)&&(e.class=oe(o)),$(l)&&(pi(l)&&!D(l)&&(l=en({},l)),e.style=ai(l))}const a=Y(n)?1:wr(n)?128:Oo(n)?64:$(n)?4:G(n)?2:0;return F(n,e,t,i,s,a,r,!0)}function xa(n){return n?pi(n)||Ir(n)?en({},n):n:null}function be(n,e,t=!1,i=!1){const{props:s,ref:r,patchFlag:a,children:o,transition:l}=n,A=e?Da(s||{},e):s,u={__v_isVNode:!0,__v_skip:!0,type:n.type,props:A,key:A&&Pr(A),ref:e&&e.ref?t&&r?D(r)?r.concat(rt(e)):[r,rt(e)]:rt(e):r,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:o,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==gn?a===-1?16:a|16:a,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:l,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&be(n.ssContent),ssFallback:n.ssFallback&&be(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return l&&i&&mi(u,l.clone(u)),u}function he(n=" ",e=0){return Hn(Pt,null,n,e)}function La(n="",e=!1){return e?(yn(),Ma(Yn,null,n)):Hn(Yn,null,n)}function Dn(n){return n==null||typeof n=="boolean"?Hn(Yn):D(n)?Hn(gn,null,n.slice()):Sr(n)?Nn(n):Hn(Pt,null,String(n))}function Nn(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:be(n)}function wi(n,e){let t=0;const{shapeFlag:i}=n;if(e==null)e=null;else if(D(e))t=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),wi(n,s()),s._c&&(s._d=!0));return}else{t=32;const s=e._;!s&&!Ir(e)?e._ctx=Gn:s===3&&Gn&&(Gn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else G(e)?(e={default:e,_ctx:Gn},t=32):(e=String(e),i&64?(t=16,e=[he(e)]):t=8);n.children=e,n.shapeFlag|=t}function Da(...n){const e={};for(let t=0;t<n.length;t++){const i=n[t];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=oe([e.class,i.class]));else if(s==="style")e.style=ai([e.style,i.style]);else if(ft(s)){const r=e[s],a=i[s];a&&r!==a&&!(D(r)&&r.includes(a))&&(e[s]=r?[].concat(r,a):a)}else s!==""&&(e[s]=i[s])}return e}function xn(n,e,t,i=null){Un(n,e,7,[t,i])}const Ga=ar();let Ba=0;function Ea(n,e,t){const i=n.type,s=(e?e.appContext:n.appContext)||Ga,r={uid:Ba++,vnode:n,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new to(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:hr(i,s),emitsOptions:lr(i,s),emit:null,emitted:null,propsDefaults:J,inheritAttrs:i.inheritAttrs,ctx:J,data:J,props:J,attrs:J,slots:J,refs:J,setupState:J,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Aa.bind(null,r),n.ce&&n.ce(r),r}let on=null;const Ua=()=>on||Gn;let dt,Yt;{const n=yt(),e=(t,i)=>{let s;return(s=n[t])||(s=n[t]=[]),s.push(i),r=>{s.length>1?s.forEach(a=>a(r)):s[0](r)}};dt=e("__VUE_INSTANCE_SETTERS__",t=>on=t),Yt=e("__VUE_SSR_SETTERS__",t=>Ve=t)}const je=n=>{const e=on;return dt(n),n.scope.on(),()=>{n.scope.off(),dt(e)}},es=()=>{on&&on.scope.off(),dt(null)};function kr(n){return n.vnode.shapeFlag&4}let Ve=!1;function _a(n,e=!1,t=!1){e&&Yt(e);const{props:i,children:s}=n.vnode,r=kr(n);pa(n,i,r,e),ba(n,s,t||e);const a=r?Fa(n,e):void 0;return e&&Yt(!1),a}function Fa(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,ea);const{setup:i}=t;if(i){Vn();const s=n.setupContext=i.length>1?Na(n):null,r=je(n),a=$e(i,n,0,[n.props,s]),o=Ps(a);if(zn(),r(),(o||n.sp)&&!Ue(n)&&nr(n),o){if(a.then(es,es),e)return a.then(l=>{ts(n,l)}).catch(l=>{wt(l,n,0)});n.asyncDep=a}else ts(n,a)}else Cr(n)}function ts(n,e,t){G(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:$(e)&&(n.setupState=js(e)),Cr(n)}function Cr(n,e,t){const i=n.type;n.render||(n.render=i.render||Bn);{const s=je(n);Vn();try{ta(n)}finally{zn(),s()}}}const Wa={get(n,e){return Z(n,"get",""),n[e]}};function Na(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,Wa),slots:n.slots,emit:n.emit,expose:e}}function vi(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(js(Po(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in _e)return _e[t](n)},has(e,t){return t in e||t in _e}})):n.proxy}function Oa(n){return G(n)&&"__vccOpts"in n}const ot=(n,e)=>Ro(n,e,Ve),Ha="3.5.28";/**
* @vue/runtime-dom v3.5.28
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Zt;const is=typeof window<"u"&&window.trustedTypes;if(is)try{Zt=is.createPolicy("vue",{createHTML:n=>n})}catch{}const Tr=Zt?n=>Zt.createHTML(n):n=>n,Va="http://www.w3.org/2000/svg",za="http://www.w3.org/1998/Math/MathML",Wn=typeof document<"u"?document:null,ss=Wn&&Wn.createElement("template"),$a={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,i)=>{const s=e==="svg"?Wn.createElementNS(Va,n):e==="mathml"?Wn.createElementNS(za,n):t?Wn.createElement(n,{is:t}):Wn.createElement(n);return n==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:n=>Wn.createTextNode(n),createComment:n=>Wn.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>Wn.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,i,s,r){const a=t?t.previousSibling:e.lastChild;if(s&&(s===r||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),t),!(s===r||!(s=s.nextSibling)););else{ss.innerHTML=Tr(i==="svg"?`<svg>${n}</svg>`:i==="mathml"?`<math>${n}</math>`:n);const o=ss.content;if(i==="svg"||i==="mathml"){const l=o.firstChild;for(;l.firstChild;)o.appendChild(l.firstChild);o.removeChild(l)}e.insertBefore(o,t)}return[a?a.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},ja=Symbol("_vtc");function Ka(n,e,t){const i=n[ja];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const rs=Symbol("_vod"),Xa=Symbol("_vsh"),Ja=Symbol(""),qa=/(?:^|;)\s*display\s*:/;function Qa(n,e,t){const i=n.style,s=Y(t);let r=!1;if(t&&!s){if(e)if(Y(e))for(const a of e.split(";")){const o=a.slice(0,a.indexOf(":")).trim();t[o]==null&&at(i,o,"")}else for(const a in e)t[a]==null&&at(i,a,"");for(const a in t)a==="display"&&(r=!0),at(i,a,t[a])}else if(s){if(e!==t){const a=i[Ja];a&&(t+=";"+a),i.cssText=t,r=qa.test(t)}}else e&&n.removeAttribute("style");rs in n&&(n[rs]=r?i.display:"",n[Xa]&&(i.display="none"))}const os=/\s*!important$/;function at(n,e,t){if(D(t))t.forEach(i=>at(n,e,i));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const i=Ya(n,e);os.test(t)?n.setProperty(Ae(i),t.replace(os,""),"important"):n[i]=t}}const as=["Webkit","Moz","ms"],Nt={};function Ya(n,e){const t=Nt[e];if(t)return t;let i=Qn(e);if(i!=="filter"&&i in n)return Nt[e]=i;i=Ts(i);for(let s=0;s<as.length;s++){const r=as[s]+i;if(r in n)return Nt[e]=r}return e}const ls="http://www.w3.org/1999/xlink";function cs(n,e,t,i,s,r=no(e)){i&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(ls,e.slice(6,e.length)):n.setAttributeNS(ls,e,t):t==null||r&&!Rs(t)?n.removeAttribute(e):n.setAttribute(e,r?"":En(t)?String(t):t)}function As(n,e,t,i,s){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Tr(t):t);return}const r=n.tagName;if(e==="value"&&r!=="PROGRESS"&&!r.includes("-")){const o=r==="OPTION"?n.getAttribute("value")||"":n.value,l=t==null?n.type==="checkbox"?"on":"":String(t);(o!==l||!("_value"in n))&&(n.value=l),t==null&&n.removeAttribute(e),n._value=t;return}let a=!1;if(t===""||t==null){const o=typeof n[e];o==="boolean"?t=Rs(t):t==null&&o==="string"?(t="",a=!0):o==="number"&&(t=0,a=!0)}try{n[e]=t}catch{}a&&n.removeAttribute(s||e)}function Za(n,e,t,i){n.addEventListener(e,t,i)}function nl(n,e,t,i){n.removeEventListener(e,t,i)}const us=Symbol("_vei");function el(n,e,t,i,s=null){const r=n[us]||(n[us]={}),a=r[e];if(i&&a)a.value=i;else{const[o,l]=tl(e);if(i){const A=r[e]=rl(i,s);Za(n,o,A,l)}else a&&(nl(n,o,a,l),r[e]=void 0)}}const Is=/(?:Once|Passive|Capture)$/;function tl(n){let e;if(Is.test(n)){e={};let i;for(;i=n.match(Is);)n=n.slice(0,n.length-i[0].length),e[i[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Ae(n.slice(2)),e]}let Ot=0;const il=Promise.resolve(),sl=()=>Ot||(il.then(()=>Ot=0),Ot=Date.now());function rl(n,e){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;Un(ol(i,t.value),e,5,[i])};return t.value=n,t.attached=sl(),t}function ol(n,e){if(D(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const ds=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,al=(n,e,t,i,s,r)=>{const a=s==="svg";e==="class"?Ka(n,i,a):e==="style"?Qa(n,t,i):ft(e)?si(e)||el(n,e,t,i,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):ll(n,e,i,a))?(As(n,e,i),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&cs(n,e,i,a,r,e!=="value")):n._isVueCE&&(/[A-Z]/.test(e)||!Y(i))?As(n,Qn(e),i,r,e):(e==="true-value"?n._trueValue=i:e==="false-value"&&(n._falseValue=i),cs(n,e,i,a))};function ll(n,e,t,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in n&&ds(e)&&G(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=n.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return ds(e)&&Y(t)?!1:e in n}const cl=en({patchProp:al},$a);let hs;function Al(){return hs||(hs=va(cl))}const ul=((...n)=>{const e=Al().createApp(...n),{mount:t}=e;return e.mount=i=>{const s=dl(i);if(!s)return;const r=e._component;!G(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const a=t(s,!1,Il(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),a},e});function Il(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function dl(n){return Y(n)?document.querySelector(n):n}function Si(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ue=Si();function Mr(n){ue=n}var re={exec:()=>null};function U(n,e=""){let t=typeof n=="string"?n:n.source,i={replace:(s,r)=>{let a=typeof r=="string"?r:r.source;return a=a.replace(an.caret,"$1"),t=t.replace(s,a),i},getRegex:()=>new RegExp(t,e)};return i}var hl=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),an={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}>`)},gl=/^(?:[ \t]*(?:\n|$))+/,pl=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fl=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ke=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ml=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Pi=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Rr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,xr=U(Rr).replace(/bull/g,Pi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),yl=U(Rr).replace(/bull/g,Pi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),ki=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bl=/^[^\n]+/,Ci=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,wl=U(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ci).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),vl=U(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Pi).getRegex(),kt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ti=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Sl=U("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Ti).replace("tag",kt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Lr=U(ki).replace("hr",Ke).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kt).getRegex(),Pl=U(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Lr).getRegex(),Mi={blockquote:Pl,code:pl,def:wl,fences:fl,heading:ml,hr:Ke,html:Sl,lheading:xr,list:vl,newline:gl,paragraph:Lr,table:re,text:bl},gs=U("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ke).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kt).getRegex(),kl={...Mi,lheading:yl,table:gs,paragraph:U(ki).replace("hr",Ke).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",gs).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kt).getRegex()},Cl={...Mi,html:U(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ti).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:re,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:U(ki).replace("hr",Ke).replace("heading",` *#{1,6} *[^
]`).replace("lheading",xr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Tl=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ml=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Dr=/^( {2,}|\\)\n(?!\s*$)/,Rl=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ct=/[\p{P}\p{S}]/u,Ri=/[\s\p{P}\p{S}]/u,Gr=/[^\s\p{P}\p{S}]/u,xl=U(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ri).getRegex(),Br=/(?!~)[\p{P}\p{S}]/u,Ll=/(?!~)[\s\p{P}\p{S}]/u,Dl=/(?:[^\s\p{P}\p{S}]|~)/u,Er=/(?![*_])[\p{P}\p{S}]/u,Gl=/(?![*_])[\s\p{P}\p{S}]/u,Bl=/(?:[^\s\p{P}\p{S}]|[*_])/u,El=U(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",hl?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Ur=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ul=U(Ur,"u").replace(/punct/g,Ct).getRegex(),_l=U(Ur,"u").replace(/punct/g,Br).getRegex(),_r="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Fl=U(_r,"gu").replace(/notPunctSpace/g,Gr).replace(/punctSpace/g,Ri).replace(/punct/g,Ct).getRegex(),Wl=U(_r,"gu").replace(/notPunctSpace/g,Dl).replace(/punctSpace/g,Ll).replace(/punct/g,Br).getRegex(),Nl=U("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Gr).replace(/punctSpace/g,Ri).replace(/punct/g,Ct).getRegex(),Ol=U(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Er).getRegex(),Hl="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Vl=U(Hl,"gu").replace(/notPunctSpace/g,Bl).replace(/punctSpace/g,Gl).replace(/punct/g,Er).getRegex(),zl=U(/\\(punct)/,"gu").replace(/punct/g,Ct).getRegex(),$l=U(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),jl=U(Ti).replace("(?:-->|$)","-->").getRegex(),Kl=U("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",jl).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ht=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Xl=U(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",ht).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Fr=U(/^!?\[(label)\]\[(ref)\]/).replace("label",ht).replace("ref",Ci).getRegex(),Wr=U(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ci).getRegex(),Jl=U("reflink|nolink(?!\\()","g").replace("reflink",Fr).replace("nolink",Wr).getRegex(),ps=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,xi={_backpedal:re,anyPunctuation:zl,autolink:$l,blockSkip:El,br:Dr,code:Ml,del:re,delLDelim:re,delRDelim:re,emStrongLDelim:Ul,emStrongRDelimAst:Fl,emStrongRDelimUnd:Nl,escape:Tl,link:Xl,nolink:Wr,punctuation:xl,reflink:Fr,reflinkSearch:Jl,tag:Kl,text:Rl,url:re},ql={...xi,link:U(/^!?\[(label)\]\((.*?)\)/).replace("label",ht).getRegex(),reflink:U(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ht).getRegex()},ni={...xi,emStrongRDelimAst:Wl,emStrongLDelim:_l,delLDelim:Ol,delRDelim:Vl,url:U(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",ps).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:U(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",ps).getRegex()},Ql={...ni,br:U(Dr).replace("{2,}","*").getRegex(),text:U(ni.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},tt={normal:Mi,gfm:kl,pedantic:Cl},Te={normal:xi,gfm:ni,breaks:Ql,pedantic:ql},Yl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},fs=n=>Yl[n];function Fn(n,e){if(e){if(an.escapeTest.test(n))return n.replace(an.escapeReplace,fs)}else if(an.escapeTestNoEncode.test(n))return n.replace(an.escapeReplaceNoEncode,fs);return n}function ms(n){try{n=encodeURI(n).replace(an.percentDecode,"%")}catch{return null}return n}function ys(n,e){var r;let t=n.replace(an.findPipe,(a,o,l)=>{let A=!1,u=o;for(;--u>=0&&l[u]==="\\";)A=!A;return A?"|":" |"}),i=t.split(an.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!((r=i.at(-1))!=null&&r.trim())&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(an.slashPipe,"|");return i}function Me(n,e,t){let i=n.length;if(i===0)return"";let s=0;for(;s<i&&n.charAt(i-s-1)===e;)s++;return n.slice(0,i-s)}function Zl(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let i=0;i<n.length;i++)if(n[i]==="\\")i++;else if(n[i]===e[0])t++;else if(n[i]===e[1]&&(t--,t<0))return i;return t>0?-2:-1}function nc(n,e=0){let t=e,i="";for(let s of n)if(s==="	"){let r=4-t%4;i+=" ".repeat(r),t+=r}else i+=s,t++;return i}function bs(n,e,t,i,s){let r=e.href,a=e.title||null,o=n[1].replace(s.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:r,title:a,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,l}function ec(n,e,t){let i=n.match(t.other.indentCodeCompensation);if(i===null)return e;let s=i[1];return e.split(`
...
${A}`:A,s=s?`${s}
${u}`:u;let h=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,r,!0),this.lexer.state.top=h,t.length===0)break;let p=r.at(-1);if((p==null?void 0:p.type)==="code")break;if((p==null?void 0:p.type)==="blockquote"){let d=p,C=d.raw+`
`+t.join(`
`),w=this.blockquote(C);r[r.length-1]=w,i=i.substring(0,i.length-d.raw.length)+w.raw,s=s.substring(0,s.length-d.text.length)+w.text;break}else if((p==null?void 0:p.type)==="list"){let d=p,C=d.raw+`
`+t.join(`
`),w=this.list(C);r[r.length-1]=w,i=i.substring(0,i.length-p.raw.length)+w.raw,s=s.substring(0,s.length-d.raw.length)+w.raw,t=C.substring(r.at(-1).raw.length).split(`
...
`,1)[0],w=!d.trim(),x=0;if(this.options.pedantic?(x=2,p=d.trimStart()):w?x=e[1].length+1:(x=d.search(this.rules.other.nonSpaceChar),x=x>4?1:x,p=d.slice(x),x+=e[1].length),w&&this.rules.other.blankLine.test(C)&&(h+=C+`
`,n=n.substring(C.length+1),u=!0),!u){let _=this.rules.other.nextBulletRegex(x),B=this.rules.other.hrRegex(x),V=this.rules.other.fencesBeginRegex(x),R=this.rules.other.headingBeginRegex(x),Q=this.rules.other.htmlBeginRegex(x),Pn=this.rules.other.blockquoteBeginRegex(x);for(;n;){let ln=n.split(`
`,1)[0],cn;if(C=ln,this.options.pedantic?(C=C.replace(this.rules.other.listReplaceNesting,"  "),cn=C):cn=C.replace(this.rules.other.tabCharGlobal,"    "),V.test(C)||R.test(C)||Q.test(C)||Pn.test(C)||_.test(C)||B.test(C))break;if(cn.search(this.rules.other.nonSpaceChar)>=x||!C.trim())p+=`
...
`)?"":`
`)+o.raw,A.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=A.text):t.push(o);continue}if(e){let A="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(A);break}else throw new Error(A)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var l,A,u,h,p;let i=e,s=null;if(this.tokens.links){let d=Object.keys(this.tokens.links);if(d.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)d.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let r;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)r=s[2]?s[2].length:0,i=i.slice(0,s.index+r)+"["+"a".repeat(s[0].length-r-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((A=(l=this.options.hooks)==null?void 0:l.emStrongMask)==null?void 0:A.call({lexer:this},i))??i;let a=!1,o="";for(;e;){a||(o=""),a=!1;let d;if((h=(u=this.options.extensions)==null?void 0:u.inline)!=null&&h.some(w=>(d=w.call({lexer:this},e,t))?(e=e.substring(d.raw.length),t.push(d),!0):!1))continue;if(d=this.tokenizer.escape(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.tag(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.link(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(d.raw.length);let w=t.at(-1);d.type==="text"&&(w==null?void 0:w.type)==="text"?(w.raw+=d.raw,w.text+=d.text):t.push(d);continue}if(d=this.tokenizer.emStrong(e,i,o)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.codespan(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.br(e)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.del(e,i,o)){e=e.substring(d.raw.length),t.push(d);continue}if(d=this.tokenizer.autolink(e)){e=e.substring(d.raw.length),t.push(d);continue}if(!this.state.inLink&&(d=this.tokenizer.url(e))){e=e.substring(d.raw.length),t.push(d);continue}let C=e;if((p=this.options.extensions)!=null&&p.startInline){let w=1/0,x=e.slice(1),_;this.options.extensions.startInline.forEach(B=>{_=B.call({lexer:this},x),typeof _=="number"&&_>=0&&(w=Math.min(w,_))}),w<1/0&&w>=0&&(C=e.substring(0,w+1))}if(d=this.tokenizer.inlineText(C)){e=e.substring(d.raw.length),d.raw.slice(-1)!=="_"&&(o=d.raw.slice(-1)),a=!0;let w=t.at(-1);(w==null?void 0:w.type)==="text"?(w.raw+=d.raw,w.text+=d.text):t.push(d);continue}if(e){let w="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(w);break}else throw new Error(w)}}return t}},pt=class{constructor(n){z(this,"options");z(this,"parser");this.options=n||ue}space(n){return""}code({text:n,lang:e,escaped:t}){var r;let i=(r=(e||"").match(an.notSpaceStart))==null?void 0:r[0],s=n.replace(an.endingNewline,"")+`
...
Please report this to https://github.com/markedjs/marked.`,n){let i="<p>An error occurred:</p><pre>"+Fn(t.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(t);throw t}}},ce=new tc;function O(n,e){return ce.parse(n,e)}O.options=O.setOptions=function(n){return ce.setOptions(n),O.defaults=ce.defaults,Mr(O.defaults),O};O.getDefaults=Si;O.defaults=ue;O.use=function(...n){return ce.use(...n),O.defaults=ce.defaults,Mr(O.defaults),O};O.walkTokens=function(n,e){return ce.walkTokens(n,e)};O.parseInline=ce.parseInline;O.Parser=wn;O.parser=wn.parse;O.Renderer=pt;O.TextRenderer=Li;O.Lexer=bn;O.lexer=bn.lex;O.Tokenizer=gt;O.Hooks=Le;O.parse=O;O.options;O.setOptions;O.use;O.walkTokens;O.parseInline;wn.parse;bn.lex;const ws={notes:[{id:"2026-02-15-ai-3d-generation-2026",title:"AI 3D 生成 2026：从「神奇 Demo」到「生产就绪」的转折点",category:"tech",date:"2026-02-15",summary:'1. **"生产就绪"定义正在演进**：从"能渲染"到"可编辑、可动画、可集成"——PBR 材质、合理拓扑、UV 展开、LOD 成为标配',content:`# AI 3D 生成 2026：从「神奇 Demo」到「生产就绪」的转折点
...
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5},insights:{label:"洞见报告",color:"#f59e0b",priority:6}}},ic={class:"container"},sc={class:"site-header"},rc={class:"stats"},oc={class:"stat"},ac={class:"stat-num"},lc={class:"stat"},cc={class:"stat-num"},Ac={class:"stat"},uc={class:"stat-num"},Ic={class:"filter-bar"},dc=["onClick"],hc={key:0,class:"note-list"},gc=["onClick"],pc={class:"note-meta"},fc={class:"note-date"},mc={class:"note-title"},yc={key:0,class:"note-summary"},bc={key:1,class:"empty-state"},wc={class:"detail-header"},vc={class:"detail-title"},Sc={class:"detail-meta"},Pc={class:"note-date"},kc=["innerHTML"],Cc={__name:"App",setup(n){O.setOptions({breaks:!1,gfm:!0});const e=ws.notes,t=ws.categories,i=Et(null),s=Et(null),r=Et("加载中..."),a=ot(()=>new Set(e.map(d=>d.date)).size),o=ot(()=>i.value?e.filter(p=>p.category===i.value):e),l=ot(()=>s.value?O(s.value.content):"");async function A(){try{const p=localStorage.getItem("erzi-knowledge-visits");p?r.value=parseInt(p):r.value=1;const d=(parseInt(p)||0)+1;localStorage.setItem("erzi-knowledge-visits",d.toString()),r.value=d}catch(p){console.error("访问统计加载失败:",p),r.value="统计不可用"}}ir(()=>{A()});function u(p){s.value=p,Kt(()=>window.scrollTo(0,0))}function h(){s.value=null,Kt(()=>window.scrollTo(0,0))}return(p,d)=>{var C;return yn(),Rn("div",ic,[s.value?(yn(),Rn(gn,{key:1},[F("div",wc,[F("button",{class:"back-btn",onClick:h},[...d[7]||(d[7]=[F("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[F("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回 ",-1)])]),F("h1",vc,fn(s.value.title),1),F("div",Sc,[F("span",{class:oe(["note-category","note-category--"+s.value.category])},fn((C=Re(t)[s.value.category])==null?void 0:C.label),3),F("span",Pc,fn(s.value.date),1)])]),F("div",{class:"note-content",innerHTML:l.value},null,8,kc),F("footer",{class:"site-footer"},[F("button",{class:"back-btn",onClick:h},[...d[8]||(d[8]=[F("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[F("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回列表 ",-1)])])])],64)):(yn(),Rn(gn,{key:0},[F("header",sc,[d[4]||(d[4]=F("div",{class:"site-title"},"二子的知识库",-1)),d[5]||(d[5]=F("div",{class:"site-subtitle"},"跟二子一起学习",-1)),F("div",rc,[F("span",oc,[F("span",ac,fn(Re(e).length),1),d[1]||(d[1]=he(" 篇笔记",-1))]),F("span",lc,[F("span",cc,fn(a.value),1),d[2]||(d[2]=he(" 天探索",-1))]),F("span",Ac,[F("span",uc,fn(r.value),1),d[3]||(d[3]=he(" 次访问",-1))])])]),F("div",Ic,[F("button",{class:oe(["filter-btn",{active:i.value===null}]),onClick:d[0]||(d[0]=w=>i.value=null)},"全部",2),(yn(!0),Rn(gn,null,$i(Re(t),(w,x)=>(yn(),Rn("button",{key:x,class:oe(["filter-btn",{active:i.value===x}]),onClick:_=>i.value=x},fn(w.label),11,dc))),128))]),o.value.length?(yn(),Rn("div",hc,[(yn(!0),Rn(gn,null,$i(o.value,w=>{var x;return yn(),Rn("div",{key:w.id+w.category,class:"note-item",onClick:_=>u(w)},[F("div",pc,[F("span",{class:oe(["note-category","note-category--"+w.category])},fn((x=Re(t)[w.category])==null?void 0:x.label),3),F("span",fc,fn(w.date),1)]),F("div",mc,fn(w.title),1),w.summary?(yn(),Rn("div",yc,fn(w.summary),1)):La("",!0)],8,gc)}),128))])):(yn(),Rn("div",bc," 暂无笔记 ")),d[6]||(d[6]=F("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};ul(Cc).mount("#app");
