...
${u}`:u,s=s?`${s}
${h}`:h;let A=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,r,!0),this.lexer.state.top=A,t.length===0)break;let g=r.at(-1);if((g==null?void 0:g.type)==="code")break;if((g==null?void 0:g.type)==="blockquote"){let p=g,P=p.raw+`
`+t.join(`
...
`);continue}}return{type:"blockquote",raw:i,tokens:r,text:s}}}list(n){var t,i;let e=this.rules.block.list.exec(n);if(e){let s=e[1].trim(),r=s.length>1,a={type:"list",raw:"",ordered:r,start:r?+s.slice(0,-1):"",loose:!1,items:[]};s=r?`\\d{1,9}\\${s.slice(-1)}`:`\\${s}`,this.options.pedantic&&(s=r?s:"[*+-]");let o=this.rules.other.listItemRegex(s),l=!1;for(;n;){let h=!1,A="",g="";if(!(e=o.exec(n))||this.rules.block.hr.test(n))break;A=e[0],n=n.substring(A.length);let p=nc(e[2].split(`
`,1)[0],e[1].length),P=n.split(`
`,1)[0],w=!p.trim(),L=0;if(this.options.pedantic?(L=2,g=p.trimStart()):w?L=e[1].length+1:(L=p.search(this.rules.other.nonSpaceChar),L=L>4?1:L,g=p.slice(L),L+=e[1].length),w&&this.rules.other.blankLine.test(P)&&(A+=P+`
...
`+cn.slice(L);else{if(w||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||z.test(p)||M.test(p)||_.test(p))break;g+=`
`+P}w=!P.trim(),A+=ln+`
`,n=n.substring(ln.length+1),p=cn.slice(L)}}a.loose||(l?a.loose=!0:this.rules.other.doubleBlankLine.test(A)&&(l=!0)),a.items.push({type:"list_item",raw:A,task:!!this.options.gfm&&this.rules.other.listIsTask.test(g),loose:!1,text:g,tokens:[]}),a.raw+=A}let u=a.items.at(-1);if(u)u.raw=u.raw.trimEnd(),u.text=u.text.trimEnd();else return;a.raw=a.raw.trimEnd();for(let h of a.items){if(this.lexer.state.top=!1,h.tokens=this.lexer.blockTokens(h.text,[]),h.task){if(h.text=h.text.replace(this.rules.other.listReplaceTask,""),((t=h.tokens[0])==null?void 0:t.type)==="text"||((i=h.tokens[0])==null?void 0:i.type)==="paragraph"){h.tokens[0].raw=h.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),h.tokens[0].text=h.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let g=this.lexer.inlineQueue.length-1;g>=0;g--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[g].src)){this.lexer.inlineQueue[g].src=this.lexer.inlineQueue[g].src.replace(this.rules.other.listReplaceTask,"");break}}let A=this.rules.other.listTaskCheckbox.exec(h.raw);if(A){let g={type:"checkbox",raw:A[0]+" ",checked:A[0]!=="[ ]"};h.checked=g.checked,a.loose?h.tokens[0]&&["paragraph","text"].includes(h.tokens[0].type)&&"tokens"in h.tokens[0]&&h.tokens[0].tokens?(h.tokens[0].raw=g.raw+h.tokens[0].raw,h.tokens[0].text=g.raw+h.tokens[0].text,h.tokens[0].tokens.unshift(g)):h.tokens.unshift({type:"paragraph",raw:g.raw,text:g.raw,tokens:[g]}):h.tokens.unshift(g)}}if(!a.loose){let A=h.tokens.filter(p=>p.type==="space"),g=A.length>0&&A.some(p=>this.rules.other.anyLine.test(p.raw));a.loose=g}}if(a.loose)for(let h of a.items){h.loose=!0;for(let A of h.tokens)A.type==="text"&&(A.type="paragraph")}return a}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),i=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",s=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:i,title:s}}}table(n){var a;let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=bs(e[1]),i=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),s=(a=e[3])!=null&&a.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+o.raw,u.text+=`
`+o.raw,this.inlineQueue.at(-1).src=u.text):this.tokens.links[o.tag]||(this.tokens.links[o.tag]={href:o.href,title:o.title},t.push(o));continue}if(o=this.tokenizer.table(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.lheading(e)){e=e.substring(o.raw.length),t.push(o);continue}let l=e;if((a=this.options.extensions)!=null&&a.startBlock){let u=1/0,h=e.slice(1),A;this.options.extensions.startBlock.forEach(g=>{A=g.call({lexer:this},h),typeof A=="number"&&A>=0&&(u=Math.min(u,A))}),u<1/0&&u>=0&&(l=e.substring(0,u+1))}if(this.state.top&&(o=this.tokenizer.paragraph(l))){let u=t.at(-1);i&&(u==null?void 0:u.type)==="paragraph"?(u.raw+=(u.raw.endsWith(`
`)?"":`
`)+o.raw,u.text+=`
...
`)?"":`
`)+o.raw,u.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):t.push(o);continue}if(e){let u="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(u);break}else throw new Error(u)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var l,u,h,A,g;let i=e,s=null;if(this.tokens.links){let p=Object.keys(this.tokens.links);if(p.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)p.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let r;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)r=s[2]?s[2].length:0,i=i.slice(0,s.index+r)+"["+"a".repeat(s[0].length-r-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((u=(l=this.options.hooks)==null?void 0:l.emStrongMask)==null?void 0:u.call({lexer:this},i))??i;let a=!1,o="";for(;e;){a||(o=""),a=!1;let p;if((A=(h=this.options.extensions)==null?void 0:h.inline)!=null&&A.some(w=>(p=w.call({lexer:this},e,t))?(e=e.substring(p.raw.length),t.push(p),!0):!1))continue;if(p=this.tokenizer.escape(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.tag(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.link(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(p.raw.length);let w=t.at(-1);p.type==="text"&&(w==null?void 0:w.type)==="text"?(w.raw+=p.raw,w.text+=p.text):t.push(p);continue}if(p=this.tokenizer.emStrong(e,i,o)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.codespan(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.br(e)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.del(e,i,o)){e=e.substring(p.raw.length),t.push(p);continue}if(p=this.tokenizer.autolink(e)){e=e.substring(p.raw.length),t.push(p);continue}if(!this.state.inLink&&(p=this.tokenizer.url(e))){e=e.substring(p.raw.length),t.push(p);continue}let P=e;if((g=this.options.extensions)!=null&&g.startInline){let w=1/0,L=e.slice(1),O;this.options.extensions.startInline.forEach(_=>{O=_.call({lexer:this},L),typeof O=="number"&&O>=0&&(w=Math.min(w,O))}),w<1/0&&w>=0&&(P=e.substring(0,w+1))}if(p=this.tokenizer.inlineText(P)){e=e.substring(p.raw.length),p.raw.slice(-1)!=="_"&&(o=p.raw.slice(-1)),a=!0;let w=t.at(-1);(w==null?void 0:w.type)==="text"?(w.raw+=p.raw,w.text+=p.text):t.push(p);continue}if(e){let w="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(w);break}else throw new Error(w)}}return t}},gt=class{constructor(n){j(this,"options");j(this,"parser");this.options=n||he}space(n){return""}code({text:n,lang:e,escaped:t}){var r;let i=(r=(e||"").match(an.notSpaceStart))==null?void 0:r[0],s=n.replace(an.endingNewline,"")+`
...
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5}}},ic={class:"container"},sc={class:"site-header"},rc={class:"stats"},oc={class:"stat"},ac={class:"stat-num"},lc={class:"stat"},cc={class:"stat-num"},uc={class:"stat"},hc={class:"stat-num"},dc={class:"filter-bar"},pc=["onClick"],Ac={key:0,class:"note-list"},fc=["onClick"],gc={class:"note-meta"},Ic={class:"note-date"},mc={class:"note-title"},bc={key:0,class:"note-summary"},yc={key:1,class:"empty-state"},wc={class:"detail-header"},vc={class:"detail-title"},Sc={class:"detail-meta"},kc={class:"note-date"},xc=["innerHTML"],Pc={__name:"App",setup(n){W.setOptions({breaks:!1,gfm:!0});const e=ws.notes,t=ws.categories,i=Et(null),s=Et(null),r=Et("加载中..."),a=ot(()=>new Set(e.map(p=>p.date)).size),o=ot(()=>i.value?e.filter(g=>g.category===i.value):e),l=ot(()=>s.value?W(s.value.content):"");async function u(){try{const g=localStorage.getItem("erzi-knowledge-visits");g?r.value=parseInt(g):r.value=1;const p=(parseInt(g)||0)+1;localStorage.setItem("erzi-knowledge-visits",p.toString()),r.value=p}catch(g){console.error("访问统计加载失败:",g),r.value="统计不可用"}}ir(()=>{u()});function h(g){s.value=g,Kt(()=>window.scrollTo(0,0))}function A(){s.value=null,Kt(()=>window.scrollTo(0,0))}return(g,p)=>{var P;return bn(),Mn("div",ic,[s.value?(bn(),Mn(fn,{key:1},[F("div",wc,[F("button",{class:"back-btn",onClick:A},[...p[7]||(p[7]=[F("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[F("polyline",{points:"15 18 9 12 15 6"})],-1),Ae(" 返回 ",-1)])]),F("h1",vc,In(s.value.title),1),F("div",Sc,[F("span",{class:oe(["note-category","note-category--"+s.value.category])},In((P=Me(t)[s.value.category])==null?void 0:P.label),3),F("span",kc,In(s.value.date),1)])]),F("div",{class:"note-content",innerHTML:l.value},null,8,xc),F("footer",{class:"site-footer"},[F("button",{class:"back-btn",onClick:A},[...p[8]||(p[8]=[F("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[F("polyline",{points:"15 18 9 12 15 6"})],-1),Ae(" 返回列表 ",-1)])])])],64)):(bn(),Mn(fn,{key:0},[F("header",sc,[p[4]||(p[4]=F("div",{class:"site-title"},"二子的知识库",-1)),p[5]||(p[5]=F("div",{class:"site-subtitle"},"跟二子一起学习",-1)),F("div",rc,[F("span",oc,[F("span",ac,In(Me(e).length),1),p[1]||(p[1]=Ae(" 篇笔记",-1))]),F("span",lc,[F("span",cc,In(a.value),1),p[2]||(p[2]=Ae(" 天探索",-1))]),F("span",uc,[F("span",hc,In(r.value),1),p[3]||(p[3]=Ae(" 次访问",-1))])])]),F("div",dc,[F("button",{class:oe(["filter-btn",{active:i.value===null}]),onClick:p[0]||(p[0]=w=>i.value=null)},"全部",2),(bn(!0),Mn(fn,null,Hi(Me(t),(w,L)=>(bn(),Mn("button",{key:L,class:oe(["filter-btn",{active:i.value===L}]),onClick:O=>i.value=L},In(w.label),11,pc))),128))]),o.value.length?(bn(),Mn("div",Ac,[(bn(!0),Mn(fn,null,Hi(o.value,w=>{var L;return bn(),Mn("div",{key:w.id+w.category,class:"note-item",onClick:O=>h(w)},[F("div",gc,[F("span",{class:oe(["note-category","note-category--"+w.category])},In((L=Me(t)[w.category])==null?void 0:L.label),3),F("span",Ic,In(w.date),1)]),F("div",mc,In(w.title),1),w.summary?(bn(),Mn("div",bc,In(w.summary),1)):Ra("",!0)],8,fc)}),128))])):(bn(),Mn("div",yc," 暂无笔记 ")),p[6]||(p[6]=F("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};hl(Pc).mount("#app");
