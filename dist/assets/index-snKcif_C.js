...
${A}`:A,s=s?`${s}
${u}`:u;let h=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,r,!0),this.lexer.state.top=h,t.length===0)break;let p=r.at(-1);if((p==null?void 0:p.type)==="code")break;if((p==null?void 0:p.type)==="blockquote"){let I=p,k=I.raw+`
`+t.join(`
`),w=this.blockquote(k);r[r.length-1]=w,i=i.substring(0,i.length-I.raw.length)+w.raw,s=s.substring(0,s.length-I.text.length)+w.text;break}else if((p==null?void 0:p.type)==="list"){let I=p,k=I.raw+`
`+t.join(`
`),w=this.list(k);r[r.length-1]=w,i=i.substring(0,i.length-p.raw.length)+w.raw,s=s.substring(0,s.length-I.raw.length)+w.raw,t=k.substring(r.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:i,tokens:r,text:s}}}list(n){var t,i;let e=this.rules.block.list.exec(n);if(e){let s=e[1].trim(),r=s.length>1,a={type:"list",raw:"",ordered:r,start:r?+s.slice(0,-1):"",loose:!1,items:[]};s=r?`\\d{1,9}\\${s.slice(-1)}`:`\\${s}`,this.options.pedantic&&(s=r?s:"[*+-]");let o=this.rules.other.listItemRegex(s),l=!1;for(;n;){let u=!1,h="",p="";if(!(e=o.exec(n))||this.rules.block.hr.test(n))break;h=e[0],n=n.substring(h.length);let I=nc(e[2].split(`
`,1)[0],e[1].length),k=n.split(`
`,1)[0],w=!I.trim(),x=0;if(this.options.pedantic?(x=2,p=I.trimStart()):w?x=e[1].length+1:(x=I.search(this.rules.other.nonSpaceChar),x=x>4?1:x,p=I.slice(x),x+=e[1].length),w&&this.rules.other.blankLine.test(k)&&(h+=k+`
...
`+cn.slice(x);else{if(w||I.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||V.test(I)||R.test(I)||B.test(I))break;p+=`
`+k}w=!k.trim(),h+=ln+`
`,n=n.substring(ln.length+1),I=cn.slice(x)}}a.loose||(l?a.loose=!0:this.rules.other.doubleBlankLine.test(h)&&(l=!0)),a.items.push({type:"list_item",raw:h,task:!!this.options.gfm&&this.rules.other.listIsTask.test(p),loose:!1,text:p,tokens:[]}),a.raw+=h}let A=a.items.at(-1);if(A)A.raw=A.raw.trimEnd(),A.text=A.text.trimEnd();else return;a.raw=a.raw.trimEnd();for(let u of a.items){if(this.lexer.state.top=!1,u.tokens=this.lexer.blockTokens(u.text,[]),u.task){if(u.text=u.text.replace(this.rules.other.listReplaceTask,""),((t=u.tokens[0])==null?void 0:t.type)==="text"||((i=u.tokens[0])==null?void 0:i.type)==="paragraph"){u.tokens[0].raw=u.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),u.tokens[0].text=u.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let p=this.lexer.inlineQueue.length-1;p>=0;p--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[p].src)){this.lexer.inlineQueue[p].src=this.lexer.inlineQueue[p].src.replace(this.rules.other.listReplaceTask,"");break}}let h=this.rules.other.listTaskCheckbox.exec(u.raw);if(h){let p={type:"checkbox",raw:h[0]+" ",checked:h[0]!=="[ ]"};u.checked=p.checked,a.loose?u.tokens[0]&&["paragraph","text"].includes(u.tokens[0].type)&&"tokens"in u.tokens[0]&&u.tokens[0].tokens?(u.tokens[0].raw=p.raw+u.tokens[0].raw,u.tokens[0].text=p.raw+u.tokens[0].text,u.tokens[0].tokens.unshift(p)):u.tokens.unshift({type:"paragraph",raw:p.raw,text:p.raw,tokens:[p]}):u.tokens.unshift(p)}}if(!a.loose){let h=u.tokens.filter(I=>I.type==="space"),p=h.length>0&&h.some(I=>this.rules.other.anyLine.test(I.raw));a.loose=p}}if(a.loose)for(let u of a.items){u.loose=!0;for(let h of u.tokens)h.type==="text"&&(h.type="paragraph")}return a}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),i=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",s=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:i,title:s}}}table(n){var a;let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=ys(e[1]),i=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),s=(a=e[3])!=null&&a.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+o.raw,A.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=A.text):t.push(o);continue}if(e){let A="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(A);break}else throw new Error(A)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var l,A,u,h,p;let i=e,s=null;if(this.tokens.links){let I=Object.keys(this.tokens.links);if(I.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)I.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let r;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)r=s[2]?s[2].length:0,i=i.slice(0,s.index+r)+"["+"a".repeat(s[0].length-r-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((A=(l=this.options.hooks)==null?void 0:l.emStrongMask)==null?void 0:A.call({lexer:this},i))??i;let a=!1,o="";for(;e;){a||(o=""),a=!1;let I;if((h=(u=this.options.extensions)==null?void 0:u.inline)!=null&&h.some(w=>(I=w.call({lexer:this},e,t))?(e=e.substring(I.raw.length),t.push(I),!0):!1))continue;if(I=this.tokenizer.escape(e)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.tag(e)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.link(e)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(I.raw.length);let w=t.at(-1);I.type==="text"&&(w==null?void 0:w.type)==="text"?(w.raw+=I.raw,w.text+=I.text):t.push(I);continue}if(I=this.tokenizer.emStrong(e,i,o)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.codespan(e)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.br(e)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.del(e,i,o)){e=e.substring(I.raw.length),t.push(I);continue}if(I=this.tokenizer.autolink(e)){e=e.substring(I.raw.length),t.push(I);continue}if(!this.state.inLink&&(I=this.tokenizer.url(e))){e=e.substring(I.raw.length),t.push(I);continue}let k=e;if((p=this.options.extensions)!=null&&p.startInline){let w=1/0,x=e.slice(1),F;this.options.extensions.startInline.forEach(B=>{F=B.call({lexer:this},x),typeof F=="number"&&F>=0&&(w=Math.min(w,F))}),w<1/0&&w>=0&&(k=e.substring(0,w+1))}if(I=this.tokenizer.inlineText(k)){e=e.substring(I.raw.length),I.raw.slice(-1)!=="_"&&(o=I.raw.slice(-1)),a=!0;let w=t.at(-1);(w==null?void 0:w.type)==="text"?(w.raw+=I.raw,w.text+=I.text):t.push(I);continue}if(e){let w="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(w);break}else throw new Error(w)}}return t}},pt=class{constructor(n){z(this,"options");z(this,"parser");this.options=n||ue}space(n){return""}code({text:n,lang:e,escaped:t}){var r;let i=(r=(e||"").match(an.notSpaceStart))==null?void 0:r[0],s=n.replace(an.endingNewline,"")+`
...
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5},insights:{label:"洞见报告",color:"#f59e0b",priority:6}}},ic={class:"container"},sc={class:"site-header"},rc={class:"stats"},oc={class:"stat"},ac={class:"stat-num"},lc={class:"stat"},cc={class:"stat-num"},Ac={class:"stat"},uc={class:"stat-num"},dc={class:"filter-bar"},Ic=["onClick"],hc={key:0,class:"note-list"},gc=["onClick"],pc={class:"note-meta"},fc={class:"note-date"},mc={class:"note-title"},yc={key:0,class:"note-summary"},bc={key:1,class:"empty-state"},wc={class:"detail-header"},vc={class:"detail-title"},Sc={class:"detail-meta"},Pc={class:"note-date"},Cc=["innerHTML"],kc={__name:"App",setup(n){N.setOptions({breaks:!1,gfm:!0});const e=ws.notes,t=ws.categories,i=Et(null),s=Et(null),r=Et("加载中..."),a=ot(()=>new Set(e.map(I=>I.date)).size),o=ot(()=>i.value?e.filter(p=>p.category===i.value):e),l=ot(()=>s.value?N(s.value.content):"");async function A(){try{const p=localStorage.getItem("erzi-knowledge-visits");p?r.value=parseInt(p):r.value=1;const I=(parseInt(p)||0)+1;localStorage.setItem("erzi-knowledge-visits",I.toString()),r.value=I}catch(p){console.error("访问统计加载失败:",p),r.value="统计不可用"}}ir(()=>{A()});function u(p){s.value=p,Kt(()=>window.scrollTo(0,0))}function h(){s.value=null,Kt(()=>window.scrollTo(0,0))}return(p,I)=>{var k;return yn(),Rn("div",ic,[s.value?(yn(),Rn(gn,{key:1},[_("div",wc,[_("button",{class:"back-btn",onClick:h},[...I[7]||(I[7]=[_("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[_("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回 ",-1)])]),_("h1",vc,fn(s.value.title),1),_("div",Sc,[_("span",{class:oe(["note-category","note-category--"+s.value.category])},fn((k=Re(t)[s.value.category])==null?void 0:k.label),3),_("span",Pc,fn(s.value.date),1)])]),_("div",{class:"note-content",innerHTML:l.value},null,8,Cc),_("footer",{class:"site-footer"},[_("button",{class:"back-btn",onClick:h},[...I[8]||(I[8]=[_("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[_("polyline",{points:"15 18 9 12 15 6"})],-1),he(" 返回列表 ",-1)])])])],64)):(yn(),Rn(gn,{key:0},[_("header",sc,[I[4]||(I[4]=_("div",{class:"site-title"},"二子的知识库",-1)),I[5]||(I[5]=_("div",{class:"site-subtitle"},"跟二子一起学习",-1)),_("div",rc,[_("span",oc,[_("span",ac,fn(Re(e).length),1),I[1]||(I[1]=he(" 篇笔记",-1))]),_("span",lc,[_("span",cc,fn(a.value),1),I[2]||(I[2]=he(" 天探索",-1))]),_("span",Ac,[_("span",uc,fn(r.value),1),I[3]||(I[3]=he(" 次访问",-1))])])]),_("div",dc,[_("button",{class:oe(["filter-btn",{active:i.value===null}]),onClick:I[0]||(I[0]=w=>i.value=null)},"全部",2),(yn(!0),Rn(gn,null,ji(Re(t),(w,x)=>(yn(),Rn("button",{key:x,class:oe(["filter-btn",{active:i.value===x}]),onClick:F=>i.value=x},fn(w.label),11,Ic))),128))]),o.value.length?(yn(),Rn("div",hc,[(yn(!0),Rn(gn,null,ji(o.value,w=>{var x;return yn(),Rn("div",{key:w.id+w.category,class:"note-item",onClick:F=>u(w)},[_("div",pc,[_("span",{class:oe(["note-category","note-category--"+w.category])},fn((x=Re(t)[w.category])==null?void 0:x.label),3),_("span",fc,fn(w.date),1)]),_("div",mc,fn(w.title),1),w.summary?(yn(),Rn("div",yc,fn(w.summary),1)):La("",!0)],8,gc)}),128))])):(yn(),Rn("div",bc," 暂无笔记 ")),I[6]||(I[6]=_("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};ul(kc).mount("#app");
