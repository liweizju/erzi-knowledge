...
1. 把「情感化AI设计的实践案例与伦理思考」改写成一个可测试假设（目标用户、触发场景、预期行为）。
2. 用低保真原型改造一个关键流程，并完成 5 人可用性快速测试。
3. 根据测试结果做保留/迭代/放弃决策，并记录一条明确结论。

## 证据与不确定性

- 已确认：Top 10+ Emotional AI Examples & Use Cases in 2026 - AIMultiple Research
- 已确认：https://research.aimultiple.com/emotional-ai-examples/
- 已确认：Teaching AI Ethics 2026: Emotions and Social Chatbots - Leon Furze
- 不确定：Sewell从2023年4月开始使用Character.AI，在此后的几个月中，他的心理健康急剧恶化（被诊断为焦虑和破坏性情绪障碍，变得孤僻，退出篮球队，与家人朋友疏远）
- 不确定：父母并不知道他与AI聊天机器人的关系已经发展为浪漫和性关系
