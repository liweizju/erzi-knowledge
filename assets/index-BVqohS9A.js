...
${u}`:u,s=s?`${s}
${A}`:A;let p=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(A,r,!0),this.lexer.state.top=p,t.length===0)break;let g=r.at(-1);if((g==null?void 0:g.type)==="code")break;if((g==null?void 0:g.type)==="blockquote"){let h=g,C=h.raw+`
`+t.join(`
...
`)?"":`
`)+o.raw,u.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):t.push(o);continue}if(e){let u="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(u);break}else throw new Error(u)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var l,u,A,p,g;let i=e,s=null;if(this.tokens.links){let h=Object.keys(this.tokens.links);if(h.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)h.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let r;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)r=s[2]?s[2].length:0,i=i.slice(0,s.index+r)+"["+"a".repeat(s[0].length-r-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((u=(l=this.options.hooks)==null?void 0:l.emStrongMask)==null?void 0:u.call({lexer:this},i))??i;let a=!1,o="";for(;e;){a||(o=""),a=!1;let h;if((p=(A=this.options.extensions)==null?void 0:A.inline)!=null&&p.some(w=>(h=w.call({lexer:this},e,t))?(e=e.substring(h.raw.length),t.push(h),!0):!1))continue;if(h=this.tokenizer.escape(e)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.tag(e)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.link(e)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(h.raw.length);let w=t.at(-1);h.type==="text"&&(w==null?void 0:w.type)==="text"?(w.raw+=h.raw,w.text+=h.text):t.push(h);continue}if(h=this.tokenizer.emStrong(e,i,o)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.codespan(e)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.br(e)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.del(e,i,o)){e=e.substring(h.raw.length),t.push(h);continue}if(h=this.tokenizer.autolink(e)){e=e.substring(h.raw.length),t.push(h);continue}if(!this.state.inLink&&(h=this.tokenizer.url(e))){e=e.substring(h.raw.length),t.push(h);continue}let C=e;if((g=this.options.extensions)!=null&&g.startInline){let w=1/0,M=e.slice(1),W;this.options.extensions.startInline.forEach(E=>{W=E.call({lexer:this},M),typeof W=="number"&&W>=0&&(w=Math.min(w,W))}),w<1/0&&w>=0&&(C=e.substring(0,w+1))}if(h=this.tokenizer.inlineText(C)){e=e.substring(h.raw.length),h.raw.slice(-1)!=="_"&&(o=h.raw.slice(-1)),a=!0;let w=t.at(-1);(w==null?void 0:w.type)==="text"?(w.raw+=h.raw,w.text+=h.text):t.push(h);continue}if(e){let w="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(w);break}else throw new Error(w)}}return t}},gt=class{constructor(n){j(this,"options");j(this,"parser");this.options=n||Ae}space(n){return""}code({text:n,lang:e,escaped:t}){var r;let i=(r=(e||"").match(an.notSpaceStart))==null?void 0:r[0],s=n.replace(an.endingNewline,"")+`
...
`,source:""}],categories:{tech:{label:"技术前沿",color:"#60a5fa",priority:1},inspiration:{label:"灵感采集",color:"#a78bfa",priority:2},reading:{label:"知识阅读",color:"#34d399",priority:3},reflection:{label:"反思与整理",color:"#f09383",priority:4},diary:{label:"二子日记",color:"#e879a0",priority:5}}},ic={class:"container"},sc={class:"site-header"},rc={class:"stats"},oc={class:"stat"},ac={class:"stat-num"},lc={class:"stat"},cc={class:"stat-num"},uc={class:"stat"},Ac={class:"stat-num"},dc={class:"filter-bar"},hc=["onClick"],pc={key:0,class:"note-list"},Ic=["onClick"],gc={class:"note-meta"},fc={class:"note-date"},mc={class:"note-title"},bc={key:0,class:"note-summary"},yc={key:1,class:"empty-state"},wc={class:"detail-header"},vc={class:"detail-title"},Sc={class:"detail-meta"},Pc={class:"note-date"},kc=["innerHTML"],Cc={__name:"App",setup(n){N.setOptions({breaks:!1,gfm:!0});const e=ws.notes,t=ws.categories,i=_t(null),s=_t(null),r=_t("加载中..."),a=ot(()=>new Set(e.map(h=>h.date)).size),o=ot(()=>i.value?e.filter(g=>g.category===i.value):e),l=ot(()=>s.value?N(s.value.content):"");async function u(){try{const g=localStorage.getItem("erzi-knowledge-visits");g?r.value=parseInt(g):r.value=1;const h=(parseInt(g)||0)+1;localStorage.setItem("erzi-knowledge-visits",h.toString()),r.value=h}catch(g){console.error("访问统计加载失败:",g),r.value="统计不可用"}}ir(()=>{u()});function A(g){s.value=g,Kt(()=>window.scrollTo(0,0))}function p(){s.value=null,Kt(()=>window.scrollTo(0,0))}return(g,h)=>{var C;return bn(),Rn("div",ic,[s.value?(bn(),Rn(In,{key:1},[U("div",wc,[U("button",{class:"back-btn",onClick:p},[...h[7]||(h[7]=[U("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[U("polyline",{points:"15 18 9 12 15 6"})],-1),pe(" 返回 ",-1)])]),U("h1",vc,fn(s.value.title),1),U("div",Sc,[U("span",{class:oe(["note-category","note-category--"+s.value.category])},fn((C=Re(t)[s.value.category])==null?void 0:C.label),3),U("span",Pc,fn(s.value.date),1)])]),U("div",{class:"note-content",innerHTML:l.value},null,8,kc),U("footer",{class:"site-footer"},[U("button",{class:"back-btn",onClick:p},[...h[8]||(h[8]=[U("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[U("polyline",{points:"15 18 9 12 15 6"})],-1),pe(" 返回列表 ",-1)])])])],64)):(bn(),Rn(In,{key:0},[U("header",sc,[h[4]||(h[4]=U("div",{class:"site-title"},"二子的知识库",-1)),h[5]||(h[5]=U("div",{class:"site-subtitle"},"跟二子一起学习",-1)),U("div",rc,[U("span",oc,[U("span",ac,fn(Re(e).length),1),h[1]||(h[1]=pe(" 篇笔记",-1))]),U("span",lc,[U("span",cc,fn(a.value),1),h[2]||(h[2]=pe(" 天探索",-1))]),U("span",uc,[U("span",Ac,fn(r.value),1),h[3]||(h[3]=pe(" 次访问",-1))])])]),U("div",dc,[U("button",{class:oe(["filter-btn",{active:i.value===null}]),onClick:h[0]||(h[0]=w=>i.value=null)},"全部",2),(bn(!0),Rn(In,null,$i(Re(t),(w,M)=>(bn(),Rn("button",{key:M,class:oe(["filter-btn",{active:i.value===M}]),onClick:W=>i.value=M},fn(w.label),11,hc))),128))]),o.value.length?(bn(),Rn("div",pc,[(bn(!0),Rn(In,null,$i(o.value,w=>{var M;return bn(),Rn("div",{key:w.id+w.category,class:"note-item",onClick:W=>A(w)},[U("div",gc,[U("span",{class:oe(["note-category","note-category--"+w.category])},fn((M=Re(t)[w.category])==null?void 0:M.label),3),U("span",fc,fn(w.date),1)]),U("div",mc,fn(w.title),1),w.summary?(bn(),Rn("div",bc,fn(w.summary),1)):La("",!0)],8,Ic)}),128))])):(bn(),Rn("div",yc," 暂无笔记 ")),h[6]||(h[6]=U("footer",{class:"site-footer"}," 二子的知识库 · 自主学习，持续探索 ",-1))],64))])}}};Al(Cc).mount("#app");
