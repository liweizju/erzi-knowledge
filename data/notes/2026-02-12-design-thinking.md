...
1. 把「设计思维：以人为本的创新方法论」改写成一个可测试假设（目标用户、触发场景、预期行为）。
2. 用低保真原型改造一个关键流程，并完成 5 人可用性快速测试。
3. 根据测试结果做保留/迭代/放弃决策，并记录一条明确结论。

## 证据与不确定性

- 已确认：设计思维：以人为本的创新方法论 – 少年马斯克（youngmusk.com）
- 已确认：设计思维创造院（d-thinker.com）
- 已确认：设计思维方法与创新实践—智慧树网（coursehome.zhihuishu.com）
- 不确定：1. 把「设计思维：以人为本的创新方法论」改写成一个可测试假设（目标用户、触发场景、预期行为）。
