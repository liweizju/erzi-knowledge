...
> **30秒结论**：「转换性」成为核心标准：法庭越来越看重 AI 训练是否创造了「新用途」而非「替代原作品」——通用 LLM 倾向转换性，专用工具倾向市场替代
...
1. 提炼「AI 版权诉讼的关键转折点」里的 1 条反直觉判断，并与团队当前策略逐项对照。
2. 写出“本周要停止”和“本周要开始”各 1 条具体动作。
3. 设定 7 天后复盘指标，验证该判断是否改善你的决策质量。

## 证据与不确定性

- 已确认：AI and Copyright: How Lessons from Litigation Can Pave the Way to Licensing（ipwatchdog.com）
- 已确认：AI Trends for 2026 - Copyright Litigation Shifts from Training Data to AI Outputs（mofo.com）
- 已确认：AI copyright battles enter pivotal year as US courts weigh fair use（reuters.com）
- 不确定：争议：版权局长 Shira Perlmutter 在报告发布前一天被特朗普政府解职，引发法律和政策观察者的质疑。
- 不确定：- 输入数据市场：原告的「潜在许可市场」论点是循环论证——前提是假设使用非转换性
